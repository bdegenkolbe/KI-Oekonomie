...
| **Disjunkte VZÄ-Zerlegung über hundert Felder** | **gelaufen, gerissen** | Sitzung A, Runde 0a: sieben von hundert Feldern tragen eine primäre Bezugsgröße, 42 % des Kontrollrahmens; 95 von 110 Rollen bestreiten die Vorgabe. Befund, Ursache und Reparatur in `18-Strategiepapier-2031.md` § 4 und § 5 |
...
| **Bezugsgrößendeckung** | ≥ 60 % der hundert Felder tragen eine primäre, disjunkte Bezugsgröße, und deren Summe deckt ≥ 70 % des Kontrollrahmens | ob die Zentraltabelle des Zielprodukts überhaupt gebaut werden kann — **in Sitzung A gerissen** mit 7 % und 42 % (`17-Sitzung-A.md` § 3.1) |
