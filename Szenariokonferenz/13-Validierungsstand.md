...
| **Modellabhängigkeit** | < 1 × Panel-IQR bei mindestens vier der sechs Pflichtgrößen | ob das Panel die Rollen misst oder das Modell. Sitzung A: **3 von 6, gerissen** — überwiegend Artefakt der Bezugsgröße null. Nachlauf auf sieben verankerten Rollen: **6 von 6**, keine Größe über 0,86. Das ist eine Untergrenze aus den Bänken A und C; für die Felder ohne amtliche Bezugsgröße **offen** bis Sitzung B (`17-Sitzung-A.md` § 3.3a) |
...
| **Begründungspflicht für D** | 100 % der Rollen mit D > 1,0 nennen den Mechanismus, über den mehr Personalbedarf verschwindet als Arbeitszeit frei wird | ob ein Durchgriff über 1,0 hergeleitet oder gesetzt ist. In Sitzung A **gerissen**: 11 Rollen über 1,0, davon 2 mit erkennbarer Begründung; keine über 1,5 und keine außerhalb des erlaubten Bereichs |
