...
|---|---|---|---|---|
| Basis ohne transformative KI | — | rund 2 % | rund 60 % | — |
| *modest* (gering) | gering | knapp über Basis | knapp unter 60 % | 8 von 83 |
| *substantial* (deutlich) | +8,3 % | 5,4 % | rund 56 % | 73 von 83 |
| *extreme* (sehr stark) | +32 % | 15 % | rund 45 % | 2 von 83 |
...
### Wo die US-Rechnung nicht auf Europa passt
...
|---|---|---|---|
| **Preis** | Ein Produktivitätsgewinn senkt den Preis oder erhöht die Marge. | Preise folgen Budgets, Fallpauschalen und Verhandlungsterminen. | 12 % statt 52 % |
| **Zeit** | Anpassung, sobald die Technik es erlaubt. | Tarifrunden, Vergabeverfahren und Haushaltsjahre verzögern. | rund 3 Jahre |
| **Haftung** | Kein eigener Kostenfaktor. | KI-Verordnung, Medizinprodukte- und Berufsrecht verlangen jemanden, der einsteht. | 7 von 12 |
| **Ort** | Der Gewinn bleibt im Land. | Modelle und Rechenzentren liegen überwiegend außerhalb Europas. | 55 % bleiben in der EU |
...
### Wer den Effizienzgewinn bekäme
...
Die Leistungsausgaben der GKV lagen 2025 bei 331,1 Mrd. €. Bis 2031 würden sie auf rund 420 Mrd. € steigen, ein Plus von 26,9 Prozent; mit Verwaltung und sonstigen Ausgaben wären es rund 436 Mrd. €. Das Wachstum käme aus Alterung, Krankheitslast und Menge. Die Vergütung je Leistung stiege im selben Zeitraum nur um 13 Prozent. Nach einer zweiten zulässigen Lesart des § 71 Abs. 3 SGB V wären es 16 Prozent, in einer Spanne von 8 bis 20 Prozent. Die beiden Lesarten unterscheiden sich darin, ob der Zuwachs der Einnahmen auf alle Mitglieder zusammen (2,4 Prozent im Jahr) oder je Mitglied (2,7 Prozent) gerechnet wird.

Die Kosten der Leistungserbringer würden nach den Einschätzungen um 18 bis 26 Prozent steigen. Real, also nach Abzug dieser Kostensteigerung, sänke die Vergütung je Leistung damit um 4 bis 10 Prozent.
...
### Private Krankenversicherung: stabiler Bestand, steigende Beiträge

Die private Krankenversicherung (PKV) zählte 2025 rund 8,79 Millionen Vollversicherte, 0,5 Prozent mehr als im Vorjahr. Zum 1. Januar 2026 stiegen die Beiträge im Schnitt um 12,6 Prozent, für 81 Prozent der Versicherten; im Jahr davor waren es 13,9 Prozent. Die Alterungsrückstellungen wuchsen auf 355,4 Mrd. €. Größter Kostentreiber waren die Pflegekosten im Krankenhaus mit einem Plus von 17,6 Prozent. Die PKV hätte damit einen starken Anreiz, Effizienzgewinne zu nutzen, aber wenig Einfluss: Sie verhandelt keine Krankenhauspreise.
...
### Mehr Preisdruck, mehr Bedarf an Evidenz

Wer einen Preis verteidigen muss, braucht bessere Begründungen. 14 der 18 Einschätzungen zur Pharmaindustrie erwarten deshalb, dass die US-Politik den deutschen Markt für Evidenz vergrößert; vier erwarten das Gegenteil. Der Median läge bei +9 Prozent, in Euro bei rund 65 Mio.
...
|---|---|---|---|
| Extern beauftragte Evidenz und Analytik, Deutschland | 800 Mio. € | 550 bis 1.150 | auf 50 Mio. € genau zu lesen |
| Preisindex je Leistung (2025 = 100) | 75 | 55 bis 95 | ein Viertel billiger |
| Menge gegenüber 2025 | rund 1,5-fach | 1,25 bis 1,80 | die Hälfte mehr Aufträge |
| Preisdurchgriff im Markt des Verbunds | 58 % | — | der Gewinn geht an die Kunden |
...
### Zwei Leistungsarten mit entgegengesetzter Entwicklung
...
### Der Ausblick je Gesellschaft

**WIG2 und GREENBAY Software** würden jeweils um rund 20 Prozent wachsen. Die Fachrollen ordnen WIG2 der Leistung mit Haftung zu; der Wert ist eher vorsichtig, denn die gesamte Spanne für WIG2 liegt unter dem Mittelwert dieser Leistungsart. Bei GREENBAY Software ist die Zuordnung offen: Als Anbieter von Leistung mit Haftung käme die Gesellschaft auf plus 40 bis 60 Prozent, als Anbieter von Standardauswertung auf minus 25 Prozent. Die angegebenen plus 20 Prozent klären diese Frage nicht.

**4K ANALYTICS** würde rund 10 Prozent Umsatz und 30 Prozent Deckungsbeitrag verlieren. Ihr Geschäft liegt überwiegend in der Standardauswertung, deren Wertanteil von 70 auf 32 Prozent fiele. Die Abhängigkeit von zwei Kunden verstärkt das Risiko. In Euro stünden einem Plus von rund 1,3 Mio. € bei WIG2 ein Minus von rund 0,6 Mio. € bei 4K gegenüber.

**CLINIBOTS** läge bei minus 60 Prozent Umsatz und minus 80 Prozent Deckungsbeitrag. Das Produkt wertet öffentlich zugängliche Daten aus, etwa nach § 21 KHEntgG und aus den Qualitätsberichten der Krankenhäuser. Diese Art von Auswertung könnte KI am leichtesten ersetzen. Der Betrag ist mit rund 49.000 € klein; offen ist, welches Geschäftsmodell die Gesellschaft 2031 trägt.
...
|---|---|---|
| Haftung | 7 von 12 | 7 Nennungen |
| Refinanzierung | 4 von 12 | 29 Nennungen |
| Akzeptanz | 1 von 12 | — |
| Investitionsfähigkeit | — | 24 Nennungen |
| Recht | — | 23 Nennungen |
...
|---|---|---|
| 1 Europa | Im Gesundheitswesen zeigt sich ein Effizienzgewinn kaum im Preis. | Billigere Standardarbeit allein bringt keinen höheren Preis. |
| 2 Deutschland | Die Beitragsbasis wächst weiter; im Markt des Verbunds erhielten die Kunden den größten Anteil eines Effizienzgewinns. | Die Finanzierung trägt; der Wettbewerb gibt Effizienz weiter. |
| 3 Gesundheitswesen | Mehr Leistungen, real sinkende Vergütung, strengere Nachweise. | Kunden kaufen belastbare Ergebnisse, keine Auswertung um ihrer selbst willen. |
| 4 Pharma und USA | Preisdruck erhöht den Bedarf an Evidenz für die Nutzenbewertung. | Wachstum liegt bei Ergebnissen, die in Verfahren bestehen. |
| 5 Unser Markt | Wertanteil der Leistung mit Haftung steigt von 30 auf 68 Prozent. | Die Richtung: vom Auswerten zum Einstehen. |
| 6 Die Gesellschaften | Große Unterschiede; wichtigster Engpass ist die Haftung. | Gemeinsame Richtung, eigene Wege je Gesellschaft. |

Quelle: Kapitel 1 bis 6 dieses Papiers.

### Die Richtung: vom Auswerten zum Einstehen

Der Verbund würde seinen Wert künftig weniger aus Rechenarbeit ziehen als aus Ergebnissen, für die er einsteht. Die Standardauswertung verschwände nicht; sie würde billiger, stärker automatisiert und wäre eher Grundlage als Produkt. Das Produkt wäre das verantwortete Ergebnis.

### Zwei Pfade zur Orientierung

Die Modellrechnung unterscheidet zwei Pfade. In **Pfad A** kann der Verbund für seine Ergebnisse haften, mit Versicherungsdeckung und Abnahmeverfahren. Der Außenumsatz stiege bis 2031 um rund 5 Prozent, der Deckungsbeitrag sänke um 15 Prozent. In **Pfad B** bliebe der Verbund bei der Standardauswertung. Der Außenumsatz fiele um rund 30 Prozent (Spanne minus 45 bis minus 20), der Deckungsbeitrag um 60 Prozent.
...
|---|---|---|
| **Nachweisfähigkeit** | Ergebnisse so erzeugen und dokumentieren, dass sie vor Aufsicht, Nutzenbewertung und Gericht bestehen, auch wenn KI beteiligt ist. | Welche unserer Ergebnisse könnten wir heute unterschreiben, und was fehlt bei den übrigen? |
| **Versicherbarkeit** | Klären, zu welchen Bedingungen Berufshaftpflichtversicherer Zusicherungen für Analyseergebnisse decken. | Für welche Leistungen bräuchten wir Deckung, und in welcher Höhe? |
| **Portfolio** | Standardauswertung automatisieren und günstiger anbieten; Leistung mit Haftung gezielt aufbauen. | Welcher Anteil unseres Umsatzes hängt heute an einer Zusicherung, welcher an reinem Aufwand? |
| **Kundenbasis** | Abhängigkeit von einzelnen Kunden verringern, vor allem dort, wo Budgets für Auswertung unter Druck geraten. | Was geschähe, wenn unser größter Kunde sein Auswertungsbudget halbiert? |
| **Datengrundlage** | Kennzahlen einheitlich definieren und fehlende Zahlen nachtragen, vor allem für GREENBAY healthcare. | Welche Größen messen wir, und sind sie über die Gesellschaften hinweg vergleichbar? |
...
|---|---|---|
| Referentenentwurf zu § 130b Abs. 1c SGB V | bis Mitte 2027 | Ob deutsche Erstattungsbeträge vertraulich bleiben können; ohne Entwurf gewönne die Evidenz für die Nutzenbewertung an Gewicht. |
| Deckungsangebote von Berufshaftpflichtversicherern | bis Ende 2027 | Ob Pfad A offensteht. |
| Harmonisierte Normen und Beginn der Hochrisikopflichten der KI-Verordnung | Dez. 2027 oder Aug. 2028 | Welche Nachweise für KI-gestützte Ergebnisse verlangt werden. |
| Anerkennungsregel für maschinell erzeugte Evidenz in der Nutzenbewertung | offen | Ob KI-gestützte Evidenz im Verfahren nach § 35a SGB V verwendbar wird. |
| Überprüfung der US-Ausnahme für Generika; endgültige Regel zu GLOBE | 2026 bis 2027 | Ob der US-Druck weitere Segmente erfasst. |
| Bearbeitungsdauer der Zugangsstellen im Gesundheitsdatenraum | vor März 2031 | Wie schnell die zusätzliche Datennachfrage ab 2031 bedient werden kann. |
...
Grundlage ist eine Szenariokonferenz, deren vierte Sitzung am 25. September 2026 stattfand. Hundert Fachrollen haben die US-Studie von Korinek u. a. auf Deutschland übertragen, entlang einer Wirkungskette mit fünf Stufen: Gesamtwirtschaft, Kranken- und Pflegekassen, Leistungserbringer, Pharma und der Markt des Verbunds. Jede Stufe gab einen Zentralwert mit Spanne an die nächste weiter. 83 Einschätzungen bilden diese Kette, dazu acht Einschätzungen zu Europa und sechs zur Technik.

**Die Fachrollen sind KI-Agenten, keine befragten Menschen.** Jede Rolle wurde von einem Sprachmodell eingenommen, mit einem festen Fragebogen, einem gemeinsamen Faktenstand und den Ergebnissen der vorigen Stufe. Die Einschätzungen sind deshalb als strukturierte Modellrechnung zu lesen, nicht als Expertenbefragung. Die Ist-Werte 2025 des Verbunds stammen aus den DATEV-Kontenblättern und sind gemessen.

### Grenzen

**Die Endzahlen folgen vor allem aus deutschem Recht und deutschen Verträgen.** Die US-Studie liefert den Rahmen der Fragen, nicht die Antworten. Die 420 Mrd. € GKV-Ausgaben etwa ergeben sich aus der Fortschreibung deutscher Regeln.

**Die Wahl des Szenarios stammt aus den USA.** 88 Prozent der Einschätzungen wählten das mittlere Szenario, obwohl die Autoren keine Wahrscheinlichkeiten angeben. Ein anderes Szenario würde die Zahlen verschieben, nach Einschätzung der Fachrollen aber nicht die Richtung.

**Die Studie rechnet bis 2030, dieses Papier bis 2031.** Das zusätzliche Jahr bewegt auf der Einnahmenseite rund 42 Mrd. €, das Vier- bis Fünffache der gesamten KI-Wirkung auf die Beitragsbasis.
