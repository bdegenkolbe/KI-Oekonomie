...
| **Modellabhängigkeit** | < 1 bei ≥ 4 von 6 | **3 von 6** — P3 1,23 · P3₀ 1,37 · P5 1,10 · D 1,39 | **gerissen**, § 3.3 |
...
**Unabhängig davon steht D.** Der Durchgriff bleibt auch ohne G03 bei 1,23 und ist damit die einzige Größe, deren Modellabhängigkeit sich nicht auf den Defekt zurückführen lässt. Das ist erwartbar: D ist ein Quotient aus einer Differenz, also die Größe, in der sich Streuung am stärksten aufschaukelt. **D wäre im Strategiepapier folglich nicht als Zahl zu berichten, sondern als Spannweite und als Erklärungsfigur** — wofür sie gebaut wurde.
...
2. **Kontrollarm wiederholen** auf bereinigter Bezugsgröße, zehn Aufrufe. Erst danach steht fest, ob die Modellabhängigkeit wirklich gerissen ist.
3. **Absolute Spalte nachrechnen** als P3-Prozent mal Bezugsgröße — ohne die Rollen erneut zu befragen.
4. **Teil 0 des Strategiepapiers** aus diesem Dokument schreiben.
