...
## Validierung 18. Mai 2026 (Lauf 002 vom 18. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Zweiter regulärer Daily-Update-Lauf am 18. Mai 2026 (Folgelauf zu Lauf 001 vom 8. Mai 2026). Web-Recherche im Korridor der Cluster A–J am 18. Mai 2026 mit 7-Tage-Fenster (11.–18. Mai 2026; Cluster F und I im erweiterten 48-Stunden-Korridor): Optimalsteuer-/Aufgabenforschung (A); Robotersteuer/Wertschöpfungsabgabe DE/EU/national, EU-AI-Act-Omnibus (B); internationale Praxis inkl. China-Gerichtsurteil und polnische ulga (C); Politik-Initiativen (D); Arbeitsmarkt- und Sozialversicherungsdaten inkl. IAB (E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (F); Gesundheitswesen (G); Deutschland-These-Bezugspunkte (H); Frontier-Modelle und Marktstruktur (I); Robotik (J). Fünf belegbare Treffergruppen im Korridor identifiziert und eingearbeitet (EU Digital Omnibus on AI Trilog-Einigung 7. Mai 2026; Mai-Welle Cluster F mit Upwork/BILL/LinkedIn/Cisco und Meta-Stichtag 20. Mai; TrueUp-Tagesfortschreibung 13./15. Mai 2026; Hangzhou Intermediate People's Court Entscheidung 28. April 2026; IAB-Kurzbericht 8/2026 vom 5. Mai 2026).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU Digital Omnibus on AI — provisorische Trilog-Einigung in den frühen Morgenstunden des 7. Mai 2026 zwischen Rat und Parlament unter zypriotischer Ratspräsidentschaft (statt der bisher im Dokument erwarteten „nächsten Runde 13. Mai 2026"): Bestätigung der Verschiebung der Hochrisiko-Pflichten auf 2. Dezember 2027 (Anhang III) bzw. 2. August 2028 (Anhang I); Verschiebung der Maschinenverordnungs-Systeme von Anhang-I-Sektion A nach Sektion B; neue Art.-5-Verbotsregel für KI-Erzeugung von Material sexuellen Kindesmissbrauchs und nicht-konsensueller intimer Inhalte; Kennzeichnungspflicht (Art. 50 Abs. 2) bleibt anwendbar ab 2. August 2026 mit Übergangsfrist bis 2. Dezember 2026; formelle Annahme durch Rat und Parlament vor dem 2. August 2026 angestrebt. Quellen: Rat der EU (Pressemitteilung 7. Mai 2026), Bird & Bird, Taylor Wessing, White & Case, techUK, Timelex. | § 4.4 (neuer Absatz „Digital Omnibus on AI — provisorische Einigung im Trilog (7. Mai 2026)" mit Konformitätsbewertungs-Detail); § 11.3 neuer Sammelbeleg zu fünf Kanzlei- und Verbandsquellen; Aktualitätshinweis am Dokumentende aktualisiert (Korrektur: Stichtag „nächste Runde 13. Mai" abgelöst durch „provisorische Einigung 7. Mai"). | Stabilisierung des unionsrechtlichen Rahmens für die Konformitätsbewertung von Hochrisiko-Systemen — eine notwendige Bedingung für eine spätere KI-bezogene Abgabe, die die Steuerdebatte selbst nicht löst, aber technisch ankoppelbar macht. Korrigiert eine im Aktualitätshinweis bereits angelegte Erwartung, die durch die tatsächliche Trilog-Dynamik vorgezogen wurde. |
| 2 | Mai-2026-Welle der Tech-Layoffs (Cluster F, 48-Stunden- und 7-Tage-Fenster): *Upwork* rund 145 Stellen (24 %) am 7. Mai 2026 (CEO Hayden Brown, Aktie −19 %); *BILL* bis zu 30 % der Belegschaft; *LinkedIn* rund 875 Stellen (5 %) am 13. Mai 2026 — CEO Daniel Shapero begründet nach Reuters-Recherche *nicht* mit KI, sondern mit Konsolidierung (Marketing, Vendoren, ungenutzte Büroflächen, Schließung Graz), bei +12 % YoY Umsatzwachstum und erstmals über 5 Mrd. USD Quartalsumsatz; *Cisco* knapp 4.000 Stellen (<5 %) am 13. Mai 2026 — CEO Chuck Robbins „Our Path Forward", CFO Mark Patterson: „not a savings-driven restructure", Realignment um „silicon, optics, security and AI"; Q3 FY 2026 Rekordumsatz 15,8 Mrd. USD; AI-Infrastrukturaufträge der Hyperscaler 5,3 Mrd. USD YTD; Aktienkurs +20 % nachbörslich. *Meta*-Stichtag 20. Mai 2026 (rund 8.000 Stellen / 10 %, plus 6.000 gecancelte offene Stellen, kumuliert 14.000 Positionen, Reorganisation in „Superintelligence-Labs-Pods" unter Alexandr Wang). Quellen: Office Chai, Fast Company, Engadget, HC Online, Reuters, Dataconomy, The Next Web, TechCrunch, Outlook Business, The HR Digest, CFO Dive, TechRadar, Axios, Analytics Insight. | § 1.1 (Fortsetzung des Welle-Absatzes nach dem Cloudflare-Block: Upwork/BILL als Folge-Tag, LinkedIn/Cisco als 13.-Mai-Doppelschlag mit gegensätzlicher Selbstinterpretation, Meta-Stichtag 20. Mai); § 11.5 vier neue Sammelbelege (Cisco, LinkedIn, Upwork, Meta-Stichtag); Aktualitätshinweis aktualisiert; README.md neuer Versionseintrag 23.0. | LinkedIn-Cisco-Doppel illustriert die in § 1.1 dokumentierte Differenzierungslinie zwischen *ai-attributed* (Cisco: explizite Investitionsverlagerung) und *not-AI-attributed* (LinkedIn: Kostenkonsolidierung) — und stützt damit die in der Vorperiode integrierte *Washington-Post*-Differenzierungsanalyse vom 1. Mai 2026. Die Kombination aus Welle und Differenzierung verschärft die in § 9.1 dokumentierte Kausalitätslücke. |
| 3 | TrueUp Tracker — Tagesfortschreibung zum 13./15. Mai 2026: 138.837 Personen aus 324 Layoff-Meldungen (rund 1.006 Stellen pro Tag); höchster Stand seit der Kontraktion 2023. Quelle: TrueUp Layoffs Tracker. | § 1.1 (Tagesfortschreibung der Tracker-Reihe in den bestehenden Block 25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 13./15. Mai 2026); § 11.5 neuer Eintrag „TrueUp (Stand 13./15. Mai 2026)"; Aktualitätshinweis aktualisiert; README.md neuer Versionseintrag 23.0. | Schließt die Tracker-Reihe an den Tag des Laufs an, quantifiziert die Erweiterung um die Cluster-F-Mai-Welle und liefert die Aggregat-Größe für die in § 8.4 entwickelte Stabilitätslinie, ohne den aggregiert moderaten Befund aus § 3.5 (Yale Budget Lab / Massenkoff/McCrory) umzukehren. |
| 4 | Hangzhou Intermediate People's Court (VR China) — Entscheidung vom 28. April 2026 in zweiter Instanz: Kündigung eines QA-Supervisors („Zhou", Jahresgehalt 300.000 RMB, rund 43.900 USD), dessen Aufgabe in der Verifikation generativer KI-Antworten bestanden hatte und der nach KI-Übernahme mit 40-prozentiger Lohnkürzung degradiert wurde, ist unrechtmäßig; KI-bedingte Substitution ist kein „bedeutender Wandel der objektiven Umstände" im Sinne des chinesischen Labor Contract Law; zweite Gerichtsentscheidung dieser Art binnen sechs Monaten; flankierender Kommentar Pan Helin (Expertenrat MIIT) fordert „faire Behandlung" und „angemessene Abfindung". Quellen: NPR, Caixin Global, Fortune, Bloomberg, CGTN, Tom's Hardware, Fisher Phillips LLP. | Neuer Abschnitt § 6.4 *„Volksrepublik China: Arbeitsrechtliche Schranke gegen KI-bedingte Entlassungen (April 2026)"* (alter § 6.4 „Weitere Ansätze" → § 6.5); § 11.5 neuer Sammelbeleg „NPR / Caixin Global / Fortune / Bloomberg / CGTN / Tom's Hardware / Fisher Phillips LLP" mit sechs URLs; Aktualitätshinweis aktualisiert. | Etabliert eine gerichtlich kodifizierte Begründungslast für arbeitgeberseitige KI-Substitution, die — über ein anderes Rechtsregime — dieselbe in § 9.1 diskutierte Messlücke adressiert wie der Connecticut-WARN-AI-Disclosure-Mechanismus (Statistik vs. einzelvertragliche Auflösbarkeit). Erweitert den internationalen Vergleich (§ 6) erstmals um einen substanziellen China-Strang mit Bezug zur Steuer- und Sozialdebatte. |
| 5 | IAB-Kurzbericht 8/2026 *„Jeder vierte Betrieb in Deutschland nutzt mittlerweile generative KI"* (5. Mai 2026) auf Basis des IAB-Betriebspanels (rund 15.000 Betriebe): Anstieg der betrieblichen Nutzung generativer KI von rund 5 % auf rund 25 % binnen zweier Jahre; weitere 9 % planen Einführung; Spreizung Betriebe ≥ 200 Beschäftigte 48 % vs. < 10 Beschäftigte 21 %; Branchen Information/Kommunikation 59 %, Finanz-/Versicherungsdienste 50 %, unternehmensnahe Dienste 37 %, Bildung 34 %; 90 % nutzen frei zugängliche Modelle, 16 % gekaufte Modelle mit eigenen Trainingsdaten, 6 % eigene Modelle; Schulungen in > 25 % der KI-nutzenden Betriebe. | § 8.1 (neuer empirischer Stützungs-Absatz unter den drei begründenden Argumenten der Drei-Faktor-Modellierung); § 11.3 neuer IAB-Eintrag „IAB-Kurzbericht 8/2026"; Aktualitätshinweis am Dokumentende ergänzt; README.md neuer Versionseintrag 23.0. | Empirische Bestätigung der in § 8.1/§ 8.2 entwickelten Linie: KI ist in der deutschen Wertschöpfung bereits angekommen (jeder vierte Betrieb), und die Nutzung erfolgt überwiegend über *frei zugängliche*, also importierte Basismodelle (90 %) — was die Rohstoff- und Veredelungs-Logik der Deutschland-These operativ untermauert, nicht aber die These selbst beweist. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Connecticut SB 5 — Lamont-Unterzeichnung zum Stichtag 18. Mai 2026 weiterhin nicht öffentlich datierbar (Bill Notification 2026-5 enthält SB 5 nicht; mehrere Kanzleianalysen Mai 2026 sprechen weiterhin im Konjunktiv von „Lamont is reportedly set to sign"); bestehender § 4.5-Block bleibt korrekt; in einem späteren Lauf nachzutragen, sobald die formale Unterzeichnung mit Datum belegt ist.
- Bundesrat 1065. Sitzung 8. Mai 2026 — Beschlussergebnisse zum GKV-Beitragssatzstabilisierungsgesetz und übrigen Tagesordnungspunkten Stand Mitte Mai 2026 nicht in einheitlicher Beschlusssammlung publiziert; bestehende § 5.2- und Aktualitätshinweis-Verweise bleiben korrekt.
- Yale Budget Lab — Fortune-Artikel vom 6. Mai 2026 („AI could solve America's $39 trillion debt crisis"): bereits in Version 19.0 dokumentiert; keine neue Modellierung.
- Microsoft VRSAR — Acceptance-Stand zum 18. Mai 2026 nicht öffentlich veröffentlicht; Annahmefrist läuft bis 8. Juni 2026; bestehende Programmangabe bleibt korrekt.
- Big-Tech-AI-Capex — keine neue Konsens-Schätzung über das in Version 21.0 dokumentierte 725-Mrd.-USD-Aggregat hinaus; einzelne Detail-Datenpunkte (Microsoft Azure-Backlog 80 Mrd. USD power-constrained, Alphabet Capex-Range-Update 180–190 Mrd. USD) werden in einem späteren Lauf gebündelt aufgenommen, sobald sie sich in einer Aggregat-Linie verdichten.
- Anthropic Economic Index — kein neuer Bericht zwischen 8. und 18. Mai 2026; bestehender § 3.5-Block bleibt aktuell.
- Tesla Optimus / humanoide Robotik (Cluster J) — keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster; bestehender Stand bleibt aktuell.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide Treffer im 7-Tage-Fenster.
- Frontier-Modelle / Inferenzpreise (Cluster I) — keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster.

### Prüfergebnis

| Prüfschritt | Ergebnis | Auffälligkeiten |
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; ein zusätzlicher Unterabschnitt in Kapitel 6 (§ 6.4 China, alter „Weitere Ansätze" → § 6.5); keine leeren Abschnitte. |
| 2.1.2 Nummerierung | OK | Kapitel 1–11 lückenlos; Unterabschnitt 6.1–6.5 lückenlos (vorher 6.1–6.4); 8.1–8.7 unverändert; fünf Robotersteuer-Typen, drei Hebel der Deutschland-These und sieben Empfehlungen unverändert. |
| 2.1.3 Querverweise | OK | Querverweise auf § 6.1 und § 6.2 (in § 4.5 Maine-Block, § 6.3 Polen-Block) bleiben korrekt — Südkorea und Italien unverändert. Keine Verweise auf das alte § 6.4 (Weitere Ansätze) im Dokument. Neuer Abschnitt § 6.4 verweist auf § 4.5 (Connecticut), § 9.1 (Messlücke) und § 6.1 bis § 6.3 (Investitions-/Wertschöpfungsseite). |
| 2.1.4 Roter Faden | OK | Drei-Säulen-Bauweise Kapitel 8 bleibt erhalten; die neue empirische Stützung in § 8.1 ist als nachgelagerte Empirie zu den drei begründenden Argumenten formuliert, nicht als Erweiterung der These; § 6.4 China führt die internationale Vergleichslinie konsistent fort. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; bestehende Tabellen unverändert; neue Fließtext-Passagen mit konsistenten fett gesetzten Lead-Ins. |
| 2.2.1 Sachliche Richtigkeit | OK | Hangzhou-Urteil: Gericht, Datum, Akteur, Rechtsfrage und Gehaltsangabe (300.000 RMB ≈ 43.900 USD) gegen Caixin Global, NPR, Bloomberg und Tom's Hardware abgeglichen. IAB-Kurzbericht 8/2026: Adoptionsanteile gegen iab.de-Pressemitteilung und Kurzbericht-PDF abgeglichen. Cisco-/LinkedIn-/Upwork-Zahlen gegen Konzernblog (Cisco „Our Path Forward"), Reuters-Recherche (LinkedIn) und CEO-Statement (Upwork) abgeglichen. Trilog-Einigung 7. Mai gegen Pressemitteilung Rat der EU (consilium.europa.eu) abgeglichen. |
| 2.2.2 Redundanzprüfung | OK | Cloudflare-/Cognizant-/PayPal-/Coinbase-/Freshworks-Block in § 1.1 wird in der neuen Passage nicht erneut ausgespielt, sondern als Vorlauf referenziert. § 8.1-Ergänzung ist explizit als empirische Stütze zur These formuliert, nicht als Wiederholung der drei Argumente. § 6.4 China verweist auf § 4.5 (Connecticut) und § 9.1 (Messlücke), ohne diese zu wiederholen. |
| 2.2.3 Argumentation | OK | Drei-Faktor-Argumentation in § 8.1 bleibt klar als analytische Position des Autors markiert; der hinzugefügte IAB-Befund stützt sie empirisch, ohne sie zur Lehrmeinung zu erklären. Acemoglu/Thuemmel-Linie in § 3 unverändert. |
| 2.2.4 Ausgewogenheit | OK | LinkedIn-Beispiel (explizit *nicht* mit KI begründet) und Washington-Post-Differenzierung (Version 13.0) bleiben als Gegengewichte zur „AI labor crisis"-Lesart sichtbar; Bloomberg-Editorial (Version 20.0), de la Feria, IW Köln/Hentze und Yale Budget Lab als Gegenstimmen erhalten. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenprüfung der neu eingefügten Passagen; einheitliche Konjunktiv-Form bei Policy-Papieren und Gesetzentwürfen (Digital Omnibus on AI: „bestätigt", „angestrebt"; SB 5: weiter „angekündigt"); China-Urteil im Indikativ, weil rechtskräftige zweite Instanz. |
| 2.3.2 Terminologie | OK | „Digital Omnibus on AI" einheitlich; „Hangzhou Intermediate People's Court" mit Erstnennung und Erläuterung „in zweiter Instanz"; MIIT (Ministry of Industry and Information Technology) ausgeschrieben; VRSAR / WARN / DRAM bleiben mit Erstnennung erläutert. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Alle neu eingeführten Quellen sind im Literaturverzeichnis (§ 11.3 IAB, § 11.3 Rat der EU / Kanzleien, § 11.5 Cisco/LinkedIn/Upwork/Meta/TrueUp/China-Urteil) eingetragen; im Fließtext referenzierte Akteure (Reuters, Shipman & Goodwin Mai 2026) ohne neuen Literatureintrag bleiben über die Sammelbelege abgedeckt. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-naher Zitierstil mit Datum, Titel, Pipe-getrennten URLs einheitlich; keine URL-Shortener; keine reinen Startseiten. |
| 2.4.3 Aktualität und Belastbarkeit | OK | Drei der fünf Treffer aus institutionellen / amtlichen Primärquellen (Rat der EU, IAB, Hangzhou-Gericht über Caixin Global / CGTN); Cluster F durch Konzernblog (Cisco), Reuters-Recherche (LinkedIn) und CEO-Statement (Upwork) primär belegt. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Drei neue URLs stichprobenartig aufgerufen (consilium.europa.eu Pressemitteilung, iab.de Pressemitteilung 8/2026, fortune.com Hangzhou-Bericht) — alle erreichbar und direkt zur zitierten Quelle führend. |
| 2.4.5 Zitatgenauigkeit | OK | Direkte Zitate in den neuen Passagen: „agentic AI-first operating model" (Cloudflare, Version 22.0 unverändert), „Our Path Forward" / „not a savings-driven restructure" (Cisco/Patterson 13. Mai 2026, gegen TechCrunch und CFO Dive abgeglichen), „bedeutender Wandel der objektiven Umstände" (Hangzhou-Gericht, deutsche Übersetzung der Bloomberg-/Caixin-Fassung), „more efficient operating model as the nature of work evolves" (Upwork/Brown 7. Mai 2026, gegen Office Chai abgeglichen). |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | de la Feria et al. 2022 bleibt als verifizierungsbedürftig markiert (nicht Gegenstand dieses Laufs); Sanders 2025 Titelangabe seit Version 5.0 verifiziert. Keine neuen verifizierungsbedürftigen Einträge in diesem Lauf. |
| 2.5 Versionskonsistenz und Lizenz | OK | Version 23.0 an vier Stellen eingetragen: Dokumentkopf, Aktualitätshinweis am Dokumentende, README.md (zwei Stellen: Versionszeile und Zitiervorschlag), Validierung-Ergebnisse.md (dieser Block). Autor (Björn Degenkolbe), Organisation (HIGL), CC-BY-4.0-Lizenz und Haftungshinweis unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Im Repository nach wie vor keine dedizierten Skripte; manuelle Stichproben gemäß § 2.1.2, § 2.1.3 und § 2.4.1 ersetzen den automatisierten Teil. |

### Gefundene Fehler

Keine kritischen Fehler. Eine gering schwerwiegende Korrektur im Aktualitätshinweis: Stichdatum vom 8. Mai (Lauf 001) auf 18. Mai (Lauf 002) und Trilog-Stand vom „nächste Runde 13. Mai" auf „provisorische Einigung 7. Mai" aktualisiert.

### Durchgeführte Bereinigungen

| # | Fehler | Maßnahme | Erledigt |
|---|---|---|---|
| 1 | Aktualitätshinweis bezog sich noch auf Schnitt 8. Mai 2026 und antizipierte „nächste Trilog-Runde 13. Mai 2026". | Schnittangabe auf 18. Mai 2026 (Lauf 002) aktualisiert; Trilog-Passage auf die tatsächliche provisorische Einigung 7. Mai 2026 umgeschrieben (inkl. Annex-/Art.-50-Detail). | Ja |
| 2 | § 6 hatte vier Unterabschnitte; mit dem China-Block (§ 6.4 neu) verschiebt sich der bisherige „Weitere Ansätze" auf § 6.5. | Umbenennung des bisherigen § 6.4 auf § 6.5; Prüfung aller Querverweise auf § 6.x (kein § 6.4-Verweis im Fließtext gefunden, daher kein Folgeaufwand). | Ja |

### Nachprüfung

- Betroffene Prüfschritte (2.1.1 Gliederung, 2.1.2 Nummerierung, 2.1.3 Querverweise, 2.5 Versionskonsistenz) erneut durchlaufen: OK.
...
- Neue Version: 23.0
- PDF erstellt: Ja (gemäß Phase 5)
- Word erstellt: Ja (gemäß Phase 5)
