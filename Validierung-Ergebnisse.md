...
## Validierung 16. Mai 2026 (Lauf 002 vom 16. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Zweiter regulärer Daily-Update-Lauf nach Lauf 001 vom 8. Mai 2026. Web-Recherche im Korridor der Cluster A–J am 16. Mai 2026 mit Stichtag-Schnitt vom 9. bis 16. Mai 2026 (7-Tage-Fenster) bzw. 48-Stunden-Fenster für die Cluster F und I. Vier belegbare Treffer identifiziert und eingearbeitet: (1) die am 7. Mai 2026 zwischen Rat und Parlament erzielte vorläufige politische Einigung über das Digital-Omnibus-on-AI-Paket samt umfangreicher Kanzleianalysen vom 7.–15. Mai 2026 — diese Einigung ist in Lauf 001 nicht erfasst worden, weil sie zeitlich unmittelbar mit dem Recherchezeitpunkt zusammenfiel und die Sekundäranalysen erst in den Folgetagen erschienen; (2) die am 7. Mai 2026 von Upwork angekündigte Streichung von rund 24 % der Belegschaft; (3) die am 13. Mai 2026 von LinkedIn angekündigte Streichung von rund 5 % der Belegschaft (rund 875 Stellen); (4) die am 14. Mai 2026 von Cisco parallel zum Q3-FY2026-Rekordumsatz angekündigte Streichung von unter 4.000 Stellen sowie die Tagesfortschreibung der TrueUp-Tracker-Methodik auf den 15./16. Mai 2026 (128.270 Personen aus 286 Layoff-Meldungen, rund 1.002 Personen pro Tag) und die Aggregat-Berichterstattung von *American Bazaar* vom 10. Mai 2026 (nahe 38.000 US-Stellenstreichungen aller Branchen in den ersten zehn Tagen des Mai 2026).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Rat der EU / Europäisches Parlament — vorläufige politische Einigung über das *Digital-Omnibus-on-AI*-Paket am 7. Mai 2026 (04:30 Uhr Brüsseler Zeit; Council-Pressemitteilung 2026-05-07). Stichtage für Hochrisiko-Pflichten: 2. Dezember 2027 für eigenständige Annex-III-Systeme; 2. August 2028 für in regulierte Produkte eingebettete Annex-I-Systeme. Verschiebung der Watermarking-/Transparenzpflicht nach Art. 50 Abs. 2 vom 2. August 2026 auf den 2. Dezember 2026. Verschiebung der Maschinenverordnung aus Sektion A in Sektion B von Annex I — eingebettete Maschinen-KI wird künftig primär über das sektorale Maschinenrecht adressiert. Neues Verbot KI-generierter nicht-einvernehmlicher intimer Inhalte und kindlicher Missbrauchsdarstellungen ab 2. Dezember 2026. Vereinfachte Dokumentation und Sanktionen für KMU und *small mid-caps*. Förmliche Annahme vor 2. August 2026 erwartet. Quellen: Rat der EU (Pressemitteilung 7. Mai 2026); White & Case, Lewis Silkin, Hogan Lovells, Taylor Wessing, Orrick (Kanzleianalysen 7.–15. Mai 2026); IAPP, Tech Policy Press, Lexology, BlueArrow.ai. | § 4.3 (vollständige Aktualisierung des Digital-Omnibus-Abschnitts; Streichung der bisherigen Zukunftsprojektion auf den 13. Mai 2026; Beschreibung des Inhalts der Einigung, der gestaffelten Geltungsdaten und der für die Steuerdebatte relevanten Verschiebung der Maschinenverordnung); § 11.3 neuer Eintrag „Rat der Europäischen Union (7. Mai 2026)" und neuer Sammelbeleg „White & Case / Lewis Silkin / Hogan Lovells / Taylor Wessing / Orrick / IAPP / Tech Policy Press"; Aktualitätshinweis am Dokumentende vollständig auf die Trilog-Einigung umgestellt; README.md mit neuem Versionseintrag 23.0. | Die Trilog-Einigung kam fast eine Woche früher zustande als im vorigen Lauf erwartet (für den 13. Mai 2026) und ist die zentrale rechtspolitische Entwicklung des Recherchefensters. Für die KI-Steuerdebatte ist neben der Verschiebung der Hochrisiko-Pflichten vor allem die Auslagerung eingebetteter Maschinen-KI in das sektorale Maschinenrecht bedeutend, weil sie eine einheitliche steuerliche Anknüpfung an „KI-Systeme" definitionsrechtlich weiter erschwert und die in § 4.3 entwickelte Linie („AI-Act-Kategorien als steuerlicher Anknüpfungspunkt möglich, aber zeitlich gestreckt") empirisch bestätigt. |
| 2 | Upwork — Layoff-Ankündigung am 7. Mai 2026: Streichung von rund 145 Stellen (etwa 24 % von rund 600 Beschäftigten); Restrukturierungsaufwand 16–23 Mio. USD im Q2 2026; Strategie, mehr Umsatz über KI-Agenten zu routen; CEO Hayden Brown: *„two pizza teams are dead"*; Aktienkurs −19,3 %. Quellen: Upwork-Pressemitteilung 7. Mai 2026; Barchart, Layoffhedge, OfficeChai. | § 1.1 (Ergänzung im bestehenden Layoff-Block hinter dem Cloudflare-Eintrag); § 11.5 neuer Sammelbeleg „Upwork / Barchart / Layoffhedge / OfficeChai (7. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt. | Upwork ist der erste KI-gestützte Freelancer-Marketplace, der eine konzernweite Restrukturierung explizit damit begründet, mehr Umsatz über KI-Agenten zu routen — eine Konstellation, in der die Plattform ihre eigene Wertschöpfungsbasis (menschliche Freelancer) durch KI substituiert. Für § 8.2 (KI als Rohstoff) und § 8.3 (Teilhabe) liefert das ein qualitatives Pendant zur Cloudflare-Welle der Vorwoche. |
| 3 | LinkedIn — Layoff-Ankündigung am 13. Mai 2026: Streichung von rund 875 Beschäftigten (rund 5 % von 17.500) trotz +12 % Jahresumsatz im LinkedIn-Quartalsergebnis; betroffen sind Global Business Organization, Marketing, Engineering und Produkt; Reorganisation unter Chief Product Officer Hari Srinivasan zugunsten kleinerer, KI-gestützter Teams. Quellen: Quartz, GeekWire, Republic World, IndMoney, Seeking Alpha, Seattle Times (13. Mai 2026). | § 1.1 (Ergänzung im bestehenden Layoff-Block in der TrueUp-Reihe-Aktualisierung); § 11.5 neuer Sammelbeleg „LinkedIn / Quartz / GeekWire / Republic World / IndMoney / Seeking Alpha / Seattle Times (13. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt. | Trotz +12 % Umsatzwachstum reduziert ein Microsoft-Tochter-Unternehmen seine Belegschaft — eine Konstellation, die die *Washington-Post*-Differenzierung vom 1. Mai 2026 (Layoffs nicht monokausal AI-getrieben) für eine andere Akteursgruppe (Plattform mit B2B-Diensten) bestätigt. Reuters berichtet ausdrücklich, die Maßnahme sei nicht primär AI-Verdrängung, sondern Reorganisation — ein Befund, der die Kausalitätsmessung für eine Typ-5-Ersatzabgabe (§ 9.1) zusätzlich erschwert. |
| 4 | Cisco — Layoff-Ankündigung am 14. Mai 2026 parallel zum Q3-FY2026-Rekordumsatz: Streichung von unter 4.000 Stellen (<5 % der globalen Belegschaft); Q3-FY2026-Umsatz 15,8 Mrd. USD (+12 % YoY); 5,3 Mrd. USD AI-Infrastrukturbestellungen YTD; Projektion auf 9 Mrd. USD AI-Orders im FY2026 (zuvor 5 Mrd. USD); CFO Mark Patterson: nicht *„savings-driven"*, sondern Re-Allokation zu Silizium, Optik, Sicherheit und KI; CEO Chuck Robbins; Aktienkurs +15 % am Earnings-Tag. TrueUp-Tracker-Stand 15./16. Mai 2026: 128.270 Personen aus 286 Layoff-Meldungen (rund 1.002 Personen pro Tag). *American Bazaar*: nahezu 38.000 US-Stellenstreichungen aller Branchen in den ersten zehn Tagen des Mai 2026. Quellen: CNBC, TechCrunch, Benzinga, Business Today, Fox Business; TrueUp Tracker; American Bazaar (10. Mai 2026). | § 1.1 (Ergänzung im bestehenden Layoff-Block hinter dem Cloudflare-/Coinbase-/PayPal-/Freshworks-/Cognizant-Block; TrueUp-Stand auf den 15./16. Mai 2026 fortgeschrieben; *American-Bazaar*-Aggregat-Linie hinzugefügt); § 11.5 neue Sammelbelege „Cisco / CNBC / TechCrunch / Benzinga / Business Today / Fox Business (13./14./15. Mai 2026)", „TrueUp (Stand 15./16. Mai 2026)" und „American Bazaar (10. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Cisco ist nach Cloudflare der zweite Netzinfrastruktur-Anbieter, der eine konzernweite Restrukturierung explizit am Übergang zu einer AI-zentrierten Strategie festmacht — aber mit gegenläufiger Aktienkurs-Reaktion (+15 % statt −18 %), weil der Layoff hier parallel zu einem Rekord-Quartalsumsatz und einer fast verdoppelten AI-Order-Projektion erfolgt. Die explizite CFO-Aussage „nicht *savings-driven*, sondern Re-Allokation" liefert ein zweites Frontier-Beispiel für strukturelle (nicht kostenmotivierte) KI-induzierte Personalanpassung. Für § 1.1 ist relevant, dass der Verdrängungs-Augmentations-Mix in der Tech-Sub-Industrie nun klar differenziert messbar wird. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Connecticut SB 5 — Lamont-Unterzeichnung zwischen 9. und 16. Mai 2026 nicht öffentlich mit Datum dokumentiert (Pressespokesperson weiterhin „looks forward to signing"); bestehender § 4.5-Block bleibt korrekt; in einem späteren Lauf nachzutragen, sobald die formale Unterzeichnung mit Datum belegt ist.
- Sanders/Warren — *„robot tax legislation"* (Washington Examiner): Sanders' Ankündigung weiterhin im Diskussionsstadium ohne formellen Bill-Text im 7-Tage-Fenster; in einem späteren Lauf zu prüfen, sobald der Gesetzentwurf eingebracht wird.
- Anthropic *„Preparing for AI's economic impact: exploring policy responses"* — Anthropic-eigene Quelle bereits in den Vorversionen in der Linie der Economic-Index-Berichte verortet; im 7-Tage-Fenster keine neue Veröffentlichung über das bereits dokumentierte Massenkoff/McCrory-Papier, den 22.-April-Survey und den 23.-April-Folgeband hinaus.
- Bundesrat 1065. Sitzung vom 8. Mai 2026 — Beschlüsse wurden im Nachgang dokumentiert, ergeben aber keine neue Sachebene gegenüber dem in Version 22.0 erfassten Erstdurchgang; Folge-Befassung vor der Sommerpause 2026 abzuwarten.
- IFR World Robotics Report / humanoide Robotik (Tesla Optimus, Figure, Boston Dynamics) — keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster, lediglich Marketingankündigungen und Produktionsmeilensteine ohne unmittelbare Steuerdebatte-Anschlussfähigkeit.
- Hyperscaler-AI-Capex — keine wesentliche neue Revision über das in Version 21.0/22.0 dokumentierte 725-Mrd.-USD-Aggregat hinaus.
...
- Cluster I (Frontier-Modelle) — keine neue Frontier-Modell-Veröffentlichung oder Preisstrukturierungs-Bewegung im 48-Stunden-Fenster.
- Acemoglu/Autor/Johnson *„Building Pro-Worker AI"* — bereits in Version 16.0 vollständig in § 3.3 und § 11.1 verortet, kein Update im 7-Tage-Fenster.
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; die neue Trilog-Einigung-Passage in § 4.3 verweist über den bestehenden Kontext implizit auf § 2.1 (Definition KI-System) und § 9.1 (Messprobleme bei Anknüpfung) — diese Ziele existieren weiterhin; die neuen Cisco-/LinkedIn-/Upwork-Passagen in § 1.1 fügen sich in den bestehenden Layoff-/Tracker-Block ein. |
| 2.1.4 Roter Faden | OK | Aktualisierung des bestehenden Layoff-/Tracker-Blocks und Update des EU-Trilog-Status; der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert; die Trilog-Einigung verstärkt die Linie aus § 4.3 zur AI-Act-Anknüpfungsfähigkeit. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Trilog-Einigungsdatum 7. Mai 2026 (04:30 Brüsseler Zeit), Stichtage 2. Dezember 2027 (Annex III), 2. August 2028 (Annex I) sowie Watermarking-Verschiebung auf 2. Dezember 2026 in der Council-Pressemitteilung und in mindestens fünf unabhängigen Kanzlei-/Fachanalysen (White & Case, Lewis Silkin, Hogan Lovells, Taylor Wessing, Orrick) konsistent. Cisco-Zahlen (unter 4.000 Stellen, <5 % der Belegschaft, 15,8 Mrd. USD Quartalsumsatz, 5,3 Mrd. USD AI-Orders YTD, +15 % Aktienkurs, CFO Patterson, CEO Robbins) wörtlich aus CNBC, TechCrunch, Benzinga und Business Today. LinkedIn-Zahlen (875 Stellen, 5 % von 17.500, CPO Srinivasan) aus Quartz, GeekWire, Republic World, IndMoney und Seattle Times konsistent. Upwork-Zahlen (145 von 600 Stellen, 24 %, 16–23 Mio. USD Restrukturierung, CEO Brown, −19 % Aktienkurs) aus Upwork-Press, Barchart, Layoffhedge und OfficeChai konsistent. |
| 2.2.2 Redundanzprüfung | OK | Die Trilog-Aktualisierung in § 4.3 ersetzt die zuvor formulierte Zukunftsprojektion auf den 13. Mai 2026 — keine Doppelung. Cisco, LinkedIn und Upwork sind drei neue, in keinem Vorlauf erwähnte Layoff-Wellen. Die TrueUp-Reihe wird gemäß Claude.md § 4.2 als Tagesfortschreibung der bisherigen Stände geführt (8. Mai → 15./16. Mai 2026) — keine Doppelung. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Cisco-Aussage „Re-Allokation, nicht *savings-driven*" als CFO-Zitat (Mark Patterson) kennzeichnet; LinkedIn-Aussage „nicht primär AI-Verdrängung" als Reuters-Wiedergabe explizit kennzeichnet. |
| 2.2.4 Ausgewogenheit | OK | Die Cisco-Aussage „strukturell, nicht kostenmotiviert" wird neutral wiedergegeben und durch die parallele Aktienkurs-Reaktion (+15 %) und Rekord-Quartalsumsatz-Zahl quantitativ eingebettet; LinkedIn-Reorganisation wird ausdrücklich nicht monokausal AI-getrieben gerahmt; die in § 1.1 etablierte *Washington-Post*-Differenzierung vom 1. Mai 2026 bleibt explizit erhalten. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Digital Omnibus on AI", „Annex III", „Annex I", „Maschinenverordnung" einheitlich; „two pizza teams are dead" als zitierter CEO-Begriff in Anführungszeichen; bestehende Schreibweisen „TrueUp", „SkillSyncer", „Hyperscaler" einheitlich; APA-konforme Quellenangabe für alle vier neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Council-Pressemitteilung und Sammelbeleg White-&-Case-Cluster neu in § 11.3; Upwork-, LinkedIn-, Cisco-Cluster sowie TrueUp- und American-Bazaar-Einträge neu in § 11.5; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Primärquellen: Rat der EU (Pressemitteilung), Upwork (Pressemitteilung), Cisco (Earnings-Call). Sekundärquellen: führende Kanzleien (White & Case, Lewis Silkin, Hogan Lovells, Taylor Wessing, Orrick) und Fachpresse (IAPP, Tech Policy Press, CNBC, TechCrunch, Benzinga). Tracker-Stände durch InformationWeek/TrueUp verifiziert. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobenartige Prüfung: Council-Pressemitteilung 2026-05-07, White & Case Insight Alert, IAPP-Artikel zur Trilog-Einigung, CNBC-Cisco-Earnings, Upwork-Pressemitteilung und TrueUp-Tracker-Startseite jeweils erreichbar. |
| 2.4.5 Zitatgenauigkeit | OK | „two pizza teams are dead" (Hayden Brown, Barchart) wörtlich; Cisco-CFO-Patterson-Zitat „not a savings-driven exercise" (Benzinga) wörtlich; Trilog-Stichtage (2. Dezember 2027 / 2. August 2028 / 2. Dezember 2026) aus Council-Pressemitteilung wörtlich. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | de la Feria-Markierung unverändert erhalten; Sanders-Report bleibt verifiziert (Version 5.0). |
| 2.5 Versionskonsistenz und Lizenz | OK | Version 23.0 konsistent in Dokumentkopf, Aktualitätshinweis am Dokumentende, README.md und in diesem Abschluss-Block; Lizenz CC BY 4.0 unverändert; Autor Björn Degenkolbe / HIGL unverändert; KI-Offenlegung in README.md unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Keine Prüfskripte im Repo. |

### Gefundene Fehler

| # | Stelle | Fehler | Schwere |
|---|---|---|---|
| 1 | § 4.3, Lauf-001-Status | Veraltete Aussage „Die nächste Trilogrunde ist auf den 13. Mai 2026 terminiert" — tatsächlich Trilog-Einigung am 7. Mai 2026 vor diesem Termin erzielt. | Mittel |

### Durchgeführte Bereinigungen

| # | Fehler | Maßnahme | Erledigt |
|---|---|---|---|
| 1 | Veraltete Trilog-Projektion auf den 13. Mai 2026 | § 4.3-Passage vollständig auf die Einigung vom 7. Mai 2026 (04:30 Brüsseler Zeit) umgestellt; Inhalt der Einigung (Stichtage, Watermarking, Verschiebung der Maschinenverordnung, neues Verbot, SME-/small-mid-cap-Vereinfachungen, formale Annahme vor 2. August 2026) eingearbeitet. Aktualitätshinweis am Dokumentende parallel umgestellt. | Ja |
