...
## Validierung 15. Mai 2026 (Lauf 001 vom 15. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Regulärer Daily-Update-Lauf am 15. Mai 2026, sieben Tage nach Lauf 001 vom 8. Mai 2026. Web-Recherche im Korridor der Cluster A–J: Optimalsteuer-/Aufgabenforschung (A); Robotersteuer/Wertschöpfungsabgabe DE/EU (B); internationale Praxis inkl. China (C); Politik-Initiativen (D); Arbeitsmarkt- und Sozialversicherungsdaten (E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (F); Gesundheitswesen (G); Deutschland-These-Bezugspunkte (H); Frontier-Modelle (I); Robotik (J). Fünf belegbare Treffer identifiziert und eingearbeitet: (1) die vorläufige politische Trilog-Einigung zum *Digital Omnibus on AI* vom 7. Mai 2026, die in Lauf 001 vom 8. Mai 2026 wegen der frühen Tageszeit der Einigung nicht erfasst war; (2) der *IAB-Kurzbericht 08/2026* von Friedrich und Kagerl vom 5. Mai 2026; (3) die Spruchpraxis des *Hangzhou Intermediate People's Court* mit Veröffentlichung in englischer Übersetzung am 28. April 2026 und breiter Rezeption Anfang Mai 2026; (4) die LinkedIn-Streichungen vom 13. Mai 2026; (5) die Cisco-Restrukturierung vom 14. Mai 2026 mit Q3-FY2026-Rekordquartalsumsatz; flankiert durch die TrueUp-Tagesfortschreibung 13. Mai 2026.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Rat der EU / Europäisches Parlament — vorläufige politische Einigung zum *Digital Omnibus on AI* in der dritten Trilogrunde in der Nacht vom 6. auf den 7. Mai 2026: Verschiebung der Hochrisiko-Pflichten Anhang III auf 2. Dezember 2027 und Anhang I auf 2. August 2028; neues Art.-5-Verbot für KI-Systeme zur Erzeugung von CSAM und nicht-einvernehmlichen intimen Bildern mit Anpassungsfrist 2. Dezember 2026; förmliche Verabschiedung vor 2. August 2026 vorgesehen. Quellen: consilium.europa.eu (Pressemitteilung 7. Mai 2026), Bird & Bird, Modulos, NicFab, Lexology, Timelex. | § 4.3 (Aktualisierung des Trilog-Absatzes: Ersetzung des „nächste Runde 13. Mai 2026"-Status durch die Einigung vom 7. Mai 2026, mit präzisen neuen Stichtagen und Art.-5-Erweiterung); § 11.3 zwei neue Einträge (Rat der EU Pressemitteilung und Kanzlei-Sammelbeleg Bird & Bird / Modulos / NicFab / Lexology); Aktualitätshinweis ersetzt; README.md mit neuem Versionseintrag 23.0. | Die in Lauf 003 vom 7. Mai 2026 und Lauf 001 vom 8. Mai 2026 als „nächste Runde 13. Mai 2026" verzeichnete Trilog-Linie ist faktisch durch die Einigung am 7. Mai 2026 überholt. Die neue Stichtagsarchitektur (Anhang III 2027, Anhang I 2028) ist die zentrale rechtlich-zeitliche Rahmenbedingung für die in § 4.3 diskutierte Anknüpfung steuerlicher Tatbestände an AI-Act-Kategorien und damit für die in Kapitel 8 entwickelte Position. |
| 2 | Friedrich, M., & Kagerl, C. (5. Mai 2026): *IAB-Kurzbericht 08/2026 — „Künstliche Intelligenz in deutschen Betrieben: Jeder vierte Betrieb nutzt mittlerweile generative KI"*. Anstieg der Adoption von 5 % (2023) auf 25 % (2025); 48 % bei 200+ Beschäftigten, 21 % bei unter 10 Beschäftigten; 59 % in Information/Kommunikation; 90 % frei zugängliche Anwendungen, 16 % gekaufte Modelle mit eigenem Datentraining, 6 % eigene Modelle. | § 3.5 (Komplementärabsatz zur US-zentrierten Anthropic-Index- und Yale-Budget-Lab-Linie: deutscher Adoptions­befund mit expliziter Anschlussfähigkeit an die Verarbeiter-Logik in § 8.2 und die Eigentums-/Rentenfrage in § 8.3); § 11.3 neuer IAB-Eintrag; Aktualitätshinweis ergänzt; README.md mit neuem Versionseintrag 23.0. | Liefert die erste belastbare deutsche Aggregat-Zahl zur generativen-KI-Adoption nach IAB-Methodik im IAB-Betriebspanel — ein für die Deutschland-These (§ 8.2 Veredelungsstrategie, § 8.3 Teilhabefrage) zentraler Datenpunkt, weil er die *Strukturasymmetrie* zwischen importierten Basismodellen (90 % freie/gekaufte Anwendungen) und eigenständiger Modellentwicklung (6 %) erstmals quantifiziert. |
| 3 | Hangzhou Intermediate People's Court — typische Verfahren zur AI-Replacement-Frage, in englischer Übersetzung am 28. April 2026 publiziert (China.org.cn, SCIO, Caixin); im Folgezeitraum 1.–3. Mai 2026 breit rezipiert (NPR 1. Mai, Bloomberg 2. Mai, Fortune 3. Mai). Kernaussage: Die Ersetzung eines Beschäftigten (Qualitätssicherung für LLM-Ausgaben, 25.000 RMB/Monat) durch ein KI-System erfüllt nicht den Tatbestand „major change in objective circumstances" der chinesischen Arbeitsvertragsregelung und rechtfertigt allein keine Kündigung; Vergleichsfall im Kartografie-Sektor (Ende 2025). | Neuer § 6.5 *„China — arbeitsrechtliche Grenze einer KI-getriebenen Substitution (April/Mai 2026)"* mit Bezug zu § 9.1 (Displacement-Messprobleme), § 4.5 (Connecticut-SB-5-WARN-AI-Disclosure) und Kapitel 8; ergänzender Satz unter Displacement-basiert in § 9.1; § 11.3 neuer Eintrag (Hangzhou-Gericht/China.org.cn/SCIO/Caixin/Fisher Phillips); § 11.5 neuer Sammelbeleg (NPR/Bloomberg/Fortune/NextWeb); Aktualitätshinweis ergänzt. | Etabliert einen *zweiten* internationalen Vergleichspfad neben dem Connecticut-SB-5-WARN-AI-Pfad — Connecticut zwingt zur Offenlegung, China zur Begründung. Für die Steuerdebatte materiell relevant, weil die Spruchpraxis die in § 9.1 dokumentierten Mess- und Beweisprobleme einer Typ-5-Ersatzabgabe entlastet, ohne sie zu lösen, und weil ein KI-industriepolitisch fokussiertes Land eine arbeitsrechtliche Auffanglinie zieht — ein Befund mit hoher Signalwirkung für die EU-/DE-Debatte. |
| 4 | LinkedIn (Microsoft-Tochter) — Streichung von rund 875 Stellen (etwa 5 % der globalen Belegschaft) am 13. Mai 2026, schwerpunktmäßig EMEA und Asien-Pazifik, in den Funktionen Engineering, Product, Marketing und Global Business Organization; internes Memo Chief Product Officer Hari Srinivasan („smaller, faster and more agile teams that can heavily leverage AI tools"); offizielle Stellungnahmen weisen direkte KI-Substitution als Begründung zurück; Q1-Umsatz +12 % YoY. Quellen: Republic World (14. Mai), Business Today (14. Mai), Inc., Reuters/Bloomberg-Sekundärberichterstattung. | § 1.1 (Ergänzung des Mai-2026-Layoff-Blocks; neue Sub-Reihung „Folgewoche 13./14. Mai 2026"); § 11.5 neuer Sammelbeleg „Republic World / Bloomberg / Reuters / Business Today / Inc." mit drei URLs; Aktualitätshinweis ergänzt; README.md mit neuem Versionseintrag 23.0. | Erweitert die in Version 22.0 dokumentierte Layoff-Reihe um die *zweite große KI-getriebene Personalanpassung innerhalb der Microsoft-Konzernfamilie* binnen zwei Wochen (nach dem Microsoft-VRSAR-Programm). Inhaltlich relevant ist die explizite Spannung zwischen interner Begründung („leverage AI tools") und offizieller Stellungnahme („keine KI-Substitution") — ein Mikrobefund für die in § 9.1 diskutierten Kausalitäts- und Messprobleme. |
| 5 | Cisco — Restrukturierung mit knapp 4.000 Stellenstreichungen (unter 5 % der globalen Belegschaft) parallel zum Q3-FY2026-Rekord­quartalsumsatz von rund 15,8 Milliarden US-Dollar (+12 % YoY) am 14. Mai 2026; CEO Chuck Robbins im internen Memo: Verlagerung von Ressourcen in „KI, Cybersecurity und Hochgeschwindigkeits-Netzwerkausrüstung für Rechenzentren"; anteilige FY26-Boni, Severance, Outplacement. Quellen: TechCrunch (14. Mai), The Tech Portal (14. Mai), 24/7 Wall St., Baltimore Sun. Flankierend: TrueUp Tracker zum 13. Mai 2026 (128.270 Personen aus 286 Layoff-Meldungen, rund 1.002 pro Tag, höchstes Niveau seit der Tech-Kontraktion 2023). | § 1.1 (Ergänzung des Mai-2026-Layoff-Blocks; neue Sub-Reihung „Folgewoche 13./14. Mai 2026"; zusätzlich Tagesstand 13. Mai 2026 in der TrueUp-Reihe); § 11.5 zwei neue Sammelbelege (Cisco TechCrunch/Tech Portal/24/7 Wall St./Baltimore Sun; TrueUp/Yahoo Finance/Next Web 13. Mai 2026); Aktualitätshinweis ergänzt; README.md mit neuem Versionseintrag 23.0. | Verstärkt das in Version 22.0 (Cloudflare) eingeführte Muster *„Rekord-Umsatz und gleichzeitig KI-getriebene Stellenstreichungen"* um eine bei klassischen Netzwerk-Infrastrukturanbietern bisher nicht beobachtete Erscheinung. Für die in § 1.1 zentrale Asymmetrie-Linie (Personalreduktion vs. Infrastrukturausbau) und für die in § 9.1 diskutierte Kausalattribution ein materieller Beleg, der die *Washington-Post*-Differenzierungsanalyse vom 1. Mai 2026 weiter empirisch unterfüttert. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Bundesrat 1065. Sitzung 8. Mai 2026 — GKV-Erstdurchgang nicht eindeutig dokumentiert; öffentlich zugängliche Sitzungsergebnisse legen Schwerpunkt auf andere Vorlagen (private Altersvorsorge, Steuerberatungsgesetz); ressortinterne Stellungnahmen zum GKV-Beitragssatzstabilisierungsgesetz noch nicht datierbar; bestehender § 5.2-Hinweis bleibt korrekt — im nächsten Lauf nachzutragen.
- Connecticut SB 5 — Lamont-Unterzeichnung zum Stichtag 15. Mai 2026 nach Berichterstattung der Kanzlei-Analysen (DLA Piper, Davis Wright Tremaine, Freshfields) zwar als beschlossen referenziert, ein konkretes Unterzeichnungsdatum aber weiterhin nicht öffentlich publiziert; bestehender § 4.5-Block bleibt korrekt; weiter zu beobachten.
- Block / Square — KI-getriebene Stellenstreichungen Q1 2026 sind bereits seit Februar/März 2026 dokumentiert und in Version 13.0+ erfasst; die *Baltimore Sun*-Aggregation vom 14. Mai 2026 wiederholt diese ohne neue Substanz.
- Anthropic — Gates-Foundation-Partnerschaft 13. Mai 2026 und PwC-Deployment-Ankündigung 14. Mai 2026: Geschäftsmeldungen ohne unmittelbare politisch-fiskalische Implikation; für die Steuerdebatte nicht trennscharf einordbar.
- Plattform-Digitalabgabe (Weimer): keine formale Bewegung über Version 22.0 hinaus zwischen 8. und 15. Mai 2026; Eckpunktepapier weiterhin angekündigt, aber nicht vorgelegt; bestehender § 4.4-Block bleibt korrekt.
- Tesla Optimus / Figure / 1X NEO (Cluster J): keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster.
- DeepSeek / OpenAI / Anthropic Frontier-Releases (Cluster I): kein neues Modell mit unmittelbarer Inferenzpreis- oder Marktstruktur­wirkung im 48-Stunden-Fenster; Musk-vs.-Altman-Trial (12.–14. Mai 2026) für die Steuerdebatte nicht trennscharf einordbar.
...
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; Kapitel 6 erhält eine neue Unterüberschrift § 6.5 — die Kapitelanzahl bleibt unverändert; keine leeren Abschnitte. |
| 2.1.2 Nummerierung | OK | Kapitel 1–11 lückenlos; Kapitel 6 jetzt 6.1–6.5 lückenlos; fünf Robotersteuer-Typen, drei Hebel der Deutschland-These und sieben Empfehlungen unverändert. |
| 2.1.3 Querverweise | OK | Neuer § 6.5 verweist auf § 9.1 und § 4.5 (Connecticut-SB-5-WARN-AI); § 9.1 Displacement-basiert ergänzt mit Querverweis auf § 6.5 und § 4.5; § 3.5 IAB-Komplementärabsatz mit Querverweis auf § 8.2 (Veredelungsstrategie) und § 8.3 (Teilhabe). Alle Ziele existieren. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen verlängern die bestehende Linie ohne Architekturverschiebung: § 4.3 EU-AI-Act-Update setzt die in Version 11.0 begonnene Trilog-Linie fort; § 3.5 deutsche Adoptionszahl ergänzt die internationale Befundbasis; § 6.5 erweitert das internationale Vergleichsspektrum um einen arbeitsrechtlichen Pfad neben den steuerlichen Modellen (Südkorea, Italien, Polen); § 1.1 Mai-2026-Folgewoche reiht sich an die bestehende Layoff-Tracker-Chronologie an. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; neue Unterüberschrift § 6.5 mit konsistenter Hierarchie (`### 6.5 …`); keine Tabellenänderungen; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | EU-Trilog-Einigung vom 7. Mai 2026 mit Stichtagen 2. Dezember 2027 und 2. August 2028 sowie Art.-5-Verbot (Anpassungsfrist 2. Dezember 2026) durch consilium.europa.eu, twobirds.com und modulos.ai konsistent; IAB-Kurzbericht 08/2026 mit Veröffentlichungsdatum 5. Mai 2026, Autoren Friedrich/Kagerl und Kernzahlen (25 % / 48 % / 21 % / 59 % / 90 % / 16 % / 6 %) durch iab.de Presseinformation und doku.iab.de PDF-Direktlink belegt; Hangzhou-Urteil mit Datum 28. April 2026 und Sekundärberichterstattung NPR (1. Mai), Bloomberg (2. Mai), Fortune (3. Mai) durch china.org.cn, SCIO, Caixin und Fisher Phillips konsistent; LinkedIn-Streichungen 875 Stellen / 5 % am 13. Mai 2026 durch Republic World, Business Today, Inc.; Cisco-Restrukturierung 4.000 Stellen / unter 5 % / Q3-FY2026-Rekordumsatz 15,8 Mrd. USD / +12 % YoY durch TechCrunch, Tech Portal, 24/7 Wall St., Baltimore Sun. |
| 2.2.2 Redundanzprüfung | OK | EU-Trilog-Einigung ist neuer Sachstand (überholt die Version-22.0-Formulierung „nächste Runde 13. Mai 2026"); IAB-Kurzbericht 08/2026 ist erste deutsche Aggregat-Zahl zur generativen KI im Betriebspanel (keine Vorversion); Hangzhou-Spruchpraxis ist erstmals im Dokument (neuer Abschnitt § 6.5); LinkedIn und Cisco sind erstmalig erfasste Tageswellen. Keine Doppelung. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; EU-Trilog-Einigung im Konjunktiv referiert (vorläufige politische Einigung, förmliche Verabschiedung noch ausstehend); chinesische Spruchpraxis als Tatsache mit klarer Quellenzuschreibung; LinkedIn-Begründung („leverage AI tools") als Memo-Aussage in Anführungszeichen. |
| 2.2.4 Ausgewogenheit | OK | EU-Trilog-Einigung neutral als Verschiebung dargestellt, ohne als „Aufweichung" qualifiziert zu werden; Hangzhou-Spruchpraxis nicht als Vorbild, sondern als „Hinweisquelle" eingeordnet; LinkedIn-Streichungen unter expliziter Wiedergabe der offiziellen Gegen­darstellung (keine KI-Substitution); Cisco-Restrukturierung neutral mit beiden Seiten der Asymmetrie-Linie (Personalreduktion vs. Infrastrukturausbau) dokumentiert. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Digital Omnibus on AI" als Eigenname in Original-Schreibweise; „major change in objective circumstances" als gerichtsoffizielle Fachformel in Anführungszeichen; „observed exposure" und „Veredelungsstrategie" konsistent mit bisheriger Verwendung. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Neue Einträge: § 11.3 +4 (Rat-der-EU-Pressemitteilung 7. Mai, Bird & Bird / Modulos / NicFab / Lexology, Friedrich & Kagerl IAB-Kurzbericht 08/2026, Hangzhou-Gericht); § 11.5 +4 (LinkedIn-Sammelbeleg, Cisco-Sammelbeleg, TrueUp/Yahoo Finance/Next Web 13. Mai, NPR/Bloomberg/Fortune/NextWeb China-Spruchpraxis). Jede Fließtext-Referenz hat einen Eintrag; keine Karteileichen. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-naher Zitierstil, vollständige URLs ohne Shortener, Datumsangaben „DD. Monat YYYY"; IAB-Kurzbericht 08/2026 mit korrektem Identifikator. |
| 2.4.3 Aktualität und Belastbarkeit | OK | Primärquellen (consilium.europa.eu für Trilog-Einigung; iab.de und doku.iab.de für IAB-Kurzbericht; china.org.cn/SCIO für Hangzhou-Urteil); Sekundärberichterstattung mit etablierten Medien (Bloomberg, NPR, Fortune, Reuters, TechCrunch); Kanzlei-Analysen (Bird & Bird, Modulos, NicFab, Lexology, Timelex, DLA Piper, Fisher Phillips) für rechtliche Detailtiefe. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs: consilium.europa.eu/en/press/press-releases/2026/05/07/ (öffentlich, Inhalt konsistent); twobirds.com/en/insights/2026/digital-omnibus-on-ai-provisional-agreement (öffentlich); iab.de/presseinfo/jeder-vierte-betrieb-in-deutschland-nutzt-generative-ki (öffentlich, Inhalt konsistent mit Friedrich/Kagerl-PDF); doku.iab.de/kurzber/2026/kb2026-08.pdf (öffentlich); npr.org/2026/05/01/nx-s1-5807131 (öffentlich); fortune.com/2026/05/03/chinese-court-layoffs (öffentlich); techcrunch.com/2026/05/14/cisco-cuts-nearly-4000-jobs (öffentlich); republicworld.com/tech/linkedin-layoffs-2026 (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | EU-Stichtage (2. Dezember 2027 / 2. August 2028) und CSAM-Anpassungsfrist (2. Dezember 2026) wörtlich aus consilium.europa.eu; IAB-Kennzahlen (5 → 25 %, 48 %, 21 %, 59 %, 90 %, 16 %, 6 %) wörtlich aus IAB-Presseinformation und Kurzbericht-PDF; Hangzhou-Vergütung (25.000 RMB/Monat) und Rechtsformel „major change in objective circumstances" wörtlich aus Fortune und Caixin Global; LinkedIn-Stellenzahl (875), Anteil (5 %) und Funktionsbereich (EMEA/APAC, Engineering/Product/Marketing/GBO) wörtlich aus Republic World/Business Today; Cisco-Kennzahlen (4.000 Stellen / unter 5 % / 15,8 Mrd. USD / +12 % YoY) wörtlich aus TechCrunch/Tech Portal. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; neue Sammelbelege haben jeweils Primär- und mindestens eine unabhängige Sekundärquelle und benötigen keine eigene Verifizierungsmarkierung. |
...
Keine — die fünf Ergänzungen verlängern bestehende Linien (EU-AI-Act-Trilog, IAB-Forschung, internationale Vergleichsfälle, Layoff-Tracker) bzw. eröffnen mit § 6.5 einen sachlich gerechtfertigten neuen Unterabschnitt ohne Korrekturbedarf an anderen Aussagen.
