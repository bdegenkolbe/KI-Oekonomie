...
## Validierung 28. Mai 2026 (Lauf 001 vom 28. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf nach Lauf 001 vom 8. Mai 2026 (Version 22.0); zwischen den beiden Läufen liegen 20 Kalendertage. Web-Recherche im Korridor der Cluster A–J am 28. Mai 2026: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Sechs belegbare Treffer aus Cluster D (Warren-Op-Ed) und Cluster F (Groupon, Wix, BigID, Intuit als Aggregat-Bestandteil der Tracker-Methodik, SkillSyncer-Tracker-Tagesfortschreibung) sowie ein zentraler deutscher Frühindikator aus Cluster E (ifo Beschäftigungsbarometer Mai 2026) im 7-Tage-Fenster identifiziert und eingearbeitet; alle übrigen recherchierten Themen waren in Version 22.0 bereits enthalten oder lagen außerhalb des 7-Tage- bzw. 48-Stunden-Korridors.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Warren-Op-Ed *„Why We Need to Tax AI"* (Time, 27. Mai 2026) — zwei flankierende Abgabe-Instrumente (per-kWh-Excise auf Rechenzentren-Stromverbrauch, skaliert nach Operationsumfang; Vermögensteuer auf KI-Sektor-Milliardäre namentlich Bezos/Altman) zur Finanzierung universaler Krankenversicherung, beitragsfreier Hochschulbildung und gestärkter Arbeitslosenversicherung für durch Automatisierung verdrängte Beschäftigte; Verweis auf fünfjährige Strompreissteigerung um rund 267 % in einzelnen US-Gemeinden im Datenzentren-Kontext; Begleitstrang Ultra-Millionaire Tax Act of 2026 (2 % ab 50 Mio. USD, +1 % für Milliardäre, von UC Berkeley auf rund 6,2 Bio. USD über zehn Jahre geschätzt). Quellen: Time, Axios, The Hill, TechTimes, Cryptobriefing (alle 27. Mai 2026); Begleitstrang U.S. Senate (Warren). | § 4.5 neuer Absatz zwischen Bloomberg-Editorial-Block und Andrew-Yang-Block: Warren-Vorstoß zur KI-Besteuerung; § 11.5 zwei neue Einträge (Warren-Belegcluster und Begleitstrang Untersuchungsanfrage); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versions-Eintrag 23.0. | Der Vorstoß verschiebt die Anknüpfung der Robotersteuer-Diskussion erstmals systematisch von der Outputs-Seite (nachgewiesene Stellenverdrängung — Typ 5 nach § 2.1) auf die Inputs-Seite (Energie- und Rechenleistung) und umgeht damit die in § 9.1 dokumentierten Mess- und Kausalitätsprobleme einer Typ-5-Ersatzabgabe; schließt an die progressive Linie Sanders/AOC (§ 4.5) und die Staatsfonds-Linie (§ 5.4) an, ohne die OpenAI-Linie einer breit angelegten Steuermodernisierung aufzunehmen, und ist insofern ein eigenständiger Pfad neben dem April-2026-OpenAI-Papier (§ 4.5) und dem Bloomberg-Editorial vom 29. April 2026 (§ 4.5); präzisiert den US-Bezugsrahmen der Rechenzentren-Politik nach dem Maine-Veto und *S. 4214* (Sanders/Ocasio-Cortez). |
| 2 | Groupon — Restrukturierungsprogramm *„Project Foundry"* (8-K-Filing 26. Mai 2026, Vorstandsbeschluss 21. Mai 2026, Ankündigung 27. Mai 2026): bis zu 400 Stellen weltweit (rund 24 % der Belegschaft von ungefähr 1.700 Beschäftigten), Abschluss bis Ende Q3 2026; annualisierte Einsparung 20–25 Mio. USD, Restrukturierungsaufwand 7–13 Mio. USD vor Steuern, 2026-Bruttoeinsparung 10–12 Mio. USD bei Wiederinvestition rund der Hälfte in Marketing, AI-Infrastruktur und Talentdichte; EBITDA-Prognose 2026 von 70–75 auf 75–80 Mio. USD angehoben; AI-*Voice Agents* übernehmen Outbound-Sales; COO Jiri Ponrt-Rücktritt zum 10. Juli 2026; Aktienkurs +10 %. Quellen: Stocktitan-8-K, Crain's Chicago Business, Fast Company, PYMNTS, TipRanks, Yahoo Finance, IBTimes UK, American Bazaar, Layoffhedge (alle 21./26./27. Mai 2026). | § 1.1 (Ergänzung des Layoff-Blocks: neue „zweite Layoff-Welle der Maihälfte 2026"); § 11.5 neuer Sammelbeleg „Groupon-Belegcluster" mit neun URLs; Aktualitätshinweis am Dokumentende ergänzt. | Erster expliziter AI-*Voice Agents*-Anwendungsfall in der Layoff-Begründung, der eine konkrete funktionale Substitution (Outbound-Sales) anstelle einer abstrakten „AI-first"-Rahmung benennt — und damit die in § 9.1 dokumentierten Abgrenzungsprobleme einer Typ-5-Ersatzabgabe (§ 2.1) zwar nicht löst, aber operationalisierbarer macht. Das +10 %-Aktienkurssignal verschärft zudem die in § 1.1 dokumentierte Asymmetrie-Linie zwischen Personalreduktion und Kapitalmarktbewertung. |
| 3 | Wix — Personalreduktion vom 26. Mai 2026: rund 1.000 Stellen (etwa 20 % der Belegschaft) als größte Personalreduktion der Unternehmensgeschichte; Q1-2026-Umsatz 541 Mio. USD bei Quartalsverlust durch Marketing- und Rechenkosten der Base44-Übernahme (KI-Entwicklungswerkzeug); Aktienkursrückgang nach den Zahlen. Quellen: Gigazine, Times of Israel, GuruFocus, CoinCentral, Seeking Alpha (alle 26./27. Mai 2026). | § 1.1 (Ergänzung im neuen Layoff-Block); § 11.5 neuer Sammelbeleg „Wix-Belegcluster" mit fünf URLs; Aktualitätshinweis am Dokumentende ergänzt. | Wix ist der erste Website-Baukasten-Anbieter, der eine Personalreduktion explizit an einer KI-Übernahme (Base44) festmacht; verstärkt die in § 1.1 dokumentierte Linie, dass die Akquisition von KI-Entwicklungswerkzeugen unmittelbar mit Personalreduktion verknüpft wird. |
| 4 | BigID — Personalreduktion vom 26. Mai 2026: rund 150 Stellen aus 650 (über 20 %); CEO-Mitteilung: „adapting our workforce and accelerating an AI-first approach in both software development and operations". Quelle: Globes. | § 1.1 (Ergänzung im neuen Layoff-Block); § 11.5 neuer Eintrag „Globes BigID"; Aktualitätshinweis am Dokumentende ergänzt. | Verstärkt die in § 1.1 etablierte Linie der KI-induzierten Personalreduktionen mit explizitem „AI-first"-Memo-Vokabular; israelisches Unicorn im Datenschutz-/Compliance-Segment komplettiert die geografische und sektorale Breite. |
| 5 | Intuit — Programm vom 20. Mai 2026: rund 3.000 Stellen (17 % der Belegschaft), vom CEO Sasan Goodarzi gegenüber CNBC öffentlich nicht als KI-Maßnahme gerahmt („nothing to do with AI"), aber parallel bekanntgewordene Anthropic- und OpenAI-Verträge zur Modellintegration in Produkte. Quellen: TechCrunch, CNBC, Quartz, HR Digest, The Workers Rights (alle 20. Mai 2026). | § 1.1 (Aggregat-Bestandteil der Tracker-Methodik im neuen Layoff-Block; bewusst neutral wiedergegeben, weil der Vorstandsvorsitzende den KI-Bezug öffentlich bestreitet); § 11.5 neuer Sammelbeleg „Intuit-Belegcluster"; Aktualitätshinweis am Dokumentende ergänzt. | Wichtiger Ausgewogenheits-Anker zur in § 1.1 dokumentierten *Washington-Post*-Differenzierung vom 1. Mai 2026: Selbst bei einer 17-Prozent-Personalreduktion mit parallelen KI-Modellverträgen bestreitet das Management öffentlich die KI-Begründung; verstärkt die in § 9.1 dokumentierten Mess- und Kausalitätsprobleme einer Typ-5-Ersatzabgabe (§ 2.1). |
| 6 | SkillSyncer / TrueUp Tracker — Tagesfortschreibung zum 27. Mai 2026: 134.603 Beschäftigte aus 212 Layoff-Ereignissen (rund 916 Stellen pro Tag); US-Tech-Arbeitslosenquote 5,8 % — höchster Stand seit dem Dotcom-Einbruch 2001/2002. Quellen: SkillSyncer, TrueUp. | § 1.1 (Tagesfortschreibung der Tracker-Reihe als Anschluss an 25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 27. Mai 2026); § 11.5 neuer Eintrag „SkillSyncer/TrueUp (Stand 27. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt. | Schließt die Tracker-Reihe an den Tag des Laufs an; die zusätzliche Datenpunkt-Bestätigung der US-Tech-Arbeitslosenquote 5,8 % als höchster Stand seit dem Dotcom-Einbruch 2001/2002 liefert einen makroökonomischen Anker für die in § 1.1 und § 3.5 dokumentierten Befunde. |
| 7 | ifo Beschäftigungsbarometer Mai 2026 (27. Mai 2026): Anstieg von 91,4 Punkten im April auf 93,9 Punkte im Mai (höchster Wert seit zehn Monaten); Industrie und Chemie weiter mit Stellenabbau, Dienstleister erholt; ifo-Konjunkturchef Klaus Wohlrabe: Beschäftigungspläne „nicht mehr ganz so restriktiv"; rund 9.500 monatliche Unternehmensantworten. Quellen: ifo, Handelsblatt, Onvista, t-online, HASEPOST. | § 1.1 (neuer Satz nach IAB-Erwerbspersonenpotenzial-Block: ifo-Frühindikator als deutscher Parallelbefund zur US-Layoff-Sichtbarkeit); § 11.5 neuer Sammelbeleg „ifo-Belegcluster" mit fünf URLs; Aktualitätshinweis am Dokumentende ergänzt. | Erste deutsche Frühindikator-Wende in der Beschäftigungsfrage nach den deutlich revidierten IAB-/Bundesbank-Prognosen vom März 2026; relevant für die in § 5.1 dokumentierte Wertschöpfungsabgaben-Linie, weil eine Verlangsamung des Stellenabbaus die Anpassungspfade der lohnbasierten Sozialversicherungsfinanzierung temporär entlastet, ohne die in § 8.3 entwickelte Teilhabefrage zu adressieren. |

**Nicht aufgenommen (bewusste Auslassungen):**
- *Hangzhou*-Urteil des chinesischen Gerichts vom 30. April / 1.–3. Mai 2026 (Kündigung wegen KI-Ersatz als unzulässig erklärt) — sehr hohe Relevanz für Cluster C, aber außerhalb 7-Tage-Fenster; im nächsten Lauf gezielt nachzutragen, sobald eine Anschluss­entwicklung (MOHRSS-Verlautbarung, weiteres Urteil) im Fenster liegt.
- EU-Kommission *Draft Commission guidelines on the classification of high-risk AI systems* (19. Mai 2026) — außerhalb 7-Tage-Fenster; Konsultation bis 23. Juni 2026; im nächsten Lauf mit Stellungnahmen aus dem Konsultationsstrang nachzutragen.
- EU-Kommission / Consilium — Digital Omnibus on AI, politische Einigung 7. Mai 2026 — außerhalb 7-Tage-Fenster; bestehender Aktualitätshinweis bleibt korrekt.
- 24/7 Wall St. *Another Company Trades AI Layoffs For Stock Price* (27. Mai 2026, Groupon) — Inhalt vom Groupon-Belegcluster bereits abgedeckt.
- Anthropic Economic Index Mai 2026 — kein neuer Bericht im 7-Tage-Fenster.
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; der neue Warren-Absatz in § 4.5 verweist auf § 4.5 (Sanders/AOC, Bloomberg-Editorial, Maine-Veto), § 5.4 (Staatsfonds/UBC), § 3.5 (Yale Budget Lab), § 9.1 (Mess-/Kausalitätsprobleme Typ 5) und § 2.1 (Typologie) — alle Ziele existieren weiterhin; der neue Layoff-Block in § 1.1 verweist implizit auf § 9.1, § 2.1 und über den bestehenden Kontext auf § 5.1, § 8.3 und § 8.4. |
| 2.1.4 Roter Faden | OK | Die Warren-Ergänzung erweitert § 4.5 spiegelbildlich zur OpenAI-/Sanders-Linie und zum Bloomberg-Editorial um eine eigenständige Inputs-bezogene Anknüpfung; die Layoff-Welle und das ifo-Barometer sind Aktualisierungen des bestehenden Stellenabbau-/Tracker-Blocks und der deutschen Arbeitsmarktlinie. Der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Warren-Vorstoß: per-kWh-Excise und Vermögensteuer in der Time-Op-Ed-Primärquelle bestätigt, von Axios, The Hill, TechTimes, Cryptobriefing konsistent referiert; 267-%-Strompreissteigerung von Cryptobriefing als zusätzlicher Beleg referenziert; Ultra-Millionaire Tax Act of 2026 (2 % ab 50 Mio. USD, +1 % für Milliardäre, 6,2 Bio. USD über zehn Jahre) als Begleitstrang aus mehreren Quellen bestätigt. Groupon-8-K-Daten (400 Stellen, 20–25 Mio. USD annualisiert, 7–13 Mio. USD Restrukturierung, EBITDA 75–80 Mio. USD) wörtlich aus der Stocktitan-8-K-Veröffentlichung; Vorstandsbeschluss 21. Mai 2026 aus dem 8-K. Wix-Daten (1.000 Stellen / 20 %, Q1 541 Mio. USD, Base44) konsistent in mehreren Quellen. BigID-Daten (150 / 650, über 20 %, „AI-first") aus Globes-Primärfassung. Intuit-Daten (3.000 / 17 %, CEO-Bestreitung) aus CNBC und TechCrunch konsistent. SkillSyncer-Tracker-Stand (134.603 / 212) und US-Tech-Arbeitslosenquote 5,8 % wörtlich aus SkillSyncer-Layoff-Tracker. ifo-Daten (93,9 / 91,4) wörtlich aus ifo, Handelsblatt und Onvista. |
| 2.2.2 Redundanzprüfung | OK | Die Tracker-Reihe wird gemäß Claude.md § 4.2 als Tagesfortschreibung der bisherigen Stände (25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 27. Mai 2026) geführt — keine Doppelung. Groupon, Wix, BigID, Intuit sind neue, in keinem Vorlauf erwähnte Layoff-Wellen. Warren-Op-Ed ist eine in keinem Vorlauf erwähnte Initiative. ifo Beschäftigungsbarometer ist ein neuer Frühindikator. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten. Warren-Vorstoß wird im Konjunktiv referiert (§ 4.2 Claude.md), als eigenständiger Pfad neben Sanders/OpenAI/Bloomberg gekennzeichnet, ohne ihn zu den bestehenden Linien zu vermengen. Intuit-Bestreitung („nothing to do with AI") wird neutral wiedergegeben, ohne den parallelen Anthropic-/OpenAI-Vertragsstrang als Gegenbeweis zu instrumentalisieren. |
| 2.2.4 Ausgewogenheit | OK | Die Warren-Linie wird parallel zur OpenAI-/Sanders-Linie (progressiv) und zum Bloomberg-Editorial vom 29. April 2026 (Gegenposition) eingeordnet; die Aussicht auf kurzfristige Verabschiedung wird explizit als gering bezeichnet. Die Layoff-Aussagen Groupon („Project Foundry"/AI-Voice-Agents), Wix (Base44-Übernahme), BigID („AI-first") werden neutral als Memo-Aussagen der Konzerne zitiert (kein Autorenkommentar); die Intuit-Bestreitung wird ausdrücklich als Ausgewogenheits-Anker neben die explizit AI-rahmenden Memos gestellt. Die in § 1.1 etablierte *Washington-Post*-Differenzierung vom 1. Mai 2026 bleibt explizit erhalten und wird durch den Intuit-Fall sogar quantitativ gestützt. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „AI-native"/„AI-first"/„agentic" als zitierte Memo-Begriffe konsistent in Anführungszeichen; „Excise Tax" und „per-kWh" als US-Steuerterminologie eingeführt; bestehende Schreibweisen „TrueUp", „SkillSyncer", „Hyperscaler", „VRSAR" einheitlich; APA-konforme Quellenangabe für alle neun neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Warren-Belegcluster (Time/Axios/The Hill/TechTimes/Cryptobriefing) als neuer Eintrag in § 11.5; Warren-Senatsstrang separat in § 11.5; Groupon-Belegcluster als neuer Eintrag in § 11.5; Wix-Belegcluster als neuer Eintrag in § 11.5; BigID-Eintrag in § 11.5; Intuit-Belegcluster in § 11.5; SkillSyncer/TrueUp-Tagesstand 27. Mai 2026 in § 11.5; ifo-Belegcluster in § 11.5; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Warren-Op-Ed: Primärquelle Time-Op-Ed vom 27. Mai 2026, von Axios/The Hill/TechTimes/Cryptobriefing als Sekundärquellen referiert. Groupon: Primärquelle Stocktitan-8-K-Filing vom 26. Mai 2026 (öffentliche SEC-Veröffentlichung), Sekundärquellen Crain's/Fast Company/PYMNTS/TipRanks/Yahoo Finance/IBTimes UK/American Bazaar/Layoffhedge. Wix: Sekundärquellen Gigazine/Times of Israel/GuruFocus/CoinCentral/Seeking Alpha vom 26./27. Mai 2026. BigID: Globes-Primärfassung. Intuit: TechCrunch/CNBC vom 20. Mai 2026 als Primärquellen, Quartz/HR Digest/The Workers Rights als Sekundärquellen. SkillSyncer-/TrueUp-Tagesstand: Primärquelle Tracker-Dashboard. ifo: Primärquelle ifo Institut, Sekundärquellen Handelsblatt/Onvista/t-online/HASEPOST. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: time.com/article/2026/05/27/why-we-need-to-tax-ai/ (Paywall, Headline und Lead-Sätze konsistent); axios.com/2026/05/27/elizabeth-warren-tax-ai-companies-benefit-americans (öffentlich, Inhalt konsistent); thehill.com/homenews/senate/5898081-warren-proposes-ai-tax/ (öffentlich, Inhalt konsistent); techtimes.com/articles/317294/20260527/warren-proposes-ai-data-center-tax-fund-workers-displaced-automation.htm (öffentlich, Inhalt konsistent); stocktitan.net/sec-filings/GRPN/8-k-groupon-inc-reports-material-event-1ecafd00d145.html (öffentliche SEC-Veröffentlichung, Inhalt konsistent); gigazine.net/gsc_news/en/20260526-wix-layoff/ (öffentlich, Inhalt konsistent); globes.co.il/en/article-ai-forces-israeli-unicorn-bigid-to-lay-off-150-1001544054 (öffentlich, Inhalt konsistent); cnbc.com/2026/05/20/intuit-ceo-says-companys-17percent-workforce-cut-had-nothing-to-do-with-ai.html (öffentlich, Inhalt konsistent); ifo.de/en/survey/ifo-employment-barometer (öffentlich, Inhalt konsistent). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Warren (per-kWh-Excise, Vermögensteuer 2 %/+1 %, 6,2 Bio. USD, 267 %, Bezos/Altman) wörtlich aus den verifizierten Quellen übernommen; Kernzahlen Groupon (400 Stellen / 24 %, 20–25 Mio. USD, 7–13 Mio. USD, EBITDA 75–80 Mio. USD, +10 % Aktienkurs, Vorstandsbeschluss 21. Mai 2026, 8-K 26. Mai 2026, Ankündigung 27. Mai 2026) wörtlich aus Stocktitan-8-K; Kernzahlen Wix (1.000 / 20 %, Q1 541 Mio. USD, Base44) wörtlich aus Gigazine; Kernzahlen BigID (150 / 650, über 20 %, „AI-first") wörtlich aus Globes; Kernzahlen Intuit (3.000 / 17 %) wörtlich aus TechCrunch/CNBC; SkillSyncer-Tracker (134.603 / 212, 916 / Tag, 5,8 %) wörtlich aus SkillSyncer; ifo (93,9 / 91,4, Juli-2025-Höchststand, „Stellenabbau verlangsamt sich", Wohlrabe-Zitat „nicht mehr ganz so restriktiv") wörtlich aus ifo/Handelsblatt. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die sieben neuen Treffer benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen oder direkte Primärquelle 8-K-Filing / ifo-Erhebung). |
| 2.5 Versionskonsistenz und Lizenz | OK | Versionsnummer 23.0 in Dokumentkopf, Aktualitätshinweis, README.md (Versionszeile, Zitiervorschlag, KI-Offenlegung mit neuem Versions-Eintrag 23.0) und diesem Validierungsblock identisch; CC-BY-4.0-Hinweis und Haftungshinweis unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Keine Skripte vorhanden; manuelle Stichproben gemäß § 2.6 ersetzen den automatisierten Teil. |

### Gefundene Fehler

Keine — die sieben Ergänzungen sind Aktualisierungen einer bestehenden Linie und ein neuer Politik-Vorstoß im § 4.5-Block ohne Korrekturbedarf an anderen Aussagen.
