...
## Validierung 7. Juni 2026 (Lauf 001 vom 7. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf nach einem Monat ohne Lauf (zuletzt Lauf 001 am 8. Mai 2026). Da das Zeitfenster seit dem letzten Schnitt 30 Tage beträgt, wurde der Recherchekorridor analog zu Lauf 001 vom 8. Mai 2026 ("erweitertes Fenster" für Cluster F) auf den Zeitraum 9. Mai – 7. Juni 2026 erweitert — strikte 7-Tage- bzw. 48-Stunden-Fenster werden für die jüngsten Tagesfortschreibungen weiterhin angelegt. Web-Recherche im Korridor der Cluster A–J: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Sechs belegbare Treffer im erweiterten Fenster identifiziert und eingearbeitet.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Kalifornien — Newsom *Executive Order N-6-26* vom 21. Mai 2026: erste US-bundesstaatliche Exekutivanweisung zur Vorbereitung von Arbeitnehmern und Unternehmen auf KI-bedingte Verschiebungen; Auftrag an *Labor and Workforce Development Agency*, *Government Operations Agency* und weitere Fachministerien, binnen 180 Tagen (Mitte November 2026) Empfehlungen zur Revision des kalifornischen WARN Acts, zu Sicherungsinstrumenten (Abfindungen, equity-basierte Vergütung, CalWORKs/JobsNOW) und zur fortlaufenden KI-Arbeitsmarkt­berichterstattung vorzulegen. Quellen: Office of the Governor (21. Mai 2026), CDF Labor Law, Fisher Phillips, A&O Shearman, StateScoop, HRD, DLA Piper, Duane Morris, CalMatters. | § 4.5 (neuer Block „Sub-föderale Parallele — Kalifornien (Mai 2026)" zwischen Connecticut und Gegenmodell-Bundesregierung); § 1.1 mit Querverweis im Mai-Wellen-Absatz; § 11.5 neuer Sammelbeleg „Office of Governor Newsom / CDF / Fisher Phillips / A&O Shearman / StateScoop / HRD / DLA Piper / Duane Morris / CalMatters" mit sechs URLs; Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versions-Eintrag 23.0. | Erste US-bundesstaatliche Exekutivanweisung zur KI-Arbeitsmarkt-Wirkung — komplementär zu Connecticuts WARN-Disclosure-Linie (SB 5, § 4.5); schafft eine zweite administrative Datenquelle zur Aggregat-Messung KI-bedingter Stellenstreichungen, die für die Typ-5-Ersatzabgabe-Linie (§ 2.1, § 9.1) zentral ist, ohne in den fiskalischen Pfad einzugreifen. |
| 2 | US-Senat — Sanders *American AI Sovereign Wealth Fund Act*-Ankündigung in *New-York-Times*-Namensbeitrag vom 2. Juni 2026: einmalige 50-%-Equity-Abgabe auf das Aktienkapital großer KI-Unternehmen (OpenAI, Anthropic, xAI); Stimmrechte und gleichberechtigte Vertretung im Verwaltungsrat zur Blockierung „schädlicher" Unternehmens­entscheidungen; Erträge zunächst als Direktzahlungen an Bürgerinnen und Bürger, perspektivisch Finanzierung von Gesundheit, Bildung, Wohnungspolitik. Quellen: The Hill, Fox Business, Yahoo News, RealClearPolitics, Reason, Free Beacon. | § 4.5 (Erweiterung des Sanders-Blocks zwischen 16.-April-Namensbeitrag und Schlussabsatz; konzeptionelle Einordnung als Verschiebung von Robotersteuer/Moratorium hin zu einer Staatsfonds-Variante mit Pflichtbeteiligung, näher an § 5.4 und am OpenAI-Vorschlag eines öffentlichen Wohlstandsfonds); § 11.5 neuer Sammelbeleg „The Hill / Fox Business / Yahoo News / RealClearPolitics / Reason / Free Beacon (2. Juni 2026)" mit fünf URLs; Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versions-Eintrag 23.0. | Verschiebung der Sanders-Linie konzeptionell von Verbrauchsteuer/Moratorium hin zu einer Staatsfonds-Variante mit Pflicht­beteiligung — schließt funktional an § 5.4 (Staatsfonds) und am OpenAI-Vorschlag eines öffentlichen Wohlstandsfonds (§ 4.5) an; verfassungsrechtlich Takings-Klausel des Fünften Verfassungs­zusatzes berührt. |
| 3 | EU — Politische Einigung im dritten Trilog zum *Digital Omnibus on AI* am 7. Mai 2026 (vorgezogen statt 13. Mai 2026): Verschiebung der HRAIS-Pflichten auf den 2. Dezember 2027 (von 2. August 2026), gezielte Vereinfachungen, neue Verbote für KI-generierte nicht-einvernehmliche intime Bildinhalte und CSAM (Wirksamkeit 2. Dezember 2026); beschäftigungs­bezogene KI-Systeme bleiben als Hochrisiko klassifiziert. Quellen: Consilium, European Commission, Lexology, Latham & Watkins, DLA Piper, White & Case, Verifywise, Global Policy Watch. | § 11.5 neuer Sammelbeleg „Consilium / European Commission / Lexology / Latham & Watkins / DLA Piper / White & Case / Verifywise / Global Policy Watch (7. Mai 2026)" mit sechs URLs; Aktualitätshinweis am Dokumentende vollständig umformuliert (Trilog-Verhandlungen → erzielte Einigung mit konkreten Stichtagen); README.md mit Versions-Eintrag 23.0. | Vorgezogener Abschluss der Trilog-Verhandlungen am 7. Mai 2026 — eigentlich noch innerhalb des 7-Tage-Fensters von Lauf 001 vom 8. Mai 2026, dort jedoch nicht erfasst (Catch-up). Die neuen Stichtage (HRAIS 2. Dezember 2027) und Verbote (Wirksamkeit 2. Dezember 2026) ersetzen den bisherigen Trilog-Verhandlungs­stand im Aktualitätshinweis und sind für die in § 4 referierte EU-Architektur und die parallele Disclosure-Diskussion (Connecticut SB 5, Kalifornien EO N-6-26) zentral. |
| 4 | Tech-Layoff-Welle Mai/Juni 2026: Walmart 1.000 Corporate-Tech-Rollen am 13. Mai 2026 (offizielle KI-Begründung zurückgewiesen, intern überlappende Strukturen aus KI-Produkt­einheiten); Meta-Vollzug der April-Ankündigung am 20. Mai 2026 (rund 8.000 Stellen / 10 %, parallel bis zu 7.000 Versetzungen in *Applied AI Engineering*, *Agent Transformation Accelerator XFN*, *Central Analytics*; rund 6.000 nicht zu besetzende Stellen; Konzern-Capex 2026 125–145 Mrd. USD); Intuit 3.000 Stellen / 17 % am 20. Mai 2026 (CEO-Memo Sasan Goodarzi; Verlagerung auf KI in TurboTax/QuickBooks/Credit Karma/Mailchimp; Mehrjahres­vereinbarungen mit OpenAI und Anthropic); Uber 23 % der *People-and-Places*-Division am 3. Juni 2026 (rund 95 % der Ingenieure mit monatlicher KI-Tool-Nutzung; rund 70 % des committed Codes von KI generiert; KI-Coding-Tool-Budget in vier Monaten ausgeschöpft; neues Pro-Ingenieur-Monatslimit 1.500 USD für Claude Code, Cursor). Quellen: TechCrunch, Slashdot, CBC, NPR, Quartz, Investing Cube, Yahoo Finance, CNBC, TechTimes, PYMNTS, BusinessToday, WoodRadio, HR Executive, MetaIntro. | § 1.1 (neuer Folgeabsatz nach Challenger-April-Bestätigung „Die Linie setzt sich im Mai und Anfang Juni 2026 fort"); § 11.5 vier neue Sammelbelege (Intuit, Meta-Vollzug, Uber, Walmart) mit insgesamt 14 URLs; Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versions-Eintrag 23.0. | Setzt die in § 1.1 entwickelte KI-Verdrängungslinie über die Vorwochen-Welle (Cloudflare, Coinbase, PayPal, Freshworks, Cognizant) auf vier neue Akteurs­typen fort: Retail (Walmart), Social/Foundation-Models (Meta), Fintech/Tax-SaaS (Intuit), Mobility (Uber). Uber-Fall mit empirischem Beleg für § 8.2-Linie zum Verhältnis Anwender/Modellanbieter (95 % Ingenieur-Nutzung, 70 % Code von KI, 4-Monate-Budget-Ausschöpfung); Intuit-Fall mit expliziter Verweisung auf OpenAI- und Anthropic-Mehrjahres­vereinbarungen, die die OpenAI-Strategiepapier-Linie (§ 4.5) und die Plattform-Architektur-Frage (§ 8.2, § 8.3) konkretisieren. |
| 5 | Challenger, Gray & Christmas — *Mai-2026-Job-Cuts-Report* (veröffentlicht 4. Juni 2026): KI-bezogene Streichungen 38.579 im Mai 2026 (rund 40 % aller Mai-Streichungen) — erstmals KI als am häufigsten genannter Einzelgrund nach Challenger-Methodik (im April 2026 noch Rang 2 mit 26 %); YTD KI-bezogen 87.714 (bereits über dem Vorjahresvergleichswert von 54.836 für ganz 2025). Quellen: TechJacks Solutions, TechTimes. | § 1.1 (Aktualisierung der Challenger-Aggregat-Linie im Anschluss an die April-Report-Ergänzung von Lauf 001 vom 8. Mai 2026 — KI rückt vom zweiten auf den ersten Rang; YTD-Wert übersteigt den Vorjahresgesamtwert); § 11.5 neuer Sammelbeleg „Challenger / TechJacks Solutions / TechTimes (4./5. Juni 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versions-Eintrag 23.0. | Methodisch unabhängige Aggregat-Bestätigung der KI-Verdrängungslinie aus einer in den USA seit den 1970er-Jahren etablierten Privatdatenquelle; KI als #1-Einzelgrund nach Challenger-Methodik markiert eine qualitative Schwelle, die das in § 1.1 referierte Niveau aus § 3.5 (Anthropic Economic Index, Yale Budget Lab) nicht umkehrt, aber die diskursive Sichtbarkeit weiter erhöht. |
| 6 | TrueUp Tracker — Tagesfortschreibung zum 5. Juni 2026: 149.935 Personen aus 363 Layoff-Meldungen (rund 974 Stellen pro Tag); Anstieg gegenüber dem 8.-Mai-Stand (127.411 / 283) primär gespeist durch die im Mai/Juni 2026 angekündigten Wellen (Walmart, Meta, Intuit, Uber u. a.). Quelle: TrueUp, TechTimes (Stand 5. Juni 2026). | § 1.1 (Tagesfortschreibung der Tracker-Reihe im neuen Mai/Juni-Absatz); § 11.5 neuer Eintrag „TrueUp / TechTimes (Stand 5. Juni 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versions-Eintrag 23.0. | Schließt die Tracker-Reihe an den Monatsende-Tag an und dokumentiert, dass die kumulativen Tech-Streichungen 2026 inzwischen die 150.000-Marke erreichen; absolute Tagesrate sinkt leicht (von 1.003 auf 974), das kumulative Niveau übersteigt aber den Stand 8. Mai 2026 um rund 18 %. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Federal Reserve Bank of Atlanta WP 2026-04 (25. März 2026; in Lauf 002/7. Mai bereits als „außerhalb Fenster" markiert) — weiterhin außerhalb des erweiterten Fensters.
- Korinek & Lockwood *„Public Finance in the Age of AI: A Primer"* (Brookings/NBER WP 34873, 8. Januar 2026) — in § 3.3 (Korinek & Lockwood) bereits seit Version 9.0 dokumentiert.
- Anthropic-Economic-Index-Folgeberichte (kein neuer Bericht zwischen 9. Mai und 7. Juni 2026; bestehender § 3.5-Block bleibt aktuell).
- Connecticut SB 5 — Lamont-Unterzeichnung: weiterhin nicht mit eindeutigem Datum dokumentiert in den Tagesquellen; bestehender § 4.5-Block bleibt korrekt, im nächsten Lauf erneut zu prüfen.
- Bundesrat 1065. Sitzung 8. Mai 2026 / Bundestag-Erstlesung 12. Juni 2026 zum GKV-Beitragssatzstabilisierungsgesetz: Tagesordnung und Sitzungstermine im Aktualitätshinweis aktualisiert; verbindliche Beschlüsse zum 7. Juni 2026 noch nicht öffentlich.
- Procter & Gamble Restrukturierung (Juni 2025; vorgängiger Vorgang, nicht im 2026er-Korridor) — verworfen.
- Sanders-Robotersteuer-Folgeinitiative aus Oktober 2025 / S. 4214 (Moratorium) — bereits in § 4.5 dokumentiert.
- Federal-Preemption-Linie und *National AI Policy Framework* — bereits in § 4.5 dokumentiert.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide KI-spezifische Treffer im Fenster (G-BA-/gematik-/BfArM-Listings ohne Aggregat-Wirkung).
...
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; neue Unterüberschrift „Sub-föderale Parallele — Kalifornien (Mai 2026)" als zusätzlicher Lead-In im bestehenden § 4.5 (analog zu Maine und Connecticut, kein neuer Unterabschnitt); keine leeren Abschnitte. |
| 2.1.2 Nummerierung | OK | Kapitel 1–11 lückenlos; Unterabschnitt 8.1–8.7 unverändert; fünf Robotersteuer-Typen, drei Hebel der Deutschland-These und sieben Empfehlungen unverändert. |
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; der neue Kalifornien-Block verweist zurück auf Connecticut (§ 4.5 vorangehend) und auf § 9.1 / § 2.1; der neue Mai/Juni-Absatz in § 1.1 verweist auf § 8.2 (Uber-KI-Coding-Budget); der Sanders-Erweiterungs­absatz verweist auf § 5.4 (Staatsfonds), § 4.5 (OpenAI), § 2.1 Typ 5. Alle Ziele existieren. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind eine Aktualisierung des bestehenden Layoff-/Tracker-Blocks (§ 1.1) und der US-Politik-Initiativen (§ 4.5); der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; keine neuen Tabellen; neue Lead-Ins („Sub-föderale Parallele — Kalifornien (Mai 2026):") im Stil der bestehenden Maine-/Connecticut-Lead-Ins; Versionszeile im Dokumentkopf (22.0 → 23.0) und Stand-Zeile (Mai 2026 → Juni 2026) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Newsom EO-Nummer N-6-26, Unterzeichnungsdatum 21. Mai 2026, 180-Tage-Frist (Mitte November 2026), Auftrag­behörden LWDA/GovOps in mehreren unabhängigen Quellen (Office of Governor, Fisher Phillips, A&O Shearman, CalMatters) konsistent; Sanders-Vorschlag 50 % Equity-Abgabe, OpenAI/Anthropic/xAI als Adressaten, Direktzahlungen in mehreren Quellen (The Hill, Fox Business, RealClearPolitics, Reason) übereinstimmend; EU Digital Omnibus politische Einigung am 7. Mai 2026, HRAIS-Verschiebung auf 2. Dezember 2027 in Consilium, Commission, Lexology, Latham & Watkins, DLA Piper, White & Case übereinstimmend; Meta 8.000 / 10 %, Janelle Gale als CPO, Versetzungen 7.000, Capex 125–145 Mrd. USD in NPR/Quartz/InvestingCube/Yahoo Finance konsistent; Intuit 3.000 / 17 %, CEO Sasan Goodarzi, Memo-Datum 20. Mai 2026 in TechCrunch/Slashdot/CBC/Tech Startups konsistent; Uber 23 % People-and-Places-Division, 95 % Ingenieur-Nutzung, 70 % AI-Code, Budget-Ausschöpfung in vier Monaten, 1.500-USD-Monatslimit in CNBC/TechTimes/PYMNTS konsistent; Walmart 1.000 Stellen, Suresh Kumar, 13. Mai 2026, AI-Begründung zurückgewiesen in HR Executive/MetaIntro/Quartz konsistent; Challenger Mai-Report 38.579 / 40 %, YTD 87.714, Vorjahresgesamt 54.836 in TechJacks Solutions/TechTimes konsistent; TrueUp 149.935 / 363 in TrueUp/TechTimes (Stand 5. Juni 2026) konsistent. |
| 2.2.2 Redundanzprüfung | OK | Die Mai/Juni-Welle wird nicht als Wiederholung der April/Mai-Welle behandelt, sondern als deren Fortsetzung mit neuen Akteuren; die TrueUp-Reihe wird gemäß Claude.md § 4.2 als Tagesfortschreibung der bisherigen Stände (25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 5. Juni 2026) geführt; Newsom-EO ist eine neue, in keinem Vorlauf erwähnte sub-föderale Initiative; Sanders American AI Sovereign Wealth Fund Act ist eine neue Folgeinitiative, konzeptionell unterschiedlich zum bestehenden Robotersteuer-Vorschlag (Sanders Oktober 2025) und zum Moratorium (S. 4214, 25. März 2026); EU Digital Omnibus politische Einigung ersetzt die bisherige Trilog-Status­beschreibung im Aktualitätshinweis. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Sanders-American-AI-Sovereign-Wealth-Fund-Act konzeptionell als Staatsfonds-Variante mit Pflichtbeteiligung eingeordnet (näher an § 5.4 als an Typ 5); Newsom EO N-6-26 als Disclosure- und Sicherungs-Architektur (komplementär zu Connecticut SB 5) ohne Eingriff in den fiskalischen Pfad eingeordnet. |
| 2.2.4 Ausgewogenheit | OK | Die Newsom-EO wird sachlich beschrieben (keine Pflichten für private Arbeitgeber); die Sanders-Initiative wird als Vorschlag im Konjunktiv referiert (gemäß Claude.md § 4.2), mit explizitem Hinweis auf die verfassungs­rechtliche Herausforderung (Takings-Klausel des Fünften Verfassungs­zusatzes) und die geringe Annahme­wahrscheinlichkeit im republikanisch geführten Kongress; das Bloomberg-Editorial vom 29. April 2026 als Gegenstimme bleibt erhalten (§ 4.5); die Walmart-Streichungen werden mit der ausdrücklich zurückgewiesenen KI-Begründung wiedergegeben (Multikausalität gemäß *Washington-Post*-Differenzierung 1. Mai 2026). |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Executive Order N-6-26", „American AI Sovereign Wealth Fund Act", „Digital Omnibus on AI", „HRAIS" als zitierte Begriffe in Kursivschrift bzw. mit Anführungszeichen; „CalWORKs/JobsNOW", „Applied AI Engineering" usw. einheitlich; APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sechs neue Sammelbelege als Einträge in § 11.5 (Newsom EO, Sanders AI Sovereign Wealth Fund Act, EU Digital Omnibus, Intuit, Meta-Vollzug, Uber, Walmart, Challenger Mai, TrueUp 5. Juni); keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Newsom EO: Primärquelle ist die offizielle Pressemitteilung des Governor's Office; zahlreiche unabhängige Kanzleianalysen (Fisher Phillips, A&O Shearman, DLA Piper, CDF Labor Law, Duane Morris) bestätigen Inhalte. Sanders: Primärquelle ist der *New-York-Times*-Namensbeitrag vom 2. Juni 2026 (Sekundärquellen via The Hill, Fox Business, RealClearPolitics, Reason). EU Digital Omnibus: Primärquellen sind Consilium-Pressemitteilung und EU-Kommissions-Pressemitteilung vom 7. Mai 2026. Layoff-Belege: Primärquellen sind Konzern-Memos/Pressemitteilungen (Intuit Goodarzi, Meta Gale, Uber-Memo), in TechCrunch/CNBC/NPR/Quartz referiert. Challenger-Bericht: Primärquelle ist der Originalreport vom 4. Juni 2026. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: gov.ca.gov/2026/05/21/governor-newsom-signs-first-of-its-kind-executive-order (öffentlich, Inhalt konsistent); consilium.europa.eu/en/press/press-releases/2026/05/07/artificial-intelligence-council-and-parliament-agree-to-simplify-and-streamline-rules (öffentlich); thehill.com/policy/technology/5906140-sanders-ai-ownership-wealth (öffentlich); techcrunch.com/2026/05/20/intuit-to-lay-off-over-3000-employees-to-refocus-on-ai (öffentlich); cnbc.com/2026/06/03/uber-layoffs-people-division-ai (öffentlich); npr.org/2026/05/20/nx-s1-5826917/meta-layoffs-ai-jobs (öffentlich); trueup.io/layoffs (öffentlich, Tracker-Dashboard); techtimes.com/articles/317848 (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Newsom EO (180-Tage-Frist, WARN-Reform, CalWORKs/JobsNOW), Sanders (50 % Equity-Abgabe, OpenAI/Anthropic/xAI, Verwaltungsrat­vertretung), EU Digital Omnibus (HRAIS 2. Dezember 2027, neue Verbote 2. Dezember 2026), Meta (8.000 / 10 %, 7.000 Versetzungen, 6.000 nicht zu besetzende Stellen, Capex 125–145 Mrd. USD), Intuit (3.000 / 17 %), Uber (23 %, 95 %, 70 %, 1.500 USD/Monat), Walmart (1.000), Challenger (38.579 / 40 %, YTD 87.714, Vorjahr 54.836), TrueUp (149.935 / 363, 974/Tag) wörtlich aus den verifizierten Quellen übernommen. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Sammelbelege benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen, in mehreren Fällen amtliche Primärquellen). |
| 2.5 Versionskonsistenz und Lizenz | OK | Versionsnummer 23.0 in Dokumentkopf, Stand-Zeile, Aktualitätshinweis, README.md (Versionszeile, Stand-Zeile, Zitiervorschlag, KI-Offenlegung mit neuem Versionseintrag) und diesem Validierungsblock identisch; CC-BY-4.0-Hinweis und Haftungshinweis unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Keine Skripte vorhanden; manuelle Stichproben gemäß § 2.6 ersetzen den automatisierten Teil. |

### Gefundene Fehler

Keine — die sechs Ergänzungen sind Aktualisierungen bestehender Linien (§ 1.1, § 4.5, § 11.5) ohne Korrekturbedarf an anderen Aussagen.
