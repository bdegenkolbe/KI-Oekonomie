...
## Validierung 19. Mai 2026 (Lauf 001 vom 19. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf am 19. Mai 2026 nach Lauf 001 vom 8. Mai 2026 (elf Tage Abstand). Web-Recherche im Korridor der Cluster A–J: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Vier belegbare Treffer aufgenommen: vorläufige AI-Act-Omnibus-Trilog-Einigung vom 7. Mai 2026 (Cluster B; im Vorlauf vom 8. Mai 2026 als „nach Stichtag" verworfen, tatsächlich bereits vor Stichtag erfolgt — Sachverhaltskorrektur); IAB-Kurzbericht 8/2026 vom 5. Mai 2026 zur generativen KI-Nutzung in deutschen Betrieben (Cluster E/H; im Vorlauf nicht gefunden, im erweiterten Fenster nachgereicht); Mai-2026-Layoff-Welle Walmart/Cisco/BILL/Upwork und TrueUp-Tracker-Tagesfortschreibung zum 19. Mai 2026 (Cluster F); zusätzlich Sachverhaltskorrektur zum *GKV-Beitragssatzstabilisierungsgesetz*, das in der 1065. Bundesratssitzung am 8. Mai 2026 entgegen der in Version 22.0 dokumentierten Erwartung *nicht* auf der Tagesordnung stand und Stand 19. Mai 2026 vom BMG noch nicht dem Bundestag zugeleitet wurde.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU — *Digital Omnibus on AI*, vorläufige politische Einigung am 7. Mai 2026 (rund 4:30 Uhr); Maschinenverordnung Anhang I aus Sektion A in Sektion B verschoben; Stichtage 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); Watermark-Pflicht nach Art. 50 (2) mit Übergang zum 2. Dezember 2026; neuer Art.-5-Verbotstatbestand für nicht-einvernehmliche intime Inhalte und CSAM-Erzeugung ab 2. Dezember 2026; deutsche Wirtschaftsverbände (Bitkom, BDI) begrüßen, TÜV ambivalent, 130+ zivilgesellschaftliche Organisationen kritisieren; bilaterale Verständigung Berlin–Paris vor Trilog-Schluss­runde Schlüsselereignis; förmliche Annahme „vor 2. August 2026". Quellen: Rat der EU (7. Mai 2026), Bird & Bird, White & Case, Lexology, Timelex, Modulos, IAPP, Bitkom, BDI, TÜV, CDU/CSU-Fraktion, Table.Briefings, Tagesspiegel Background. | § 4.5 neuer eigener Absatz „EU — Digital Omnibus on AI, vorläufige Einigung am 7. Mai 2026"; Korrektur der bisherigen Erwartung „nächste Runde 13. Mai 2026" im Aktualitätshinweis; § 11.3 neuer Eintrag zur Rats-Pressemitteilung sowie neue Sammelbelege (Kanzlei­analysen, Wirtschafts- und Prüfverbände, deutsche Berichterstattung). | Die Einigung ist die erste substantielle Änderung der KI-Verordnung vor Inkrafttreten der zentralen Hochrisiko-Pflichten und betrifft die Konformitätsbewertungs-Architektur für Anhang I direkt — die in Version 22.0 noch offene Frage ist damit beantwortet. Die Verschiebung der Maschinenverordnung auf Sektion B ist für den deutschen Maschinenbau industriepolitisch zentral und verschiebt zugleich die Beschäftigungs-KI-Compliance um zwölf Monate — eine relevante Verschärfung der in § 1.1, § 4.5 und § 9.1 diskutierten zeitlichen Lücke zwischen sichtbarer KI-Verdrängung und greifender europäischer Regulierung. |
| 2 | IAB — *IAB-Kurzbericht 8/2026: „Jeder vierte Betrieb in Deutschland nutzt generative KI"* (5. Mai 2026): Generativer KI-Nutzungsanteil von 5 % (2023) auf knapp 25 % (2025); weitere 9 % planen die Einführung; 48 % in Betrieben ≥ 200 Beschäftigte vs. 21 % in Kleinstbetrieben < 10 Beschäftigte. Datenbasis IAB-Betriebspanel mit rund 15.000 Betrieben. | § 1.1 Ergänzung in der Erwerbspersonenpotenzial-Passage; § 11.3 neuer Eintrag bei den IAB-Kurzberichten. | Direkte Primärquelle zur betrieblichen KI-Adoption in Deutschland; ergänzt die in § 1.1 dokumentierte Tracker- und Stellenausschreibungs­linie um eine repräsentative innerbetriebliche Nutzungsstatistik, die für die Lohnquoten- und Sozialversicherungs­diskussion (§ 5.1, § 7) den deutschen Datenpunkt liefert. Im Vorlauf vom 8. Mai 2026 nicht erfasst — Aufnahme im erweiterten Fenster mit Vermerk in Auffälligkeiten. |
| 3 | Mai-2026-Layoff-Welle: *BILL Holdings* (bis zu 30 % der Belegschaft, ca. 700 Stellen; 8-K vom 7. Mai 2026 mit parallelem 1,0-Mrd.-USD-Aktienrückkauf; CEO-Brief Lacerte „AI-native company"; Restrukturierung 30–60 Mio. USD); *Upwork* (rund 24 %, ca. 145 Stellen; CEO-Memo Brown „Two pizza teams are dead"; Aktienkurs −19 %); *Walmart* (12. Mai 2026: rund 1.000 Konzern-Stellen, Konsolidierung der globalen Technologie- und AI-Produktorganisation; AI im Memo *nicht* als Begründung); *Cisco* (14. Mai 2026: rund 4.000 Stellen, < 5 % der Belegschaft, parallel Rekordumsatz 15,8 Mrd. USD im Q3 FY2026, KI-Auftragseingänge 5,3 Mrd. USD YTD; Severance/Restrukturierung rund 1 Mrd. USD); TrueUp-Tracker-Tagesfortschreibung 19. Mai 2026: 138.837 Personen aus 324 Layoff-Meldungen, rund 1.006 Stellen pro Tag. | § 1.1 Erweiterung der bestehenden Layoff-Reihe nach Cloudflare-Block; § 11.5 sechs neue Sammelbelege (PYMNTS/Yahoo/Simply Wall St/Stocktitan; OfficeChai/Yahoo/Upwork Press; WSJ/GV Wire/Storyboard18/Quartz; TechCrunch/Tech Portal/Mirror Review/TechRadar/SEC 8-K; TrueUp/TechTimes/Yahoo Tech; Bloomberg Goldman Sachs Waldron); Aktualitätshinweis am Dokumentende und README-Versionseintrag entsprechend erweitert. | Setzt die in § 1.1 etablierte Layoff-/Tracker-Linie über den Mai 2026 fort. Bemerkenswert ist die qualitative Spreizung: BILL und Upwork (kleine SaaS-/Marketplace-Akteure mit ausdrücklichem „AI-native"-Framing), Cisco (Infrastruktur mit Rekordumsatz und explizitem KI/Cybersecurity-Pivot), Walmart (Großhandel mit AI-Programmkonsolidierung, aber *ohne* AI-Begründung im Memo) — bestätigt die in der *Washington-Post*-Differenzierung vom 1. Mai 2026 angemerkte Mehrkanalerklärung. Goldman-Sachs-Präsident Waldron beziffert den Effekt auf die eigene Organisation („Skalierung ohne nennenswerten Personalaufbau") und ergänzt damit die in § 3.5 referierte Goldman-April-Schätzung um eine konzernöffentliche Selbstaussage. |
| 4 | Sachverhaltskorrektur — *GKV-Beitragssatzstabilisierungsgesetz*: In der 1065. Bundesratssitzung am 8. Mai 2026 (gemäß Versionseinträgen 19.0 → 22.0 als Erstdurchgang verzeichnet) *nicht* auf der Tagesordnung; das BMG hat den Kabinettentwurf vom 29. April 2026 zum 19. Mai 2026 weder dem Bundestag zugeleitet noch in der Bundestags-Sitzungswoche eingebracht; das Ziel einer Verabschiedung vor der Sommerpause 2026 bleibt nach BMG-Verfahrensseite bestehen. Quelle: Bundesrat-Kompakt-Bericht zur 1065. Sitzung; BMG-Pressemeldung und Verfahrensseite. | § 1.1 / § 5.2 Kontext: GKV-BSSG-Passage präzisiert (Hinweis auf die in Lauf 001 vom 8. Mai 2026 fehlerhaft fortgeschriebene Erwartung, Tagesordnung der 1065. Sitzung beschrieben, neuer Termin im Bundesrat zum 19. Mai 2026 öffentlich nicht datiert); Aktualitätshinweis am Dokumentende korrigiert; README-Versionseintrag 23.0 mit Korrekturvermerk. | Faktenkorrektur: Die in den Versionen 14.0 / 15.0 / 16.0 / 17.0 / 18.0 / 22.0 fortgeschriebene Erwartung war zum Recherchezeitpunkt korrekt formuliert (Bundesrats-Termin angekündigt), bei der Sitzung selbst aber nicht eingetreten; die jetzt korrigierte Aussage spiegelt den belegten Verfahrensstand. Inhaltlich bleibt der § 5.2-Befund (gleichzeitige Spannung der lohnbasierten Sicherungszweige durch Demografie und KI) unverändert, lediglich die parlamentarische Phase wird zurückversetzt. |

**Nicht aufgenommen (bewusste Auslassungen):**
- *Anthropic Economic Index* — zwischen 24. März 2026 („Learning curves") und 19. Mai 2026 kein neuer Bericht veröffentlicht; bestehender § 3.5-Block bleibt aktuell.
- *Acemoglu/Manera/Restrepo / Thuemmel / Costinot & Werning* — keine neuen Working Paper oder peer-reviewed Veröffentlichungen im 7-Tage-Fenster mit unmittelbar steuerpolitischer Konsequenz; das *Hamilton-Project*-Papier von Acemoglu/Autor/Johnson (Februar 2026) bleibt der jüngste in § 11.1 referierte Beleg.
- *Sanders / Warren / Wyden* — keine neue KI-spezifische Steuergesetzgebung im 7-Tage-Fenster (Wealth-Tax- und Carried-Interest-Initiativen aus April 2026 sind nicht KI-spezifisch); bestehender § 4.5-Block bleibt korrekt.
- *Generationenkapital* — keine neuen Tranchen-/Renditeangaben im 7-Tage-Fenster (Gesamt-Performance 7,2 % für 2026 nach Erstmeldungen bereits in Version 6.0 / 7.0 dokumentiert); bestehender § 8.6-Verweis bleibt aktuell.
- *Bundesbank / Sachverständigenrat* — Bundesbank-Symposium 2026 thematisierte KI im Bankwesen, ohne neuen quantitativen Befund im 7-Tage-Fenster; Sachverständigenrats-Jahresgutachten 2025/2026 bleibt der jüngste Bezugspunkt.
- *IFR World Robotics* — letzte Veröffentlichung *World Robotics 2025* aus 2025; keine neue Statistik im 7-Tage-Fenster (Top-5-Trends-Pressemitteilung war Ende 2025/Januar 2026).
- *Frontier-Modell-Releases* (Cluster I, 48-Stunden-Fenster 17.–19. Mai 2026) — keine politisch-fiskalisch relevanten Tagesmeldungen.
- *Cluster G — Gesundheitswesen* — fünftes Mal in Folge ohne valide KI-spezifische Neuigkeiten im 7-Tage-Fenster; die *Seniors Deserve SMARTER Care Act*-Initiative von Warren/Wyden adressiert KI in CMS-Vorab-Genehmigungen, ist aber kein Steuer-Vorgang und passt nicht in den Korridor.
- *Connecticut SB 5 — Lamont-Unterzeichnung* — formales Datum zum 19. Mai 2026 in der gesichteten Berichterstattung weiterhin nicht datiert (Kanzlei­analysen sprechen von erwarteter Unterzeichnung „in den kommenden Wochen"); bestehende Formulierung „mit angekündigter Unterzeichnung" bleibt korrekt. Nächster Lauf zu prüfen.
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; der neue § 4.5-Absatz zum Digital Omnibus on AI verweist über den bestehenden Kontext implizit auf § 1.1 und § 9.1; die GKV-Korrektur in § 1.1 / § 5.2-Kontext bleibt mit § 5.1, § 7.2 und § 5.2 konsistent. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen führen die in § 1.1 etablierte Layoff-/Tracker-Linie fort und ergänzen § 4.5 um eine substantielle EU-rechtliche Aktualisierung; die Sachverhaltskorrektur zum GKV-BSSG verändert weder die Argumentationslinie noch die Empfehlungen in Kapitel 10. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; ein neuer fett gesetzter Lead-In in § 4.5 („EU — Digital Omnibus on AI, vorläufige Einigung am 7. Mai 2026:") einheitlich zum bestehenden Stil („Sanders-Report (Oktober 2025) und Folgeinitiativen 2026:", „Bloomberg-Editorial (29. April 2026):" etc.); Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | AI-Act-Omnibus-Eckpunkte (Maschinenverordnung Sektion A → B, Stichtage 2027/2028, Watermark 2. Dezember 2026, neue Art.-5-Vorschrift) in mehreren unabhängigen Quellen (Rat der EU, Bird & Bird, White & Case, Lexology, Bitkom, BDI) konsistent; IAB-Kurzbericht 8/2026-Kennzahlen (5 → 25 %, 9 % Pläne, 48 / 21 %) aus der IAB-Pressemitteilung und der zugehörigen Kurzbericht-PDF; Layoff-Zahlen BILL (30 % / 700 / 1 Mrd. USD Buyback / 30–60 Mio. USD Restrukturierung), Upwork (24 % / 145 / −19 %), Walmart (1.000 / Bentonville-Nordkalifornien), Cisco (4.000 / 15,8 Mrd. USD / 5,3 Mrd. USD / 1 Mrd. USD) wörtlich aus den 8-K-Filings bzw. Konzern-Pressemeldungen; TrueUp-Tagesstand 138.837 / 324 / 1.006 wörtlich aus dem öffentlich zugänglichen Tracker-Dashboard. |
| 2.2.2 Redundanzprüfung | OK | Die neuen Layoff-Ergänzungen werden gemäß Claude.md § 4.2 als Fortsetzung der bestehenden Reihe geführt; keine Doppelung. Der neue § 4.5-Absatz steht eigenständig und verweist auf den bisherigen § 4.5-Kontext (Trilog-Verhandlungsstand vor der Einigung) im Aktualitätshinweis, ohne ihn zu duplizieren. Die GKV-BSSG-Korrektur ersetzt den falschen Verweis in § 1.1, ohne den § 5.2-Block zu wiederholen. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; AI-Act-Omnibus-Eckpunkte im Konjunktiv referiert, wo sie noch nicht förmlich angenommen sind („vorläufige politische Einigung … muss nun von Rat und Parlament förmlich bestätigt … werden"). |
| 2.2.4 Ausgewogenheit | OK | Pro/Contra zum AI-Act-Omnibus ausgewogen dargestellt: Bitkom/BDI-Lob, TÜV-Skepsis, zivilgesellschaftliche Kritik nebeneinander; die in § 4.5 bestehende Spiegelung Sanders/OpenAI vs. Bloomberg-Editorial / IW Köln / de la Feria bleibt erhalten; die Walmart-Aussage „AI nicht als Begründung" wird ausdrücklich der KI-zentrischen Lesart entgegengestellt. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Digital Omnibus on AI" als zitierter Begriff in Anführungszeichen; „agentic AI-first operating model" zitiert in Anführungszeichen; bestehende Schreibweisen „TrueUp", „SkillSyncer", „Hyperscaler", „VRSAR", „IRAP" einheitlich; APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Rats-Pressemitteilung (7. Mai 2026), Sammelbeleg Kanzlei­analysen und Wirtschafts-/Prüfverbands-Stellungnahmen als neue Einträge in § 11.3; IAB-Kurzbericht 8/2026 in § 11.3 (Sektion IAB-Quellen); sechs neue Layoff-Sammelbelege in § 11.5; bestehender 13.-Mai-Trilog-Eintrag durch Erweiterung um den Sachverhalt „vorgezogen auf 7. Mai 2026" ergänzt; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | AI-Act-Omnibus: Primärquelle ist die Rats-Pressemitteilung vom 7. Mai 2026, ergänzt um Kanzlei- und Verbandsanalysen sowie deutsche Berichterstattung. IAB-Kurzbericht 8/2026: Primärquelle ist die IAB-Pressemitteilung und die Kurzbericht-PDF. Layoffs: Primärquellen sind die SEC-8-K-Filings (BILL, Cisco) bzw. CEO-Memos (Upwork, BILL); Walmart-WSJ-Bericht als Sekundärquelle mit zitiertem Memo; TrueUp-Tracker-Stand öffentlich zugänglich. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe: consilium.europa.eu/en/press/press-releases/2026/05/07/artificial-intelligence-council-and-parliament-agree (öffentlich), iab.de/presseinfo/jeder-vierte-betrieb (öffentlich), doku.iab.de/kurzber/2026/kb2026-08.pdf (öffentlich), techcrunch.com/2026/05/14/cisco-cuts-nearly-4000-jobs (öffentlich), trueup.io/layoffs (öffentlich), bill.com/blog/a-message-to-bill-employees-may-2026 (öffentlich). Die bundesrat.de-Sitzungs-URL gab im Direktabruf 403, die Tagungsergebnisse sind in der parallel zitierten Bundesrat-kompakt-Berichtsseite konsistent abgebildet. |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen AI-Act-Omnibus (Anhang I Sektion A → B, 2. Dezember 2027 / 2. August 2028, 2. Dezember 2026 Watermark/CSAM) wörtlich aus Rat der EU / Bird & Bird; IAB-Kennzahlen (5 → 25 %, 9 %, 48 / 21 %) wörtlich aus IAB-Presseinfo; Layoff-Kennzahlen (BILL 30 %, ca. 2.333 Belegschaft / 700 Stellen, 1,0 Mrd. USD Buyback, 30–60 Mio. USD Restrukturierung; Upwork 24 % / 145 / −19 %; Walmart 1.000; Cisco 4.000 / < 5 % / 15,8 Mrd. USD / 5,3 Mrd. USD / 1 Mrd. USD) wörtlich aus den verifizierten Quellen. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Sammelbelege benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen plus offizielle Primärquellen). |
...
|---|---|---|---|
| 1 | § 1.1 (Erstdurchgang GKV-BSSG am 8. Mai 2026 in 1065. Bundesratssitzung) sowie Aktualitätshinweis | In den Versionen 14.0 ff. fortgeschrieben; in Lauf 001 vom 8. Mai 2026 als „in einem späteren Lauf nachzutragen" markiert. Tatsächlich war das Gesetz an der 8.-Mai-Sitzung nicht auf der Tagesordnung; das BMG hatte den Entwurf zum 19. Mai 2026 weder dem Bundestag zugeleitet noch in der Sitzungswoche eingebracht. | Mittel |
| 2 | Aktualitätshinweis am Dokumentende (Trilog-Erwartung „nächste Runde 13. Mai 2026") | In Version 12.0 ff. fortgeschrieben. Die dritte Trilogrunde wurde tatsächlich auf den 6./7. Mai 2026 vorgezogen und führte am 7. Mai 2026 zur vorläufigen Einigung. | Mittel |

### Durchgeführte Bereinigungen

| # | Fehler | Maßnahme | Erledigt |
|---|---|---|---|
| 1 | Bundesrats-Erstdurchgang GKV-BSSG | § 1.1 / GKV-Passage präzisiert: 8.-Mai-Sitzung lief mit anderen Schwerpunkten; Stand 19. Mai 2026 ist der Entwurf noch nicht im Bundestag eingebracht; Ziel „Verabschiedung vor der Sommerpause 2026" bleibt bestehen. Aktualitätshinweis und README-Versionseintrag entsprechend formuliert. | Ja |
| 2 | Trilog-Erwartung 13. Mai 2026 | § 4.5 neuer Absatz „EU — Digital Omnibus on AI, vorläufige Einigung am 7. Mai 2026:" eingefügt; Aktualitätshinweis am Dokumentende vollständig überarbeitet (Maschinenverordnung A → B, Stichtage 2027/2028, Watermark 2. Dezember 2026, Art. 5 CSAM, förmliche Annahme vor 2. August 2026). | Ja |
