...
## Validierung 12. Mai 2026 (Lauf 001 vom 12. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf am 12. Mai 2026 nach der zwischenzeitlich pausierten Recherche (letzter Lauf 001 am 8. Mai 2026). Web-Recherche im Korridor der Cluster A–J im 7-Tage- bzw. 48-Stunden-Fenster (Cluster F und I): Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle und Marktstruktur (Cluster I); Robotik (Cluster J). Fünf belegbare Treffer im Korridor identifiziert und eingearbeitet: AI-Omnibus-Trilog-Einigung 7. Mai 2026 (Cluster B), IAB-Kurzbericht 8/2026 vom 5. Mai 2026 (Cluster E/H), BILL/Upwork-Layoffs sowie TrueUp-Tagesstand 12. Mai (Cluster F), Anthropic-SpaceX-Compute-Partnerschaft / xAI-Auflösung (Cluster I), formelle NBER-Working-Paper-Konkretisierung 34873 zu Korinek/Lockwood (Cluster A). Zusätzlich Korrektur eines Befunds aus Lauf 001 vom 8. Mai 2026: Das *GKV-Beitragssatzstabilisierungsgesetz* war entgegen vorläufiger Annahme NICHT auf der Tagesordnung der 1065. Bundesratssitzung am 8. Mai 2026 — diese Aussage wurde im Aktualitätshinweis bereinigt.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU — Vorläufige politische Trilog-Einigung in der Nacht zum 7. Mai 2026 (4:39 Uhr) unter zypriotischer Ratspräsidentschaft zum *Digital Omnibus on AI* — also vor dem ursprünglich für den 13. Mai 2026 angesetzten dritten Trilogtermin. Inhalte: bestätigte Stichtage 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); KI-Komponenten in Produkten, die unter die Maschinenverordnung fallen, nicht mehr automatisch im Hochrisikobereich; neues Art.-5-Verbot der Erzeugung von CSAM und NCII; Watermarking nach Art. 50 Abs. 2 bleibt ab 2. August 2026 mit Übergangsfrist bis 2. Dezember 2026 für vor diesem Datum am Markt befindliche Systeme; formelle Annahme durch Rat und Parlament „in den kommenden Wochen" (voraussichtlich Juni 2026); Veröffentlichung im Amtsblatt voraussichtlich Ende Juli 2026. Quellen: Pressemitteilung des Rates der EU (7. Mai 2026), Bird & Bird, Hogan Lovells, IAPP, Table.Media, BVDW, TechPolicy.Press, Modulos. | § 4.2 (Rewrite des Trilog-Status-Absatzes mit „Stand März 2026 … aktualisiert im Mai 2026 …" gemäß Claude.md § 4.2 — alte Aussage bleibt als zeitlich frühere Referenz erhalten); § 11.3 neuer/aktualisierter Eintrag „Europäisches Parlament / Rat der EU" mit acht URLs; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Korrigiert die in Lauf 001 vom 8. Mai 2026 noch dokumentierte Annahme „nächste Trilog-Runde 13. Mai 2026" (de facto war die Einigung bereits am Tag vor diesem Lauf erzielt — eine Lücke in der Recherchedichte, die der heutige Lauf schließt); zugleich substanzielle Aktualisierung der EU-rechtlichen Rahmenbedingungen, an die § 4.2 die mittelfristige steuerpolitische Anknüpfungsfähigkeit von KI-Definitionen knüpft. |
| 2 | IAB — *IAB-Kurzbericht 8/2026 „Jeder vierte Betrieb in Deutschland nutzt generative KI"*, veröffentlicht am 5. Mai 2026. Datenbasis IAB-Betriebspanel mit rund 15.000 Betrieben: Verbreitungsgrad generativer KI in deutschen Betrieben von 5 % (2023) auf 25 % (2025); weitere 9 % mit Einführungsplänen; nach Betriebsgröße 48 % bei Betrieben mit 200 und mehr Beschäftigten gegenüber 21 % bei Kleinbetrieben unter zehn Beschäftigten; sektoral 59 % Information und Kommunikation, 50 % Finanz- und Versicherungsdienstleister, 37 % unternehmensbezogene Dienstleister, 34 % Bildung; 90 % der nutzenden Betriebe verwenden frei zugängliche Anwendungen, 16 % erworbene und mit eigenen Daten trainierte Modelle, 6 % Eigenentwicklungen; mehr als ein Viertel der nutzenden Betriebe bietet Schulungen an; junge Betriebe (< 5 Jahre) bei 30 %, lang bestehende Betriebe (≥ 25 Jahre) bei 21 % Adoption. Quellen: IAB-Pressemitteilung (5. Mai 2026), IAB-Kurzbericht-PDF kb2026-08.pdf. | § 1.1 (Adoption-Block in den bestehenden IAB-Prognose-Kontext eingegliedert — nach dem Tracker-Block / Cloudflare-Block / Anthropic-SpaceX-Block, vor dem Sozialversicherungs-Absatz); § 11.3 neuer Eintrag IAB-Kurzbericht 8/2026 mit beiden URLs; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erstmals belastbare deutsche Verbreitungsdaten zur generativen KI auf Betriebsebene (Vervielfachung gegenüber 2023; klare Betriebsgrößen- und Branchen-Gradienten); empirische Brücke zwischen der in § 1.1 dokumentierten Tech-Layoff-Welle in den USA und der bislang weitgehend prognosegestützten deutschen Lage (IAB-Frühjahrsprognose, Anthropic Economic Index). Stärkt § 7 (Gesundheitswesen — Bildungssektor 34 %) und § 8 (Deutschland-These — Information/Kommunikation 59 % unterfüttert die Veredelungsstrategie-These). |
| 3 | Tech-Layoffs — Am 7./8. Mai 2026 angekündigte Stellenstreichungen bei *BILL Holdings* (rund 700 Stellen — bis zu 30 % der Belegschaft, parallel zu einem Aktienrückkaufprogramm über bis zu 1 Mrd. USD) und *Upwork* (rund 145 Stellen — rund 24 %, mit CEO-Memo der „Function-by-Function"-Neukonzeption und Aktienkursrückgang um rund 19 % im Anschluss an die Q1-2026-Quartalszahlen). Daneben TrueUp-Tagesfortschreibung auf den 11./12. Mai 2026 (128.270 Personen aus 286 Layoff-Meldungen — rund 1.002 Personen pro Tag) und *American-Bazaar*-Aggregat für die ersten zehn Maitage 2026 (rund 38.000 US-Stellenstreichungen). Quellen: Yahoo Finance / GuruFocus / LayoffHedge / American Bazaar / TrueUp. | § 1.1 (Ergänzung des Layoff-Blocks: BILL und Upwork als weitere Cluster-F-Beispiele nach Coinbase/PayPal/Freshworks/Cognizant/Cloudflare; TrueUp-Tagesstand 12. Mai als Fortschreibung der Reihe 25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 12. Mai 2026); § 11.5 neue Sammelbelege „Yahoo Finance / GuruFocus / LayoffHedge" und „TrueUp / American Bazaar"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | BILL ist der erste Fall einer KI-induzierten Layoff-Welle, die ausdrücklich parallel zu einem signifikanten Aktienrückkaufprogramm angekündigt wird — ein zusätzlicher Beleg für die in § 1.1 referierte Asymmetrie zwischen Personalreduktion und Kapital-Allokation; Upwork-Memo verschärft den in § 3.5 begonnenen *Anthropic-Economic-Index*-Befund zur „Hire-Verlangsamung" um eine konkrete unternehmensseitige Reorganisationsbegründung („from scratch"). |
| 4 | Anthropic-SpaceX — Compute-Partnerschaft vom 6. Mai 2026: Vollständiger Zugriff von Anthropic auf das SpaceX-Rechenzentrum *Colossus 1* in Memphis mit über 222.000 Nvidia-GPUs (H100, H200, GB200) und mehr als 300 Megawatt Rechenleistung; geäußertes Interesse an mehreren Gigawatt orbitalem Compute. Parallel: Elon Musk löst *xAI* als eigenständiges Unternehmen auf und überführt es in SpaceX als *SpaceXAI* (Colossus 2 verbleibt dort). Anthropic-Umsatz laut Fortune im Quartal rund 80-fach gestiegen. Quellen: Anthropic / xAI / CNBC / Axios / Tom's Hardware / Al Jazeera / Fortune (6.–8. Mai 2026). | § 1.1 (Anbieterseiten-Block: Compute-Konzentration ergänzt die in § 1.1 dokumentierte Asymmetrie zwischen Personalreduktion und Infrastrukturausbau um eine Marktstruktur-Dimension; expliziter Querverweis auf § 8.2 KI als globaler Rohstoff); § 11.5 neuer Sammelbeleg „Anthropic / xAI / CNBC / Axios / Tom's Hardware / Al Jazeera / Fortune"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erste deutlich sichtbare Konzentrationsbewegung an der Spitze der Frontier-Compute-Architektur: ein Hyperscaler-naher Modellanbieter (Anthropic) und ein vertikal integrierter Konglomerat-Eigentümer (SpaceX/Musk) verbinden ihre Compute-Kapazitäten direkt. Marktstruktur-Verschärfung mit Implikationen für die Rohstoff-Analogie in § 8.2 und die Frage der KI-Renten-Verteilung in § 8.3. |
| 5 | NBER — Working Paper 34873 *„Public Finance in the Age of AI: A Primer"* von Anton Korinek und Lee M. Lockwood (DOI 10.3386/w34873); inhaltlich identisch mit dem Brookings-Arbeitspapier vom 8. Januar 2026, jetzt jedoch zusätzlich als formelles NBER-Working-Paper und als NBER-Konferenz-Kapitel veröffentlicht (NBER-Konferenz-PDF c15323.pdf). | § 11.1 (Aktualisierung des bestehenden Korinek-Lockwood-Eintrags um NBER-Nummer 34873, DOI, NBER-Eintragsseite und NBER-Konferenz-PDF; die in § 3.1 / § 5.3 bestehenden Verweise auf das Papier bleiben inhaltlich unverändert); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Schließt eine bestehende Quellenlücke (NBER-Working-Paper-Nummer und Konferenz-Kapitel-PDF waren im Januar-Stand noch nicht öffentlich); inhaltlich keine Änderung des Befunds, aber formell höhere Zitierfähigkeit nach Claude.md § 4.2 (Primärquelle bevorzugt). |

**Korrektur einer früheren Aussage (Bereinigung):**
- Der Aktualitätshinweis in Version 22.0 sprach vom „Erstdurchgang des GKV-Beitragssatzstabilisierungsgesetzes in der 1065. Bundesratssitzung am 8. Mai 2026 mit 79 Tagesordnungspunkten". Eine erneute Auswertung der amtlichen Bundesrat-Tagesordnung und des „BundesratKOMPAKT"-Rückblicks (1065. Sitzung) zeigt: Das Gesetz war NICHT auf der Tagesordnung der 1065. Sitzung; die Sitzung umfasste über 80 (nicht 79) Tagesordnungspunkte, darunter Schwerpunkte zu Integrationskursen, Schuldnerberatungsdienste, Verbraucherkreditrecht, Nierenspende und Vergaberecht, sowie einen niedersächsischen Antrag zur Klassifikation des § 119 BetrVG als Offizialdelikt (TOP 22). Die parlamentarische Behandlung des GKV-Beitragssatzstabilisierungsgesetzes wird in einer Folgesitzung des Bundesrates anhängig — der Kabinettsbeschluss vom 29. April 2026 bleibt der Verfahrensstand. Die Aussage wurde im Aktualitätshinweis bereinigt; § 5.2-Block bleibt korrekt (Verfahrensstand unverändert).

**Nicht aufgenommen (bewusste Auslassungen):**
- Connecticut SB 5 — Lamont-Unterzeichnung zum Stichtag 12. Mai 2026 noch nicht öffentlich mit konkretem Datum dokumentiert (nur „Governor looks forward to signing"); bestehender § 4.5-Block bleibt korrekt; in einem späteren Lauf nachzutragen, sobald die formale Unterzeichnung mit Datum belegt ist.
- Sanders Robot Tax Bill — keine formelle Einbringung im 7-Tage-Fenster (bisheriger Stand: Ankündigung „bald" gegenüber Tax Notes; HELP-Anhörung Oktober 2025 unverändert).
- IFR World Robotics 2026 Report — noch nicht erschienen (laufende Survey-Erhebung; Veröffentlichung im Spätsommer/Herbst 2026 erwartet).
- Anthropic Economic Index — kein neuer Bericht zwischen 8. und 12. Mai 2026; bestehender § 3.5-Block bleibt aktuell.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide Treffer im 7-Tage-Fenster; Empfehlung für die nächsten Läufe weiter bestehend (gezielter Abruf von g-ba.de Sitzungsergebnissen, gematik-Pressemitteilungen, BfArM-Listings).
- Generationenkapital — keine neuen Tranchen- oder Renditeangaben zwischen 8. und 12. Mai 2026; bestehender § 8.6-Verweis bleibt aktuell.
- Yale Budget Lab — keine neue Tracker-Veröffentlichung über den Stand 6. Mai 2026 hinaus.
- Plattform-Digitalabgabe (Weimer) — keine Bewegung über Version 10.0/11.0 hinaus zwischen 8. und 12. Mai 2026; Eckpunktepapier weiterhin angekündigt, aber nicht vorgelegt.
...
| 2.1.3 Querverweise | OK | Die neue Anbieterseiten-Passage in § 1.1 verweist explizit auf § 8.2 (Rohstoff-Analogie) und § 8.3 (Teilhabe/KI-Rentenverteilung); der überarbeitete § 4.2-Trilog-Absatz verweist weiterhin korrekt auf den AI-Act-Stichtag 2. August 2026. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind eine Aktualisierung des bestehenden Tagesfaktors-Blocks in § 1.1, eine inhaltlich substanzielle Aktualisierung der EU-Trilog-Lage in § 4.2 und eine Formal-Aktualisierung des Korinek-Lockwood-Literatur­eintrags. Der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; keine neuen Tabellen oder Lead-Ins; bestehende Lead-Ins unverändert; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert; Aktualitätshinweis-Absatz konsistent verlängert. |
| 2.2.1 Sachliche Richtigkeit | OK | AI-Omnibus-Einigungszeitpunkt (7. Mai 2026, 4:39 Uhr), Stichtage 2. Dezember 2027 / 2. August 2028, neue Art.-5-Verbote (CSAM/NCII) und Watermarking-Übergangsfristen konsistent in Pressemitteilung des Rates der EU, Bird & Bird, Hogan Lovells, IAPP und Table.Media. IAB-Kurzbericht-Zahlen (5 % → 25 %, 48 % / 21 %, 59 % IKT, IAB-Betriebspanel mit rund 15.000 Betrieben) wörtlich aus IAB-Pressemitteilung. BILL/Upwork-Kennzahlen (700/30 %/1 Mrd. USD Buyback; 145/24 %/−19,3 %) aus Yahoo Finance, LayoffHedge und GuruFocus konsistent. TrueUp-Tagesstand 128.270/286/1.002 wörtlich aus dem TrueUp-Dashboard. Anthropic-SpaceX (222.000 GPUs, 300 MW, Colossus 1 Memphis) wörtlich aus CNBC und Tom's Hardware. NBER-Working-Paper-Nummer 34873 und DOI 10.3386/w34873 von der NBER-Eintragsseite verifiziert. |
| 2.2.2 Redundanzprüfung | OK | TrueUp-Reihe als Tagesfortschreibung der bisherigen Stände (Reihe wird um den 12. Mai 2026 verlängert) gemäß Claude.md § 4.2 geführt — keine Doppelung. BILL/Upwork sind neue, in keinem Vorlauf erwähnte Layoff-Wellen. Korinek-Lockwood-Eintrag wird formell aktualisiert, nicht doppelt geführt. AI-Omnibus-Eintrag löst die alte „nächste Runde 13. Mai 2026"-Aussage durch eine substanziell aktualisierte Fassung mit zeitlich früherer Referenz auf den Stand März 2026 ab. IAB-Kurzbericht 8/2026 ergänzt die bestehende IAB-Linie (Kurzberichte 19/2025, 6/2026) um eine neue inhaltliche Dimension (Adoption auf Betriebsebene), ohne diese zu doppeln. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Anthropic-SpaceX-Aussagen als Konzern-/Berichterstatter­zitate referiert (kein Autorenkommentar); AI-Omnibus-Inhalte im Konjunktiv referiert, soweit die formale Annahme noch aussteht (Claude.md § 4.2). |
| 2.2.4 Ausgewogenheit | OK | Die Anthropic-SpaceX-Konzentrationsdeutung wird als „Marktstruktur-Verschärfung mit Implikationen für die Rohstoff-Analogie" sachlich referiert und nicht polemisch eingeordnet; die bestehende *Washington-Post*-Differenzierung vom 1. Mai 2026 bleibt im Layoff-Block explizit erhalten; das neue *Bloomberg-Editorial* gegen eine KI-Steuer (Version 20.0) bleibt als Gegenposition zur Sanders/OpenAI-Linie erhalten. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund; ergänzter Absatz „Eine Tagesfortschreibung der TrueUp-Methodik auf den 11./12. Mai 2026 …" syntaktisch konsistent in den bestehenden § 1.1-Fließtext eingebettet. |
| 2.3.2 Terminologie | OK | „Digital Omnibus on AI", „Anhang I / Anhang III", „CSAM", „NCII", „Watermarking", „SpaceXAI", „Colossus 1", „Compute-Partnerschaft", „NBER Working Paper" einheitlich verwendet; APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | AI-Omnibus: Eintrag in § 11.3 aktualisiert. IAB-Kurzbericht 8/2026: neuer Eintrag in § 11.3 (Institutionelle/politische Dokumente). BILL/Upwork/TrueUp 12. Mai: zwei neue Sammelbelege in § 11.5. Anthropic-SpaceX: neuer Sammelbeleg in § 11.5. Korinek-Lockwood NBER WP 34873: bestehender Eintrag in § 11.1 erweitert. Keine Karteileichen. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-Stil eingehalten; URLs vollständig (kein Shortener); Datumsangaben einheitlich; Sammelbelege mit „/"-Trenner zwischen Quellen; NBER-DOI 10.3386/w34873 entsprechend dem NBER-Stilstandard angegeben. |
| 2.4.3 Aktualität und Belastbarkeit | OK | AI-Omnibus: Primärquelle ist die Council-Pressemitteilung vom 7. Mai 2026. IAB-Kurzbericht 8/2026: Primärquelle ist die IAB-Pressemitteilung vom 5. Mai 2026 mit Verweis auf doku.iab.de/kurzber/2026/kb2026-08.pdf. BILL/Upwork: Primärquellen sind Konzernmitteilungen / Q1-Earnings-Calls, von Yahoo Finance / GuruFocus / LayoffHedge referiert. TrueUp: öffentlich zugängliches Tracker-Dashboard. Anthropic-SpaceX: Primärquellen sind die Anthropic-/xAI-/SpaceX-Pressemitteilungen, von CNBC, Axios, Tom's Hardware, Al Jazeera, Fortune referiert. NBER WP 34873: NBER-Eintragsseite mit DOI. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: consilium.europa.eu/en/press/press-releases/2026/05/07 (Council, öffentlich); table.media/europe/news/ki-omnibus-einigung-im-trilog (öffentlich, Inhalt konsistent); iab.de/presseinfo/jeder-vierte-betrieb-in-deutschland-nutzt-generative-ki/ (öffentlich); doku.iab.de/kurzber/2026/kb2026-08.pdf (PDF erreichbar); nber.org/papers/w34873 (öffentlich); cnbc.com/2026/05/06/anthropic-spacex-data-center-capacity.html (öffentlich); americanbazaaronline.com/2026/05/10/us-layoffs-in-first-10-days-of-may-2026-nearly-38000-jobs-cut (öffentlich); trueup.io/layoffs (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen AI-Omnibus (Stichtage 2. Dezember 2027 / 2. August 2028; Einigungszeitpunkt 7. Mai 2026, 4:39 Uhr; Art. 50 Abs. 2 Übergangsfrist bis 2. Dezember 2026) wörtlich aus der Council-Pressemitteilung und Bird-&-Bird-Briefing; IAB-Zahlen (5 % → 25 %, 9 %, 48 %, 21 %, 59 %, 50 %, 37 %, 34 %, 90 %, 16 %, 6 %, 30 %, 21 %, 15.000 Betriebe) wörtlich aus der IAB-Pressemitteilung; BILL/Upwork (700/30 %/1 Mrd. USD; 145/24 %/−19,3 %) wörtlich aus LayoffHedge und Yahoo Finance; TrueUp (128.270/286/1.002) wörtlich aus TrueUp-Dashboard; Anthropic-SpaceX (222.000, 300 MW, Colossus 1, Memphis) wörtlich aus Tom's Hardware und CNBC; NBER WP 34873 DOI 10.3386/w34873 wörtlich von der NBER-Eintragsseite. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Belegcluster benötigen keine eigene Verifizierungsmarkierung (Primärquellen verfügbar). Der NBER-Eintrag zu Korinek/Lockwood ist mit Version 23.0 vollständig formalisiert (NBER WP 34873, DOI 10.3386/w34873). |
...
|---|---|---|---|
| 1 | Aktualitätshinweis am Dokumentende (Version 22.0) | Aussage „Erstdurchgang des GKV-Beitragssatzstabilisierungsgesetzes in der 1065. Bundesratssitzung am 8. Mai 2026 mit 79 Tagesordnungspunkten" — das Gesetz war nicht aufgesetzt; Tagesordnung umfasste über 80 Punkte. | Mittel (sachlicher Fehler mit politischer Aussagekraft). |

### Durchgeführte Bereinigungen

| # | Fehler | Maßnahme | Erledigt |
|---|---|---|---|
| 1 | Aktualitätshinweis-Fehler GKV / Bundesrat 1065. Sitzung | Aussage in Version 23.0 bereinigt: „in der 1065. Bundesratssitzung am 8. Mai 2026 mit ihren über 80 Tagesordnungspunkten war das Gesetz nicht aufgesetzt"; Kabinettsbeschluss vom 29. April 2026 und Ankündigung der parlamentarischen Behandlung vor der Sommerpause 2026 bleiben Verfahrensstand. | Ja |

### Nachprüfung

- Betroffene Prüfschritte (2.2.1 sachliche Richtigkeit, 2.4.3 Aktualität, 2.4.5 Zitatgenauigkeit) erneut durchlaufen: OK.
