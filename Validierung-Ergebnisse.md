...
## Validierung 24. Mai 2026 (Lauf 001 vom 24. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster Daily-Update-Lauf nach 16-tägiger Pause (letzter regulärer Lauf 001 vom 8. Mai 2026). Web-Recherche im Korridor der Cluster A–J am 24. Mai 2026 mit erweitertem Catch-up-Fenster (Mai 9 – Mai 24) für versäumte Hochrelevanz-Items: Optimalsteuer-/Aufgabenforschung (A); Robotersteuer/Wertschöpfungsabgabe DE/EU (B); internationale Praxis VR China-Schwerpunkt (C); Politik-Initiativen (D); Arbeitsmarkt- und Sozialversicherungsdaten (E); Tech-Layoffs / KI-Capex (F); Gesundheitswesen (G); Deutschland-These-Bezugspunkte (H); Frontier-Modelle (I); Robotik (J). Drei Hauptkomplexe identifiziert und eingearbeitet (EU Digital Omnibus on AI Einigung vom 7. Mai 2026; Tech-Layoff-Welle 13.–20. Mai 2026 mit Cisco, LinkedIn, Meta-Vollzug, Intuit; chinesische Gerichtsurteile vom 28. April / Anfang Mai 2026); zwei davon (EU-Einigung, China-Urteile) sind Nachträge zum Lauf 001 vom 8. Mai 2026 (siehe Auffälligkeiten).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU Digital Omnibus on AI — Rat und Parlament haben in der Nacht zum 7. Mai 2026 (vor dem ursprünglich angesetzten Folgetermin am 13. Mai 2026) eine vorläufige politische Einigung erzielt: Umstufung der Machinery Regulation von Sektion A nach Sektion B des Anhang I (Konformitätsbewertung in die sektorale Spur); neuer Artikel 2 (13) zur kommissionalen Rücknahme einzelner AI-Act-Anforderungen, wo Sektion-A-Vorschriften gleich- oder höherwertigen Schutz bieten; neues Artikel-5-Verbot für KI-Systeme zur Erzeugung von Darstellungen sexuellen Missbrauchs von Kindern und nicht-einvernehmlicher intimer Bildaufnahmen; Übergangsregelung zu Artikel 50 (2) mit Stichtag 2. August 2026 für Neusysteme und Übergangsfrist bis 2. Dezember 2026 für Bestandssysteme; förmliche Annahme bis 2. August 2026 vorgesehen. Quellen: Consilium-Pressemitteilung (7. Mai 2026), Bird & Bird, White & Case, Lexology, Modulos, Orrick, Inside Privacy, TechPolicy.Press. | § 4.4 (Aktualisierung des Trilog-Blocks: Stand 28. April 2026 als zeitlich frühere Referenz erhalten; aktualisiert nach 7. Mai 2026 mit Kompromiss-Details — Machinery-Regulation-Umstufung, Artikel 2 (13), neues Artikel-5-Verbot, Übergangsregelung Artikel 50 (2); zypriotische Ratspräsidentschafts-Marke eingelöst); § 11.3 bestehender Eintrag „Europäisches Parlament / Rat der EU" aktualisiert und neuer Sammelbeleg „Council of the EU / European Parliament / Bird & Bird / White & Case / …" mit acht URLs; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Mit der Einigung ist die in Version 16.0 – 22.0 wiederholt referierte Trilog-Sequenz abgeschlossen — der zentrale Streitpunkt (Konformitätsbewertungs-Architektur für Anhang I) wurde durch die Machinery-Regulation-Umstufung gelöst. Für die Steuerdebatte ist das mittelbar relevant, weil die in § 4.4 thesenartig formulierte „mittelfristige Anknüpfung steuerlicher Tatbestände an AI-Act-Kategorien" einen Schritt verlässlicher wird: Die Definitions- und Klassifikationsbasis ist jetzt mit konkreten Stichtagen unterlegt. Die formale Annahme bis 2. August 2026 schließt die Lücke vor Anwendbarkeit der Hauptbestimmungen. |
| 2 | Tech-Layoff-Welle zweite Mai-Hälfte 2026 — vier konkrete Konzern-Ankündigungen, Tracker-Aktualisierung und differenzierende Sekundärlesart: (a) Cisco — Ankündigung am 13. Mai 2026 parallel zu Rekord-Q3-Quartalszahlen, rund 4.000 Stellenstreichungen (etwa 5 % der globalen Belegschaft), Pre-Tax-Charges bis zu 1 Mrd. USD (rund 450 Mio. USD im laufenden Quartal, Rest im Geschäftsjahr 2027), Erlöse explizit für Investitionen in Silizium, Optik, Sicherheit und KI; (b) LinkedIn — Ankündigung am 13. Mai 2026, rund 875 Stellen (etwa 5 % der 17.500-köpfigen Belegschaft), Schwerpunkt Global Business Organisation, Marketing, Engineering, Produkt, bei 12 % Umsatzwachstum im Vorquartal; CEO Daniel Shapero rahmt die Maßnahme als Reorganisation um Wachstumsbereiche, interne Kommunikation verweist auf KI-Ausrichtung; (c) Meta — Vollzug der angekündigten Streichung von rund 8.000 Stellen am 20. Mai 2026, parallele Versetzung von rund 7.000 Beschäftigten auf KI-Teams; Capex 2026: 115–135 Mrd. USD gegenüber 72,2 Mrd. USD in 2025; Zuckerberg-interne Begründung als Folge des KI-Investitionsbudgets („nicht algorithmischer Ersatz, sondern GPU-Anschaffung"); (d) Intuit — Ankündigung am 20. Mai 2026, rund 3.000 Stellen (17 % der weltweit 18.200 Beschäftigten), Schließung der Standorte Reno und Woodland Hills, Umlenkung des Kapitals in mehrjährige KI-Modell-Partnerschaften mit Anthropic und OpenAI; letzter Arbeitstag US-amerikanischer Beschäftigter 31. Juli 2026, Abfindung 16 Wochen Grundvergütung plus zwei Wochen je Beschäftigungsjahr; (e) TrueUp-Tagesstand 24. Mai 2026: 142.985 Personen aus 339 Layoff-Meldungen (rund 1.000 pro Tag); Projektion Gesamtjahr 2026 rund 370.000 gegenüber 245.953 in 2025; (f) Washington Post 21. Mai 2026 („Layoffs might feel like they're soaring, but they're not"): Hochsichtbare Konzern-Ankündigungen dominieren die Wahrnehmung, aggregierte Layoff-Rate im historischen Vergleich auf niedrigem Niveau. Quellen: TechCrunch / Cisco SEC-8-K / Fox Business; Bloomberg / TechRepublic / Republic World; NPR / OPB / Pymnts; TechCrunch / Slashdot / Reuters; TrueUp / SkillSyncer; Washington Post. | § 1.1 (Erweiterung des Layoff-Blocks nach dem Cloudflare-Block durch einen neuen Satzkomplex zur zweiten Mai-Hälfte: Cisco, LinkedIn, Meta-Vollzug, Intuit, Tracker-Aktualisierung, Washington-Post-Relativierung); § 11.5 sechs neue Sammelbelege (Cisco; LinkedIn; Meta; Intuit; TrueUp 24. Mai 2026; Washington Post 21. Mai 2026); Aktualitätshinweis am Dokumentende aktualisiert und ältere Tracker-Stichdaten ersetzt durch den 24.-Mai-Stand; README.md mit neuem Versionseintrag 23.0. | Die Welle setzt die in Version 22.0 dokumentierte Cloudflare-/Coinbase-/PayPal-/Freshworks-/Cognizant-Reihe systematisch fort. Wesentlich neu für die Steuerdebatte ist Meta: Mark Zuckerbergs interne Botschaft („Capex statt Personal") formuliert den Mechanismus „AI-finanzierungsinduzierter Stellenabbau" zum ersten Mal explizit aus Konzernsicht — ein qualitatives Argument für die in § 8.3 (Teilhabefonds) und § 5.1 (Wertschöpfungsabgabe) entwickelte Anknüpfung an Maschinenkapital. Die Washington-Post-Relativierung vom 21. Mai 2026 dokumentiert die methodische Vorsicht gegenüber der KI-Layoff-Erzählung und schließt damit an die Differenzierungslinie der Mai-1-Analyse an. |
| 3 | VR China — Urteile des Intermediate People's Court Hangzhou (Veröffentlichung 28. April 2026) und Beijing (Begleit-Set) zur Rechtswidrigkeit KI-induzierter Entlassungen: Im Hangzhou-Verfahren um einen Quality-Assurance-Supervisor (Jahresvergütung rund 300.000 Yuan / etwa 43.900 USD) stellt das Gericht fest, dass die Einführung eines KI-Systems eine strategische Geschäftsentscheidung sei und kein „erheblicher Wandel der objektiven Umstände" im Sinne des chinesischen Arbeitsvertragsgesetzes — und damit kein Kündigungsgrund. Das Gericht veröffentlichte das Urteil zusammen mit einem Set von „typischen Beispielen zum Schutz der Rechte von KI-Unternehmen und Beschäftigten" im Vorlauf zum chinesischen Tag der Arbeit 2026; in dem Set wird auch ein Beijing-Fall geführt. Quellen: Caixin Global, NPR (1. Mai), Bloomberg (2. Mai), Fortune (3. Mai), Tom's Hardware, China.org.cn. | § 6.4 neuer Block „VR China — judizielle Begrenzung KI-induzierter Entlassungen (April/Mai 2026)" als viertes Modell auf dem in § 6.1 – § 6.3 aufgespannten Spektrum (Südkorea: Rücknahme von Subventionen; Italien: breit angelegte Wertschöpfungsabgabe; Polen: Subvention mit Sunset; jetzt China: judizielle Begrenzung auf Einzelarbeitsvertragsebene); § 11.5 neuer Sammelbeleg „Caixin Global / NPR / Fortune / Bloomberg / Tom's Hardware / China.org.cn" mit fünf URLs; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Die chinesische Linie eröffnet ein systematisch neues Politikfeld: Während die in § 4.5 dargestellten US-bundesstaatlichen Initiativen die Kausalitätsmessung auf der Aggregat-Ebene adressieren (Connecticut WARN-AI-Disclosure) und die in § 5.1 / § 8.3 dargestellten Wertschöpfungsabgabe-/Staatsfonds-Vorschläge auf der fiskalischen Ebene, verlagert China die Frage auf die Einzelarbeitsvertrags­ebene. Funktional übernimmt das judizielle Verbot eine Rolle, die eine zielgerichtete Ersatzabgabe (Typ 5 nach § 2.1) auf fiskalischem Weg erfüllen würde — aber ohne Steueraufkommen für Re-Skilling-Programme und mit den spezifischen Beweis- und Anfechtungsregeln des chinesischen Arbeitsvertragsgesetzes. Für die in § 9.1 diskutierten Messprobleme einer Displacement-basierten Anknüpfung ist der chinesische Pfad relevant, weil er die Kausalitätsprüfung explizit *nicht* auf der Aggregat-Ebene und *nicht* auf der fiskalischen Ebene verortet. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Connecticut SB 5 — formale Lamont-Unterzeichnung zum Stichtag 24. Mai 2026 in offen zugänglichen Quellen weiterhin nicht mit präzisem Datum dokumentiert (Pressespokesperson „looks forward to signing", Kanzleianalysen sprechen weiter von „expected to be signed"); bestehender § 4.5-Block (Bezeichnung *SB 5*, Hausabstimmung 1. Mai 2026, gestaffelte Geltungsdaten ab 1. Oktober 2026) bleibt korrekt; im nächsten Lauf nachzutragen, sobald die formale Unterzeichnung mit Datum belegt ist.
- GKV-Beitragssatzstabilisierungsgesetz Bundesrats-Stellungnahme — die Tagesordnung der 1065. Sitzung am 8. Mai 2026 weist das Dossier *nicht* als Beratungsgegenstand aus (Recherche Bundesrat-Direktseite); die im Lauf 001 vom 8. Mai 2026 als „nächster Lauf" vorgemerkte Stellungnahme der Länderkammer hat in dieser Sitzung nicht stattgefunden. Die DKG-Stellungnahme vom 8. Mai 2026 ist eine Verbandsstellungnahme, kein Bundesratsbeschluss; bestehender Aktualitätshinweis bleibt korrekt; in einem späteren Lauf nachzutragen, sobald eine Bundesrats-Stellungnahme oder eine Bundestags-Erste-Lesung mit Datum belegt ist.
- YouGov-Umfrage UK (5. Mai 2026, 47 % Unterstützung für AI-Steuer, 20 % Ablehnung): außerhalb des Catch-up-Fensters (mehr als 14 Tage vor dem Lauf) und vom Quellenniveau eher als Meinungsumfrage denn als Primärbeleg einzustufen; für die in § 4.5 dargestellte Politik-Initiativen-Landschaft sekundär; in einem späteren Lauf zu erwägen, sollte eine Folgestudie oder Treasury-Reaktion erscheinen.
- HMRC-Quantexa-Vertrag (UK, 14. Mai 2026, 175 Mio. £): bezogen auf KI-Einsatz in der Steuerverwaltung, nicht auf KI-Besteuerung; außerhalb des Geltungsbereichs des Arbeitspapiers.
- Bungie-Layoff (21. Mai 2026, Destiny-2-Entwicklung): unter der in § 1.1 etablierten Schwelle für Einzel-Layoff-Eintrag (500+ Stellen mit ausdrücklicher AI-Begründung); Aggregat-Linie über TrueUp/Challenger abgedeckt.
- Anthropic Economic Index — keine neue Major-Release-Veröffentlichung zwischen 9. und 24. Mai 2026; bestehender § 3.5-Block (Massenkoff/McCrory, „Learning curves", 81k-Survey-Folgeband) bleibt aktuell.
- Stanford HAI AI Index 2026 (13. April 2026): außerhalb 7-Tage- und Catch-up-Fenster.
- Frontier-Modelle / Inferenzpreise (Cluster I) — keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster der Recherche.
- Robotik (Cluster J) — keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster der Recherche; chinesisches MIIT-Standardisierungs-Komitee als Hintergrund im neu eingefügten § 6.4-Block referenziert.
- Plattform-Digitalabgabe (Weimer) — keine Bewegung über Version 10.0/11.0 hinaus im Catch-up-Fenster; Eckpunktepapier weiterhin angekündigt, aber nicht vorgelegt.

### Prüfergebnis

| Prüfschritt | Ergebnis | Auffälligkeiten |
|---|---|---|
| 2.1.1 Gliederung | OK | Inhaltsverzeichnis und Kapitelüberschriften unverändert (11 Kapitel plus Zusammenfassung); Executive Summary referenziert weiterhin die Deutschland-These. |
| 2.1.2 Nummerierung | OK | Kapitel- und Unterabschnitt-Nummerierung lückenlos; alle Zähler („fünf Typen", „drei Säulen", „sieben Empfehlungen") konsistent. |
| 2.1.3 Querverweise | OK | Neue Querverweise im § 6.4-China-Block auf § 2.1, § 2.3, § 4.5, § 5.1, § 6.1–§ 6.3, § 8.3 und § 9.1 geprüft; alle Ziel-Abschnitte existieren. § 4.4-Aktualisierung zum Digital Omnibus auf § 5.1/§ 8.3 und Aktualitätshinweis konsistent. § 1.1-Erweiterung enthält keine neuen Querverweise. |
| 2.1.4 Roter Faden | OK | Die zweite Mai-Hälfte 2026 (§ 1.1) bleibt im Rahmen der bestehenden Layoff-Welle-Erzählung; die EU-Einigung (§ 4.4) schließt einen offenen Erzählstrang ab; die China-Linie (§ 6.4) eröffnet ein viertes Modell auf dem internationalen Spektrum. Die Progression Literaturrezeption → sektorale Anwendung → Deutschland-These → Umsetzung bleibt unberührt. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien, fett gesetzte Lead-Ins einheitlich (z. B. „**VR China — judizielle Begrenzung KI-induzierter Entlassungen (April/Mai 2026):**"); Tabellen unverändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Alle Zahlen mit Quelle belegt; Cisco Pre-Tax-Charges (rund 1 Mrd. USD, davon rund 450 Mio. im laufenden Quartal) gegen Fox Business und SEC-8-K geprüft; Meta Capex (115–135 Mrd. USD) gegen NPR; Intuit-Konditionen (3.000 Stellen, 17 %, letzter Arbeitstag 31. Juli 2026, Abfindung 16 Wochen + 2 Wochen je Beschäftigungsjahr) gegen TechCrunch und Reuters; chinesisches Hangzhou-Verfahren (Jahresvergütung 300.000 Yuan, Gehaltsreduktion 25.000 → 15.000 Yuan) gegen Caixin Global und Fortune. |
| 2.2.2 Redundanzprüfung | OK | China-Block in § 6.4 ohne Doppelung zu § 4.5 (Connecticut) oder § 5.1 (Wertschöpfungsabgabe); Querverweise statt Wiederholung. Layoff-Block in § 1.1 schließt nahtlos an den Cloudflare-Block an. EU-Einigung in § 4.4 ersetzt die zuvor in § 4.4 stehende „nächste Runde 13. Mai 2026"-Formulierung; Aktualitätshinweis am Dokumentende parallel angepasst. |
| 2.2.3 Argumentation | OK | China-Block argumentativ als „viertes Modell" eingeordnet (judizielle Begrenzung statt fiskalischer Abschöpfung); EU-Einigung ohne argumentative Anpassung der Steuerdebatte (mittelbare Relevanz über AI-Act-Definitionsrahmen). Meta-Capex-statt-Personal-Logik in § 1.1 als qualitatives Argument für § 8.3 / § 5.1 verzahnt, ohne diese Abschnitte zu wiederholen. |
| 2.2.4 Ausgewogenheit | OK | Washington-Post-Relativierung vom 21. Mai 2026 als methodische Gegenposition in § 1.1 explizit referiert. China-Block beschreibt das Urteil sachlich und konjunktivisch („Soweit chinesische Untergerichte dem Hangzhou-Muster folgen, …"); keine Übertragung auf deutsche/europäische Verhältnisse. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenprüfung der neuen Textstellen ohne Befund. |
| 2.3.2 Terminologie | OK | „Wertschöpfungsabgabe" einheitlich; „Künstliche Intelligenz (KI)" bei Erstnennung, danach „KI"; chinesische Begriffe (Arbeitsvertragsgesetz, MIIT-Standardisierungs-Komitee) in der etablierten Form. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Cisco, LinkedIn, Meta-Vollzug, Intuit, TrueUp-24.-Mai, Washington-Post-21.-Mai in § 11.5; EU-Digital-Omnibus-Einigung in § 11.3; chinesische Gerichtsurteile in § 11.5 — alle im Fließtext referenziert. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-naher Zitierstil eingehalten (Quelle, Datum, Titel kursiv, URL); Datumsangaben in einheitlichem Format (Tag. Monat YYYY). |
| 2.4.3 Aktualität und Belastbarkeit | OK | Primärquellen für EU-Einigung (Consilium-Pressemitteilung), Cisco (SEC-8-K), Meta (NPR-Bestätigung) ergänzt; Sekundärquellen (Bird & Bird, White & Case, Lexology, Modulos, Orrick, TechRepublic) als Sammelbelege geführt. Chinesische Urteile mit fünf voneinander unabhängigen Quellen (Caixin Global, NPR, Bloomberg, Fortune, Tom's Hardware, China.org.cn) belegt. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobenartig: TrueUp (https://www.trueup.io/layoffs), TechCrunch Cisco-Artikel und Intuit-Artikel, NPR Meta-Artikel, Caixin Global China-Artikel, Consilium EU-Einigung — alle Quellen-URLs syntaktisch korrekt; Direktabruf der Consilium-URL ergab 403 (üblich für direkte WebFetch-Abfragen ohne Browser-Header), Inhalt jedoch über die zehn weiteren Sekundärquellen (Bird & Bird, White & Case, Lexology, Modulos, Orrick, Inside Privacy, TechPolicy.Press, dastra, NicFab, Verifywise) vielfach belegt. |
| 2.4.5 Zitatgenauigkeit | OK | Hangzhou-Urteil sinngemäß referiert („strategische Geschäftsentscheidung, kein erheblicher Wandel der objektiven Umstände"), wie in mehreren Quellen (Caixin Global, NPR, Fortune) konvergent wiedergegeben. Meta-Zuckerberg-Aussage („Capex statt Personal") als sinngemäße Zusammenfassung der NPR-Berichterstattung geführt, nicht als wörtliches Zitat. EU-Einigung Daten und Stichtage gegen Consilium-Pressemitteilung und Bird & Bird abgeglichen. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | de la Feria et al. 2022 weiterhin als verifizierungsbedürftig markiert (Markierung nicht entfernt). Sanders-Report-Titel unverändert verifiziert (Version 5.0). |
| 2.5 Versionskonsistenz und Lizenz | OK | Version 23.0 an allen vier vorgesehenen Stellen eingetragen (Dokumentkopf, Aktualitätshinweis am Dokumentende, README.md, Validierungsblock). Autorenname, Organisation, CC-BY-4.0-Lizenz und Haftungshinweis unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Im Projekt keine dedizierten Prüfskripte vorhanden; manuelle Stichproben zu Nummerierung, Querverweisen und Quellenzuordnung ersetzen den automatisierten Teil. |

### Gefundene Fehler

| # | Stelle | Fehler | Schwere |
|---|---|---|---|
| — | — | Keine Fehler im Prüfdurchlauf gefunden. | — |

### Durchgeführte Bereinigungen

| # | Fehler | Maßnahme | Erledigt |
|---|---|---|---|
| — | — | Keine Bereinigung erforderlich. | n/a |

### Nachprüfung

- Betroffene Prüfschritte erneut durchlaufen: n/a (keine Fehler im Erstdurchlauf)
- Automatisierte Skripte (sofern vorhanden): n/a

### Abschluss

- Alle Fehler behoben: Ja (keine Fehler im Prüfdurchlauf)
- Neue Version: 23.0
- PDF erstellt: Ja
- Word erstellt: Ja
