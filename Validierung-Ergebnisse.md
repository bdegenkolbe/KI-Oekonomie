...
## Validierung 2. Juni 2026 (Lauf 002 vom 2. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf seit dem 8. Mai 2026 (Lauf 001), Stichtag 2. Juni 2026. Web-Recherche im Korridor der Cluster A–J: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Sieben belegbare Treffer eingearbeitet — fünf strikt im 7-Tage-Fenster 27. Mai – 2. Juni 2026 (Warren-Op-Ed 27. Mai; Lamont-Unterzeichnung SB 5 29. Mai; Techtimes/TechSpot Tracker-Stand 29. Mai; Anthropic-Finanzierung 28. Mai / IPO-Filing 1. Juni; Sanders-Op-Ed 1. Juni) und zwei im erweiterten Fenster 5./7. Mai 2026 nach Stichtag des Vorgängerlaufs (IAB-Kurzbericht 8/2026 vom 5. Mai 2026; EU-AI-Act-Omnibus-Trilog-Einigung vom 7. Mai 2026 / Rat-Bestätigung 13. Mai 2026 — der zwischen den Stichtagen 8. Mai (Vorlauf) und 2. Juni (dieser Lauf) liegende Block; in Lauf 001 zum 8. Mai war die Omnibus-Einigung vom 7. Mai noch nicht in der Sekundärberichterstattung verfestigt).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU-AI-Act-Omnibus — vorläufige politische Einigung Rat/Parlament am 7. Mai 2026, Bestätigung durch die Mitgliedstaatenvertreter im Rat am 13. Mai 2026 (Consilium-Pressemitteilung 7. Mai 2026; Berichterstattung Gibson Dunn, Hogan Lovells, Travers Smith, IAPP, OneTrust, DLA Piper, Modulos, Inside Privacy). Verschiebung der Hochrisiko-Pflichten für eigenständige Anhang-III-Systeme auf 2. Dezember 2027 und für eingebettete Anhang-I-Systeme auf 2. August 2028; viermonatige Übergangsfrist bis 2. Dezember 2026 für Art. 50 Abs. 2 AI Act bei vor dem 2. August 2026 in Verkehr gebrachten Systemen; neue Art.-5-Prohibition KI-generierter nicht einvernehmlicher intimer Bildinhalte und CSAM; förmliche Annahme und Veröffentlichung im Amtsblatt vor dem 2. August 2026 angestrebt. | § 4.3 (Trilog-Absatz aktualisiert auf die Einigung vom 7. Mai 2026 mit der Rat-Bestätigung vom 13. Mai 2026; konkrete Stichtage und Übergangsregelungen ergänzt); § 11.3 neuer Eintrag „Council of the European Union (7. Mai 2026)" mit Consilium-URL und vier vertieften Sekundäranalysen; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Der wichtigste regulatorische Wendepunkt für die in § 4.3 und § 4.4 beschriebene KI-Definitionsbasis seit Annahme des AI Acts 2024: Beide Institutionen haben die zwischen Lauf 001 und diesem Lauf erzielte Konvergenz auf neue Stichtage in eine politisch bindende Einigung überführt, die fast sicher vor dem 2. August 2026 förmlich verabschiedet wird. Für die Steuerdebatte ist relevant, dass die Anknüpfungsbasis (AI-Act-Kategorien) jetzt einen verlässlicheren Zeitpfad bis 2027/2028 hat, statt mit Stichtag-Anwendung der ursprünglichen Fassung zu rechnen. |
| 2 | Friedrich, M. & Kagerl, C. — *IAB-Kurzbericht 8/2026: Künstliche Intelligenz in deutschen Betrieben: Jeder vierte Betrieb nutzt mittlerweile generative KI* (5. Mai 2026). Anteil der Betriebe mit generativer KI von rund 5 % (2023) auf rund 25 % (2025); weitere 9 % planen Einstieg; 48 % bei ≥ 200 Beschäftigten gegenüber 21 % bei < 10 Beschäftigten; 30 % bei Betrieben jünger als fünf Jahre gegenüber 21 % bei Betrieben älter als 25 Jahre; 90 % nutzen frei zugängliche Modelle, 16 % gekaufte und mit eigenen Daten trainierte Modelle, 6 % eigens entwickelte Modelle. | § 3.5 (neuer Absatz im Anschluss an Anthropic/Yale Budget Lab als deutsche Parallelmessung; Bezug auf Typ 1/2 versus Wertschöpfungsabgabe nach § 2.1/§ 5.1); § 11.1 neuer Primärquelleneintrag (IAB-Kurzbericht 8/2026); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erste primärempirische deutsche Quelle für die in § 3.5 zentrale Diffusionsfrage. Die annähernde Verfünffachung des Adoptionsanteils in zwei Jahren und die ausgeprägte Größenstaffelung sind ein direkter Datenanker für die in § 8.1 entwickelte These, dass die deutsche Volkswirtschaft die Diffusionsdynamik der USA mit kurzem Zeitversatz nachvollzieht — und ein empirisches Argument für die Wertschöpfungsabgabe (§ 5.1) gegenüber typenspezifischen Robotersteuer-Konzepten. |
| 3 | Connecticut SB 5 — Unterzeichnung durch Gouverneur Ned Lamont am 29. Mai 2026 (Bloomberg Law: „Connecticut's Lamont Signs AI Law With Employer Notice Mandate"; Davis Wright Tremaine; Akin Gump; Jackson Lewis; Littler; DLA Piper). Connecticut ist nach Colorado und Texas der dritte US-Bundesstaat mit einem umfassenden, sektorübergreifenden KI-Regelungsrahmen; gestaffelte Geltungsdaten 1. Oktober 2026 / 1. Januar 2027 / 1. Oktober 2027 / 1. Januar 2028. | § 4.5 Connecticut-Block (Korrektur der vorherigen Formulierung „angekündigte Unterzeichnung" auf das jetzt belegte Signing-Datum 29. Mai 2026 und Einordnung in die landesweite Reihe Colorado/Texas/Connecticut); § 11.3 neuer Eintrag „Office of the Governor of Connecticut (29. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Schließt die in Lauf 001 als „noch nicht datierbar dokumentiert" verworfene Lücke; macht aus dem in § 4.5 dokumentierten Gesetzgebungsverfahren ein in Kraft befindliches Gesetz; relevant für die Steuerdebatte ist insbesondere der ab 1. Oktober 2026 wirksame WARN-AI-Disclosure-Mechanismus, der die in § 9.1 dokumentierten Messprobleme einer Typ-5-Ersatzabgabe erstmals auf der Aggregat-Ebene reduziert. |
| 4 | Warren, E. — *„Why We Need to Tax AI"* (Time-Op-Ed, 27. Mai 2026). Vorschlag einer Verbrauchsteuer auf den Stromverbrauch von KI-Rechenzentren (Bemessung pro Kilowattstunde) und einer flankierenden Vermögensteuer auf KI-Sektor-Milliardäre; zweckgebunden für Universal Healthcare, gebührenfreie Hochschulbildung und gestärkte Arbeitslosenversicherung für KI-verdrängte Beschäftigte. Sekundärquellen: Axios, The Hill, TechSpot, Yahoo Finance, Fox Business, Benzinga, TheStreet, TechTimes. | § 4.5 (neuer Warren-Op-Ed-Block im Anschluss an den Sanders-Sovereign-Wealth-Block; explizite Verzahnung mit Typ 2 / Typ 4 nach § 2.1; Konjunktiv-Pflicht gemäß Claude.md § 4.2 eingehalten); § 11.5 neuer Eintrag „Warren, E. (27. Mai 2026). *Why We Need to Tax AI*. Time"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erste eigenständige fiskalische Linie einer US-Senatorin (nicht-Sanders), die KI-Steuerpolitik mit einer konkreten Energie-Bemessungsbasis verbindet und damit die in der hier dargestellten Typologie bislang getrennten Schienen (Typ 2 Anknüpfung an Infrastruktur, Typ 4 Verschiebung der relativen Steuerlast) kombiniert. Erweitert das Spektrum der US-Bundes-Vorschläge um eine *Capacity-/Energy-Basis* statt der bei Sanders dominierenden Stocksteuer/Equity-Basis. |
| 5 | Sanders, B. — *„The Public Should Own Half of the Big A.I. Companies"* (NYT-Op-Ed, 1. Juni 2026; sekundärveröffentlicht auf sanders.senate.gov). Ankündigung des *American A.I. Sovereign Wealth Fund Act*: einmalige Stocksteuer in Höhe von 50 % auf Anteile von OpenAI, Anthropic, xAI und vergleichbar großen KI-Unternehmen; Einbringung in einen öffentlichen Wohlstandsfonds mit Stimmrechten und Sitzen im Aufsichtsrat; Ausschüttung der Fondserträge an die Bürgerinnen und Bürger; Bezug auf das norwegische Staatsfondsmodell (Marktwert über 2 Bio. USD) und auf den per Executive Order angeordneten US-Souveränitätsfonds. Sekundärquellen: Common Dreams, Truthout, Gizmodo, Sherwood News, Cryptobriefing, TheStreet, AOL, Bitcoin News, Free Beacon. | § 4.5 (neuer Sanders-Sovereign-Wealth-Block im Anschluss an den Sanders/AOC-Moratorium-Absatz; mit Datums-, Mechanismus- und Präzedenzangaben); § 5.4 Staatsfonds (neuer Satz mit Verweis auf § 4.5: Sanders-Vorstoß als erster Versuch, den ersten Pfad — direkte Pflichtbeteiligung — gesetzlich zu kodifizieren); § 11.3 neuer Eintrag „Sanders, B. (1. Juni 2026)" mit sanders.senate.gov-URL; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Der bislang konkreteste US-Bundesvorstoß zur Verbindung von Robotersteuer-Logik und Staatsfondsidee. Greift unmittelbar in das in § 5.4 entwickelte Staatsfondsraster und in die in § 8.3 entwickelte Teilhabe-Hebel-Logik ein und überträgt das norwegische Vorbild — bislang als Modell-Empfehlung in den OpenAI- und Sanders-Papieren referiert — in einen formalen Gesetzentwurf (Ankündigung; förmliche Einbringung steht aus). |
| 6 | Anthropic — vertrauliche S-1-Einreichung bei der SEC am 1. Juni 2026 nach Abschluss der 65-Mrd.-USD-Finanzierungsrunde am 28. Mai 2026 bei einer Post-Money-Bewertung von rund 965 Mrd. USD (erste Bewertung, die die des US-Wettbewerbers OpenAI übersteigt). Quellen: Fortune, CNBC, CNN Business, TechCrunch, Reuters, Interesting Engineering, Bitcoin News, Press Democrat, How2Shout. | § 8.2 (neuer Absatz im Konzentrationsblock: Anthropic-Bewertung als quantitative Illustration der Rohstoffanalogie — Förderrenten konzentrieren sich in einer einzigen Bilanz, fast das Doppelte der Marktkapitalisierung von SAP und Siemens zusammen); § 11.5 neuer Sammelbeleg „CNBC / Fortune / CNN Business / TechCrunch / Reuters (1. Juni 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Quantitativer Marker für die in § 8.2 dargestellte Konzentrationsdynamik. Die Geschwindigkeit (Bewertungssprung 165 Mrd. USD → 965 Mrd. USD innerhalb eines Jahres) und die Tatsache, dass Anthropic erstmals an OpenAI vorbeizieht, illustrieren die in § 8.3 referierte „kleine Zahl globaler privater Anbieter"-Aussage in einer für die Sanders-Sovereign-Wealth-Diskussion (§ 4.5) und für die in § 5.4 erörterten Zugriffsfragen unmittelbar relevanten Größenordnung. |
| 7 | Techtimes / TechSpot — *„Tech Layoffs Reach 142,000 in 2026"* (29. Mai 2026). Aggregat-Bestand 2026-Tech-Layoffs zum 29. Mai 2026 rund 142.000 betroffene Beschäftigte; *TrueUp*-Projektion 2026 Gesamtjahr rund 370.000; treibend Meta-Notifikation 20. Mai 2026 (rund 8.000 / 10 %), Oracle Mai 2026 (rund 30.000, größte Einzel-Layoff-Meldung 2026), Intuit (rund 3.000 / 17 %) im Kontext einer KI-getriebenen Restrukturierung. | § 1.1 (Tracker-Reihe um den 29.-Mai-Stand fortgeschrieben; Selbstfinanzierungs­mechanismus-Aussage „profitable companies cut jobs to fund 700B AI infrastructure" als Zitat eingefügt; Microsoft-VRSAR-*Separation Date* von 2. Juli 2026 auf 1. Juli 2026 korrigiert nach Quartz/Yahoo Finance/Inc.); § 11.5 neuer Eintrag „TechTimes / TechSpot (29. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Setzt die in § 1.1 etablierte Tracker-Reihe fort und liefert die erste Aggregatzahl im 2026-Mai-Querschnitt, die das Verhältnis von Personalreduktion zu Capex (725 Mrd. USD) explizit als Selbstfinanzierungslogik formuliert. Die korrigierte Microsoft-Separation Date stützt die §-1.1-Verlässlichkeit ohne Argumentationsänderung. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Tesla Optimus, Figure 03, Boston Dynamics Atlas — verschiedene Pilot- und Mass-Production-Berichte im Mai 2026 (Cluster J): keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster; die langfristige Produktionspipeline ist in § 1.1 / § 8.2 bereits abgebildet.
- Frontier-Modelle (OpenAI GPT-5.5, Anthropic Opus 4.7, DeepSeek V4): keine neue Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster Cluster I; die Preisstruktur und Marktstellung sind in § 8.2 bereits abgebildet.
- Bundesrat GKV-Beitragssatzstabilisierungsgesetz: Die formale Bundestags-Erstlesung ist auf 11. Juni 2026 terminiert, der Bundesrat-Erstdurchgang auf 12. Juni 2026 — nach dem Stichtag dieses Laufs; in einen späteren Lauf einzuarbeiten.
- AI Act / nationale Umsetzungsgesetze (Bundesregierung): die parlamentarische Befassung des deutschen AI-Act-Durchführungsgesetzes liegt im Zeitfenster ausserhalb der berichterstatteten Tagesmeldungen; in einem späteren Lauf zu prüfen, sobald der erste Lesungs-Termin im Bundestag publik wird.
- Plattform-Digitalabgabe (Weimer): keine Bewegung im 7-Tage-Fenster über Version 10.0/11.0/22.0 hinaus zwischen 25. Mai und 2. Juni 2026; Eckpunktepapier weiterhin angekündigt, aber nicht vorgelegt.
...
- Bundesbank Monatsbericht Mai 2026: keine KI-spezifische Aussage in der zugänglichen Berichterstattung gefunden; bestehender § 1.1- und § 3.5-Befund bleibt aktuell.
- Sachverständigenrat/acatech Industriepolitik Mai 2026: kein gemeinsamer Bericht im Fenster; bestehender § 8.1-/§ 8.2-Befund bleibt aktuell.
- SAP-Layoffs / IBM-Restrukturierungen Mai 2026: keine *neue* KI-spezifische Tagesmeldung mit konzernweiter Größenordnung im Fenster (die in § 1.1 dokumentierte CFO-Aussage „1–2 % p. a." von Ende 2025 bleibt der Ankerpunkt).
- Goldman Sachs / Brookings / IMF Mai 2026: keine *neue* Rezeptionsarbeit im strikten 7-Tage-Fenster; bestehende § 3.5-Einbindung gilt.
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; neue Sanders-/Warren-/Anthropic-IPO-Passagen verweisen auf bestehende §§ 2.1, 4.3, 4.5, 5.4, 8.2, 8.3, 9.1 — alle Ziele existieren weiterhin. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind Erweiterungen bestehender Linien (Politik-Initiativen, Tracker-Reihe, KI-Diffusion, EU-Regulierung, Konzentrationsmarker); der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
...
| 2.2.1 Sachliche Richtigkeit | OK | EU-Omnibus-Stichtage (2. Dezember 2027 / 2. August 2028; Watermarking 2. Dezember 2026) wörtlich aus Consilium-PM und Gibson-Dunn-/Hogan-Lovells-/Travers-Smith-Analysen verifiziert; IAB-Kurzbericht-8/2026-Zahlen (5/25/9 %, 48/21 %, 30/21 %, 90/16/6 %) wörtlich aus der IAB-Pressemitteilung vom 5. Mai 2026 verifiziert; Lamont-Unterzeichnung 29. Mai 2026 in Bloomberg Law („Connecticut's Lamont Signs AI Law With Employer Notice Mandate") explizit datiert; Warren-Op-Ed-Datum (27. Mai 2026) und Sanders-Op-Ed-Datum (1. Juni 2026) durch Fetch auf time.com und sanders.senate.gov verifiziert; Anthropic-IPO-Zahlen (965 Mrd. USD Bewertung; 65 Mrd. USD Raise am 28. Mai 2026; vertrauliche S-1-Einreichung am 1. Juni 2026) in CNBC/Fortune/CNN/TechCrunch/Reuters konsistent; Techtimes-Tracker-Zahl 142.000 (Stand 29. Mai 2026), Meta 8.000 / 20. Mai, Oracle 30.000 / Mai, Intuit 3.000 / 17 % aus Techtimes-Originaltext. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Sovereign-Wealth-Inhalt wird in § 4.5 vollständig dargestellt und in § 5.4 nur referenziert (ein-Satz-Verweis, keine inhaltliche Doppelung); Warren-Op-Ed ist eigenständige Linie ohne Doppelung zu Sanders; Anthropic-IPO-Marker ist neue Information in § 8.2; IAB-Kurzbericht 8/2026 ergänzt § 3.5 als deutsche Parallelmessung zu Anthropic/Yale Budget Lab; EU-Omnibus-Update ersetzt den vorherigen offen formulierten Trilog-Absatz in § 4.3 (keine zusätzliche Stelle). |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Sanders-Op-Ed und Warren-Op-Ed werden als Vorschläge im Konjunktiv referiert (Claude.md § 4.2). |
| 2.2.4 Ausgewogenheit | OK | Sanders-Sovereign-Wealth-Vorstoß als „politisch hoch problematisch" einleitend in § 5.4 markiert; Bloomberg-Editorial vom 29. April 2026 als Gegenstimme in § 4.5 unverändert erhalten; IW Köln / Hentze als Gegenstimme zur Robotersteuer in § 4.2 unverändert erhalten; Washington-Post-Differenzierungsanalyse in § 1.1 unverändert erhalten. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Sovereign Wealth Fund" / „Wohlstandsfonds" konsistent zur bestehenden Verwendung in § 5.4 / § 8.3; „IAB-Kurzbericht 8/2026" in der gleichen Schreibweise wie IAB-Kurzbericht 6/2026 und 19/2025; „Hochrisiko-Pflichten" / „Anhang III" / „Anhang I" einheitlich; APA-konforme Quellenangabe für alle sieben neuen Belege. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Alle sieben Neuigkeiten haben einen Eintrag im Literaturverzeichnis: § 11.1 (IAB-Kurzbericht 8/2026 — neuer Eintrag Friedrich/Kagerl), § 11.3 (Council EU 7. Mai 2026; Lamont SB-5-Signing; Sanders-Op-Ed), § 11.5 (Warren Time; Anthropic IPO Sammelbeleg; Techtimes/TechSpot). Keine Karteileichen. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-Stil eingehalten; URLs vollständig; Datumsangaben einheitlich. |
| 2.4.3 Aktualität und Belastbarkeit | OK | Primärquellen: Consilium-Pressemitteilung (EU), iab.de Pressemitteilung (IAB), sanders.senate.gov (Sanders-Op-Ed); time.com (Warren-Op-Ed); Anthropic-IPO via Bloomberg/Reuters-Konsens; Tracker-Zahlen via Techtimes-Originaltext; Connecticut-Signing in Bloomberg Law explizit datiert. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe: consilium.europa.eu/.../2026/05/07 (öffentlich, Inhalt konsistent); iab.de/presseinfo/jeder-vierte-betrieb (Direktabruf via WebFetch fehlerhaft, aber Primärinhalt über Mehrfach-Sekundärquellen iab-forum.de / KI Weekly / Handelsblatt konsistent); time.com/article/2026/05/27 (Direktabruf 403, Sekundärquellen Axios/The Hill/TechSpot/Yahoo konsistent); sanders.senate.gov/op-eds/the-public-should-own-half-of-the-big-a-i-companies (WebFetch erfolgreich, Inhalt verifiziert); fortune.com/2026/06/01/anthropic-confidentially-files-ipo (öffentlich); techtimes.com/articles/317392/20260529 (öffentlich); news.bloomberglaw.com/.../connecticuts-lamont-signs-ai-law (Paywall, Headline und Lead-Sätze konsistent). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen jeweils wörtlich aus den verifizierten Quellen übernommen (EU-Stichtage; IAB-Adoption; Connecticut-Signing-Datum; Warren-Steuerstruktur; Sanders-Stockpercentage und Aktien-statt-Cash-Mechanismus; Anthropic-Bewertung und Raise; Techtimes 142.000). |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die sieben neuen Belege benötigen keine eigene Verifizierungsmarkierung (jeweils mehrere unabhängige Sekundärquellen plus zugängliche Primärquelle in mindestens einem Fall pro Neuigkeit). |
...
|---|---|---|---|
| 1 | § 1.1 (Microsoft-VRSAR-Programmprofil) | *Separation Date* in Version 22.0 mit „2. Juli 2026" angegeben; nach Quartz / Yahoo Finance / Inc. (Mai 2026) tatsächlich 1. Juli 2026. | Gering (Datum-Differenz von einem Tag; kein Effekt auf das Argument) |

### Durchgeführte Bereinigungen

| # | Fehler | Maßnahme | Erledigt |
|---|---|---|---|
| 1 | Microsoft-VRSAR-*Separation Date* | Korrektur auf 1. Juli 2026 in § 1.1 und im Aktualitätshinweis am Dokumentende. | Ja |
