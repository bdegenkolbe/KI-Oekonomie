...
## Validierung 26. Mai 2026 (Lauf 002 vom 26. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Zweiter regulärer Daily-Update-Lauf nach Lauf 001 vom 8. Mai 2026. Web-Recherche im Korridor der Cluster A–J am 26. Mai 2026: Optimalsteuer- und Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs und KI-Capex im 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Vier belegbare Treffer im 7-Tage- bzw. 48-Stunden-Fenster identifiziert und eingearbeitet (Trilog-Einigung *Digital Omnibus on AI* vom 7. Mai 2026; Cisco-Layoff vom 13. Mai 2026; TrueUp-/SkillSyncer-Tagesfortschreibung vom 25./26. Mai 2026; Präzisierung des GKV-Beitragssatzstabilisierungsgesetz-Verfahrenstands mit Verschiebung der ersten Bundestagslesung auf Mitte Juni 2026).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU AI Act *Digital Omnibus on AI* — provisorische politische Einigung am 7. Mai 2026 in den frühen Morgenstunden nach einer rund neunstündigen dritten Trilogrunde unter zypriotischer Ratspräsidentschaft. Bestätigung der Stichtage 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); Kennzeichnungspflicht nach Art. 50 Abs. 2 bleibt ab 2. August 2026 anwendbar, für bereits in Verkehr gebrachte generative Systeme Übergangsperiode bis 2. Dezember 2026; neues Art. 5-Verbot für KI-Systeme zur Erzeugung kinderpornografischer Inhalte und nicht einvernehmlicher intimer Bildaufnahmen in drei Konfigurationen (Inverkehrbringen mit Erzeugungszweck; Inverkehrbringen ohne angemessene Sicherheitsvorkehrungen; Einsatz durch Anwender), Anpassungsfrist bis 2. Dezember 2026; Abgrenzung zu sektoralen Produktsicherheitsregimen für Anhang I geordnet (Vermeidung von Doppelregulierung); formelle Annahme durch Rat und Parlament vor dem 2. August 2026 angestrebt. Quellen: Pressemitteilung des Rates der EU (7. Mai 2026), Bird & Bird (May Trilogue), Lexology (Omnibus Deal), White & Case (EU agrees Digital Omnibus deal), Hogan Lovells (EU legislators agree to delay), Modulos (Omnibus Deal Closed on 7 May 2026). | § 4.4 (Europarechtliche Vorgaben — der bisherige Verhandlungsstand „13. Mai 2026 / nächste Runde" wird durch die tatsächlich am 7. Mai 2026 erzielte Einigung ersetzt; die neuen Inhalte des Pakets (Art.-5-Verbot, Art.-50-Abs.-2-Übergangsperiode, Abgrenzung Anhang I) werden ergänzt); § 11.3 (Aktualisierung des bestehenden Trilog-Eintrags um Datum und Inhalt der Einigung, Pressemitteilung des Rates der EU und sechs Sekundärquellen); Aktualitätshinweis am Dokumentende ersetzt die Beschreibung „laufende Trilog-Verhandlungen" durch die Beschreibung der Einigung; README.md mit neuem Versionseintrag 23.0. | Schließt die seit Version 8.0 verfolgte Linie zum *Digital Omnibus on AI* mit der materiellen Einigung ab. Für die Steuerdebatte relevant, weil die in § 4.4 dokumentierte Anknüpfung steuerlicher Tatbestände an AI-Act-Kategorien jetzt einen verbindlichen Zeitplan erhält (2. Dezember 2027 / 2. August 2028) und die Kennzeichnungspflicht für generative KI-Outputs (Art. 50 Abs. 2) ab 2. August 2026 mit Übergangsperiode bis 2. Dezember 2026 wirksam wird — eine administrative Datenbasis, an die fiskalische Anknüpfungen mittelfristig andocken können (vgl. § 9.2). |
| 2 | Cisco Systems — Layoff-Ankündigung am 13. Mai 2026: Streichung von unter 4.000 Stellen (unter 5 % der Belegschaft) bei parallelem Rekord-Q3-FY2026-Umsatz von 15,8 Mrd. USD und 5,3 Mrd. USD an AI-Infrastruktur-Bestellungen von Hyperscalern; Restrukturierungsaufwand bis zu 1 Mrd. USD (rund 450 Mio. USD im Q4 FY2026, der Rest im FY2027); Notification-Beginn 14. Mai 2026; Unterstützungspaket: anteilige Boni, Outplacement-Services und ein Jahr Zugang zu Cisco-U-Schulungen; strategische Begründung: Neuausrichtung auf Silicon, Optics, Security und KI. Quellen: TechCrunch (14. Mai), IndexBox, The HR Digest, TheStreet, Fox Business. | § 1.1 (Ergänzung des Layoff-Blocks: Cisco wird unmittelbar nach Cloudflare als zusätzlicher Layoff-Akteur eingefügt; das Muster „Rekord-AI-Umsatz parallel zu Personalabbau" wird explizit benannt und mit den Cloudflare- und Hyperscaler-Daten verzahnt); § 11.5 neuer Sammelbeleg „TechCrunch / IndexBox / The HR Digest / TheStreet / Fox Business" mit fünf URLs; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Cisco ist nach Cloudflare der zweite Netzanbieter, der eine konzernweite Restrukturierung explizit am Übergang zu einer KI-zentrierten Wertschöpfungslogik festmacht — und damit den Trend von SaaS/Fintech/IT-Services in den Bereich der KI-Infrastruktur­akteure ausdehnt. Die Konstellation „Rekord-Umsatz + AI-Capex-Boom + Personalabbau" schärft die in § 1.1 dokumentierte Asymmetrie-Linie zwischen Personalreduktion und Infrastrukturausbau und gibt den fiskalpolitischen Schlussfolgerungen in § 5.1 / § 8.3 (Anknüpfung an Maschinenkapital) zusätzlichen empirischen Halt. |
| 3 | TrueUp / SkillSyncer — Tagesfortschreibung zum 25./26. Mai 2026: TrueUp 143.985 Personen aus 342 Layoff-Meldungen am 26. Mai 2026 (rund 993 Personen pro Tag im Jahresdurchschnitt); SkillSyncer 134.603 Personen aus 212 Layoff-Ereignissen am 25. Mai 2026 (rund 928 Personen pro Tag). Quellen: TrueUp-Tracker-Dashboard (26. Mai 2026), SkillSyncer-Tracker-Dashboard (25. Mai 2026). | § 1.1 (Tagesfortschreibung der Tracker-Reihe an den Stand 8. Mai 2026 angeschlossen; Methodikspanne zwischen TrueUp und SkillSyncer fortgesetzt dokumentiert); § 11.5 neuer Eintrag „TrueUp / SkillSyncer (Stand 25./26. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Setzt die seit Lauf 001 fortgeschriebene Tracker-Reihe (8. Mai → 26. Mai 2026) mit einem Drei-Wochen-Delta von rund 17.000 zusätzlich erfassten Personen fort; bestätigt das Niveau von rund 1.000 Personen pro Tag und stellt zugleich klar, dass die kumulative Verlangsamung im Jahresdurchschnitt (993 vs. 1.003) auf die Konsolidierung der Spitzen-Wochen Anfang Mai 2026 zurückgeht — die in § 8.4 entwickelte Stabilitätslinie wird quantitativ unterfüttert, ohne den aggregiert moderaten Befund aus § 3.5 (Yale Budget Lab / Anthropic) umzukehren. |
| 4 | GKV-Beitragssatzstabilisierungsgesetz — Präzisierung des Verfahrenstands: Die erste Lesung im Bundestag, in Version 22.0 noch für die Wochen nach dem 8. Mai 2026 erwartet, ist auf Mitte Juni 2026 verschoben; die parlamentarische Behandlung vor der Sommerpause 2026 bleibt das Ziel der Bundesregierung. Quellen: Bundesgesundheitsministerium (GKV-Beitragssatzstabilisierungsgesetz-Service), Stellungnahme der Deutschen Krankenhausgesellschaft vom 8. Mai 2026, KBV-Stellungnahme, AOK-Presse und Politik. | Aktualitätshinweis am Dokumentende: präzisierte Beschreibung des Verfahrenstands (Bundestag-Lesung verschoben auf Mitte Juni 2026); README.md mit neuem Versionseintrag 23.0. | Schließt die in § 5.2 entwickelte Linie zur lohnbasierten Sozialfinanzierung verfahrensseitig: Die in den BMG-Tabellen referierte Mehrjahresperspektive bleibt anwendbar; die parlamentarische Verzögerung verschärft die Spannung zwischen ausgaben- und einnahmenseitigen Reformbestandteilen, ohne die in § 5.2 referierten Eckzahlen zu verändern. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Connecticut SB 5 — Lamont-Unterzeichnung im Mai 2026 weiterhin nicht mit Datum belegt; Pressespokesperson „plans to sign", aber keine offizielle „Public Act"-Ankündigung im 7-Tage-Fenster vor dem 26. Mai 2026. Bestehender § 4.5-Block (Verabschiedung Repräsentantenhaus 1. Mai 2026, Geltungsdaten ab 1. Oktober 2026) bleibt korrekt; in einem späteren Lauf nachzutragen.
- Trump AI Executive Order (Voluntary AI Model Review Process, Frist 19./20. Mai 2026 zur Unterzeichnung geplant, danach verschoben mit Begründung „I didn't like certain aspects") — nach Berichterstattung von Axios und CNN vom 20./22. Mai 2026 vorerst nicht unterzeichnet; ohne formale Inkraftsetzung kein Übernahmegrund.
- *Workers' Incentives and the Optimal Taxation of AI* (arXiv-Preprint 19. März 2026) — außerhalb des 7-Tage-Fensters und ohne abschließende Peer-Review; in einem späteren Lauf bei Veröffentlichung in einem begutachteten Journal zu prüfen.
- Tesla Optimus Gen-3 / Boston Dynamics Atlas / Figure 03 — Berichterstattung zu Produktionsplänen Mai 2026 ohne neue Stückzahl-/Pilotkunden-Belege, die über den in Version 16.0/17.0 referierten Stand hinausgehen.
- IFR World Robotics 2026 — noch nicht im Frühjahr 2026 erschienen; bestehender § 6.x-Verweis auf die Vorgängerausgabe bleibt korrekt.
- Anthropic Economic Index — kein neuer Bericht im 7-Tage-Fenster vor dem 26. Mai 2026; bestehender § 3.5-Block bleibt aktuell.
- *Plattform-Digitalabgabe* (Weimer) — keine Bewegung über Version 10.0/11.0 hinaus zwischen 8. und 26. Mai 2026; Eckpunktepapier weiterhin angekündigt, aber nicht vorgelegt.
- *ulga na robotyzację* — Position des polnischen Finanzministeriums und Sejm-Erstlesung des Anhebungsentwurfs bereits in Version 16.0 dokumentiert; keine neue Entwicklung.
- Generationenkapital — keine neuen Tranchen- oder Renditeangaben zwischen 8. und 26. Mai 2026; bestehender § 8.6-Verweis bleibt aktuell.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide KI-spezifische Treffer im 7-Tage-Fenster; Empfehlung weiterhin bestehend (gezielter Abruf von g-ba.de-Sitzungsergebnissen, gematik-Pressemitteilungen, BfArM-Listings).
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; die neue Cisco-Passage in § 1.1 verweist über den bestehenden Kontext implizit auf § 5.1 und § 8.3 (Maschinenkapital-Anknüpfung); die aktualisierte Digital-Omnibus-Passage in § 4.4 ändert keine Querverweise. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind eine Aktualisierung des bestehenden Layoff-/Tracker-Blocks und des AI-Act-Trilog-Stands; der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Trilog-Einigungsdatum 7. Mai 2026 und Inhalt (Anhang-III-Stichtag 2. Dezember 2027, Anhang-I-Stichtag 2. August 2028, Art.-50-Abs.-2-Übergang bis 2. Dezember 2026, Art.-5-CSAM/NCII-Verbot mit Anpassungsfrist bis 2. Dezember 2026) in der Pressemitteilung des Rates der EU vom 7. Mai 2026 und in mindestens sechs unabhängigen Sekundärquellen (Bird & Bird, Lexology, White & Case, Hogan Lovells, Modulos, paloubis) konsistent dokumentiert. Cisco-Zahlen (unter 4.000 Stellen, unter 5 % Belegschaft, Q3-FY2026-Umsatz 15,8 Mrd. USD, 5,3 Mrd. USD AI-Bestellungen, Restrukturierungsaufwand bis zu 1 Mrd. USD; Notification-Beginn 14. Mai 2026) in mindestens fünf unabhängigen Quellen (TechCrunch, IndexBox, The HR Digest, TheStreet, Fox Business) konsistent. Tracker-Stand 26. Mai 2026 wörtlich aus TrueUp-Tracker (Stand 26. Mai 2026: 342 Layoff-Meldungen / 143.985 Personen / rund 993 Personen pro Tag); SkillSyncer-Stand 25. Mai 2026 wörtlich aus dem SkillSyncer-Tracker. |
| 2.2.2 Redundanzprüfung | OK | Cisco ist eine neue, in keinem Vorlauf erwähnte Layoff-Welle; die Cloudflare- und Coinbase-Blöcke bleiben thematisch unverändert. Die Trilog-Einigungs-Passage ersetzt vollständig die bisherige Beschreibung der „laufenden Verhandlungen" — keine Doppelung. Tracker-Stand 26. Mai 2026 wird als Fortschreibung der bisherigen Reihe geführt. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Cisco-Begründung („Neuausrichtung auf Silicon, Optics, Security und KI") als Konzernzitat ohne Autorenkommentar wiedergegeben. |
| 2.2.4 Ausgewogenheit | OK | Die Trilog-Einigung wird neutral wiedergegeben; die in § 4.4 etablierte Unsicherheit über die formelle Annahme bleibt explizit erhalten („formelle Annahme vor 2. August 2026 angestrebt"). Die *Washington-Post*-Differenzierungsanalyse (§ 1.1) und das Bloomberg-Editorial (§ 3.5/§ 4.5) bleiben als publizistische Gegenpositionen unverändert dokumentiert. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund; deutsche Schreibweisen (Hochrisiko-Pflichten, Anhang III, Anhang I, Übergangsperiode) konsistent. |
| 2.3.2 Terminologie | OK | „AI Act" / „KI-Verordnung" / „Digital Omnibus on AI" einheitlich verwendet wie in den Vorversionen; „CSAM/NCII" beim ersten Auftreten ausgeschrieben („kinderpornografische Inhalte oder nicht einvernehmliche intime Bildaufnahmen"); APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Cisco-Belegcluster (TechCrunch / IndexBox / The HR Digest / TheStreet / Fox Business) als neuer Eintrag in § 11.5; TrueUp-/SkillSyncer-Tagesstand 25./26. Mai 2026 als neuer Eintrag in § 11.5; Digital-Omnibus-Trilog-Eintrag in § 11.3 um Datum und Inhalt der Einigung sowie sechs Sekundärquellen erweitert; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Digital Omnibus: Primärquelle ist die Pressemitteilung des Rates der EU vom 7. Mai 2026 (consilium.europa.eu), Sekundärquellen Bird & Bird, Lexology, White & Case, Hogan Lovells, Modulos. Cisco: Primärquelle Cisco-Investor-Relations-Erklärung vom 13. Mai 2026, Sekundärquellen TechCrunch (14. Mai), IndexBox, The HR Digest, TheStreet, Fox Business. TrueUp/SkillSyncer: öffentlich zugängliche Tracker-Dashboards. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: consilium.europa.eu/en/press/press-releases/2026/05/07/artificial-intelligence-council-and-parliament-agree-to-simplify-and-streamline-rules/ (öffentlich, Pressemitteilung des Rates der EU); twobirds.com/en/insights/2026/digital-omnibus-on-ai-provisional-agreement-reached-at-the-may-trilogue (öffentlich); techcrunch.com/2026/05/14/cisco-cuts-nearly-4000-jobs-to-spend-more-on-ai-reports-record-quarterly-revenue/ (öffentlich); trueup.io/layoffs (öffentlich, Dashboard); skillsyncer.com/layoffs-tracker (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Digital Omnibus (Stichtage 2. Dezember 2027 / 2. August 2028, Art.-50-Abs.-2-Übergang bis 2. Dezember 2026, Art.-5-CSAM/NCII-Anpassungsfrist 2. Dezember 2026, formelle Annahme vor 2. August 2026) wörtlich aus der Pressemitteilung des Rates der EU und den Sekundärquellen übernommen; Cisco-Kernzahlen (unter 4.000 Stellen / unter 5 % Belegschaft, 15,8 Mrd. USD Q3-FY2026-Umsatz, 5,3 Mrd. USD AI-Bestellungen, bis zu 1 Mrd. USD Restrukturierungsaufwand) wörtlich aus den TechCrunch-/IndexBox-/Fox-Business-Texten; Tracker-Stände wörtlich aus TrueUp- und SkillSyncer-Dashboards. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die vier neuen Belege benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Quellen, Primärquellenverfügbarkeit ohne Paywall in allen vier Fällen). |
...
Keine — die vier Ergänzungen sind Tagesaktualisierungen einer bestehenden Linie ohne Korrekturbedarf an anderen Aussagen.
