...
## Validierung 14. Mai 2026 (Lauf 001 vom 14. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf seit dem 8. Mai 2026 (Lauf 001 — Version 22.0). Web-Recherche im Korridor der Cluster A–J am 14. Mai 2026 mit Standard-Zeitfenster 7 Tage (ab 7. Mai 2026) bzw. 48 Stunden (Cluster F und Cluster I, ab 12. Mai 2026). Drei belegbare Treffer im Fenster identifiziert und eingearbeitet: (a) Trilog-Einigung Digital Omnibus on AI vom 7. Mai 2026 (Cluster B); (b) Mai-Welle der KI-getriebenen Tech-Layoffs am 12./13. Mai 2026 — Walmart, LinkedIn, Cisco — sowie Tagesfortschreibung TrueUp Stand 13. Mai 2026 (Cluster F); (c) IAB-Kurzbericht 8/2026 vom 5. Mai 2026 zur Adoption generativer KI in deutschen Betrieben (Cluster E / H).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Digital Omnibus on AI — *Provisorische Trilog-Einigung* am 7. Mai 2026 (dritte Runde): Bestätigung der Verschiebung der Hochrisiko-Pflichten auf 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); Lösung des Anhang-I-Konformitätsstreits, der den Trilog am 28. April 2026 gesprengt hatte; neuer Tatbestand in Art. 5 mit Verbot von KI-Systemen, die CSAM (Child Sexual Abuse Material) oder NCII (non-consensual intimate imagery) generieren; formelle Billigung durch Rat und Parlament „in den kommenden Wochen", in jedem Fall vor 2. August 2026 angekündigt; der zuvor terminierte Trilog am 13. Mai 2026 ist damit obsolet. Quellen: Bird & Bird (7. Mai 2026); NicFab (7. Mai 2026); Timelex; Lexology; Dastra. | § 4.3 (Aktualisierung des Digital-Omnibus-Blocks: dritte Trilogrunde mit provisorischer Einigung; obsolet gewordener 13.-Mai-Termin); § 11.3 neuer Eintrag „Europäisches Parlament / Rat der EU (7. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Schließt die in Version 12.0–17.0 dokumentierte Trilog-Reihe ab und liefert die für die Steuerdebatte relevante Planungssicherheit über die Hochrisiko-Endstichtage 2027/2028 — eine mittelfristige Anknüpfung steuerlicher Tatbestände an AI-Act-Kategorien wird damit politisch fixiert. Die neuen Art.-5-Verbote (CSAM/NCII) sind inhaltlich nicht steuerrelevant, gehören aber zur korrekten Vollständigkeit der Beschreibung des Verhandlungsergebnisses. |
| 2 | Mai-Welle der KI-getriebenen Tech-Layoffs am 12./13. Mai 2026 — *Walmart* (rund 1.000 Corporate-Workers aus Produkt-, Design- und Technologie-Teams, internes Memo CTO Suresh Kumar und EVP AI Acceleration Daniel Danker; *ausdrücklich nicht KI-begründet*, sondern als Plattform-Konsolidierung über US-, Sam's-Club- und internationale Einheiten); *LinkedIn* (Microsoft-Tochter, rund 5 % der 17.500 Beschäftigten — rund 875–1.000 Stellen; Mitteilung 13. Mai 2026; CEO Ryan Roslansky-Memo mit Verweis auf verändertes Kundenverhalten, flachere Organisation und verlangsamtes Umsatzwachstum trotz +12 % Quartalsumsatz); *Cisco* (rund 4.000 Stellen, knapp 5 % der globalen Belegschaft; Memo CEO Chuck Robbins; Benachrichtigungen ab 14. Mai 2026; Restrukturierungsaufwand bis 1 Mrd. USD; parallel Q3-Quartalszahlen Umsatz 15,8 Mrd. USD/+12 % YoY; AI-Aufträge von Hyperscalern bislang 5,3 Mrd. USD; Jahresprognose AI-Aufträge auf 9 Mrd. USD von 5 Mrd. USD angehoben). Tagesfortschreibung TrueUp Stand 13. Mai 2026: 128.270 Personen aus 286 Layoff-Meldungen (rund 1.002 pro Tag). Quellen: Reuters/CNBC/Washington Times (Walmart 12./13. Mai); Bloomberg/Reuters/GeekWire/Seattle Times (LinkedIn 13. Mai); Reuters/Yahoo Finance/Business Standard/DNYUZ (Cisco 13./14. Mai); TrueUp/Yahoo Tech (Stand 13. Mai). | § 1.1 (Aufnahme der drei Mai-2026-Layoffs in die Tracker-Reihe; Tagesfortschreibung 25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 13. Mai 2026); § 11.5 vier neue Sammelbelege; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Cisco und LinkedIn liefern den zweiten Datenpunkt nach Cloudflare (7. Mai 2026), dass die Anbieterseite der KI-Wertschöpfung — Netzwerk- und Plattform-Anbieter — Personal reduziert und Investitionen demonstrativ in AI-Compute, AI-Chips und AI-Beschleuniger lenkt; Cisco macht das durch die parallel angehobene Order-Prognose besonders sichtbar. Walmart liefert ein Beispiel eines Nicht-Tech-Konzerns, der im selben Zeitfenster und mit ähnlicher Größenordnung restrukturiert, ohne KI als Hauptbegründung zu nennen — und stützt damit die in der *Washington-Post*-Differenzierung vom 1. Mai 2026 hervorgehobene Mehrkanalerklärung. |
| 3 | *IAB-Kurzbericht 8/2026* vom 5. Mai 2026 *„Jeder vierte Betrieb in Deutschland nutzt generative KI"*: Anteil der deutschen Betriebe mit produktivem Einsatz generativer KI von rund 5 % (2023) auf rund 25 % (Anfang 2026) gestiegen — annähernde Verfünffachung binnen zwei Jahren; weitere 9 % planen die Einführung; 48 % bei Betrieben mit ≥ 200 Beschäftigten gegenüber 21 % bei Betrieben mit < 10 Beschäftigten. Quelle: IAB-Presseinfo (5. Mai 2026); Kurzbericht-Volltext (doku.iab.de). | § 3.5 (Aufnahme als deutsche Adoptionsperspektive nach dem Yale-Budget-Lab-Datenpunkt und vor dem szenariorobust-Argument); § 11.3 neuer Eintrag „IAB (5. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Bisher beruhte die in § 3.5 referierte Adoptionsdiskussion auf US-Daten (Anthropic Economic Index, Yale Budget Lab, Massenkoff/McCrory). Der IAB-Befund schließt die Lücke auf deutscher Mikroebene mit einer betrieblichen Adoptionsrate, die ausdrücklich nicht in eine aggregierte Verdrängungswelle übersetzt werden kann — und unterfüttert die in Kapitel 8 entwickelte szenariorobuste Linie auch für den deutschen Anwendungskontext (schnelle Adoption ohne klar messbare aggregierte Beschäftigungseinbrüche). Cluster H (Deutschland-These-Bezugspunkte) und Cluster E (Arbeitsmarktdaten) sind beide adressiert. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Connecticut SB 5 — Lamont-Unterzeichnung weiterhin angekündigt, aber zum Stichtag 14. Mai 2026 noch nicht förmlich mit Datum dokumentiert; bestehender § 4.5-Block bleibt korrekt; in einem späteren Lauf nachzutragen.
- Bundesrat 1065. Sitzung 8. Mai 2026 — Erstdurchgang des GKV-Beitragssatzstabilisierungsgesetzes wie geplant erfolgt; gleichzeitig im Bundesrat blockierte 1.000-Euro-Entlastungsprämie ist nicht KI-bezogen und liegt außerhalb des Recherchekorridors; konkrete Beschlusstexte zur GKV-Reform liegen nicht in einer Form vor, die über die bestehende § 5.2-Beschreibung hinausginge. Im nächsten Lauf nach Vorliegen der Bundesratsdrucksache nachzutragen.
- Microsoft VRSAR — Annahmefenster läuft (bis 8. Juni 2026); keine neue Quantifizierung im 7-Tage-Fenster.
- Sanders/AOC AI Data Center Moratorium Act, Maine LD 307 — Sachstand unverändert, in Version 8.0–14.0 dokumentiert.
- Anthropic / OpenAI / Google DeepMind Frontier-Modell-Releases (Mythos, GPT-5.5-Cyber) — vor dem 7. Mai 2026 erfolgt; außerhalb 48-Stunden-Fenster Cluster I.
- Big-Tech-AI-Capex 2026 — Konsens-Schätzung 725 Mrd. USD seit Version 21.0 (Lauf 003 vom 7. Mai 2026) dokumentiert; keine Bewegung im 7-Tage-Fenster.
- OpenAI Workshop Eröffnung in Washington, D.C. (Mai 2026) — angekündigt, exaktes Eröffnungsdatum öffentlich nicht trennscharf belegbar.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne KI-spezifische G-BA-/gematik-/BfArM-Beschlüsse im 7-Tage-Fenster.
- Cluster I (Frontier-Modelle), Cluster J (Robotik) — keine politisch-fiskalisch relevanten Tagesmeldungen im 48-Stunden-Fenster.
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; die neuen Passagen in § 1.1 (Mai-Layoffs), § 3.5 (IAB-Kurzbericht 8/2026) und § 4.3 (Trilog-Einigung) verweisen über den bestehenden Kontext implizit auf § 5.1, § 8.2, § 8.3, § 8.4 und Kapitel 8 — diese Ziele existieren weiterhin. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind Aktualisierungen bestehender Linien (Layoff-/Tracker-Block, Trilog-Verhandlungsstand, Adoptionsbeobachtung); der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Trilog-Einigungsdaten (7. Mai 2026, Anhang-III-Stichtag 2. Dezember 2027, Anhang-I-Stichtag 2. August 2028, neuer Art.-5-Tatbestand CSAM/NCII) in mehreren unabhängigen Kanzlei- und Fachquellen (Bird & Bird, NicFab, Timelex, Lexology, Dastra) wortgleich; Layoff-Zahlen Walmart 1.000 / LinkedIn 5 % von 17.500 / Cisco 4.000 / 5 % / 1 Mrd. USD aus den Konzern-Memos und der Sekundärberichterstattung übernommen; TrueUp-Tagesstand 128.270 / 286 / ca. 1.002 pro Tag wörtlich aus dem Tracker und Yahoo-Tech-Wiedergabe; IAB-Zahlen 25 % / 5 % / 9 % / 48 % / 21 % wörtlich aus der IAB-Presseinfo vom 5. Mai 2026. |
| 2.2.2 Redundanzprüfung | OK | Die TrueUp-Reihe wird gemäß Claude.md § 4.2 als Tagesfortschreibung der bisherigen Stände (25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 13. Mai 2026) geführt — keine Doppelung. Walmart, LinkedIn und Cisco sind drei neue, in keinem Vorlauf erwähnte Layoff-Wellen. Die Trilog-Einigung schließt die Trilog-Reihe der Versionen 12.0–17.0 ab und ersetzt nicht den dort dokumentierten Verhandlungsstand, sondern führt ihn fort. Der IAB-Kurzbericht 8/2026 ist eine eigenständige IAB-Publikation und nicht mit der IAB-Prognose vom 24. März 2026 oder der IAB-Regionalprognose vom März 2026 redundant. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Trilog-Einigung als Tatsachenaussage, ohne in die Steuer-Argumentation umgedeutet zu werden; IAB-Befund explizit als „komplementäre deutsche Adoptionsperspektive" gekennzeichnet. |
| 2.2.4 Ausgewogenheit | OK | Walmart-Fall mit der Aussage „explizit nicht KI-begründet" als Stütze der *Washington-Post*-Differenzierung vom 1. Mai 2026 hervorgehoben (kein KI-zentristisches Framing); LinkedIn-Begründung des CEO neutral wiedergegeben; Cisco-Begründung als Memo-Aussage des Konzerns ohne Autorenkommentar zitiert. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund; die Satzanschlüsse in § 1.1 nach der Cisco-Aussage und nach „Die früheren Tagesfortschreibungen in dieser Reihe..." flüssig; der neue Trilog-Block in § 4.3 ohne grammatische Auffälligkeit. |
| 2.3.2 Terminologie | OK | „Provisorische Einigung" für englisches *provisional agreement* eingeführt; CSAM und NCII bei Erstnennung ausgeschrieben; „observed exposure" weiterhin als Anglizismus aus § 3.5 übernommen; „agentic AI" in Anführungszeichen; bestehende Schreibweisen einheitlich. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Trilog-Einigungs-Beleg als neuer Eintrag in § 11.3 („Europäisches Parlament / Rat der EU (7. Mai 2026)") mit fünf URLs; IAB-Kurzbericht 8/2026 als neuer Eintrag in § 11.3 mit zwei URLs; vier neue Sammelbelege in § 11.5 (Walmart, LinkedIn, Cisco, TrueUp Stand 13. Mai); keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Trilog-Einigung: Primärquellen sind Pressemitteilungen von Rat und Parlament (in den Kanzleianalysen referiert); IAB: Primärquelle ist die IAB-Presseinfo und der Volltext auf doku.iab.de; Layoffs: Primärquellen sind die Konzern-Memos (CEO-Mitarbeiterbrief), von Reuters/Bloomberg/CNBC/etc. als Sekundärquellen referiert; TrueUp: öffentlich zugängliches Tracker-Dashboard. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: iab.de/presseinfo/jeder-vierte-betrieb-in-deutschland-nutzt-generative-ki (öffentlich, Inhalt konsistent); twobirds.com/en/insights/2026/digital-omnibus-on-ai-provisional-agreement-reached-at-the-may-trilogue (öffentlich, Inhalt konsistent); cnbc.com/2026/05/13/walmart-cuts-1000-roles (öffentlich); bloomberg.com/news/articles/2026-05-13/microsoft-s-linkedin-is-cutting-jobs (Paywall, Headline und Lead-Sätze konsistent); business-standard.com/world-news/cisco-to-cut-nearly-4-000-jobs (öffentlich); trueup.io/layoffs (öffentlich, Live-Daten). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Trilog (2. Dezember 2027 Anhang III; 2. August 2028 Anhang I; neuer Art. 5 CSAM/NCII; 7. Mai 2026 als Einigungsdatum) wörtlich aus Bird & Bird und NicFab übernommen; Kernzahlen Layoffs (Walmart 1.000; LinkedIn 5 %/17.500; Cisco 4.000/5 %/1 Mrd. USD/15,8 Mrd. USD Q3-Umsatz/9 Mrd. USD Jahresprognose AI-Aufträge) aus den Konzern-Memos und Sekundärquellen; Kernzahlen IAB (25 %, 5 %, 9 %, 48 %, 21 %) wörtlich aus der IAB-Presseinfo. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Belege benötigen keine eigene Verifizierungsmarkierung (Primärquellen verfügbar bzw. mehrere unabhängige Sekundärquellen). |
...
Keine — die Ergänzungen sind Tagesaktualisierungen bestehender Linien ohne Korrekturbedarf an anderen Aussagen. Die zuvor in § 4.3 stehende Information „Die nächste Trilogrunde ist auf den 13. Mai 2026 terminiert" wurde durch die Trilog-Einigung vom 7. Mai 2026 überholt und im Rahmen der inhaltlichen Aktualisierung präzisiert.
