...
## Validierung 21. Juni 2026 (Lauf 001 vom 21. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf nach Lauf 001 vom 8. Mai 2026 (Versions-Schnitt 22.0). Web-Recherche im Korridor der Cluster A–J am 21. Juni 2026: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Wegen des sechswöchigen Abstands zum letzten Lauf wurde das Standard-7-Tage-Fenster für die Cluster A–E und G–J auf den Zeitraum seit dem 8. Mai 2026 erweitert, das 48-Stunden-Fenster der Cluster F und I jedoch beibehalten. Fünf belegbare Treffer identifiziert und eingearbeitet (Anthropic *Economic Policy Framework* 10. Juni 2026; Sanders *American AI Sovereign Wealth Fund Act* 18. Juni 2026; Warren-Op-ed in *Time* 27. Mai 2026; Trilog-Einigung zum Digital Omnibus on AI 7. Mai 2026; GitLab- und ServiceNow-Layoffs Juni 2026); die übrigen recherchierten Themen waren in Version 22.0 bereits enthalten oder lagen außerhalb des erweiterten 7-Tage-Korridors.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Anthropic — *Economic Policy Framework — Policy on the AI Exponential* (10. Juni 2026): drei an Schwellenwerten der US-Arbeitslosenquote (≈ 5 %, ≈ 10 %, jenseits historischer Höchstwerte) orientierte Politikstufen mit universal capital accounts, automatischer UI-Verlängerung, gemeinsamem Einkommensboden, KI-Nutzungsabgaben und AI Sovereign Wealth Fund; drei Fundamente (Messinfrastruktur, dedizierte staatliche Analyseeinheit, modernisierte Auszahlungsinfrastruktur); 350-Mio.-USD-Selbstverpflichtung (Economic Futures Research Fund 200 Mio. USD, Anthropic Fellowship Program 150 Mio. USD); begleitender Dario-Amodei-Essay *„Policy on the AI Exponential"*. Quellen: Anthropic-Webseite (10. Juni 2026), Anthropic-PDF, darioamodei.com; Sekundärquellen Fortune (11. Juni 2026), Bloomberg Tax, Washington Times (10. Juni 2026), ABC News, Gizmodo. | § 4.5 (neuer Absatz „Anthropic — *Economic Policy Framework* (10. Juni 2026)" zwischen Sanders-SWF-Act-Block und Andrew-Yang-Block); § 11.3 zwei neue Einträge (Anthropic-Papier; Dario-Amodei-Essay); § 11.5 neuer Sammelbeleg „Fortune / Bloomberg Tax / Washington Times / ABC News / Gizmodo (10./11. Juni 2026)"; Aktualitätshinweis am Dokumentende und README.md (Versionseintrag 23.0). | Erstmals strukturiert ein zweiter führender KI-Anbieter — neben OpenAI (§ 4.5, April 2026) — die Politikempfehlungen an makroökonomische Auslöser; nennt mit *KI-Nutzungsabgaben* und *AI Sovereign Wealth Fund* Instrumente, die im OpenAI-Papier vorgeschlagen, aber nicht in eine Skalierungslogik eingebettet waren; stützt die in § 8.3 entwickelte Teilhabefonds-These institutionell. |
| 2 | US Senate — *American AI Sovereign Wealth Fund Act* (Sanders, 18. Juni 2026): einmalige 50-%-Aktiensteuer auf KI-Unternehmen mit jährlichen Bruttoeinnahmen ≥ 200 Mio. USD; Aktien fließen in einen *American AI Sovereign Wealth Fund*, verwaltet durch eine *Independent Commission for Democratic AI* (sieben vom Präsidenten nominierte, vom Senat bestätigte Mitglieder); geschätztes Fondsvolumen rund 7 Bio. USD, jährliche Dividende rund 1.000 USD pro US-Bürger; flankierender Sanders-Op-ed *„The Public Should Own Half of the Big A.I. Companies"*. Quellen: sanders.senate.gov (Pressemitteilung und Op-ed, Juni 2026); Sekundärquellen Fortune (3. Juni 2026), Roll Call (18. Juni 2026), The Hill, Fox Business, Interesting Engineering, NPR, Reason (2. Juni 2026). | § 4.5 (neuer Absatz „Sanders — *American AI Sovereign Wealth Fund Act* (18. Juni 2026)" zwischen Warren-Block und Anthropic-Block); § 11.3 zwei neue Einträge (Gesetzentwurf und Op-ed); § 11.5 neuer Sammelbeleg „Fortune / The Hill / Roll Call / Fox Business / Interesting Engineering / NPR / Reason (Juni 2026)"; Aktualitätshinweis und README.md (Versionseintrag 23.0). | Verschiebt die US-Debatte aus der reinen Steuersystematik in die Eigentumsfrage an Frontier-Modellen (§ 8.3); liefert mit 7 Bio. USD erstmals eine konkrete politische Zielgröße für die staatliche Beteiligung an KI-Wertschöpfung; konzeptionelle Hybridkonstruktion zwischen Eigentumsabgabe und Vermögensteuer-Schließung, die nicht in den klassischen Typenkatalog nach § 2.1 passt. |
| 3 | Warren — *Why We Need to Tax AI* (Op-ed in *Time*, 27. Mai 2026): Verbrauchsteuer auf den Stromverbrauch von Rechenzentren mit Größenstaffelung; Vermögensteuer auf KI-Milliardäre (Bezos, Altman); höhere Körperschaft- und Kapitalertragsteuer; Schließung von Steuerschlupflöchern; Aufkommen für universelle Gesundheitsversorgung, gebührenfreie Hochschulbildung, erweiterte UI; Hinweis auf bevorstehende „noch weiter gehende" KI-Steuervorschläge. Quellen: time.com (27. Mai 2026), warren.senate.gov; Sekundärquellen Axios (27. Mai 2026), The Hill, TechSpot, TechTimes, TheStreet, Crypto Briefing. | § 4.5 (neuer Absatz „Warren-Op-ed in Time (27. Mai 2026)" zwischen Bloomberg-Editorial-Block und Sanders-SWF-Act-Block); § 11.3 neuer Eintrag (Warren-Op-ed in Time); § 11.5 neuer Sammelbeleg „Axios / The Hill / TechSpot / Crypto Briefing / TechTimes / TheStreet (27. Mai 2026 ff.)"; Aktualitätshinweis und README.md (Versionseintrag 23.0). | Verschiebt die Anknüpfungslogik vom Akteur (KI-Unternehmen) und vom Output (Steuern auf automatisierende Arbeit) auf den Energie-Input (Rechenzentren) — ein Pfad näher an Pigou-Logiken, der das in § 9.1 diskutierte Mess- und Abgrenzungsproblem teilweise umgeht und gleichzeitig die Spannung zur ordnungsökonomischen Kritik (de la Feria, Bloomberg-Editorial) verschärft. |
| 4 | Trilog-Einigung zum *Digital Omnibus on AI* (Rat / Europäisches Parlament / Kommission, 7. Mai 2026): vorläufige Einigung mit Verschiebung der Anhang-III-Hochrisiko-Pflichten vom 2. August 2026 auf den 2. Dezember 2027 (rund 16 Monate); Anhang-I-Hochrisiko-Pflichten vom 2. August 2027 auf den 2. August 2028; formale Definitionen für KMU und SMCs mit vereinfachter Dokumentation, proportionalen QM-Anforderungen, reduzierten Bußgeld-Obergrenzen und priorisiertem Sandbox-Zugang; Klarstellung der AI-Office-Kompetenzen für GPAI; Ausnahme von der Hochrisiko-Klassifizierung für Systeme zur Nutzungsunterstützung, Leistungsoptimierung oder Qualitätskontrolle ohne Gesundheits-/Sicherheitsgefährdung; neue Prohibition nach Artikel 5 gegen nicht-einvernehmliche realistische sexuelle Darstellungen ab 2. Dezember 2026; formale Annahme durch Plenum und Rat zum Stand Mitte Juni 2026 noch ausstehend. Quellen: consilium.europa.eu (7. Mai 2026); Sekundärquellen Gibson Dunn, DLA Piper, White & Case, Hogan Lovells, Mishcon, Covington Inside Privacy, Verifywise. | § 4.4 (neuer Absatz „Digital Omnibus on AI — Provisorische Einigung 7. Mai 2026" am Ende des Abschnitts vor § 4.5); § 11.3 zwei neue Einträge (Ratspressemitteilung; Kanzlei-/Praxisanalysen); Aktualitätshinweis und README.md (Versionseintrag 23.0). | Verschiebt — sofern formal angenommen — die Geltungsdaten der AI-Act-Hochrisiko-Pflichten erheblich; zeigt, dass die EU-Ebene gegenwärtig auf Vereinfachung und Zeitlückung setzt und damit den fiskalpolitischen Pfaden aus § 5.1 (Wertschöpfungsabgabe) und § 4.5 (Sanders, OpenAI) keinen zusätzlichen regulatorischen Rückenwind verleiht; vergrößert relativen Spielraum für unilaterale Mitgliedstaaten-Anknüpfungen (Digitalabgaben, Nutzungsabgaben, Sozialversicherungs-Verbreiterung). |
| 5 | GitLab und ServiceNow — Fortsetzung der KI-induzierten Tech-Layoff-Linie im Juni 2026: GitLab kündigt am 3. Juni 2026 die Streichung von rund 14 % der Belegschaft (rund 350 Stellen) an, kombiniert mit dem Rückzug aus 22 Ländern, einer Reorganisation der R&D-Abteilungen in rund 60 kleinere Teams und einer Flachung der Managementebenen (*„GitLab Act 2"*-Blog, „agentische Ära"); ServiceNow bestätigt ab 12. Juni 2026 die Streichung mehrerer hundert Stellen in Solution Consulting, Sales, Product Marketing und L&D, begründet mit „KI-Effizienzen" bei paralleler Einstellung KI-fokussierter Skills. Quellen: TechCrunch (3. Juni 2026), American Bazaar (12. Mai 2026), The Register (12. Mai 2026), The Next Web, GitLab Blog, NowBen, HRKatha. | § 1.1 (Erweiterung des Layoff-Blocks um GitLab und ServiceNow als Brücke zwischen Mai-2026-Welle und Juni 2026); § 11.5 zwei neue Sammelbelege (TechCrunch / American Bazaar / The Register / NextWeb / GitLab Blog; NowBen / HRKatha); Aktualitätshinweis und README.md (Versionseintrag 23.0). | Verlängert die in § 1.1 dokumentierte Linie (Cloudflare → Coinbase → PayPal → Freshworks → Cognizant → GitLab → ServiceNow) und stützt den von Challenger und TrueUp Anfang Mai 2026 ausgewiesenen Trend, dass *AI-native* oder *agentic* angekündigte Umbauten zunehmend von SaaS- und Infrastruktur-Anbietern statt von klassischen Internet-Konzernen ausgehen. |

**Nicht aufgenommen (bewusste Auslassungen):**
- *GKV-Beitragssatzstabilisierungsgesetz* — Bundesrat 1065. Sitzung am 8. Mai 2026 (Erstdurchgang) und Bundesrats-Forderungen nach Übernahme versicherungsfremder Leistungen durch den Bund; Bundestags-Lesungen Mai/Juni 2026 mit geplanter Schlussabstimmung 26. Juni 2026 (nach diesem Lauf): kein abschließender Beschlusstext im Lauf-Fenster; bestehender § 5.2-Block bleibt korrekt; im nächsten Lauf nachzutragen, sobald das Gesetz Bundestag und Bundesrat passiert hat.
- Connecticut SB 5 — Lamont-Unterzeichnung weiterhin nicht öffentlich datiert; bestehender § 4.5-Block bleibt korrekt; im nächsten Lauf nachzutragen.
- Tesla Optimus / Figure / Boston Dynamics Atlas / Unitree / 1X — Cluster J im 48-Stunden-Fenster ohne politisch-fiskalisch relevante Tagesmeldung; Berichterstattung zu Figure-02-BMW-Spartanburg-Produktion ist kein neuer fiskalischer Sachverhalt.
- Korea — Kang/Lee/Quach (SSRN 5005128) *„The Welfare Effects of a Robot Tax — Evidence from a Tax Credit for Automation Technologies in Korea"*; ITIF *Quasi-Robot Tax* (9. Februar 2026): Datierung außerhalb des erweiterten 7-Tage-Korridors; bestehender § 6.1-Block bleibt korrekt; potenziell für Wochenend-/Vertiefungslauf zu prüfen.
- Anthropic Economic Index — kein neuer Folgebericht zwischen 8. Mai und 21. Juni 2026 (letzte Veröffentlichungen: *Learning curves* März 2026, *Economic Index Survey* April 2026); bestehender § 3.5-Block bleibt aktuell.
- IAB — kein neuer Kurzbericht im Zeitraum 8. Mai – 21. Juni 2026, der über die in Version 22.0 erfassten Aktualisierungen vom 24. März 2026 (Frühjahrsprognose, Regionalprognose) hinausgeht.
- Plattform-Digitalabgabe (Weimer) — keine über Version 10.0/11.0 hinausgehende Bewegung im erweiterten 7-Tage-Fenster; Eckpunktepapier weiterhin angekündigt, aber nicht vorgelegt.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne KI-spezifische neue G-BA-Beschlüsse / gematik-Pressemitteilungen / BfArM-Listings im Lauf-Fenster.

### Prüfergebnis

| Prüfschritt | Ergebnis | Auffälligkeiten |
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; in § 4.5 drei neue Absätze (Warren-Op-ed, Sanders-SWF-Act, Anthropic EPF) zwischen Bloomberg-Editorial und Andrew Yang; in § 4.4 ein neuer Absatz (Digital-Omnibus-Einigung) am Ende vor § 4.5; in § 1.1 eine GitLab-/ServiceNow-Brücke vor der bestehenden Goldman-Sachs-Passage. Keine leeren Abschnitte. |
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; die neuen § 4.5-Absätze verweisen auf § 2.1 (Typologie), § 4.5 (OpenAI-Papier), § 5.1/5.4, § 8.3 und § 9.1 — alle Ziele existieren weiterhin; die § 4.4-Erweiterung verweist auf § 5.1 und § 4.5. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen schärfen die Linie Cluster D (Politik-Initiativen) — Anthropic, Sanders, Warren bilden eine im Mai/Juni 2026 verdichtete US-Politik­ebene neben dem OpenAI-Papier und dem Bloomberg-Editorial; die Digital-Omnibus-Einigung schärft die EU-Linie in § 4.4; GitLab/ServiceNow verlängern die § 1.1-Layoff-Reihe. Roter Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; neue Fett-Lead-Ins „**Warren-Op-ed in Time (27. Mai 2026):**", „**Sanders — *American AI Sovereign Wealth Fund Act* (18. Juni 2026):**" und „**Anthropic — *Economic Policy Framework* (10. Juni 2026):**" sowie „**Digital Omnibus on AI — Provisorische Einigung 7. Mai 2026:**" einheitlich nach bestehendem § 4.5-Stil; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Anthropic-Tier-Schwellenwerte (5 %, 10 %, jenseits historischer Höchstwerte), Fonds-Volumen (200 + 150 = 350 Mio. USD), Veröffentlichungsdatum 10. Juni 2026 in Anthropic-Original, Fortune (11. Juni), Washington Times (10. Juni), Bloomberg Tax und Gizmodo konsistent. Sanders-Eckdaten (50 % Aktiensteuer, Schwelle 200 Mio. USD Bruttoeinnahmen, ~ 7 Bio. USD, ~ 1.000 USD pro Bürger, 18. Juni 2026, 7 Mitglieder Independent Commission) wörtlich aus sanders.senate.gov, Roll Call und Interesting Engineering. Warren-Eckdaten (Stromverbrauchsteuer mit Größenstaffelung, Vermögensteuer Bezos/Altman, Stromkostenanstieg bis 57 % regional / 6–29 % national bis 2030) wörtlich aus Time-Op-ed und Axios. Digital-Omnibus-Eckdaten (2. Aug 2026 → 2. Dez 2027 Anhang III; 2. Aug 2027 → 2. Aug 2028 Anhang I; KMU/SMC-Definitionen; Artikel-5-Erweiterung 2. Dez 2026) wörtlich aus Ratspressemitteilung und Gibson Dunn / White & Case. GitLab-Eckdaten (14 % / rund 350 Stellen / 22 Länder / 60 R&D-Teams) wörtlich aus TechCrunch (3. Juni 2026) und GitLab-Blog. ServiceNow-Eckdaten (mehrere hundert Stellen / vier Funktionen / „KI-Effizienzen") konsistent in NowBen und HRKatha. |
| 2.2.2 Redundanzprüfung | OK | Die drei neuen § 4.5-Absätze ergänzen die OpenAI- (April 2026) und Sanders-Robotersteuer-/Moratorium-Linie (Oktober 2025 / März/April 2026) — keine Doppelung. Anthropic-Papier ist konzeptionell von Sanders-SWF-Act zu unterscheiden (Anthropic: bedingte Politikempfehlung mit Skalierungslogik, KI-Nutzungsabgabe als Stufe 3; Sanders: einmalige Pflichtbeteiligung über Aktiensteuer); Warren-Op-ed knüpft an Stromverbrauch und nicht an KI-Output an. Digital-Omnibus-Einigung verschärft die bestehende EU-AI-Act-Trilog-Linie aus § 11.3, ohne Doppelung. GitLab/ServiceNow sind neue, in keinem Vorlauf erwähnte Layoff-Wellen. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Anthropic-Politikempfehlungen vollständig im Konjunktiv (Claude.md § 4.2); Sanders-SWF-Act und Warren-Op-ed ebenfalls im Konjunktiv; Bloomberg-Editorial und de la Feria (§ 3.3) / IW Köln (§ 3.4) bleiben als Gegenpositionen ausdrücklich erhalten. |
| 2.2.4 Ausgewogenheit | OK | Die drei neuen Cluster-D-Vorschläge werden ausgewogen dargestellt; Anthropic explizit als „Politikempfehlung ohne Selbstbesteuerung"; Sanders mit Hinweis auf geringe Annahmewahrscheinlichkeit; Warren mit *Time*-Op-ed-Charakter und Reason-Kritik (für Sanders) eingeordnet. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund; deutsche Klammersetzung und APA-Stil eingehalten. |
| 2.3.2 Terminologie | OK | „Universal capital accounts", „AI Sovereign Wealth Fund", „Independent Commission for Democratic AI" als zitierte Begriffe in Anführungszeichen; „GPAI" und „SMCs" beim ersten Auftreten ausgeschrieben (general-purpose AI; small mid-caps); „Stromverbrauchsteuer auf Rechenzentren" einheitlich. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Anthropic, Amodei, Sanders-Gesetzentwurf, Sanders-Op-ed, Warren-Op-ed, Ratspressemitteilung und Kanzlei-Analysen als neue Einträge in § 11.3; Fortune/Bloomberg-Tax/Washington-Times/ABC-Cluster, Fortune/Hill/Roll-Call/Fox-Business/NPR/Reason-Cluster, Axios/Hill/TechSpot/TechTimes-Cluster, TechCrunch/American-Bazaar/Register/NextWeb/GitLab-Cluster, NowBen/HRKatha-Cluster als neue Einträge in § 11.5; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Anthropic-Primärquelle Anthropic-PDF und darioamodei.com; Sanders-Primärquelle sanders.senate.gov; Warren-Primärquelle time.com und warren.senate.gov; Digital-Omnibus-Primärquelle consilium.europa.eu; GitLab-Primärquelle GitLab-Blog *„GitLab Act 2"*; ServiceNow-Primärquelle Konzernkommunikation, von NowBen und HRKatha referiert. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: anthropic.com/policy-on-the-ai-exponential/epf (öffentlich, Inhalt konsistent); fortune.com/2026/06/11/anthropic-dario-amodei-ai-jobs-tax-displacement-fund/ (öffentlich); sanders.senate.gov/press-releases/news-sanders-introduces-legislation-to-create-7-trillion-ai-sovereign-wealth-fund/ (öffentlich); time.com/article/2026/05/27/why-we-need-to-tax-ai/ (öffentlich); consilium.europa.eu/en/press/press-releases/2026/05/07/artificial-intelligence-council-and-parliament-agree-to-simplify-and-streamline-rules/ (öffentlich); techcrunch.com/2026/06/03/gitlab-cuts-14-of-staff-as-it-scales-its-platform-to-serve-ai-workloads/ (öffentlich); about.gitlab.com/blog/gitlab-act-2/ (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Anthropic (5 % / 10 % / jenseits historischer Höchstwerte; 200 Mio. + 150 Mio. = 350 Mio. USD) wörtlich aus dem Anthropic-PDF; Kernzahlen Sanders (50 % Aktiensteuer; ≥ 200 Mio. USD; ~ 7 Bio. USD; ~ 1.000 USD; 7 Kommissionsmitglieder) wörtlich aus sanders.senate.gov und Roll Call; Kernzahlen Warren (Stromkosten +57 % / 6–29 % bis 2030; Verbrauchsteuer-Logik) wörtlich aus Time und Axios; Kernzahlen Digital Omnibus (2. Dez 2027; 2. Aug 2028; 2. Dez 2026 Artikel-5-Erweiterung) wörtlich aus Ratspressemitteilung; GitLab-Zahlen (14 % / 350 Stellen / 22 Länder / 60 R&D-Teams) wörtlich aus TechCrunch und GitLab Act 2. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die fünf neuen Belegcluster benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen, in allen Fällen verfügbare Primärquellen ohne Paywall). |
| 2.5 Versionskonsistenz und Lizenz | OK | Versionsnummer 23.0 in Dokumentkopf (Stand Juni 2026), Aktualitätshinweis am Dokumentende, README.md (Versionszeile, Zitiervorschlag, KI-Offenlegung mit neuem Versionseintrag) und diesem Validierungsblock identisch; CC-BY-4.0-Hinweis und Haftungshinweis unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Keine Skripte vorhanden; manuelle Stichproben gemäß § 2.6 ersetzen den automatisierten Teil. |

### Gefundene Fehler

Keine — die fünf Ergänzungen sind Neuaufnahmen aus dem Zeitfenster seit dem 8. Mai 2026 ohne Korrekturbedarf an anderen Aussagen.
