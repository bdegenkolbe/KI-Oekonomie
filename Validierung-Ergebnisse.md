...
## Validierung 27. Mai 2026 (Lauf 002 vom 27. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Regulärer Daily-Update-Lauf am 27. Mai 2026 (rund 19 Tage nach Lauf 001 vom 8. Mai 2026). Web-Recherche im Korridor der Cluster A–J: Optimalsteuer/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Vier belegbare Treffer im 7-Tage- bzw. erweiterten Korridor identifiziert und eingearbeitet (Trilog-Einigung Digital Omnibus on AI 6./7. Mai 2026 als Nachtrag zum in Lauf 001 noch nicht erfassten Ereignis; Meta-Notification 8.000 Stellen am 20. Mai 2026; Intuit-Streichung 3.000 Stellen / 17 % am 20. Mai 2026; Walmart-Streichung/-Verlagerung 1.000 Stellen am 12. Mai 2026); TrueUp-Tracker zum 27. Mai 2026 als Tagesfortschreibung integriert. Cluster G (Gesundheitswesen) zum fünften Mal in Folge ohne valide Treffer im 7-Tage-Fenster; Cluster I/J ohne politisch-fiskalisch relevante Tagesmeldungen im 48-Stunden-Fenster.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Digital Omnibus on AI — vorläufige politische Einigung in dritter, vorgezogener Trilogrunde in der Nacht vom 6. zum 7. Mai 2026 unter zypriotischer Ratspräsidentschaft (Pressemitteilung des EU-Rates vom 7. Mai 2026, Berichterstattung Bird & Bird, White & Case, Hogan Lovells, Latham & Watkins, IAPP, TechPolicy Press, Lexology, Modulos). Bestätigung der Hochrisiko-Stichtage 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); neuer Art. 5-Tatbestand zu KI-Systemen für CSAM und nicht-einvernehmliche intime Bilddaten; Verkürzung der Wasserzeichen-Übergangsfrist nach Art. 50 Abs. 2 von sechs auf drei Monate (Stichtag 2. Dezember 2026 für vor dem 2. August 2026 vermarktete Generative-KI-Systeme); Bias-Detection-Rechtsgrundlage auf Nicht-Hochrisiko-Systeme erweitert; KMU-Erleichterungen auf Small Mid-Cap Enterprises (SMCs) ausgedehnt; formale Annahme durch Rat und Parlament vor dem 2. August 2026 angestrebt. Nachtrag zum in Lauf 001 vom 8. Mai 2026 noch nicht erfassten Stichtag — die Verhandlungsrunde wurde von ursprünglich 13. Mai 2026 auf 6./7. Mai 2026 vorgezogen. | § 4.3 (Aktualisierung des Digital-Omnibus-Passus: ersetzt die alte Formulierung „nächste Trilogrunde 13. Mai 2026" durch die vorläufige Einigung mit allen materiellen Eckpunkten); § 11.3 zwei neue Einträge (Pressemitteilung des EU-Rates vom 7. Mai 2026; Sammelbeleg Kanzlei-/Fachanalysen Bird & Bird / White & Case / Hogan Lovells / Latham & Watkins / TechPolicy Press / Lexology / Modulos); § 11.3 bisheriger Trilog-Eintrag um Hinweis auf die vorgezogene dritte Runde ergänzt; Aktualitätshinweis am Dokumentende mit konsolidierter Beschreibung; README.md mit neuem Versionseintrag 23.0. | Schließt eine in Lauf 001 vom 8. Mai 2026 nicht erfasste Lücke bei einem für die Steuerdebatte zentralen Ereignis: Die Stichtage 2027/2028 sind nun politisch festgezurrt, der Verkürzungspfad für die Transparenzpflichten nach Art. 50 Abs. 2 ist konkret, und die SMC-Erweiterung schafft eine neue, in § 4.4 relevante Kategorie europäischer Unternehmen. Für die in § 4.3/§ 4.4 referierte Anknüpfung steuerlicher Tatbestände an AI-Act-Kategorien ist die formelle Annahme die letzte rechtssetzungstechnische Hürde — die operative Planungsbasis liegt damit vor. |
| 2 | Meta-Layoff-Notification — Beginn der Mitarbeitendenbenachrichtigung am Mittwoch, 20. Mai 2026, ab 4 Uhr Ortszeit in drei Wellen für rund 8.000 Stellen; Memo von Vorstandsvorsitzendem Mark Zuckerberg „Success isn't a given" in der KI-Phase; rund 7.000 Beschäftigte werden in KI-fokussierte Rollen versetzt; 6.000 unbesetzte Stellen werden nicht mehr besetzt; betroffen sind nach Berichterstattung von Al Jazeera, NPR und CNBC Integrity-, Cybersecurity- und Content-Design-Teams; US-Beschäftigte erhalten 16 Wochen Grundabfindung zuzüglich zwei Wochen je Beschäftigungsjahr; zugleich meldet Meta Q1-2026-Rekord-Umsätze von 56,31 Mrd. USD und hebt die AI-Capex-Linie 2026 auf bis zu 145 Mrd. USD an. Quellen: Al Jazeera (20. Mai 2026), NPR (20. Mai 2026), CNBC (20. Mai 2026), Yahoo Finance (20. Mai 2026), Quartz (20. Mai 2026). | § 1.1 (die in Version 22.0 noch als „ab 20. Mai 2026" angekündigte Maßnahme wird auf den tatsächlichen Notification-Start, die drei-Wellen-Struktur, die parallele Streichung von 6.000 unbesetzten Stellen und Versetzung von 7.000 Beschäftigten, die betroffenen Teams sowie das Severance-Paket erweitert; die Personalreduktion wird ausdrücklich in den Kontext des Q1-2026-Rekord-Umsatzes und der auf 145 Mrd. USD angehobenen AI-Capex-Linie gestellt — Lesart als interne Ressourcen-Verlagerung); § 11.5 neuer Sammelbeleg „Al Jazeera / NPR / CNBC / Yahoo Finance / Quartz"; Aktualitätshinweis am Dokumentende ergänzt. | Die Maßnahme verdeutlicht die in § 1.1 entwickelte Asymmetrie zwischen Personalreduktion und Infrastrukturausbau in besonders zugespitzter Form: Meta reduziert die Belegschaft in einer Phase steigender Umsätze und Capex-Programme, was die Personalkostenlinie als Finanzierungsmechanismus der AI-Capex-Linie sichtbar macht. Für § 5.1 (Wertschöpfungsabgabe) und § 8.3 (Teilhabefonds) ist das ein empirisch verdichteter Anknüpfungspunkt, der das Maschinenkapital-Argument quantitativ untermauert. |
| 3 | Intuit-Layoff-Ankündigung — Streichung von rund 3.000 Stellen (etwa 17 % der weltweiten Belegschaft) am 20. Mai 2026; Restrukturierungsaufwand rund 300 Mio. US-Dollar; letzter Beschäftigungstag der Betroffenen 31. Juli 2026; Memo von Vorstandsvorsitzendem Sasan Goodarzi mit Begründung Konzernkomplexitäts-Reduktion und Fokus auf KI-Produkte; CFO Sandeep Aujla präzisierte, primär betroffen seien Koordinationsrollen wie Projektmanagement sowie mittlere und niedrigere Management-Ebenen; CEO Goodarzi gegenüber CNBC öffentlich: „None of it had to do with AI" — gleichwohl hat Intuit 2025 einen 100-Mio.-US-Dollar-Mehrjahresvertrag mit OpenAI geschlossen und arbeitet mit Anthropic an der KI-Integration der Hauptprodukte TurboTax, QuickBooks, Credit Karma und Mailchimp. Quellen: TechCrunch (20. Mai 2026), Quartz (20. Mai 2026), CBC News (20. Mai 2026), CNBC (20. Mai 2026), Inc. (21. Mai 2026), Breitbart (21. Mai 2026). | § 1.1 (Einarbeitung nach dem Walmart-Block: Intuit wird mit den exakten Zahlen, dem letzten Beschäftigungstag, dem Public-Framing „nothing to do with AI" und der zugleich dokumentierten Anthropic-/OpenAI-Integration in TurboTax/QuickBooks/Credit Karma/Mailchimp eingeführt — als Beleg für die Public-Framing-Spannung zwischen Kausalverneinung und produktstrategischer KI-Verlagerung); § 11.5 neuer Sammelbeleg „TechCrunch / Quartz / CBC News / CNBC / Inc."; Aktualitätshinweis am Dokumentende ergänzt. | Liefert ein methodisch wichtiges Gegenbeispiel zum monokausalen „AI labor crisis"-Frame (Coinbase, Freshworks, Cloudflare) und stützt damit die in der *Washington-Post*-Differenzierung vom 1. Mai 2026 entwickelte Mehrkanalerklärung. Für die in § 9.1 dokumentierten Messprobleme einer Typ-5-Ersatzabgabe ist die Aussage besonders relevant: Wenn selbst ein Konzern, der seine Produkte explizit mit KI integriert, die Personalreduktion nicht KI zuschreibt, wird die administrative Nachweisbarkeit „KI-bedingter Verdrängung" weiter erschwert. |
| 4 | Walmart-Stellenstreichung/-Verlagerung — Bekanntgabe am 12. Mai 2026 in einem internen Memo der Manager Daniel Danker (Head of Global AI Acceleration) und Suresh Kumar (Global Technology Chief) von rund 1.000 Konzern-Tech- und KI-Produktstellen, die unter einer einheitlichen globalen Technologie- und AI-Produktstruktur zusammengelegt werden; Begründung im Memo: Konsolidierung redundanter Teams und Beschleunigung der KI-getriebenen Transformation gegenüber Amazon, Costco und Aldi; ausdrücklich nicht als KI-Ersatz von Arbeitsplätzen gerahmt (im Unterschied zu IBM, Salesforce, Klarna, Duolingo, Meta und Microsoft). Quellen: Quartz (12. Mai 2026), Business Insider (12. Mai 2026), Meta Intro (Mai 2026). | § 1.1 (in den Aufzählungsteil nach Intuit als Gegenbeispiel zum „AI-replaces-jobs"-Framing eingegliedert — bewusste Abkehr vom Coinbase/Freshworks-Frame trotz expliziter „AI-driven transformation"-Begründung); § 11.5 neuer Sammelbeleg „Quartz / Business Insider / Meta Intro"; Aktualitätshinweis am Dokumentende ergänzt. | Zweiter prominenter Fall — neben Intuit — in dem die Kommunikationsstrategie bewusst nicht den KI-Verdrängungs-Frame nutzt, obwohl die strategische Konzentration auf KI ausdrücklich Teil des Memo-Texts ist. Für § 9.1 verschärft das die Mess- und Zuschreibungsprobleme einer zielgerichteten Ersatzabgabe (Typ 5 nach § 2.1): Selbst der größte Privatarbeitgeber der USA framt die Konsolidierung explizit nicht als KI-bedingt, obwohl die unternehmensinterne KI-Strategie offen kommuniziert wird. |
| 5 | TrueUp-Tracker — Tagesfortschreibung zum 27. Mai 2026: 143.985 betroffene Personen aus 342 Layoff-Meldungen (rund 993 Stellen pro Tag); Anstieg gegenüber dem 8.-Mai-Stand (127.411 / 283) primär gespeist durch Meta (rund 8.000 Stellen, Notification ab 20. Mai 2026), Intuit (rund 3.000 Stellen, Ankündigung 20. Mai 2026) und Walmart (rund 1.000 Stellen, Bekanntgabe 12. Mai 2026). Quelle: TrueUp (Stand 27. Mai 2026). | § 1.1 (Tagesfortschreibung der Tracker-Reihe in den bestehenden Block 25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 27. Mai 2026 eingegliedert); § 11.5 neuer Eintrag „TrueUp (Stand 27. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt. | Schließt die Tracker-Reihe an den Tag des Laufs an und bestätigt, dass das kumulative 2026-Niveau die Marke von rund 1.000 Stellen pro Tag im Jahresdurchschnitt knapp unterschreitet — ein nominales Niveau, das die in § 8.4 entwickelte Stabilitätslinie quantitativ unterfüttert, ohne den aggregiert moderaten Befund aus § 3.5 (Yale Budget Lab) umzukehren. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Tesla Optimus Pilot-Produktionslinie (Video 21. Mai 2026, Fremont): zwar im 7-Tage-Fenster (Cluster J), aber ohne unmittelbare politisch-fiskalische Implikation für die Steuerdebatte; Aufnahme bei späteren Massenfertigungs-Meilensteinen (Tesla strebt Massenfertigung Juli/August 2026 an und für die Erstgeneration eine Jahreskapazität von 1 Million Einheiten an — der entsprechende Stichtag wird im Lauf nach Massenfertigungs-Start aufgenommen).
- Connecticut SB 5 — Lamont-Unterzeichnung weiterhin nicht mit Datum belegt (Stand Recherche 27. Mai 2026); Pressespokesperson „intends to sign"; bestehender § 4.5-Block bleibt korrekt; in einem späteren Lauf nachzutragen, sobald die formale Unterzeichnung mit Datum dokumentiert ist.
- Bundesrat 1065. Sitzung 8. Mai 2026 (GKV-BStabG, Erstdurchgang) — der Bundesrat hat das Gesetz bislang nicht beschlossen; nach Berichterstattung ist das Vorhaben weiterhin im parlamentarischen Verlauf vor der Sommerpause 2026, bestehende Beschlusslage zum Recherchezeitpunkt nicht öffentlich verfügbar; bestehender § 5.2/§ 7-Aktualitätsverweis bleibt korrekt.
- Upwork-Layoff vom 7. Mai 2026 (rund 150 Stellen, etwa 24 % der Belegschaft) — außerhalb 7-Tage-Fenster; das Aggregat ist über die TrueUp-Reihe (27. Mai 2026) bereits implizit abgebildet; bei späterer Wiederaufnahme wird die Maßnahme als Sammelbeleg in § 11.5 nachgereicht.
- Cisco 4.000 Stellen (Mai 2026) — Datierung in Sekundärquellen nicht eindeutig (Yahoo Finance: „in May 2026"); ohne Primärquellen-Datierung im 7-Tage-Fenster nicht trennscharf einordbar; in einem späteren Lauf bei Primärquellen-Verfügbarkeit aufzunehmen.
- AI Workforce Training Act (H.R. 7576, Gottheimer/Lawler) — bereits in Lauf 001 (Kontext-Recherche) als „Februar 2026"-Vorlage erfasst; keine neue Bewegung zwischen 8. und 27. Mai 2026.
- Anthropic Economic Index Survey — keine neue Veröffentlichung zwischen Anfang Mai und 27. Mai 2026 (letzte Veröffentlichung „Learning curves" 24. März 2026 + Folgeband 23. April 2026); bestehender § 3.5-Block bleibt aktuell.
- Stanford HAI AI Index 2026 (13. April 2026) — außerhalb 7-Tage-Fenster; war bereits in Lauf 003 vom 7. Mai 2026 als „außerhalb 7-Tage-Fenster" markiert.
- Plattform-Digitalabgabe (Weimer) — keine Bewegung zwischen 8. und 27. Mai 2026; Eckpunktepapier weiterhin angekündigt, aber nicht vorgelegt; bestehender § 4.4-Block bleibt korrekt.
- Generationenkapital — keine neuen Tranchen- oder Renditeangaben zwischen 8. und 27. Mai 2026; bestehender § 8.6-Verweis bleibt aktuell.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide Treffer im 7-Tage-Fenster; Empfehlung für die nächsten Läufe bestehend (gezielter Abruf von g-ba.de Sitzungsergebnissen, gematik-Pressemitteilungen, BfArM-Listings).
- Cluster I (Frontier-Modelle) — keine neuen Frontier-Modell-Releases mit politisch-fiskalischer Implikation im 48-Stunden-Fenster.
- Cluster J (Robotik) — Tesla Optimus Pilot-Produktion (siehe oben); weitere humanoide Robotik (Figure, Boston Dynamics, Unitree) ohne Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster.
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; die neue Trilog-/Meta-/Intuit-/Walmart-/Tracker-Passage in § 4.3 und § 1.1 verweist über den bestehenden Kontext implizit auf § 4.4, § 5.1, § 8.3, § 8.4, § 9.1 und § 3.5 — diese Ziele existieren weiterhin. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind eine Aktualisierung des bestehenden Layoff-/Tracker-Blocks (§ 1.1) und des EU-AI-Act-Omnibus-Passus (§ 4.3); der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; keine neuen Tabellen oder Lead-Ins; bestehende Lead-Ins unverändert; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Trilog-Einigung 6./7. Mai 2026 in der EU-Rats-Pressemitteilung sowie in mindestens sieben Kanzlei-/Fach-Sekundärquellen konsistent dokumentiert; Meta-Notification 20. Mai 2026 und Zahlen (8.000 Stellen, drei Wellen, 16 Wochen Severance, 145 Mrd. USD Capex) in Al Jazeera/NPR/CNBC/Yahoo Finance/Quartz konsistent; Intuit 3.000 Stellen / 17 % / 300 Mio. USD / 31. Juli 2026 in TechCrunch/Quartz/CBC/CNBC konsistent; Walmart 1.000 Stellen / Memo Danker/Kumar in Quartz/Business Insider konsistent; TrueUp 143.985 / 342 wörtlich vom Tracker-Dashboard. |
| 2.2.2 Redundanzprüfung | OK | Die TrueUp-Reihe wird gemäß Claude.md § 4.2 als Tagesfortschreibung der bisherigen Stände (25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai → 27. Mai 2026) geführt — keine Doppelung. Meta-Block in § 1.1 ersetzt die alte „ab 20. Mai 2026"-Formulierung durch die tatsächliche Notification, ohne Inhalte zu duplizieren. Intuit, Walmart und die Trilog-Einigung sind in keinem Vorlauf erwähnt. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Intuit-/Walmart-Framing („nothing to do with AI" / „not AI-replacement") als zitierte Konzernaussagen gekennzeichnet (kein Autorenkommentar). Trilog-Einigung im Konjunktiv referiert, wo die formale Annahme noch aussteht (Claude.md § 4.2). |
| 2.2.4 Ausgewogenheit | OK | Die Cloudflare-/Coinbase-/Freshworks-Reihe (klares „AI"-Framing) wird durch Intuit und Walmart (explizit kein „AI"-Framing) gespiegelt; die in § 1.1 etablierte *Washington-Post*-Differenzierung bleibt erhalten und wird durch die zwei neuen Gegenbeispiele zusätzlich gestützt. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Provisional Agreement", „SMC", „CSAM", „Annex I/III", „Bias-Detection-Rechtsgrundlage" beim ersten Auftreten erklärt bzw. ausgeschrieben; bestehende Schreibweisen „TrueUp", „SkillSyncer", „VRSAR", „Capex" einheitlich; APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Trilog-Einigung-Belegcluster (Pressemitteilung Rat der EU) und Kanzleisammelbeleg (Bird & Bird et al.) als neue Einträge in § 11.3; bestehender Trilog-Eintrag in § 11.3 um Hinweis auf die vorgezogene dritte Runde ergänzt; Meta-/Intuit-/Walmart-/TrueUp-27.-Mai-Belege als neue Einträge in § 11.5; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Trilog-Einigung: Primärquelle ist die Pressemitteilung des EU-Rates vom 7. Mai 2026, sekundär Bird & Bird, White & Case, Hogan Lovells, Latham & Watkins, IAPP, TechPolicy Press, Lexology, Modulos. Meta-Notification: Primärquellen sind Meta-interne Memos (von NPR/CNBC zitiert) und Q1-2026-Earnings-Call. Intuit: Primärquelle ist die Intuit-interne Mitteilung von CEO Goodarzi (von TechCrunch/Quartz/CBC/CNBC zitiert). Walmart: Primärquelle ist das interne Memo Danker/Kumar (von Quartz/Business Insider zitiert). TrueUp: Primärquelle ist das öffentlich zugängliche Tracker-Dashboard. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: consilium.europa.eu/en/press/press-releases/2026/05/07/artificial-intelligence (403, gleichwohl Headline und Inhalt durch parallele Berichterstattung konsistent); twobirds.com/en/insights/2026/digital-omnibus-on-ai-provisional-agreement-reached-at-the-may-trilogue (öffentlich, Inhalt konsistent); aljazeera.com/economy/2026/5/20/meta-cuts-8000-jobs-in-sweeping-global-layoffs (öffentlich); techcrunch.com/2026/05/20/intuit-to-lay-off-over-3000-employees-to-refocus-on-ai/ (öffentlich); qz.com/walmart-layoffs-tech-product-jobs-restructuring-051326 (öffentlich); trueup.io/layoffs (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Trilog (Stichtag 2. Dezember 2027 Anhang III, 2. August 2028 Anhang I, 3 Monate Übergangsfrist Art. 50 Abs. 2, Stichtag 2. Dezember 2026 für Bestandssysteme, SMC-Erweiterung) wörtlich aus der EU-Rats-Pressemitteilung; Kernzahlen Meta (8.000 Stellen, drei Wellen ab 4 Uhr Ortszeit, 16 Wochen + 2 Wochen je Jahr, 6.000 unbesetzte Stellen, 7.000 Versetzungen, 56,31 Mrd. USD Umsatz, 145 Mrd. USD Capex) wörtlich aus den Al-Jazeera-/NPR-/CNBC-/Yahoo-Finance-/Quartz-Texten; Kernzahlen Intuit (3.000 Stellen / 17 %, 300 Mio. USD, 31. Juli 2026, 100-Mio.-USD-OpenAI-Vertrag 2025) wörtlich aus TechCrunch/Quartz/CBC/CNBC; Walmart (1.000 Stellen, Danker/Kumar) wörtlich aus Quartz/Business Insider; TrueUp (143.985 / 342 / 993 pro Tag) wörtlich vom Tracker-Dashboard. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Sammelbelege benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen, in allen Fällen Verfügbarkeit mindestens einer Primärquelle oder offiziellen Pressemitteilung). |
...
Keine — die fünf Ergänzungen sind Tagesaktualisierungen und Nachträge zu einer bestehenden Linie ohne Korrekturbedarf an anderen Aussagen. Allerdings musste eine in Lauf 001 vom 8. Mai 2026 noch korrekt formulierte Stelle in § 4.3 („Die nächste Trilogrunde ist auf den 13. Mai 2026 terminiert") an die zwischenzeitlich erfolgte vorgezogene Einigung angepasst werden — dies ist eine reguläre Tagesaktualisierung, kein Fehler.
