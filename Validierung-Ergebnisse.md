...
## Validierung 29. Juni 2026 (Lauf 001 vom 29. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf nach der mehrwöchigen Pause seit dem 8. Mai 2026 (Version 22.0). Web-Recherche im Korridor der Cluster A–J am 29. Juni 2026: Optimalsteuer- und Aufgabenforschung (Cluster A); DE/EU-Robotersteuer/Wertschöpfungsabgabe (Cluster B); internationale Praxis (Cluster C); Policy-Initiativen Sanders/OpenAI/Anthropic (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten DE (Cluster E); Tech-Layoffs / KI-Capex (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle und Marktstruktur (Cluster I); Robotik (Cluster J). Zwölf belegbare Treffer im Recherchefenster identifiziert und in das Hauptdokument eingearbeitet (Sanders American AI Sovereign Wealth Fund Act 18. Juni 2026; Anthropic Economic Policy Framework und Amodei-Essay 10. Juni 2026; Bloomberg-Tax-Einordnung Anthropic 10. Juni 2026; Alterssicherungskommission-Bericht 24. Juni 2026; Bundestags-GKV-Anhörung 22. Juni 2026; Weimer Plattform-Solidaritätsabgabe / #beBETA 2026; EU Digital Omnibus on AI EP-Annahme 16. Juni 2026; Connecticut SB 5 Lamont-Unterzeichnung 27. Mai 2026; Anthropic Economic Index „Cadences" Juni 2026; Challenger Mai-2026-Job-Cuts-Report 5. Juni 2026; TechCrunch Running List 22. Juni 2026; SkillSyncer-Trackerstand 27. Juni 2026; Microsoft-VRSAR-Vollzug 2. Juli 2026 mit Vorbehalt). Cluster G, H, I, J ohne neue belegbare Treffer im Recherchefenster.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Sanders, *American AI Sovereign Wealth Fund Act* (18. Juni 2026): einmalige 50-%-Aktienabgabe auf KI-Firmen > 200 Mio. USD Umsatz, Treuhandfonds mit präsidial nominierten und Senats-bestätigten Mitgliedern, geschätzter Fondswert rund 7 Bio. USD, jährliche Bürgerdividende rund 1.000 USD, Public Voting Stake; erfasst Datacenter, Compute-Infrastruktur und „advanced robotics". Quellen: sanders.senate.gov (Pressemitteilung), Roll Call (Detail-Coverage), Axios (politische Einordnung). | § 4.5 (Sanders-Block: neue Sub-Passage zum Sovereign-Wealth-Fund-Ansatz); § 11.3 drei neue Einträge; Aktualitätshinweis am Dokumentende; README.md mit Versionseintrag 23.0. | Erster US-Senatsentwurf, der an die Eigentumsstruktur (Aktienstake) statt an Umsatz oder Gewinn anknüpft — eine alternative Mechanik zu Robotersteuer im engeren Sinn; konzeptionell die US-Variante des in § 5.4 entwickelten Staatsfondsmodells. Robotik ist im Tatbestand explizit benannt, was die deutsche Robotersteuer-Debatte direkt berührt. |
| 2 | Anthropic *Economic Policy Framework* (10. Juni 2026) + Amodei-Essay *„Policy on the AI Exponential"*: gestufte Skalenarchitektur fiskalischer Reaktion mit Schwellen 5 %/10 %/„beispiellos" Arbeitslosigkeit; zur Diskussion gestellte 3-%-Steuer auf den eigenen KI-Umsatz; Selbstverpflichtung 350 Mio. USD (200 Mio. *Economic Futures Research Fund* + 150 Mio. *Claude Corps Fellowship*, Bewerbungsschluss 17. Juli 2026, 100 Plätze, 85.000 USD/Jahr). Bloomberg-Tax-Einordnung (10. Juni 2026). | § 4.5 (neuer Block „Anthropic-Doppelpaket"); § 11.3 drei neue Einträge (Framework, Amodei-Essay, Bloomberg Tax); Aktualitätshinweis. | Erstmals schlägt ein führendes Frontier-Labor selbst eine Selbstbesteuerung in einem strukturierten Politikpapier vor — Kontrast zum OpenAI-Vorschlag (April 2026), der die Last konzeptionell auf Anwender verschiebt. Konzeptionell näher an der Wertschöpfungsabgaben-Logik (§ 5.1). |
| 3 | Alterssicherungskommission (ASK) — Abschlussbericht 24. Juni 2026 (BMAS-Faktenpapier 23. Juni 2026): 33 Reformempfehlungen; gesetzliche Kapitalrente, Erwerbstätigenversicherung (Einbeziehung von Selbständigen, Beamten, Abgeordneten, Vorständen), Anpassung Renteneintrittsalter, Abschaffung Minijob-Sonderstatus zugunsten einer einheitlichen Beitragspflicht ab dem ersten Euro. | § 5.2 (Ergänzung des ASK-Blocks um die Übergabe und die 33 Empfehlungen mit drei paradigmatischen Stellschrauben); § 11.3 neuer Eintrag; Aktualitätshinweis. | Erstmals konsensgetragener Regierungsvorschlag, der das in § 5.1 entwickelte Konzept der breiten Bemessungsbasis programmatisch unterlegt. Erweitert die Beitrags- und Aufkommensbasis der Sozialversicherung, ohne die Anknüpfung an KI-Wertschöpfung zu lösen. |
| 4 | Bundestag Gesundheitsausschuss (Kalenderwoche 26 / 22. Juni 2026): rund zweieinhalbstündige öffentliche Anhörung zum GKV-Beitragssatzstabilisierungsgesetz; mehr als 90 Fachverbände, Sozialverbände und Gewerkschaften kritisieren einseitige Belastung der Versicherten und fehlende Einnahmenseite. | § 5.2 (Ergänzung des GKV-Reform-Blocks um die Anhörung); § 11.5 neuer Eintrag. | Direkter Bezug zum bereits dokumentierten BStabG-Prozess; argument pro alternative Finanzierungsquellen (KI/Wertschöpfung). |
| 5 | Kulturstaatsminister Weimer auf der *#beBETA 2026* (BDZV): begriffliche Verschiebung des deutschen Vorschlags von „Digitalabgabe" auf „Plattform-Solidaritätsabgabe" als „ordoliberaler Eingriff" / zweckgebundene Sonderabgabe; Zusatzbegründung Schutz journalistischer Inhalte vor KI-Training. | § 4.4 (Ergänzung des Plattform-Digitalabgabe-Blocks um die rhetorische Verschiebung); § 11.5 neuer Eintrag. | Fiskaljuristisch zentrale Unterscheidung Steuer vs. Sonderabgabe wird offen zur Kernbegründung des deutschen Konzepts — macht das Konzept anschlussfähig an die Wertschöpfungsabgaben-Logik (§ 5.1). |
| 6 | EU Digital Omnibus on AI: Trilog-Konsens 7. Mai 2026, EP-Plenarannahme 16. Juni 2026; Ratsannahme vor 30. Juni 2026 angestrebt; Stichtage 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); „hard wall" 2. August 2026 unverändert. | § 4.4 (Ergänzung des OECD-Pillar-/EU-Sekundärrecht-Blocks); § 11.3 neuer Eintrag (Bird & Bird). | Eine zukünftige fiskalische Anknüpfung an Hochrisiko-KI-Tatbestände setzt einen verlässlichen sekundärrechtlichen Rahmen voraus; Trilog-Konsens verschiebt den frühest möglichen Anknüpfungszeitpunkt um rund 16 Monate. |
| 7 | Connecticut SB 5 — Gouverneur Lamont hat das *Connecticut Artificial Intelligence Responsibility and Transparency Act* am 27. Mai 2026 unterzeichnet (im Lauf 001 vom 8. Mai 2026 als offener Punkt markiert). | § 4.5 (Connecticut-Block: Ergänzung um Unterzeichnungs-Datum); § 11.3 neuer Eintrag. | Schließt den im letzten Lauf offen gehaltenen Punkt; WARN-AI-Disclosure-Pflicht zum 1. Oktober 2026 wird damit Recht. |
| 8 | Anthropic *Economic Index report „Cadences"* (Juni 2026): rund 9.700 verlinkte Survey-Antworten Mai/Anfang Juni 2026; Claude-Nutzung folgt globalen Arbeitsrhythmen; Anstieg agentischer Tasks via Claude Code/Cowork; Heavy-User systematisch optimistischer bzgl. Job-Sicherheit und Gehaltsentwicklung. | § 3.5 (Anthropic-Economic-Index-Block: dritte Index-Iteration ergänzt); § 11.1 neuer Eintrag. | Erste linkage von Survey-Selbstauskünften und tatsächlichen Nutzungsdaten — stützt die *Produktivitäts-Angst-Paradoxie* aus der 81k-Befragung jetzt aggregatfest. |
| 9 | Challenger, Gray & Christmas — *May 2026 Job Cuts Report* (5. Juni 2026): 97.006 angekündigte Streichungen (+16 % gegenüber April; höchster Mai seit 2020); KI-bezogen 38.579 (40 % aller Mai-Streichungen, höchster jemals erfasster Monatswert); YTD KI-bezogen 87.714 (rund 22 % aller bislang im Jahr 2026 angekündigten Streichungen, übersteigt Gesamtjahr 2025 mit 54.836). | § 1.1 (Ergänzung um den Mai-Report nach dem dokumentierten April-Report); § 11.5 neuer Eintrag. | Eskalation der KI-Verdrängungs-Aggregatlinie; bestätigt die in § 3.5 referierte sektorale Frühwirkung, ohne den aggregiert moderaten Arbeitsmarkt-Befund umzukehren. |
| 10 | TechCrunch — *The running list: major tech layoffs in 2026 where employers cited AI* (22. Juni 2026): aktualisierte Sammelliste KI-attribuierter Tech-Layoffs 2026; Oracle ~21.000 / 13 %, GitLab ~350 / 14 % (explizit zur Finanzierung von KI-Infrastruktur), ServiceNow „hundreds". | § 1.1 (Ergänzung um Oracle-Größenordnung und GitLab-Bezug); § 11.5 neuer Eintrag. | Erweitert die in § 1.1 etablierte Layoff-Reihe um Hyperscaler-Einzelangaben (Oracle 21.000 / 13 % global) — Asymmetrie-Linie Personal/Capex zusätzlich gestützt. |
| 11 | SkillSyncer-Tracker — Stand 27. Juni 2026: 185.894 betroffene Beschäftigte aus 267 Layoff-Ereignissen (rund 1.044 Stellen pro Tag); 56 % aller Ereignisse mit explizitem KI-/Automation-/ML-Bezug (156.270 Beschäftigte in 150 Unternehmen). | § 1.1 (Ergänzung der Tracker-Reihe); § 11.5 neuer Eintrag. | Erste dauerhafte Tausender-Tagesschwelle; methodisch starker Datenpunkt zur KI-Quote (56 %) der Layoff-Ereignisse. |
| 12 | Microsoft-VRSAR-Vollzug 2. Juli 2026 (PBS News / Bloomberg, Anfang Juli 2026): erster regulärer *Separation Date* des Programms; im Vorlauf gemeldete zusätzliche Welle mit Schwerpunkt Xbox/Gaming/Sales/Hardware unter neuer Xbox-CEO Asha Sharma; konkrete Stellenzahl konzernseitig zum Schnitt des Laufs nicht bestätigt (Hinweis auf vorläufigen Stand in § 1.1). | § 1.1 (Ergänzung mit explizitem Vorbehalt); § 11.5 neuer Eintrag. | Vollzieht den im letzten Lauf angekündigten *Separation Date* und liefert den ersten Anhaltspunkt für die finale Größenordnung des Programms — kanonischer Endpunkt der Microsoft-VRSAR-Reihe. Das Datum (2. Juli 2026) liegt knapp außerhalb des engen 7-Tage-Fensters; die Aufnahme erfolgt als Ausnahme im Rahmen des direkten Anschlusses an einen bereits dokumentierten Sachverhalt mit klarer Kennzeichnung als vorläufig. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Anthropic *Cadences*-Survey-Detailauswertungen jenseits der Aggregatzahlen — werden in nachfolgenden Index-Berichten erwartet; im nächsten Lauf zu prüfen.
- Sanders *Artificial Intelligence Data Center Moratorium Act* (S. 4214) — bereits in Version 8.0 erfasst; keine Bewegung im Recherchefenster.
- OpenAI-Folgeveröffentlichungen Mai/Juni 2026 — keine über den im April 2026 vorgelegten Strategiepapier hinausgehende substantive Veröffentlichung im Recherchefenster.
- Generationenkapital — keine neuen Tranchen- oder Renditeangaben im Recherchefenster; bestehender § 8.6-Verweis bleibt aktuell.
- Cluster G (Gesundheitswesen) — weiterhin ohne KI-spezifische neue G-BA-Beschlüsse oder DiGA-Listings im 7-Tage-Fenster (fünftes Mal in Folge); Beobachtung fortsetzen.
- Cluster H (Deutschland-These-Bezugspunkte) — keine neuen Studien zur deutschen KI-Wertschöpfungsposition mit Mai/Juni-2026-Datum identifiziert.
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; neue Passagen verweisen auf § 5.1, § 5.4, § 8.3, § 8.4, § 3.5, § 9.1 — alle Ziele existieren weiterhin. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind eine Aktualisierung der bestehenden Linie: Sanders-/Anthropic-Initiative in § 4.5 verlängert die Policy-Achse, ASK-Bericht in § 5.2 vertieft die Bürgerversicherung, Layoff-Updates in § 1.1 schreiben die Tracker-Reihe fort. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-AI-Sovereign-Wealth-Fund-Eckdaten (50 %, > 200 Mio. USD, rund 7 Bio. USD, rund 1.000 USD Bürgerdividende, 7 Treuhänder) konsistent in sanders.senate.gov, Roll Call und Axios; Anthropic-Framework (3 %, 200/150 Mio. USD, 100 Plätze, 85.000 USD/Jahr) konsistent in Anthropic-Primärquelle und Bloomberg Tax; ASK-Bericht (33 Empfehlungen, gesetzliche Kapitalrente, Erwerbstätigenversicherung, Minijob-Reform) wörtlich aus der Bundesregierung-PDF und dem BMAS-Faktenpapier; Challenger-Mai-Zahlen (97.006, 38.579, 40 %, YTD 87.714) wörtlich aus dem Challenger-Originalreport; SkillSyncer-Stand wörtlich vom Tracker-Dashboard. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Sovereign-Wealth-Fund-Ansatz ist eigenständige neue Mechanik; nicht redundant mit dem in § 5.4 dargestellten OpenAI-Staatsfondsmodell, sondern als US-Variante explizit darauf bezogen. Anthropic-Block neu; nicht redundant mit OpenAI-Block. ASK-Empfehlungen schreiben den bestehenden ASK-Block in § 5.2 fort, ohne Doppelung der Bürgerversicherungs-Grundidee. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert; Anthropic-3-%-Vorschlag im Konjunktiv referiert („zur Diskussion gestellt"); ASK-Empfehlungen als Modellvorschläge benannt, nicht als beschlossene Reformen. |
| 2.2.4 Ausgewogenheit | OK | Anthropic-Vorschlag wird kritisch eingeordnet (Mess- und Kausalitäts­probleme der Auslösemechanik); Sanders-Sovereign-Wealth-Fund als „Signalgebung mit geringer Annahmewahrscheinlichkeit" referenziert; ASK-Bericht und Bundestags-Anhörung jeweils mit Kritik der Verbände kontextualisiert. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Plattform-Solidaritätsabgabe" und „ordoliberaler Eingriff" als Weimer-Zitate in Anführungszeichen; „agentic AI" konsistent in Anführungszeichen; „Erwerbstätigenversicherung", „gesetzliche Kapitalrente" als deutsche Fachbegriffe ohne Anführungszeichen; APA-konforme Quellenangabe für alle zwölf neuen Belege. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Alle zwölf neuen Quellen sind in § 11.1 (Anthropic Cadences), § 11.3 (Sanders, Anthropic Framework/Amodei/Bloomberg Tax, ASK, Bird & Bird, CT-Gouverneur) und § 11.5 (Challenger Mai, TechCrunch, SkillSyncer, PBS/Bloomberg Microsoft, Kulturigo/BDZV, Bundestag) zugeordnet; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders: Primärquelle ist die Pressemitteilung des US-Senats. Anthropic: Primärquellen sind das Anthropic-Posting und das Begleit-PDF, von Bloomberg Tax referiert. ASK: Primärquellen sind das Bundesregierung-PDF und das BMAS-Faktenpapier. Challenger: Primärquelle ist der Original-Report. SkillSyncer/TechCrunch: öffentlich zugängliche Tracker bzw. Sammelliste. Bundestag/CT-Gouverneur: jeweils Pressemitteilung der Institution. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs (sanders.senate.gov, anthropic.com/research/economic-policy-responses, bundesregierung.de Bericht-PDF, bundestag.de kw26-pa-gesundheit, challengergray.com Mai-Report-PDF, skillsyncer.com/layoffs-tracker, portal.ct.gov/governor) ohne Fehler; einige Sekundärquellen (Bloomberg, Axios) hinter Paywall, Headline und Lead-Sätze öffentlich verifizierbar. |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Sanders (50 % Aktienstake, 200 Mio. USD Umsatzschwelle, 7 Bio. USD Fondswert, 1.000 USD Dividende, 7 Treuhänder), Anthropic (3 % Steuer, 200/150 Mio. USD Self-Commit, Schwellen 5 %/10 %), ASK (33 Empfehlungen, Erwerbstätigenversicherung, Kapitalrente, Minijob), Challenger (97.006 / 38.579 / 40 % / YTD 87.714), SkillSyncer (185.894 / 267 / 1.044, 56 %) wörtlich aus den jeweiligen Primärquellen übernommen. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert; PBS/Bloomberg Microsoft-Xbox-Welle ausdrücklich als „vorläufig, Stellenzahl konzernseitig nicht bestätigt" gekennzeichnet — keine eigene Verifizierungsmarkierung im Literaturverzeichnis, weil die Aussage in § 1.1 selbst den Vorbehalt führt. |
...
Keine — die zwölf Ergänzungen sind Aktualisierungen oder Verlängerungen bestehender Linien ohne Korrekturbedarf an anderen Aussagen.
