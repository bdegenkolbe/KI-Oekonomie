...
## Validierung 9. Juni 2026 (Lauf 002 vom 9. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Zweiter regulärer Daily-Update-Lauf nach Lauf 001 vom 8. Mai 2026. Web-Recherche im Korridor der Cluster A–J am 9. Juni 2026: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Fünf belegbare Treffer im Zeitfenster (Schließung von zwei zuvor offenen Items und drei neue Tagesentwicklungen) identifiziert und eingearbeitet (Sanders *American AI Sovereign Wealth Fund Act* vom 3. Juni 2026; Altman-Washington-Reise vom 3. Juni 2026; Connecticut SB 5 Lamont-Unterzeichnung am 29. Mai 2026; EU AI Act Digital Omnibus Trilog-Einigung vom 6. Mai 2026, vom Rat am 13. Mai 2026 bestätigt; Challenger *May-2026-Job-Cuts-Report* vom 4. Juni 2026; TrueUp-Tagesstand 9. Juni 2026; Salesforce-Customer-Support-Konkretisierung).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Bernie Sanders — Ankündigung des *American AI Sovereign Wealth Fund Act* am 3. Juni 2026: einmalige 50 %-Stocksteuer an OpenAI, Anthropic, xAI und weiteren führenden US-KI-Anbietern zugunsten eines öffentlichen Staatsfonds mit Stimmrechten, paritätischer Verwaltungsratsvertretung, Direktauszahlungen an Bürgerinnen und Bürger und mittelfristiger Finanzierung universeller Programme (Gesundheit, Bildung, Wohnen); flankierender HELP-Bericht *„The Big Tech Oligarchs' War Against Workers"* mit Fortschreibung der Schätzung von rund 100 Mio. bedrohten US-Stellen über eine Dekade. Förmliche Einbringung als Gesetzentwurf „in den kommenden Wochen" angekündigt. Quellen: The Hill, Fortune, Newsweek, Reason, Fox Business (3.–6. Juni 2026). | § 4.5 (Ergänzung des Sanders-Blocks; Verortung als eigentumsbezogene Anknüpfung im Sinne von Typ 4 nach § 2.1 und als US-Parallele zur Teilhabe-Säule der Deutschland-These § 8.3); § 11.3 neuer Eintrag *Sanders, B. (3. Juni 2026). American AI Sovereign Wealth Fund Act — Ankündigung*; Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versionseintrag 23.0. | Erster politischer US-Bundesvorstoß, der nicht nur die Erträge, sondern die Eigentumsstruktur führender KI-Anbieter zur Disposition stellt; Spiegelbild zur in § 5.4 referierten Staatsfonds-Argumentation des OpenAI-Strategiepapiers vom April 2026 und zur Teilhabe-Säule der Deutschland-These (§ 8.3) — konzeptionell anschlussfähig für die deutsche Debatte, ohne die Verarbeitungs-/Veredelungsfrage zu adressieren. |
| 2 | Sam Altman (OpenAI) — Washington-Reise am 3. Juni 2026: Treffen mit House Speaker Mike Johnson, Minority Leader Hakeem Jeffries und Vertretern der Trump-Administration; angekündigtes Gespräch mit Sanders zur Verteilung KI-induzierter Wohlstandsgewinne; gleichzeitige Ablehnung verbindlicher Vorab-Zulassung von KI-Modellen, Plädoyer für freiwilliges Safety-Testing-Regime mit dem U.S. Department of Commerce. Quellen: CNBC (3. Juni 2026), Claims Journal (4. Juni 2026). | § 4.5 (in den Sanders-/OpenAI-Komplex integriert); § 11.3 neuer Eintrag *Altman, S. / OpenAI (3. Juni 2026)*; Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versionseintrag 23.0. | Dokumentiert die zeitgleiche Konvergenz von Sanders/OpenAI auf die Teilhabe-Frage bei fortbestehender Divergenz in der Regulierungsfrage; konkretisiert die in § 4.5 dokumentierte Agenda-Setting-Linie des OpenAI-Strategiepapiers vom April 2026. |
| 3 | Connecticut SB 5 — Gouverneur Ned Lamont hat den am 1. Mai 2026 vom Repräsentantenhaus (131 zu 17) verabschiedeten *Connecticut Artificial Intelligence Responsibility and Transparency Act* am 29. Mai 2026 unterzeichnet; gestaffelte Geltungsdaten (1. Oktober 2026 / 1. Januar 2027 / 1. Oktober 2027 / 1. Januar 2028) bestätigt. Quellen: Holland & Knight (Juni 2026), DLA Piper (Mai 2026), Ogletree, WilmerHale (4. Juni 2026), Davis Wright Tremaine. | § 4.5 (Aktualisierung: „angekündigte Unterzeichnung" wird zur „erfolgten Unterzeichnung am 29. Mai 2026" mit Kanzleianalysen als Beleg); Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versionseintrag 23.0. | Schließung eines in Lauf 001 vom 8. Mai 2026 als „nächster Lauf zu prüfen" markierten Items; die Geltungsregelung für die WARN-AI-Disclosure-Pflicht ab 1. Oktober 2026 ist gleichzeitig der für die Steuerdebatte zentrale Mechanismus (vgl. § 9.1 Messprobleme einer Typ-5-Ersatzabgabe). |
| 4 | EU AI Act Digital Omnibus — Trilog-Einigung am 6. Mai 2026, vom Rat (Vertretern der Mitgliedstaaten) am 13. Mai 2026 bestätigt: Anhang-III-Hochrisiko-Pflichten verschoben auf 2. Dezember 2027, Anhang-I-Pflichten auf 2. August 2028, AI-Regulatory-Sandbox-Frist auf 2. August 2027; neues Art.-5-Verbot KI-generierten nicht-konsensualen intimen Bildmaterials und Materials sexuellen Kindesmissbrauchs (Geltung 2. Dezember 2026); förmliche Adoption für Juni/Juli 2026 erwartet. Quellen: Pressemitteilung Rat der EU (7. Mai 2026), Kanzleianalysen Bird & Bird, Gibson Dunn, White & Case, Hogan Lovells, Addleshaw Goddard, Travers Smith (Mai 2026). | § 4.3 (Aktualisierung: aus „nächste Trilogrunde 13. Mai 2026" wird „vorläufige Einigung am 6. Mai 2026, Council-Bestätigung 13. Mai 2026" mit konkreten Verschiebungs-Stichtagen, neuen Verboten und Adoptions-Zeitplan); § 11.3 neuer Eintrag *Rat der Europäischen Union (7. Mai 2026)*; Aktualitätshinweis am Dokumentende ergänzt. | Schließung eines in Lauf 001 vom 8. Mai 2026 als „liegt nach Stichtag" markierten Items; die endgültige Verschiebung der Anhang-III-Hochrisiko-Pflichten auf den 2. Dezember 2027 verlängert den in § 4.3 dokumentierten zeitlichen Vorlauf für KI-Definitionen aus dem AI Act, ohne die Anknüpfungslogik selbst zu verändern. |
| 5 | Challenger, Gray & Christmas — *May-2026-Job-Cuts-Report* vom 4. Juni 2026: Mai-2026-Streichungen 97.006 (+16 % gegenüber April, +3 % gegenüber Mai 2025, höchster Mai seit 2020); KI-bezogen 38.579 (40 % der Mai-Streichungen, erstmals absoluter Spitzenwert; KI führt den dritten Monat in Folge die Gründerangaben an; Monatsanteil 7 % (Jan.) → 25 % (März) → 26 % (April) → 40 % (Mai)); YTD KI-bezogen 87.714, übertrifft den vollständigen Vorjahreswert 2025 (54.836) um mehr als 60 %; Tech-Sektor Mai 38.242 (höchster Monatswert seit August 2024) / YTD 123.653 (+66 % gegenüber Vergleichszeitraum 2025); YTD-Gesamtvolumen 397.755 (−43 % gegenüber 2025). Quellen: Challenger Gray (4. Juni 2026), CNBC (5. Juni 2026); ergänzend TrueUp-Tagesstand 9. Juni 2026 (149.935 Personen aus 363 Layoff-Meldungen, rund 974 Personen pro Tag) und Salesforce-Konkretisierung (Kundendienst rund 9.000 → 5.000, rund 50 % aller Kundenkontakte durch KI-Agenten). | § 1.1 (Verlängerung der KI-Verdrängungslinie um den Mai-Aggregat-Befund, den TrueUp-Stand 9. Juni 2026 und die Salesforce-Konkretisierung; mit Beibehaltung der methodischen Vorsicht aus der *Washington-Post*-Differenzierung vom 1. Mai 2026); § 11.5 neue Einträge „Challenger / CNBC" (May-2026-Report), „TrueUp (Stand 9. Juni 2026)" und „Salesforce / Benioff (Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit Versionseintrag 23.0. | Die KI-Anteilssteigerung auf 40 % im Mai (von 26 % im April) und das Übertreffen des Vollvorjahreswerts in fünf Monaten verschärfen die in § 1.1 dokumentierte Asymmetrie zwischen Personalreduktion und KI-Capex (725 Mrd. USD); die Salesforce-Konkretisierung liefert das bislang exakteste Mengengerüst zu KI-Agenten in einem Kundensegment einer US-Großorganisation (50 % aller Kontakte). |

**Nicht aufgenommen (bewusste Auslassungen):**
- Korinek & Lockwood (NBER WP 34873) *„Public Finance in the Age of AI: A Primer"* (Februar 2026, Brookings-Konferenz): außerhalb des 7-Tage-Fensters; konzeptionell relevant für § 3, in einem späteren Vertiefungslauf einzuarbeiten — als Marker im Logbuch festgehalten.
- Hamilton-Project-Papier Acemoglu/Autor/Johnson (Februar 2026) — bereits in Version 16.0 / § 4.5 referenziert.
- Anthropic Economic Index — keine neue Index-Veröffentlichung im 48-Stunden-Fenster (Massenkoff-/McCrory-Befund von März 2026 in § 3.5 bereits referiert).
- Reason-Artikel zur Sanders-Initiative (2. Juni 2026) und R-Street-Institute-Kommentar als kritische Gegenstimmen zum Sanders-Vorstoß: thematisch relevant, aber als Meinungsbeiträge eingestuft — die in § 4.5 bereits referierte *Bloomberg-Editorial*-Linie deckt den ökonomischen Einwand gegen eine KI-Steuer aus mainstream-finanzpublizistischer Sicht ab; eine zusätzliche libertäre Stimme würde keine neue Argumentationsachse hinzufügen.
- GKV-Beitragssatzstabilisierungsgesetz — Bundestag-Behandlung für 12. Juni 2026 angekündigt, zweiter Bundesratdurchgang für 10. Juli 2026: Termine liegen nach dem Stichtag 9. Juni 2026; in einem späteren Lauf nachzutragen.
- Polnische *ulga na robotyzację* Verlängerungs-/Aufstockungsentwurf — keine Bewegung über Version 16.0 hinaus zwischen 8. Mai und 9. Juni 2026; bestehender § 6.3-Block bleibt aktuell.
- Generationenkapital — keine neuen Tranchen- oder Renditeangaben; bestehender § 8.6-Verweis bleibt aktuell.
...
- Cluster I (Frontier-Modelle) und Cluster J (Robotik) im 48-Stunden-Fenster ohne politisch-fiskalisch relevante Tagesmeldungen mit Steuerbezug.
...
| 2.1.3 Querverweise | OK | Neue Sanders-Passage verweist explizit auf § 2.1 (Typ 4), § 5.4 (OpenAI-Staatsfonds), § 8.3 (Teilhabe-Säule der Deutschland-These) — alle Ziele existieren. Aktualisierung in § 4.3 (Digital Omnibus) und § 4.5 (Connecticut SB 5 Unterzeichnung) bewahrt bestehende Querverweise. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind eine Aktualisierung des bestehenden § 4.3-Trilog-Blocks, des § 4.5-Sanders-Blocks und der § 1.1-KI-Verdrängungslinie; der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. Die Sanders-Eigentumsanknüpfung erweitert das § 4.5-Typ-Spektrum aus § 2.1 in der radikalsten denkbaren Form. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; keine neuen Tabellen oder Lead-Ins; bestehende Lead-Ins unverändert; Versionszeile im Dokumentkopf (22.0 → 23.0) und Stand-Angabe (Mai → Juni 2026) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Stocksteuer 50 % und Mechanismus (Stocktransfer, Stimmrechte, Verwaltungsratsvertretung, Direktauszahlungen, Universalprogramme) in mehreren unabhängigen Quellen (The Hill, Fortune, Newsweek, Reason, Fox Business) konsistent; Connecticut SB 5 Unterzeichnungsdatum (29. Mai 2026) und Geltungsdaten (1.10.2026 / 1.1.2027 / 1.10.2027 / 1.1.2028) wörtlich aus mehreren Kanzleianalysen; Digital Omnibus Postponement-Stichtage (2.12.2027 / 2.8.2028 / 2.8.2027) wörtlich aus der Council-Pressemitteilung vom 7.5.2026; Challenger-Zahlen Mai 2026 (97.006 / 38.579 / 40 %, YTD KI 87.714, Tech Mai 38.242 / YTD 123.653) wörtlich aus dem Challenger-Originalreport und CNBC-Wiedergabe. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Folgeinitiative wird neben (nicht statt) der bereits dokumentierten Robotersteuer- und Moratoriums-Linie geführt; die KI-Capex-/Personalreduktion-Asymmetrie wird durch den May-Report verlängert, nicht doppelt referiert; die Aktualisierung des § 4.3-Trilog-Stands ersetzt die Vor-Einigungs-Formulierung sauber. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Sanders-Stocksteuer als eigentumsbezogene Form von Typ 4 explizit eingeordnet, nicht mit Typ 5 (Ersatzabgabe) vermengt. Aussagen aus dem Sanders-Entwurf werden im Konjunktiv referiert (Claude.md § 4.2). |
| 2.2.4 Ausgewogenheit | OK | Sanders-Vorstoß wird neutral als „bisher weitestgehender politischer Vorschlag" referiert; die in § 4.5 bereits etablierte *Bloomberg-Editorial*-Gegenstimme bleibt erhalten; die geringe Annahmewahrscheinlichkeit im republikanisch geführten Kongress ist explizit benannt; Altmans gleichzeitige Ablehnung verbindlicher Vorab-Zulassung wird ebenfalls referiert. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Stocksteuer", „Sovereign Wealth Fund", „Anhang III"/„Anhang I", „WARN-AI-Disclosure" einheitlich; APA-konforme Quellenangabe für alle fünf neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders-Folgeinitiative als § 11.3-Eintrag; Altman-Washington-Reise als § 11.3-Eintrag; EU-Council-Pressemitteilung 7. Mai 2026 als § 11.3-Eintrag; Challenger-May-Report als § 11.5-Eintrag; TrueUp-Stand 9. Juni 2026 als § 11.5-Eintrag; Salesforce-Benioff-Konkretisierung als § 11.5-Eintrag; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders-Vorstoß: Primärquelle ist Sanders' eigene Ankündigung am 3. Juni 2026; Sekundärquellen The Hill, Fortune, Newsweek, Reason, Fox Business mit konsistenter Wiedergabe der Schlüsselangaben (50 %, Stocktransfer, OpenAI/Anthropic/xAI, Direktauszahlungen). Connecticut SB 5: Primärquelle ist der Lamont-Unterzeichnungsakt; Kanzleianalysen referenzieren das Datum 29. Mai 2026 konsistent. Digital Omnibus: Primärquelle ist die Council-Pressemitteilung 7. Mai 2026; Kanzleianalysen konsistent. Challenger May-Report: Primärquelle ist der Original-Report; CNBC referiert konsistent. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs erfolgreich aufgerufen: challengergray.com/blog/challenger-report-may-job-cuts (öffentlich, Inhalt konsistent); thehill.com/policy/technology/5906140-sanders-ai-ownership-wealth (öffentlich, Headlines konsistent); cnbc.com/2026/06/03/open-ai-altman-congress (öffentlich); consilium.europa.eu/en/press/press-releases/2026/05/07/artificial-intelligence (öffentlich, Pressemitteilung). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Sanders (50 %, OpenAI / Anthropic / xAI, paritätische Verwaltungsratsvertretung, „kollektives Wissen der Menschheit") wörtlich aus den verifizierten Sekundärquellen; Kernzahlen Connecticut SB 5 (Unterzeichnung 29. Mai 2026, Geltungsdaten gestaffelt) aus den Kanzleianalysen wörtlich; Digital Omnibus Postponement-Daten (2. Dezember 2027 / 2. August 2028 / 2. August 2027) wörtlich aus der Council-Pressemitteilung; Challenger May-Zahlen (97.006 / 38.579 / 40 %, 87.714, 38.242 / 123.653, +66 %, 397.755 / −43 %, +16 %) wörtlich aus dem Challenger-Originalreport und CNBC-Wiedergabe. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die sechs neuen Belegcluster benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen, in den meisten Fällen Verfügbarkeit der Primärquelle ohne Paywall). |
...
Keine — die fünf Ergänzungen sind teils Schließungen offener Items (Connecticut SB 5 Unterzeichnung, Digital Omnibus Trilog-Einigung) und teils Tagesfortschreibungen einer bestehenden Linie (Sanders-Folgeinitiative, Challenger-May-Aggregat, TrueUp-Stand, Salesforce-Konkretisierung) ohne Korrekturbedarf an anderen Aussagen.
