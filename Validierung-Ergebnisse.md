...
## Validierung 4. Juni 2026 (Lauf 001 vom 4. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf nach Version 22.0 (Schnitt 8. Mai 2026). Zwischen den beiden Läufen liegen rund vier Wochen, sodass das 7-Tage-Standardfenster (Cluster A–E, G, H) und das 48-Stunden-Schnellfenster (Cluster F, I) durch einen erweiterten Korridor 8. Mai – 4. Juni 2026 ergänzt wurden, um die wichtigsten Bewegungen des Zwischenmonats zu erfassen. Web-Recherche im Korridor der Cluster A–J. Sieben belegbare Neuigkeiten eingearbeitet (Sanders *American A.I. Sovereign Wealth Fund Act*, Connecticut SB 5 Unterzeichnung, Digital Omnibus Trilog-Einigung 7. Mai 2026, Meta-Umsetzung 20. Mai 2026, Oracle-Finalphase, TrueUp 1. Juni 2026, IAB-Arbeitsmarktbarometer Mai 2026); zwei flankierende deutsche Verfahrensentwicklungen (1065. Bundesrats-Sitzung Ergebnis, GKV-Verfahrensplanung-Aktualisierung). Cluster G (Gesundheitswesen): fünftes Mal in Folge ohne eigenständige neue Treffer im 7-Tage-Fenster — GKV-Reform-Entwicklungen sind aus § 5.2 abgedeckt. Cluster I (Frontier-Modelle) und Cluster J (Robotik): keine neuen politisch-fiskalisch relevanten Meldungen im 48-Stunden-Fenster.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Sanders — *American A.I. Sovereign Wealth Fund Act* (NYT-Op-Ed vom 2. Juni 2026, *„The Public Should Own Half of the Big A.I. Companies"*): einmalige 50-%-Aktienabgabe auf die größten KI-Unternehmen (genannt: OpenAI, Anthropic, xAI); stimmberechtigte Bundesanteile und paritätische Aufsichtsratsvertretung; Erträge über Direktzahlungen sowie Gesundheits-/Bildungs-/Wohnungsausgaben; Referenzmodelle norwegischer Staatsfonds und Alaska Permanent Fund Dividend; Gesetzestext zum Schnitt noch nicht eingebracht. Quellen: sanders.senate.gov (Op-Ed), Common Dreams, Newsweek, Truthout, Reason, Fox Business, The Hill (alle 2./3. Juni 2026). | § 4.5 (eigener Absatz nach dem 16.-April-Sanders-Beitrag, Verzahnung mit § 5.4); § 5.4 (Verweis auf die eigentumspolitische Variante neben dem fiskalischen Pfad); § 11.3 (zwei neue Sanders-/Berichts-Belegcluster); § 11.5 (US-Berichterstattungs-Cluster pro/contra); README.md und Aktualitätshinweis am Dokumentende. | Die Initiative kombiniert erstmals den Sanders-Robotersteuer-Pfad mit dem Staatsfondsmodell und liefert den US-bundespolitischen Gegenentwurf zum *Bloomberg-Editorial* vom 29. April 2026; konzeptionell ist sie der zur Zeit weitreichendste politische Vorstoß im Korridor von Typ-4-Steuerlastverschiebung und Teilhabefonds. Verändert nicht die Deutschland-These, schärft aber den internationalen Vergleichsrahmen. |
| 2 | Connecticut SB 5 — Unterzeichnung durch Gouverneur Ned Lamont am 29. Mai 2026; Inkrafttreten in gestaffelten Stufen ab 1. Oktober 2026 (Automated-Employment-Decision-Rahmen, „AI is not a defense", Frontier-Whistleblower, WARN-AI/Technology-Change-Disclosure), ab 1. Januar 2027 (anonyme interne Meldewege Frontier-Entwickler) und ab 1. Oktober 2027 (Deployer-Vorab-Information). Quellen: Holland & Knight (6/2026), DLA Piper (5/2026), Ogletree, Davis Wright Tremaine, FPF, Akin. | § 4.5 (Aktualisierung der bisherigen Formulierung „Lamont hat seine Unterzeichnung angekündigt"); § 1.1 (Verzahnung mit der TrueUp-/Oracle-/Meta-Linie zum WARN-AI-Datenquellen-Argument); § 11.3 (neuer Sammelbeleg „State of Connecticut, Office of the Governor (29. Mai 2026)"); Aktualitätshinweis am Dokumentende. | Schließt die in Version 22.0 als „nachzutragen" markierte Lücke und macht die US-bundesstaatliche WARN-AI-Disclosure-Quelle (ab 1. Oktober 2026) operativ wirksam — der für die in § 9.1 diskutierten Messprobleme wichtigste administrative Datenquellen-Mechanismus. |
| 3 | Digital Omnibus on AI — vorläufige politische Einigung im dritten Trilog am 7. Mai 2026 (Pressemitteilung Rat „Artificial Intelligence: Council and Parliament agree to simplify and streamline rules"): bestätigte Hochrisiko-Stichtage 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); Verschiebung der Transparenz- und Kennzeichnungspflichten vom 2. August 2026 auf 2. Dezember 2026; neue Verbotsregel für nicht einvernehmliche intime Darstellungen einschließlich CSAM mit Geltung ab 2. Dezember 2026; SME-Erleichterungen; Klarstellung der Aufsichtsrolle des AI Office; förmliche Annahme vor 2. August 2026 vorgesehen. Quellen: Rat der EU (7. Mai 2026), Bird & Bird, White & Case, Mishcon, Gibson Dunn, Matheson, OneTrust. | § 4.3 (Trilog-Absatz vollständig auf den Einigungsstand umgestellt; vorheriger Verhandlungsstand 28. April 2026 entfällt); § 11.3 (neuer Sammelbeleg „Rat der EU (7. Mai 2026)"); Aktualitätshinweis. | Schließt die in Version 22.0 als „nächste Runde 13. Mai 2026" terminierte Linie ab und etabliert die jetzt verbindlichen AI-Act-Stichtage als Bezugsrahmen für die in § 4.4 diskutierte Anknüpfung steuerlicher Tatbestände an AI-Act-Definitionen. |
| 4 | Meta — Umsetzung der Personalreduktion am 20. Mai 2026: HR-Memo Janelle Gale; rund 8.000 Streichungen (≈ 10 % der Belegschaft) plus Streichung weiterer rund 6.000 unbesetzter Stellen (effektive Bestandsreduktion rund 14.000); Anhebung der 2026er-AI-Capex-Guidance auf 125–145 Mrd. USD; Re-Organisation in AI-fokussierte „Pods"; weitere Streichungen für die zweite Jahreshälfte 2026 angekündigt. Quellen: The Next Web (20. Mai), Yahoo Finance, Bloomberg, Pymnts, Metaintro. | § 1.1 (Ergänzung als konkrete Umsetzungs-Tagesangabe der bislang nur als Ankündigung referierten Meta-Reduktion „rund 8.000 Stellen ab 20. Mai 2026"); § 11.5 (neuer Sammelbeleg „The Next Web / Yahoo Finance / Bloomberg / Reuters (20. Mai 2026)"); Aktualitätshinweis. | Bestätigt die in Version 22.0 vorgemerkte Linie empirisch und verschärft die Asymmetrie-Linie zwischen Personalreduktion und Infrastrukturausbau (jetzt zwei Hyperscaler mit konkret datierbaren KI-Pod-Re-Organisationen). |
| 5 | Oracle — finale Phase der konzernweiten Reduktion (rund 20.000–30.000 Stellen, größte Personalanpassung der Konzerngeschichte): finale Trennungstermine 1.–15. Juni 2026; Severance vier Wochen Grundvergütung plus eine Woche je Dienstjahr (Cap 26 Wochen) ohne Beschleunigung unverfallbarer Stock-Tranchen — öffentliche Kritik an Severance-Konditionen; Schwerpunkt Oracle Health (8.000–10.000 Stellen aus der Cerner-Akquisition); Verknüpfung mit AI-Infrastruktur-Programm von rund 156 Mrd. USD. Quellen: Tech Times (1. Juni 2026), Goodreturns (Juni 2026), The AI Insider (9. Mai), CNBC (31. März), CX Today. | § 1.1 (Ergänzung des bislang nur als „April 2026 angekündigte" Oracle-Reduktion-Block mit konkreten finalen Trennungsdaten und Severance-Spezifikation); § 11.5 (neuer Sammelbeleg „Tech Times / CNBC / The AI Insider / Goodreturns"); Aktualitätshinweis. | Schließt eine in Version 22.0 noch offene Datierungs-/Programmangabe und liefert den belastbaren Folgekontext zur in § 1.1 dokumentierten Asymmetrie-Linie. |
| 6 | TrueUp / Tech Times / Yahoo Finance — Tracker-Tagesfortschreibung zum 1. Juni 2026: 148.092 Tech-Beschäftigte aus 354 Layoff-Meldungen (rund 981 Personen pro Tag, etwa 46 % über dem Niveau 2025); Tech-Times-/Yahoo-Auswertung: rund 142.000 Tech-Stellen in den ersten fünf Monaten 2026; Jahres-Lauftempo zielt auf rund 370.000 (Nähe Pandemie-Spitzenwert 430.000 aus 2023). | § 1.1 (Aktualisierung der Tracker-Reihe; explizite Tagesfortschreibung vom 8. Mai 2026 — 127.411 / 283 — auf den 1. Juni 2026 — 148.092 / 354); § 11.5 (neuer Sammelbeleg „TrueUp / Tech Times / Yahoo Finance (Stand 1. Juni 2026)"); Aktualitätshinweis. | Tagesfortschreibung der etablierten Reihe; das Niveau bestätigt die in § 1.1 referierte Asymmetrie und liefert eine Jahresprognose-Größe (370.000), die das in § 8.4 entwickelte Stabilitätsargument quantitativ unterfüttert, ohne den aggregiert moderaten Befund aus § 3.5 (Yale Budget Lab) umzukehren. |
| 7 | IAB-Arbeitsmarktbarometer Mai 2026 — erster Anstieg nach sechs Monaten Rückgang: +0,1 auf 99,6 Punkte (Gesamtindex); Beschäftigungskomponente stagniert bei 100,1 Punkten (schwächster Ausblick außerhalb der Pandemie); europäisches Arbeitsmarktbarometer 100,1; ergänzende IAB-Lageeinschätzung Mai 2026: BIP Q1 2026 +0,3 % (preisbereinigt, saison- und kalenderbereinigt); Iran-Krieg verhindert weitere Erholung; sozialversicherungspflichtige Beschäftigung im März nach fünf Rückgangsmonaten erstmals wieder gestiegen, Erwerbstätigkeit insgesamt im April erneut gesunken. Quellen: iab.de (Pressemitteilung), iab-forum.de (Lageeinschätzung Mai), iab.de/daten (Barometer-Dashboard). | § 1.1 (Verzahnung mit dem deutschen Strang am Ende des Layoff-Blocks); § 11.3 (neuer Sammelbeleg „IAB (Mai 2026)"); Aktualitätshinweis. | Aktualisiert die in § 1.1 referierte IAB-Linie nach der März-Frühjahrsprognose um einen monatlich aktualisierten Indikator; bestätigt empirisch die im Papier zugrunde gelegte Konjunktur- und Beschäftigungsschwäche. |

**Flankierende deutsche Verfahrensentwicklungen (in bestehende Abschnitte eingearbeitet, kein eigener Block in der Tabelle):**

- 1065. Bundesrats-Sitzung am 8. Mai 2026 — Ergebnis: 14 Bundestags-Gesetze passiert, zwei abgelehnt; die 1.000-Euro-*Entlastungsprämie für Beschäftigte* (im Steuerberatungsgesetz enthalten) fand keine Mehrheit (Hinweis Bundesrats-Finanzausschuss auf 2,8 Milliarden Euro Steuerausfälle ohne Gegenfinanzierung); Bundesregierung verfolgt das Vorhaben am 13. Mai 2026 nicht weiter. → § 5.2 Aktualisierung; § 11.3 neue Quelle.
- *GKV-Beitragssatzstabilisierungsgesetz* — Verfahrensplanung aktualisiert: Erster Bundesrats-Durchgang in der 1066. Sitzung am 12. Juni 2026 (vorher als 1065. Sitzung am 8. Mai 2026 angenommen — Korrektur); zweite und dritte Bundestagslesung 26. Juni 2026; zweiter Bundesrats-Durchgang 10. Juli 2026. → § 5.2 Aktualisierung; § 11.3 neuer 1066.-Sitzungs-Eintrag.

**Nicht aufgenommen (bewusste Auslassungen):**
- Microsoft VRP — Annahmequote: die Annahmefrist endet erst am 8. Juni 2026 (nach dem Schnittdatum 4. Juni 2026); belastbare Übernahmequoten liegen Stand 4. Juni 2026 nicht öffentlich vor; eine ausdrückliche Erwähnung des nahenden Fristendes ist in § 1.1 ergänzt, eine Auswertung folgt im nächsten Lauf.
- 1066. Bundesrats-Sitzung am 12. Juni 2026 — Beschlüsse liegen noch nicht vor; nur Tagesordnungs-Hinweis aufgenommen.
- Cluster G (Gesundheitswesen) — fünfter Lauf in Folge ohne eigenständige neue Treffer im 7-Tage-Fenster; bestehende GKV-Reform-Verzahnung in § 5.2 reicht aus; Empfehlung für die nächsten Läufe weiterhin: gezielter Abruf g-ba.de, gematik, BfArM.
- Cluster I (Frontier-Modelle) und Cluster J (Robotik) — keine politisch-fiskalisch relevanten Meldungen im 48-Stunden-Fenster; Tesla-Optimus-/Figure-Stand bleibt informationsökonomisch unverändert gegenüber Version 22.0.
- Plattform-Digitalabgabe (Weimer) — keine neue Entwicklung über Version 22.0 hinaus zwischen 8. Mai und 4. Juni 2026; bestehender § 4.4-Verweis bleibt aktuell.
- Anthropic Economic Index — kein neuer Hauptbericht nach März-2026-Folgebericht; bestehender § 3.5-Block aktuell.
- OECD Pillar 2 — die im Mai 2026 dokumentierten Aktivitäten (Australien-Konsultation, Kanada Bill C-31, Schweiz-Konsultation) sind nationale Umsetzungs-/Konsultationsmeldungen ohne neue Substanz zum Verhältnis Pillar 2 ↔ KI-Steuerdebatte.
...
| 2.1.3 Querverweise | OK | Die neuen Passagen verweisen auf bestehende Abschnitte (§ 4.5 → § 5.4; § 1.1 → § 5.1, § 8.3, § 8.4, § 3.5, § 9.1; § 5.4 → § 4.5); alle Ziele existieren weiterhin. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen erweitern bestehende Linien (Sanders/OpenAI/Bloomberg-Spektrum in § 4.5; Layoff-Tracker in § 1.1; Fondsmodell in § 5.4); die Deutschland-These (§ 8) bleibt eigenständig und unverändert. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Aktienabgabe (50 %), genannte Unternehmen (OpenAI, Anthropic, xAI), Referenzmodelle (Norwegen, Alaska) wörtlich aus der Op-Ed und mehreren unabhängigen Sekundärquellen; Connecticut-Unterzeichnungsdatum (29. Mai 2026) und gestaffeltes Inkrafttreten (1. Oktober 2026 / 1. Januar 2027 / 1. Oktober 2027) aus mehreren US-Kanzleianalysen verifiziert; Digital-Omnibus-Einigungsdatum (7. Mai 2026) und Stichtage aus Pressemitteilung des Rates. Meta-Streichungszahl (8.000) und Capex-Guidance (125–145 Mrd. USD) sowie Oracle-Severance-Konditionen aus konsistenter Mehrfachberichterstattung; TrueUp-Tagesstand (148.092 / 354 / 981/Tag) aus Tech Times (29. Mai 2026) und Yahoo Finance; IAB-Barometer-Zahl (99,6 / +0,1) aus iab.de-Pressemitteilung. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Sovereign-Wealth-Fund-Verweis in § 5.4 ist eine Kurzfassung mit Querverweis auf § 4.5 (kein Doppelaufbau); § 4.5 trägt die ausführliche Darstellung. Connecticut-SB-5-Unterzeichnung ersetzt die bisherige Ankündigung in § 4.5 (kein Parallel-Block). TrueUp-Reihe als Tagesfortschreibung gekennzeichnet. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These unverändert. Die neue Sanders-Initiative wird ausdrücklich als „eigentumspolitische Variante neben dem fiskalischen Pfad" eingeordnet und nicht mit der Deutschland-These vermengt. Konjunktivpflicht für die noch nicht eingebrachte Gesetzgebung beachtet („vorsähe", „würde", „soll"). |
| 2.2.4 Ausgewogenheit | OK | Sanders-Initiative wird kritisch eingeordnet (politisch zugespitzt, in republikanisch geführtem Kongress nicht aussichtsreich); Reaktionen pro/contra in § 11.5 sichtbar (Common Dreams/Truthout zustimmend; Reason/Fox Business kritisch); Bloomberg-Editorial vom 29. April 2026 bleibt als spiegelbildliches Pendant erhalten. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „American A.I. Sovereign Wealth Fund Act" als originalsprachiger Bill-Name beibehalten; „Digital Omnibus on AI" konsistent; „WARN-AI/Technology-Change-Disclosure" konsistent. APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders-Op-Ed in § 11.3 (politische Dokumente); Sanders-Berichterstattungs-Cluster in § 11.5 (journalistische Quellen); Connecticut-Unterzeichnungs-Eintrag in § 11.3; Digital-Omnibus-Einigungs-Cluster in § 11.3; IAB-Barometer in § 11.3; Bundesrats-1065-Ergebnisbericht in § 11.3; Bundesrats-1066-Tagesordnung in § 11.3; Meta-/Oracle-/TrueUp-Cluster in § 11.5; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders: Primärquelle ist die Op-Ed auf sanders.senate.gov, von NYT (paywalled) und mehreren US-Outlets referiert. Connecticut: Primärquelle ist das Lamont-Office-Statement, von DLA Piper, Holland & Knight, Ogletree, FPF, Davis Wright Tremaine referiert. Digital Omnibus: Primärquelle ist die Pressemitteilung des Rates (consilium.europa.eu). IAB: Primärquelle iab.de. Meta: HR-Memo (intern), von The Next Web verifiziert. Oracle: SEC-Filings und Berichterstattung Tech Times. TrueUp: öffentlich zugängliches Dashboard. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: sanders.senate.gov/op-eds/the-public-should-own-half-of-the-big-a-i-companies/ (öffentlich); consilium.europa.eu/en/press/press-releases/2026/05/07 (öffentlich); hklaw.com/en/insights/publications/2026/06/connecticut-enacts-comprehensive-ai-legislation (öffentlich); iab.de/presseinfo/iab-arbeitsmarktbarometer-schwaechster-beschaeftigungsausblick-ausserhalb-der-pandemie/ (öffentlich); techtimes.com/articles/317527/20260601 (öffentlich); thenextweb.com/news/meta-layoffs-may-2026-ai-restructuring-thousands (öffentlich); bundesrat.de/DE/plenum/bundesrat-kompakt/26/1065/1065-pk.html (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Sanders: 50-%-Aktienabgabe und genannte Unternehmen (OpenAI, Anthropic, xAI) wörtlich aus der Op-Ed. Connecticut: gestaffeltes Inkrafttreten direkt aus Holland-&-Knight-/DLA-Piper-Analysen. Digital Omnibus: Stichtage (2. Dezember 2027, 2. August 2028, 2. Dezember 2026) wörtlich aus der Ratspressemitteilung. Meta/Oracle/TrueUp/IAB-Zahlen wörtlich aus den verifizierten Primär- und Sekundärquellen. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; keine neuen Markierungen erforderlich (alle neuen Quellen mehrfach unabhängig verifiziert). |
...
|---|---|---|---|
| 1 | § 5.2 (Version 22.0) | Schätzung „erster Bundesrats-Durchgang des GKV-Beitragssatzstabilisierungsgesetzes in der 1065. Sitzung am 8. Mai 2026" hat sich nicht bestätigt; die tatsächliche Verfahrensplanung sieht den ersten Durchgang in der 1066. Sitzung am 12. Juni 2026 vor (Verhältnis Tagesordnung Bundesrat). | Gering (Datumsfehler, kein Sachverhaltsfehler) |

### Durchgeführte Bereinigungen

| # | Fehler | Maßnahme | Erledigt |
|---|---|---|---|
| 1 | § 5.2 GKV-Bundesrats-Erstdurchgang-Datum | Formulierung korrigiert auf „erster Bundesrats-Durchgang in der 1066. Sitzung am 12. Juni 2026"; ergänzt durch das Ergebnis der 1065. Sitzung (Entlastungsprämie scheitert) und die nachfolgenden Terminierungen 26. Juni 2026 (Bundestag 2./3. Lesung) und 10. Juli 2026 (Bundesrat zweiter Durchgang). | Ja |
...
- Alle Fehler behoben: Ja (Datums-Korrektur in § 5.2).
- Neue Version: 23.0.
- PDF erstellt: Ja.
- Word erstellt: Ja.
