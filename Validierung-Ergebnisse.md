...
## Validierung 1. Juni 2026 (Lauf 001 vom 1. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf am 1. Juni 2026 (rund 24 Tage nach Lauf 001 vom 8. Mai 2026, mit dem Version 22.0 abgeschlossen wurde). Web-Recherche im Korridor der Cluster A–J am 1. Juni 2026: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Fünf belegbare Treffer im 7-Tage-Fenster (25. Mai – 1. Juni 2026) identifiziert und eingearbeitet (Wix-Layoff vom 28. Mai 2026; TrueUp-Tagesfortschreibung 30./31. Mai 2026; IAB-Forum-Einschätzung Mai 2026 vom 29. Mai 2026; Casar-Op-Ed *„Tax AI to Create Jobs"* vom 28. Mai 2026; Unterzeichnung des *Connecticut Artificial Intelligence Responsibility and Transparency Act* durch Gouverneur Lamont am 29. Mai 2026); alle übrigen recherchierten Themen waren in Version 22.0 bereits enthalten oder lagen außerhalb des 7-Tage-Korridors.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Wix.com Ltd. (NASDAQ: WIX) — Layoff-Ankündigung am 28. Mai 2026: Streichung von rund 1.000 Stellen (etwa 20 % der Belegschaft, größte Reduktion der Unternehmensgeschichte); CEO Avishai Abrahami begründet den Schritt in einem öffentlich gemachten Mitarbeitendenbrief mit einer durch den anhaltend starken Schekel-Kurs gegen den US-Dollar verschärften Kostenstruktur und einem konzernweiten Umbau zu „AI-native"-Arbeitsweisen. Quellen: CNBC (28. Mai), Times of Israel, Calcalist, Jerusalem Post, TechRadar. | § 1.1 (Ergänzung des Tracker-/Layoff-Blocks: Wix wird als Mai-2026-Tagesfall neben der Meta-Welle vom 20. Mai 2026 in die TrueUp-Tagesfortschreibung integriert); § 11.5 neuer Sammelbeleg „CNBC / Times of Israel / Calcalist / Jerusalem Post / TechRadar"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Wix verbindet erstmals zwei strukturelle Kostendruck-Linien — Währungskurs (Schekel-Aufwertung) und KI-Umbau — in einer einzelnen Mai-2026-Konzernentscheidung; für die Steuerdebatte ist dies relevant, weil die in § 9.1 diskutierte Kausalattribution zwischen KI-Verdrängung und anderen Restrukturierungsgründen — wie schon in der *Washington-Post*-Differenzierung vom 1. Mai 2026 — ein weiteres dokumentiertes Beispiel mehrkanaliger Begründungslagen erhält. |
| 2 | TrueUp Tracker — Tagesfortschreibung zum 30./31. Mai 2026: rund 148.092 betroffene Personen aus 354 Layoff-Meldungen (rund 981 Stellen pro Tag im Jahresdurchschnitt), nach Aufnahme der Meta-Welle vom 20. Mai 2026 (rund 8.000 Stellen) und der Wix-Streichungen vom 28. Mai 2026 (rund 1.000 Stellen); SkillSyncer auf vergleichbarem Niveau. Quellen: TrueUp, Layoffs.fyi, SkillSyncer, Yahoo Finance, TechSpot. | § 1.1 (Fortschreibung der bestehenden Tagesfortschreibungsreihe 6. Mai → 7. Mai → 8. Mai → 30./31. Mai 2026); § 11.5 neuer Eintrag „TrueUp / Layoffs.fyi / SkillSyncer (Stand 30./31. Mai 2026)" sowie neuer Aggregat-Eintrag „Yahoo Finance / TechSpot / The Times (Mai 2026)" zur Mai-Welle. | Schließt die Tracker-Reihe an das Monatsende Mai 2026 an und macht die seit Anfang Mai 2026 etablierte Schwelle von > 1.000 Personen pro Tag durch die Aufnahme der Meta- und Wix-Wellen empirisch sichtbar; bestätigt die in § 8.4 entwickelte Stabilitätslinie quantitativ, ohne den aggregiert moderaten Befund aus § 3.5 (Yale Budget Lab) umzukehren. |
| 3 | IAB-Forum — *Einschätzung des IAB zur wirtschaftlichen Lage Mai 2026* (Publikation am 29. Mai 2026): IAB-Arbeitsmarktbarometer 99,6 Punkte (+0,1 Punkte gegenüber April 2026), weiterhin knapp unter neutraler Marke; deutsches BIP +0,3 % im ersten Quartal 2026 (getragen von Exporten +3,3 % nach drei Rückgangsquartalen und Staatskonsum); April-Inflation 2,9 %; *„am Arbeitsmarkt ist in den nächsten Monaten keine Besserung in Sicht"*; Iran-Krieg verhindert weitere Erholung. | § 1.1 (Ergänzung des bestehenden IAB-Prognose-Blocks vom 24. März 2026 um die *Einschätzung Mai 2026* als Folgestand der Frühjahrsprognose); § 11.5 neuer Eintrag „IAB-Forum (29. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Bestätigt das Anfang März 2026 dokumentierte Bild (Frühjahrsprognose, BIP +0,8 %, Iran-Krieg-Dämpfung 0,2–0,3 Pp.) auf monatlich aktualisierter Datenbasis und liefert mit dem Barometer-Wert eine quantitative Frühindikator-Größe, die in der bisherigen § 1.1-Darstellung fehlte; durch den Hinweis „keine Trendwende erwartet" wird die in § 7 und § 8.4 referierte Stabilitäts-Argumentation gestützt, ohne den Befund umzukehren. |
| 4 | Casar, Greg (D-TX) — Op-Ed *„Tax AI to Create Jobs"* im *American Prospect* am 28. Mai 2026: Vorschlag einer auf KI-Tokens und der zugrundeliegenden Rechenleistung (Compute) bezogenen Bundesabgabe, mit Mehrbelastung für Unternehmensnutzung gegenüber Privatnutzung und automatischer Nachjustierung des Satzes, bis das durch KI verdrängte Arbeitsvolumen durch neu geschaffene öffentliche Beschäftigung kompensiert ist; Aufkommen finanziert ein bundesweites Beschäftigungsprogramm nach Vorbild der *Works Progress Administration* (WPA). Quellen: The American Prospect (28. Mai), Casar House Office, Common Dreams, Breitbart, Texas Politics, KTSM. | § 4.5 neuer Block „Casar-Vorschlag — AI Token Tax und WPA-inspiriertes Jobs-Programm (Mai 2026)" nach dem No-Robot-Bosses-Act-Absatz; § 11.3 neuer Eintrag „Casar, G. (28. Mai 2026). *Tax AI to Create Jobs*"; § 11.5 neuer Sammelbeleg zur konservativ-publizistischen Rezeption; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Casar benennt — anders als der Sanders-Bericht (Oktober 2025) und das OpenAI-Papier (April 2026) — eine konkrete *technische* Bemessungsgrundlage (Tokens, FLOPs), die nicht an „Roboter" oder „Automatisierung" als unscharfen Oberbegriffen anknüpft; die WPA-Koppelung verschiebt das Aufkommens-Verwendungs-Konzept von reiner Transferzahlung zu staatlicher Beschäftigung. Der Vorstoß differenziert die US-Debatte und verweist innerhalb der Typologie der fünf Robotersteuer-Varianten (§ 2.1) auf Typ 3 (KI/Compute-bezogene Abgabe). |
| 5 | Connecticut — Unterzeichnung des *Connecticut Artificial Intelligence Responsibility and Transparency Act* (SB 5) durch Gouverneur Ned Lamont am 29. Mai 2026 (in Lauf 001 vom 8. Mai 2026 als „nächster Lauf zu prüfen" markiert): Bestätigung der gestaffelten Geltungsdaten 1. Oktober 2026 (Automated-Employment-Decision-Rahmen, „AI is not a defense"-Klarstellung, Frontier-Whistleblower und WARN-AI-Disclosure), 1. Januar 2027 (anonyme interne Meldewege Frontier-Entwickler), 1. Juli 2027 (Sandbox-Programm-Deadline) und 1. Oktober 2027 (deployerseitige Vorab-Information bei substantieller KI-Nutzung); Reichweite umfasst zusätzlich Companion Chatbots und Provenance Data für generative-AI-Anbieter mit mehr als einer Million monatlicher Nutzer. Quellen: CT Mirror, Davis Wright Tremaine, DLA Piper, Littler, Ogletree, Future of Privacy Forum, Freshfields. | § 4.5 Connecticut-Block aktualisiert (Lamont-Unterzeichnung mit Datum 29. Mai 2026 ergänzt, Formulierung „hat seine Unterzeichnung angekündigt" durch „hat das Gesetz am 29. Mai 2026 unterzeichnet" ersetzt; ergänzender Hinweis auf das Gesamtwirkungsbild als erster US-Bundesstaat mit kodifizierter AI-Layoff-Disclosure-Architektur); § 11.3 neuer Eintrag „Davis Wright Tremaine / DLA Piper / Littler / Ogletree / Future of Privacy Forum (Mai 2026)"; § 11.5 neuer Sammelbeleg „CT Mirror / Davis Wright Tremaine / Freshfields (29. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Connecticut wird der erste US-Bundesstaat mit einer in Kraft tretenden AI-Layoff-Disclosure-Architektur — die in § 9.1 dokumentierten Mess- und Umgehungsprobleme einer Displacement-basierten Anknüpfung werden auf der Aggregat-Ebene reduziert, ohne die Einzelfall-Kausalität zu lösen. Der Vorgang schließt das in Version 22.0 als „nächster Lauf zu prüfen" markierte offene Beobachtungselement ab. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Meta — Layoff-Welle am 20. Mai 2026 (rund 8.000 Stellen, 10 % der Belegschaft); Intuit-Layoffs am selben Tag (rund 3.000 Stellen, 17 %); BILL-Layoffs (rund 30 %); Upwork (rund 25 %): alle außerhalb des 7-Tage-Fensters (vor dem 25. Mai 2026); aggregiert über die TrueUp-Tagesfortschreibung zum 30./31. Mai 2026 abgedeckt.
- EU AI Act Digital Omnibus — Provisorische Einigung am 7. Mai 2026 (Postponements 2. Dezember 2027 / 2. August 2028, neues Verbot für KI-generiertes nicht-einvernehmliches intimes Material): außerhalb des 7-Tage-Fensters; bestehende Aktualitätshinweis-Formulierung zur Trilog-Verhandlungslinie aus Lauf 001 vom 8. Mai 2026 ist überholt, eine inhaltliche Korrektur erfolgt aber erst im nächsten Lauf, sobald die formale Verabschiedung durch Parlament und Rat (angekündigt vor dem 2. August 2026) belegt ist.
- OECD — *„Who will be the workers most affected by AI?"* (Originalbericht aus Oktober 2024; Mai-2026-Datierung in den Suchergebnissen bezieht sich auf eine Indexierungs-Bereinigung): außerhalb des Aktualitätskorridors, kein neuer Befund.
- Anthropic Economic Index — kein neuer Bericht im Mai 2026; bestehender § 3.5-Block bleibt aktuell (jüngster Bericht *„Learning curves"* vom 24. März 2026 unverändert in Version 22.0 dokumentiert).
- Generationenkapital — Renditeangabe 7,2 % für das erste Jahr 2026 bereits in Sekundärquellen kursierend, aber keine offizielle NBIM-/Stiftung-Generationenkapital-Veröffentlichung mit Datierung im 7-Tage-Fenster; bestehender § 8.6-Verweis bleibt aktuell.
...
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; ein neuer Lead-In-Absatz in § 4.5 (Casar-Vorschlag) eingefügt; keine leeren Abschnitte. |
| 2.1.2 Nummerierung | OK | Kapitel 1–11 lückenlos; Unterabschnitt 8.1–8.7 lückenlos; fünf Robotersteuer-Typen, drei Hebel der Deutschland-These und sieben Empfehlungen unverändert; Verweis von Casar-Vorschlag auf Typ 3 nach § 2.1 konsistent. |
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; der neue Casar-Absatz verweist auf § 2.1 (Typ-3-Zuordnung) und § 9.1 (Abgrenzungsproblem) — beide Ziele existieren. Connecticut-Block-Update lässt alle bestehenden Querverweise (§ 2.1, § 5.1, § 9.1) intakt. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind Aktualisierungen bestehender Diskussionsstränge (US-Tax-Debatte, Connecticut-WARN-Disclosure, Layoff-Tracker, IAB-Folgestand) — kein neuer Strang ohne Anbindung; rote Faden Literaturrezeption → Position → Umsetzung unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; ein neuer fett gesetzter Lead-In („**Casar-Vorschlag — AI Token Tax und WPA-inspiriertes Jobs-Programm (Mai 2026):**") nach bestehendem Muster der § 4.5-Blöcke (Sanders, Maine, Connecticut, OpenAI, Bloomberg-Editorial, Yang, No Robot Bosses Act); Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Wix-Streichungszahl (rund 1.000 / 20 %) und CEO-Aussage (Schekel-Aufwertung + AI-native) in mehreren unabhängigen Quellen (CNBC, Times of Israel, Calcalist, Jerusalem Post) konsistent; TrueUp-Tagesstand 148.092 / 354 / rund 981 pro Tag aus Tracker-Dashboard mit Yahoo-Finance-/TechSpot-Bestätigung; IAB-Barometerwert 99,6 / +0,1 sowie BIP +0,3 % / Exporte +3,3 % / April-Inflation 2,9 % wörtlich aus IAB-Forum-Original; Casar-Vorschlagskonditionen (Token-/Compute-Bemessung, WPA-Vorbild, höhere Belastung Unternehmens­nutzung, automatische Nachjustierung) wörtlich aus dem American-Prospect-Original und der Casar-Pressemitteilung; Lamont-Unterzeichnungsdatum 29. Mai 2026 in Davis Wright Tremaine, DLA Piper, FPF und CT-Mirror konsistent. |
| 2.2.2 Redundanzprüfung | OK | Wix als neuer Layoff-Fall in die bestehende Tracker-Reihe integriert (keine Doppelung); TrueUp-Stand 30./31. Mai 2026 als Fortschreibung der bisherigen 8.-Mai-Marke (keine Doppelung). IAB-Mai-2026-Block explizit als Folgestand der März-2026-Frühjahrsprognose gekennzeichnet (Konjunktiv erhalten). Casar-Block trennscharf gegen Sanders-, OpenAI- und Bloomberg-Editorial-Blöcke (Token-/Compute-Bemessungsgrundlage als neues Unterscheidungsmerkmal). Connecticut-Update behält die bestehende Block-Struktur und ergänzt nur das Unterzeichnungsdatum. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen weiter konsequent auseinandergehalten; Casar-Token-/Compute-Bemessung als eigenständige Bemessungsgrundlage in der bestehenden Typ-3-Kategorie verortet (kein Eingriff in die Typologie). |
| 2.2.4 Ausgewogenheit | OK | Casar-Vorschlag wird im Konjunktiv referiert (Claude.md § 4.2 — Policy-Vorschlag, nicht beschlossen); progressive Rezeption (American Prospect, Common Dreams) und konservative Rezeption (Breitbart, Texas Politics) symmetrisch genannt; Connecticut-Update als Tatsachenfeststellung (Unterzeichnung), nicht als Wertung; das in Version 22.0 etablierte Bloomberg-Editorial-Gegengewicht bleibt erhalten und wirkt symmetrisch zur Casar-Linie. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund; Einfügungen in § 1.1 (Wix-Wix-Tracker-IAB) als grammatisch korrekte Fortsetzungen des bestehenden Satzbaus eingefügt; § 4.5-Casar-Block beginnt mit Lead-In und neuem Absatz. |
| 2.3.2 Terminologie | OK | „AI-native" als zitierter CEO-Begriff in Anführungszeichen; „token" und „FLOPs" eingeführt; „Works Progress Administration (WPA)" beim ersten Auftreten ausgeschrieben; bestehende Schreibweisen „TrueUp", „SkillSyncer", „Hyperscaler", „AI-Layoff-Disclosure", „Schekel" einheitlich; APA-konforme Quellenangabe für alle fünf neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Wix-Belegcluster als neuer Eintrag in § 11.5; TrueUp-/Layoffs.fyi-/SkillSyncer-30/31-Mai-Stand als neuer Eintrag in § 11.5; IAB-Forum Mai-2026 als neuer Eintrag in § 11.5; Casar Op-Ed als neuer Eintrag in § 11.3 und Sammelbeleg-Rezeption als neuer Eintrag in § 11.5; CT-Mirror-/DWT-/Freshfields-Sammelbeleg zur Unterzeichnung als neuer Eintrag in § 11.5 sowie Kanzlei­analyse-Sammeleintrag in § 11.3 (Davis Wright Tremaine / DLA Piper / Littler / Ogletree / FPF). Keine Karteileichen. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-Stil eingehalten; URLs vollständig (kein Shortener); Datumsangaben einheitlich; Sammelbelege mit „/"-Trenner zwischen Quellen; Casar-Eintrag als Op-Ed mit Veröffentlichungsdatum 28. Mai 2026 referenziert. |
| 2.4.3 Aktualität und Belastbarkeit | OK | Wix: Primärquelle ist der CEO-Mitarbeiterbrief vom 28. Mai 2026, von CNBC / Times of Israel / Calcalist / Jerusalem Post als Sekundärquellen referiert. TrueUp: öffentlich zugängliches Tracker-Dashboard, in Yahoo Finance / TechSpot referiert. IAB: Primärquelle IAB-Forum 29. Mai 2026. Casar: Primärquelle American Prospect 28. Mai 2026 und die zugehörige Casar-House-Office-Pressemitteilung. Connecticut-Unterzeichnung: Primärquellen sind die Kanzleianalysen Davis Wright Tremaine, DLA Piper, FPF und Freshfields, alle datiert Mai 2026. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: iab-forum.de/einschaetzung-des-iab-zur-wirtschaftlichen-lage-mai-2026/ (öffentlich, Inhalt konsistent); prospect.org/2026/05/28/tax-ai-to-create-jobs/ (öffentlich); dwt.com/blogs/artificial-intelligence-law-advisor/2026/05/ct-ai-transparency-safety-consumer-protection-law (öffentlich, Inhalt konsistent); cnbc.com/2026/05/28/wix-layoffs-ai-exchange-rates.html (HTTP 403 via WebFetch, Sekundärquellen-Stichprobe vorgenommen); trueup.io/layoffs (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Wix (1.000 Stellen / 20 %, Schekel + AI-native) wörtlich aus CNBC und Calcalist; Kernzahlen TrueUp (148.092 / 354 / 981 pro Tag) aus dem Tracker-Dashboard; Kernzahlen IAB (99,6 / +0,1, BIP +0,3 %, Exporte +3,3 %, April-Inflation 2,9 %) wörtlich aus IAB-Forum; Kernaussagen Casar (Token-/Compute-Abgabe, WPA-Vorbild) wörtlich aus American Prospect und Casar-Pressemitteilung; Kernaussage Connecticut (Lamont-Unterzeichnung 29. Mai 2026, gestaffelte Geltungsdaten 1. Oktober 2026 / 1. Januar 2027 / 1. Juli 2027 / 1. Oktober 2027) wörtlich aus Davis Wright Tremaine / DLA Piper. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die fünf neuen Belegcluster benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen, in vier Fällen Verfügbarkeit der Primärquelle ohne Paywall; CNBC-Wix-Artikel via Sekundärquellen-Stichprobe verifiziert). |
| 2.5 Versionskonsistenz und Lizenz | OK | Versionsnummer 23.0 in Dokumentkopf, Aktualitätshinweis, README.md (Versionszeile, Zitiervorschlag, KI-Offenlegung mit neuem Versionseintrag) und diesem Validierungsblock identisch; CC-BY-4.0-Hinweis und Haftungshinweis unverändert; Stand auf „Juni 2026" geändert. |
| 2.6 Automatisierte Prüfung | n/a | Keine Skripte vorhanden; manuelle Stichproben gemäß § 2.6 ersetzen den automatisierten Teil. |

### Gefundene Fehler

Keine — die fünf Ergänzungen sind eine Mischung aus Tagesaktualisierungen (Wix, TrueUp, IAB) und Abschluss bisheriger Beobachtungspunkte (Casar als neuer Vorstoß in der US-Tax-Debatte; Connecticut-Lamont-Unterzeichnung als nachgereichter Stichtag) ohne Korrekturbedarf an anderen Aussagen.
