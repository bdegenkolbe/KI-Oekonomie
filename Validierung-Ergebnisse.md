...
## Validierung 6. Juni 2026 (Lauf 001 vom 6. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf am 6. Juni 2026 nach einer fast vierwöchigen Recherche-Pause seit dem 8. Mai 2026 (Lauf 001 vom 8. Mai 2026, Version 22.0). Web-Recherche im Korridor der Cluster A–J am 6. Juni 2026: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Vier belegbare Treffer in den jeweils einschlägigen Zeitfenstern identifiziert und eingearbeitet (Sanders' *American A.I. Sovereign Wealth Fund Act* vom 1. Juni 2026 + Trump-Konvergenzsignal vom 5. Juni 2026; Challenger *Mai-2026-Job-Cuts-Report* vom 5. Juni 2026; Uber-Layoff *People-and-Places*-Division vom 3. Juni 2026; Tech-Layoff-Tracker-Aggregat-Stand zum 5. Juni 2026); alle übrigen recherchierten Themen waren in Version 22.0 bereits enthalten oder lagen außerhalb des jeweiligen Zeitfensters.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Sanders, B. (1. Juni 2026): *The Public Should Own Half of the Big A.I. Companies* (NYT-Op-Ed) — Ankündigung des *American A.I. Sovereign Wealth Fund Act*: einmalige Anteilsabgabe von 50 % der Aktien (nicht des Gewinns) von OpenAI, Anthropic, xAI an einen US-Staatsfonds mit Stimmrechten, gleichberechtigter Vorstandsvertretung; Erträge für Direktzahlungen, Gesundheit, Bildung, Wohnen. Flankierend: Trump-Aussage 5. Juni 2026 (CNBC, Fortune), US-Bundesregierung erwäge direkte Eigentumsanteile an OpenAI/Anthropic/xAI; Bessent-Lutnick-Vorentwurf eines allgemeinen US-Staatsfonds; Sanders-Altman-Gespräch 3. Juni 2026; Warren-Vorschlag in Time wenige Tage zuvor. Quellen: sanders.senate.gov (1. Juni), CNBC (5. Juni), Fortune (3./5. Juni), The Hill, Newsweek, Common Dreams, Benzinga, Yahoo Finance, Washington Post (Opinion 3. Juni), Reason (2. Juni). | Neuer Block in § 4.5 *„Sanders' American AI Sovereign Wealth Fund Act (Juni 2026)"*; Verlängerung in § 5.4 mit Verweis auf Art. 14 GG / Art. 15 GG; Erweiterung in § 8.3 (Eigentums-/Verstaatlichungslogik-Passage) um den US-Vergleichsmaßstab und das Trump-Konvergenzsignal; § 11.3 neuer Eintrag „Sanders, B. (1. Juni 2026)" und neuer Sammelbeleg „The White House / CNBC / Fortune. (3.–5. Juni 2026)"; § 11.5 neuer Sammelbeleg „Fortune / Common Dreams / Newsweek / The Hill / Yahoo Finance" sowie „Washington Post / Reason"; Aktualitätshinweis am Dokumentende neu gefasst; README.md mit neuem Versionseintrag 23.0. | Markiert den Übergang vom *Public Wealth Fund* als rhetorischer Figur (OpenAI-Strategiepapier April 2026, Anthropic-Befürwortung) zu einer kongressreif vorbereiteten Gesetzesankündigung mit konkretem Mechanismus (50 % Anteilsabgabe statt Steuer) und namentlich genannten Adressaten — die erste US-Bundesinitiative, die die Eigentums- statt der Abschöpfungslogik wählt. Das parallele Trump-Konvergenzsignal verschiebt die Annahmewahrscheinlichkeit von „nahezu null" auf „nicht auszuschließen" und macht den Vorgang für die Deutschland-These doppelt einschlägig: als kongressreifer Gegenpol zur in § 8.3 abgelehnten Eigentumslogik, der die verfassungsrechtlichen Vorfragen über Art. 14 GG und Art. 15 GG erstmals aus einem realen Gesetzgebungsvorhaben heraus zur Diskussion stellt. |
| 2 | Challenger, Gray & Christmas — *Mai-2026-Job-Cuts-Report* (veröffentlicht am 5. Juni 2026): US-Mai-Streichungen 97.006 (+16 % gegenüber April, höchster Mai-Wert seit Pandemie-Mai 2020); KI-bezogene Streichungen 38.579 (40 % der Mai-Streichungen — höchster Monatswert seit Tracking-Beginn 2023; Januar 2026: 7 %; März: 25 %; April: 26 %); YTD-Gesamt 397.755, KI-bezogen YTD 87.714 (22 % aller 2026-Streichungen, übersteigt die 54.836 für 2025 vor Jahresmitte); Tech Mai 38.242 (höchster Wert seit August 2024), YTD 123.653 (+66 % gegenüber Vorjahresstand). Aussage Andy Challenger (CRO): „AI is now the leading reason companies give for cutting jobs and the primary industry citing it is Technology." Quellen: Challenger Gray (5. Juni), CNBC, Tom's Hardware, Yahoo Finance, Quartz, HR Director. | § 1.1 (Aggregat-Bestätigung der KI-Verdrängungslinie als methodisch unabhängige Sekundärquelle zu TrueUp/SkillSyncer; explizite Fortschreibung der bisherigen Reihe Januar–April mit dem Monatssprung KI 21.490 → 38.579 und Anteilsverlauf 7 → 25 → 26 → 40 %; YTD-Übertreffen der 2025-Vorjahreszahl 54.836 bereits zur Jahresmitte als Beleg für die Beschleunigung der KI-Sichtbarkeit); § 11.5 neuer Sammelbeleg „Challenger, Gray & Christmas / CNBC / Tom's Hardware / Yahoo Finance / Quartz / HR Director (5. Juni 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Schließt die in § 1.1 dokumentierte Reihe der Challenger-Aggregate (März, April, Mai 2026) ohne Lücke und liefert mit dem 40-%-Wert den höchsten je gemessenen Monatsanteil seit Tracking-Beginn 2023 — ein quantitativer Marker für die in § 8.4 entwickelte Stabilitätslinie, der zugleich von der Differenzierungslinie der Washington Post (1. Mai 2026: nicht alles KI) nicht widerlegt, sondern relativiert wird (auch beim 40-%-Wert sind 60 % nicht KI-bezogen). Das YTD-Übertreffen der 2025-Vorjahreszahl in der Mitte des Jahres ist die zentrale neue Größenordnungs-Aussage gegenüber Version 22.0. |
| 3 | Uber Technologies — Personalreduktion am 3. Juni 2026: 23 % der *People-and-Places*-Division (Human Resources, Recruiting, Workplace Facilities, Culture); rund 1 % der weltweit ca. 34.000 Konzernbeschäftigten; offizielle Begründung Khosrowshahi/Hazelbaker: „organisationsbezogen, nicht KI-getrieben". Kontext: 95 % der Ingenieure nutzen KI-Tools monatlich; rund 70 % des Konzern-Codes KI-generiert; AI-Coding-Tools-Budget im April 2026 in vier Monaten ausgeschöpft (1.500-USD-Soft-Cap pro Ingenieur und Monat). Forrester-Analyst J. P. Gownder ordnet das Muster als „AI washing" ein. Quellen: CNBC (3. Juni), TechTimes (5. Juni), NewsX, Layoffhedge. | § 1.1 (Spiegelbild zur Cloudflare-Logik: dasselbe Phänomen mit umgekehrter Selbstbeschreibung; Hervorhebung als Beleg für die in § 9.1 dokumentierten Mess- und Kausalattributionsprobleme); § 11.5 neuer Sammelbeleg „CNBC / TechTimes / NewsX / Layoffhedge (3.–5. Juni 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Der Fall ist methodisch zentral für die in § 9.1 dokumentierten Kausalattributionsprobleme einer Typ-5-Ersatzabgabe (§ 2.1): Cloudflare deklariert KI explizit als Treiber, Uber dementiert das bei vergleichbarer interner KI-Durchdringung — die in der *Washington-Post*-Differenzierung vom 1. Mai 2026 formulierte Mehrkanalerklärung wird durch das *„AI washing"*-Konzept (Forrester, Juni 2026) gespiegelt und auf den Fall ohne KI-Selbstzuschreibung ausgedehnt. Für die Aggregat-Statistik (Challenger 38.579 KI-bezogen) bedeutet das, dass die Zahl nach unten wie nach oben verzerrt sein kann. |
| 4 | TechTimes/TrueUp/SkillSyncer-Aggregation — Tech-Layoff-Tracker-Stand zum 5. Juni 2026: 149.935 betroffene Personen aus 363 Layoff-Ereignissen (rund 974 Stellen pro Tag); 2026-Tempo gegenüber 2025 um rund 44 % beschleunigt; Reihenfortschreibung gegenüber Vorlauf-Stand 127.411 zum 8. Mai 2026: +22.524 Personen in 28 Tagen (+18 %). Quellen: TechTimes (5. Juni 2026), TrueUp Dashboard, SkillSyncer Dashboard. | § 1.1 (Tagesfortschreibung der Tracker-Reihe in den bestehenden Block 25. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai 2026 → 5. Juni 2026 eingegliedert); § 11.5 neuer Eintrag „TechTimes / TrueUp / SkillSyncer (Stand 5. Juni 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Schließt die Tracker-Reihe an den Tag des Laufs an und zeigt mit dem 4-Wochen-Sprung +22.524 / +18 %, dass die im Mai dokumentierte Welle nicht ausgelaufen ist; das 2026-Tempo-Plus von 44 % gegenüber 2025 bestätigt den Challenger-Befund methodisch unabhängig. Stützt die in § 8.4 entwickelte Stabilitätslinie quantitativ. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Anthropic Economic Index — kein neuer Hauptbericht zwischen 9. Mai und 6. Juni 2026; der März-2026-Bericht *„Learning curves"* (Februar-2026-Daten) und der April-2026-Survey bleiben in § 3.5 referenziert.
- Dario Amodei *Jevons-Paradox*-Pivot (Anthropic-Briefing Lower Manhattan, ca. 5. Mai 2026) — liegt knapp vor dem 7-Tage-Fenster für Cluster A/D und damit außerhalb; in einem späteren Lauf zu prüfen, wenn ein schriftliches Folgepapier vorliegt.
- NVIDIA Q1-FY27-Earnings (20. Mai 2026, $81,6 Mrd. Gesamterlös, $75,2 Mrd. Data Center, Sovereign AI > $30 Mrd. in FY26) — Cluster I/F außerhalb des 48-Stunden-Fensters; bestehender § 1.1-Hyperscaler-Capex-Block bleibt aktuell. Eine Einarbeitung wäre möglich, aber die spezifische Aussage stützt eine bereits dokumentierte Linie ohne neue Stellgröße — Lauf-Empfehlung: bei nächster Tagesaktualisierung im Capex-Block aufnehmen.
- IFR World Robotics 2026 (Januar 2026 publiziert) — außerhalb 7-Tage-Fenster und bereits indirekt in § 1.1 (Robotik-Adoption) abgedeckt.
- GKV-Beitragssatzstabilisierungsgesetz — 1. Bundesratsdurchgang am 12. Juni 2026, 2. Durchgang am 10. Juli 2026; beide nach dem Stichtag. In den nächsten Läufen aufzunehmen.
- KI-MIG (KI-Marktüberwachungs- und Innovationsförderungsgesetz, Kabinettsbeschluss 11. Februar 2026; BMDS) — außerhalb 7-Tage-Fenster und thematisch primär AI-Act-Implementierung, nicht KI-Besteuerung; im Aktualitätshinweis-Verweis auf den 2. August 2026 als Anwendungsbeginn der AI-Act-Hauptbestimmungen abgedeckt.
- Bundesbank-Symposium 2026, Sachverständigenrat-Frühjahrsgutachten — keine spezifische Robotersteuer- oder Wertschöpfungsabgaben-Bewegung im 7-Tage-Fenster identifiziert.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide Treffer im 7-Tage-Fenster; Empfehlung für die nächsten Läufe bestehend.
- Cluster J (Robotik) — im 48-Stunden-Fenster ohne politisch-fiskalisch relevante Tagesmeldungen.
- Microsoft VRSAR — Annahmefrist läuft am 8. Juni 2026 ab (Vorlauf, kein Vollzug); im Aktualitätshinweis weiterhin nur als laufendes Verfahren referenziert.

### Prüfergebnis

| Prüfschritt | Ergebnis | Auffälligkeiten |
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; ein neuer Block in § 4.5 *„Sanders' American AI Sovereign Wealth Fund Act (Juni 2026)"* eingefügt zwischen dem bestehenden Sanders-Folgeinitiativen-Block und dem Maine-Sub-föderale-Parallele-Block — Konstruktion analog zu den bestehenden 4.5-Blöcken; keine leeren Abschnitte. |
...
| 2.1.3 Querverweise | OK | Der neue § 4.5-Block verweist auf § 4.3 (verfassungsrechtliche Fragen), § 5.4 (Staatsfonds und Dividendenmodelle), § 8.3 (Teilhabefrage) — alle Ziele existieren. Der ergänzte § 5.4-Satz verweist auf § 4.5 — Ziel existiert. Die ergänzte § 8.3-Passage verweist auf § 4.5 und § 5.4 — beide Ziele existieren. Art.-14-GG- und Art.-15-GG-Querverweise greifen auf § 4.3 zurück, wo Art. 14 und Art. 105 GG bereits behandelt werden; Art. 15 GG wird als ergänzende verfassungsrechtliche Vorfrage zur Sozialisierung neu in Bezug genommen, ohne § 4.3 inhaltlich zu verändern. |
| 2.1.4 Roter Faden | OK | Die Sanders/Trump-Konvergenz wird als Pol-Verschiebung zur in § 8.3 abgelehnten Eigentumslogik eingeführt — die Deutschland-These bleibt als eigenständige Positionierung erkennbar, weil § 8.3 ausdrücklich die mittelbare, abschöpfungsbasierte Pfadlogik als für den deutschen Kontext überlegen markiert. Die § 1.1-Ergänzungen sind eine Fortschreibung des bestehenden Layoff-/Tracker-/Challenger-Aggregat-Blocks; der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; ein neuer Lead-In („Sanders' American AI Sovereign Wealth Fund Act (Juni 2026):") einheitlich zum bestehenden 4.5-Stil formatiert; bestehende Lead-Ins unverändert; Versionszeile im Dokumentkopf (22.0 → 23.0; Stand Mai → Juni 2026) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Daten und -Namen (NYT-Veröffentlichungsdatum 1. Juni 2026, Bill-Titel *American A.I. Sovereign Wealth Fund Act*, 50 %-Anteilsabgabe, namentlich OpenAI/Anthropic/xAI, Stimmrechte und Vorstandsvertretung) wörtlich aus dem op-ed-Volltext auf sanders.senate.gov (primär) und mehreren unabhängigen Sekundärquellen (CNBC, Fortune, Hill, Newsweek, Common Dreams, Benzinga); Trump-Aussage (5. Juni 2026, „make them a partnership in this revolution") wörtlich aus CNBC und Fortune; Bessent-Lutnick-Vorentwurf bezeugt durch CBS News (Vorlauf); Sanders-Altman-Gespräch 3. Juni 2026 bezeugt durch Fortune und Sanders-Pressemeldung. Challenger-Zahlen (97.006 Gesamt, 38.579 KI, 40 %, 87.714 / 22 % YTD, 397.755 YTD-Gesamt, 38.242 Tech Mai, 123.653 Tech YTD, +66 %) wörtlich aus dem Challenger-Originalreport vom 5. Juni 2026 und CNBC/Tom's-Hardware-Wiedergabe. Uber-Zahlen (23 % der People-and-Places-Division, weniger als 1 % der ~34.000 Konzernbeschäftigten, 95 % KI-Tool-Nutzung, ~70 % KI-Code, AI-Budget-Erschöpfung in 4 Monaten, 1.500-USD-Cap) wörtlich aus CNBC/TechTimes. Tracker-Stand 149.935 / 363 / 974 pro Tag wörtlich aus TechTimes (5. Juni 2026). |
| 2.2.2 Redundanzprüfung | OK | Der Staatsfonds-Gedanke wird in § 5.4 (Einführung) und § 8.3 (Teilhabefrage) wie bisher querverweisend geführt; die neue Sanders/Trump-Linie wird in § 4.5 eingeführt und in § 5.4 sowie § 8.3 nur per Verweis aufgenommen — keine Doppelung. Die Cloudflare-/Coinbase-/PayPal-/Freshworks-/Cognizant-Welle bleibt in § 1.1 als Mai-2026-Sequenz erhalten; die Juni-2026-Ergänzung schließt mit dem Mai-Challenger-Aggregat und dem Uber-Spiegelfall daran an, ohne den Mai-Stoff zu duplizieren. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen Veredelungsstrategie, Wertschöpfungsabgabe, Staatsfonds) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten. Der Sanders-Vorstoß wird ausdrücklich als *eigentumsrechtliche* statt steuerliche Logik markiert und damit von Typ 5 (zielgerichtete Ersatzabgabe nach § 2.1) abgegrenzt. Konjunktiv-Regel gemäß Claude.md § 4.2 eingehalten: „würde", „sollte", „erhielte" für noch nicht eingebrachte Gesetzgebung; faktische Aussagen (Trump-Statement, Bessent-Lutnick-Vorentwurf, Sanders-Altman-Gespräch) im Indikativ als belegte Tatsachen referiert. |
| 2.2.4 Ausgewogenheit | OK | Die Sanders/Trump-Konvergenz wird neutral wiedergegeben; die Annahmewahrscheinlichkeit explizit als „nicht auszuschließen", nicht als hoch eingeschätzt. Gegenstimmen sind in § 11.5 dokumentiert (Reason: „doesn't understand AI or wealth"; Bloomberg Editorial Board 29. April 2026 weiterhin in § 4.5 und § 11.5 referenziert). Der Uber-Fall wird mit beiden Seiten dargestellt (Konzern-Selbstbeschreibung *vs.* Forrester-„AI washing"-Einordnung). Die Challenger-Aggregate werden gemäß Claude.md § 4.2 als Modellprognose-/Stichprobenbefund kontextualisiert (60 % auch im Hoch-Monat Mai nicht KI-bezogen). |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. Schreibweise „Konzernpräsidentin" für Jill Hazelbaker korrigiert gegenüber initialem maskulinem Entwurf. |
| 2.3.2 Terminologie | OK | „Public Wealth Fund", „American A.I. Sovereign Wealth Fund Act", „AI washing", „People-and-Places-Division" als zitierte Begriffe in Anführungszeichen bzw. mit Kursivierung; bestehende Schreibweisen „TrueUp", „SkillSyncer", „VRSAR", „IRAP", „OECD Pillar 2" einheitlich. Erstnennungen englischer Termini knapp eingeordnet (z. B. „Anteilsabgabe statt Steuer", „AI washing" als „die Aussage 'nicht KI-getrieben' decke sich nicht zwingend mit der zugleich kommunizierten internen KI-Durchdringung"). |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders-NYT-Op-Ed und Trump-Konvergenzsignal als zwei neue Einträge in § 11.3 (institutionell-politische Dokumente — Sanders-Senate-Quelle plus CNBC/Fortune-Sammelbeleg) korrekt zugeordnet; Sammelberichterstattung zur Sanders-Initiative (Fortune, Common Dreams, Newsweek, The Hill, Yahoo Finance) sowie Washington Post / Reason (Mainstream- und libertäre Kommentierung) in § 11.5 (journalistisch) korrekt zugeordnet; Challenger-Mai-Bericht in § 11.5 (journalistisch-praxisorientiert, ergänzend zur bestehenden Challenger-April-Quelle); Uber-Sammelbeleg in § 11.5; Tech-Layoff-Tracker-Aktualisierung in § 11.5 in der Tracker-Reihe. Keine Karteileichen. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-Stil eingehalten; URLs vollständig (kein Shortener); Datumsangaben einheitlich (Tag. Monat YYYY); Sammelbelege mit „/"-Trenner zwischen Quellen; mehrere URLs je Sammelbeleg mit „|"-Trenner getrennt — Konsistenz mit dem bestehenden § 11.5-Format. |
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders: Primärquelle ist der op-ed-Volltext auf sanders.senate.gov, von der NYT zuerst veröffentlicht (Sanders ist Senator und Verfasser — höchstes Quellenniveau); Trump-Aussage: CNBC-Primärbericht mit Direktzitat aus dem Reporter-Statement; Bessent-Lutnick-Vorentwurf: CBS-News-Recherche mit interner Quellenangabe. Challenger: Primärquelle ist der Original-Report von Challenger, Gray & Christmas, von CNBC/Tom's Hardware/Yahoo Finance/Quartz/HR Director gespiegelt. Uber: Primärquelle ist die Memo-Veröffentlichung von Khosrowshahi/Hazelbaker (über CNBC zugänglich gemacht); Sekundärquellen TechTimes/NewsX/Layoffhedge. Tracker: TechTimes-Bericht mit TrueUp- und SkillSyncer-Verlinkung. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: sanders.senate.gov/op-eds/the-public-should-own-half-of-the-big-a-i-companies/ (öffentlich, Inhalt mit dem op-ed-Volltext konsistent); cnbc.com/2026/06/05/trump-open-ai-altman-stake.html (öffentlich); fortune.com/2026/06/03/bernie-sanders-ai-ownership-sovereign-wealth-fund-electrification/ (öffentlich); challengergray.com/blog/challenger-report-may-job-cuts-rise-16-from-april-highest-may-total-since-2020/ (öffentlich, Inhalt konsistent); cnbc.com/2026/06/05/ai-is-now-the-leading-reason-companies-give-for-cutting-jobs-says-new-report-what-that-means-for-workers.html (öffentlich); techtimes.com/articles/317842/20260605/uber-cuts-23-hr-staff-new-president-denies-ai-role-95-engineers-use-it-daily.htm (öffentlich); techtimes.com/articles/317848/20260605/tech-layoffs-2026-hit-149935-uber-cuts-hr-days-after-ai-drained-its-coding-budget.htm (öffentlich). Die CNBC-Uber-Primärseite cnbc.com/2026/06/03/uber-layoffs-people-division-ai.html antwortete am 6. Juni 2026 mit 403 Forbidden für anonyme Programmzugriffe; in § 11.5 als URL erhalten (Zugriff über regulären Browser unverändert möglich), die inhaltlichen Aussagen aus TechTimes/NewsX/Layoffhedge bestätigt. |
| 2.4.5 Zitatgenauigkeit | OK | Kernzitat Sanders („would create a sovereign wealth fund through a one-time 50 percent tax — not on the profits of OpenAI, Anthropic, xAI and other companies, but paid with something far more valuable than that: the stock") aus dem op-ed-Volltext; Kernzitat Trump („You make them a partnership in this revolution. It would be a beautiful thing") aus CNBC; Kernzitat Andy Challenger („AI is now the leading reason companies give for cutting jobs and the primary industry citing it is Technology") aus dem Challenger-Originalreport; Uber-Aussagen (Khosrowshahi: „maximize the effectiveness of the People team"; Hazelbaker: „complex and fragmented, with overlapping responsibilities, unclear ownership, and teams operating too far from the businesses and partners they support") wörtlich aus CNBC/TechTimes. Sämtliche prognostische und legislative Aussagen sind im Konjunktiv referiert (siehe 2.2.3). |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Belege benötigen keine Verifizierungsmarkierung (Sanders-Op-Ed ist Primärquelle des Senators selbst auf senate.gov-Domain; Trump-Aussage durch zwei unabhängige Sekundärquellen [CNBC, Fortune] mit Direktzitat belegt; Challenger-Report ist Primärquelle der Privatdatenfirma; Uber-Memo über CNBC zugänglich). Eine Bill-Nummer für den *American A.I. Sovereign Wealth Fund Act* liegt zum Recherchezeitpunkt nicht vor — im § 4.5-Text und im § 11.3-Eintrag explizit so gekennzeichnet („in den kommenden Wochen"). |
| 2.5 Versionskonsistenz und Lizenz | OK | Versionsnummer 23.0 in Dokumentkopf, Aktualitätshinweis, README.md (Versionszeile, Zitiervorschlag, KI-Offenlegung mit neuem Versionseintrag) und diesem Validierungsblock identisch; Stand „Juni 2026" konsistent in Dokumentkopf und README.md geändert; CC-BY-4.0-Hinweis und Haftungshinweis unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Keine Skripte vorhanden; manuelle Stichproben gemäß § 2.6 ersetzen den automatisierten Teil. |

### Gefundene Fehler

Keine — die vier Ergänzungen sind eine Erweiterung der bestehenden Linien (Politik-Initiativen § 4.5, Aggregat-Layoff-Statistik § 1.1, Tracker-Reihe § 1.1, Staatsfonds-Linie § 5.4 / § 8.3) ohne Korrekturbedarf an anderen Aussagen. Der initial entworfene Schreibfehler „Konzernpräsidenten" für Jill Hazelbaker wurde vor Speicherung des § 1.1-Texts auf „Konzernpräsidentin" korrigiert.
