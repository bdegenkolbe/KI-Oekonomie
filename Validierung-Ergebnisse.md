...
## Validierung 13. Mai 2026 (Lauf 001 vom 13. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Regulärer Daily-Update-Lauf am 13. Mai 2026 (fünf Tage nach Lauf 001 vom 8. Mai 2026). Web-Recherche im Korridor der Cluster A–J: Optimalsteuer-/Aufgabenforschung (A); Robotersteuer/Wertschöpfungsabgabe DE/EU (B); internationale Praxis (C); Politik-Initiativen (D); Arbeitsmarkt- und Sozialversicherungsdaten (E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (F); Gesundheitswesen (G); Deutschland-These-Bezugspunkte (H); Frontier-Modelle 48-Stunden-Fenster (I); Robotik (J). Sechs belegbare Treffer im 7-Tage- bzw. 48-Stunden-Fenster identifiziert und eingearbeitet: provisorische Trilog-Einigung Digital Omnibus on AI (7. Mai 2026, Cluster B); Vorschlag „National Dividend" Kim Yong-beom (12. Mai 2026, Cluster C/D); GM-IT-Layoffs (11. Mai 2026, Cluster F); Fidelity-Layoffs (7./8. Mai 2026, Cluster F); Strauss-Borrelli-Cloudflare-WARN-Untersuchung (12. Mai 2026, Cluster F/B); TrueUp-Tagesfortschreibung (12. Mai 2026, Cluster F).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU AI Act — provisorische politische Einigung zum *Digital Omnibus on AI* in den frühen Morgenstunden des 7. Mai 2026 (vor der ursprünglich für den 13. Mai 2026 angesetzten dritten Trilog-Runde). Verbindliche neue Stichtage: Anhang III (eigenständige Hochrisiko-Systeme) 2. Dezember 2027; Anhang I (KI in regulierten Produkten) 2. August 2028; Artikel 50 Abs. 2 Watermarking für Bestandsmodelle 2. Dezember 2026. Streitpunkt Konformitätsbewertung Anhang I über sektorale Pfadtrennung (Maschinenverordnung herausgenommen, delegierte Rechtsakte für Medizinprodukte/Spielzeug/Aufzüge) gelöst; neues Verbotsmerkmal in Artikel 5 für CSAM-/NCII-generierende Systeme; Selbsteinstufungs-Registrierung über Anhang VIII Section B erhalten. Quellen: Consilium (7. Mai), Modulos, Hogan Lovells, Bird & Bird, Matheson, Pinsent Masons. | § 4.4 (neuer eigenständiger Block „EU AI Act — provisorische Trilog-Einigung zum Digital Omnibus on AI (7. Mai 2026)" vor dem Plattform-Digitalabgabe-Block); § 11.3 (neue Einträge: Consilium-Pressemitteilung 7. Mai 2026 und Kanzlei-/Beratungs­zusammenstellung Modulos/Hogan Lovells/Bird & Bird/Matheson/Pinsent Masons; bestehender Trilog-Eintrag aktualisiert); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erste verbindliche Folgeentscheidung zum AI Act nach dem im letzten Lauf dokumentierten Verhandlungsstillstand; die im letzten Lauf als „Stichtag nach Lauf" verworfene 13.-Mai-Trilog­runde wurde durch die frühere Einigung obsolet. Verschiebung der Hochrisiko-Pflichten in den Dezember 2027 verstärkt einseitig die in § 1.1 / § 8.3 beschriebene Asymmetrie zwischen Personalreduktion und Infrastrukturausbau. |
| 2 | Republik Korea — am 12. Mai 2026 vom Senior Presidential Secretary for Policy Kim Yong-beom in einem Facebook-Beitrag vorgeschlagene „National Dividend" auf Übergewinne von KI-Halbleiter­konzernen (namentlich Samsung Electronics und SK hynix). Aufkommens­zweckbindung: Gründungs­förderung Jugend, Grundeinkommen ländliche/Fischerei­regionen, Künstler­förderung, Stärkung der Renten. Stützung u. a. durch Abgeordnete Moon Geum-ju (Demokratische Partei); keine formelle Regierungsposition zum Stichtag. Quellen: Bloomberg (12. Mai), techxplore, AI Commission. | § 6.1 (neuer Block „Vorstoß Mai 2026 — ‚National Dividend' auf KI-Übergewinne" hinter dem 2017er-Abschnitt); § 11.3 (neuer Eintrag „Republik Korea — Office of the President / Kim Yong-beom (12. Mai 2026)"); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erste konkret artikulierte Bürger­dividenden-Konstruktion durch ein hochrangiges Mitglied einer amtierenden Regierung — mit Anknüpfung an einen Übergewinn-Begriff im Stil einer Windfall-Tax statt an Wertschöpfung. Dokumentiert, dass die in § 8.3 entwickelte Staatsfonds-/Teilhabelogik in einem hochautomatisierten ostasiatischen Industriestaat anschlussfähig ist (spiegelbildliche Risikoanalyse: Lohnbasis erodiert in Südkorea primär durch KI-Halbleiter-Rente). |
| 3 | General Motors — Streichung von rund 600 IT-Stellen (etwas mehr als 10 % der konzern­weiten IT) am 11. Mai 2026. Begründung: Verschiebung des Anforderungsprofils zu AI-native Development, Daten- und Cloud-Engineering, Agenten-/Modellentwicklung sowie Prompt-Engineering; gleichzeitig laufen Neueinstellungen in diesen Bereichen. Quellen: TechCrunch, CNBC (jeweils 11. Mai 2026). | § 1.1 (eingebettet in den fortlaufenden Layoff-Block hinter der Bloomberg/Washington-Post-Differenzierung); § 11.5 neuer Eintrag „TechCrunch / CNBC (11. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erster nicht-Tech-Industriekonzern, der eine konzern-IT-Reduktion in dieser Größenordnung ausdrücklich als KI-getriebene Qualifikations-Umschichtung — und nicht als Kostenmaßnahme — begründet. Zeigt, dass das in den Tech-Layoffs der vergangenen Wochen prägende Muster „Abbau-bei-Neueinstellung" jetzt auch in der klassischen Industrie ankommt; verschärft die in § 9.1 dokumentierte Kausalattributions-Problematik (Brutto-Streichung vs. saldierte Reduktion). |
| 4 | Fidelity Investments — Streichung von rund 800 Tech-/Produkt-Stellen (rund 1 % von 80.000 Beschäftigten) am 7./8. Mai 2026; gleichzeitig Ankündigung von 3.300 Neueinstellungen in 2026 (rund 1.650 in Tech/Produkt, rund 2.000 in Einstiegspositionen). Übergang von kleinteiligen *agile*-Squads zu größeren, durchgängig KI-gestützten Build-Teams. Quellen: Bloomberg (7. Mai), Boston Globe (7. Mai), Boston.com (11. Mai), Citywire. | § 1.1 (eingebettet in den fortlaufenden Layoff-Block); § 11.5 neuer Eintrag „Bloomberg / Boston Globe / Boston.com / Citywire (7./8./11. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Klassischer Finanzdienstleister mit explizitem AI-native-Restrukturierungsnarrativ und parallelem Hiring-Plan — Beleg, dass das Muster aus § 1.1 über reine Tech-Konzerne hinaus reicht. Das parallele Hiring relativiert die Streichungszahl und stärkt damit die in § 9.1 / § 9.2 dokumentierten Mess- und Definitionsprobleme einer Displacement-basierten Anknüpfung. |
| 5 | Strauss Borrelli PLLC — am 12. Mai 2026 öffentlich angekündigte Sammelklage­untersuchung zu möglichen Verstößen von *Cloudflare* gegen den *Worker Adjustment and Retraining Notification Act* (WARN) bei der am 7. Mai 2026 dem kalifornischen *Employment Development Department* angezeigten Streichung von 224 Beschäftigten in San Francisco; Vorwurf: möglicherweise weniger als 60 Tage Vorankündigung. Quelle: Strauss Borrelli PLLC (12. Mai 2026). | § 1.1 (eingebettet in den fortlaufenden Layoff-Block, mit Querverweis auf die in § 4.5 (Connecticut SB 5) angelegte AI/Technology-Change-Disclosure ab 1. Oktober 2026); § 11.5 neuer Eintrag „Strauss Borrelli PLLC (12. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erster dokumentierter rechtlicher Pushback gegen die KI-getriebene Layoff-Welle 2026; konkretes Beispiel dafür, dass die in § 4.5 dokumentierte WARN-AI-Disclosure-Logik von Connecticut SB 5 in einem WARN-Standardverfahren (60-Tage-Vorankündigung) bereits justiziable Ankerpunkte schafft. Relevanz für § 9.1 (Messbarkeit), § 4.5 (Disclosure-Pflichten als Vorstufe einer fiskalischen Anknüpfung). |
| 6 | TrueUp Tracker — Tagesfortschreibung zum 12. Mai 2026: 128.270 Personen aus 286 Layoff-Meldungen (rund 1.002 Stellen pro Tag); SkillSyncer unverändert bei 113.863 Personen aus 179 Ereignissen; ergänzendes American-Bazaar-Aggregat: rund 38.000 Stellenstreichungen in den ersten zehn Tagen Mai 2026 über Technologie-, Finanz-, Luftfahrt-, Medien- und Cybersicherheitsbranchen hinweg. Quellen: TrueUp (Stand 12. Mai), American Bazaar (10. Mai). | § 1.1 (Tagesfortschreibung der Tracker-Reihe 8. Mai → 12. Mai 2026 eingegliedert); § 11.5 neuer Eintrag „TrueUp / American Bazaar (Stand 11./12. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Setzt die Tracker-Reihe an den Tag des Laufs an; das Niveau bleibt über 1.000 Personen pro Tag, die in § 8.4 entwickelte Stabilitätslinie wird quantitativ unterfüttert. Das American-Bazaar-Aggregat erweitert die KI-Disruptions-Sichtbarkeit auf Branchen außerhalb der Tech-Tracker-Engfassung (Luftfahrt, Medien, Cybersicherheit). |

**Nicht aufgenommen (bewusste Auslassungen):**
- Connecticut SB 5 — Lamont-Unterzeichnung weiterhin nicht mit Datum dokumentiert; im § 4.5-Block bleibt die bestehende Formulierung („angekündigte Unterzeichnung") korrekt; in einem späteren Lauf nachzutragen, sobald die formale Unterzeichnung mit Datum belegt ist.
- GM-Layoff-Spannweite — einige Sekundärquellen sprechen von „mehreren hundert", die TechCrunch-Primärquelle nennt rund 600 / >10 % der IT; die konservative Zahl ist übernommen.
- Bundesrat 1065. Sitzung 8. Mai 2026 — die offizielle Rückblicks-Seite (1065-pk.html) listet zum Recherchezeitpunkt private Altersvorsorge-Reform, Gaspreis-Entschließung und Steuer- bzw. Verbraucherthemen; ein dezidierter GKV-Beschluss findet sich dort nicht; bestehender Aktualitätshinweis bleibt — eine Bundesrat-Stellungnahme wird in einem späteren Lauf zu prüfen sein, sobald die Drucksachen-Nummer veröffentlicht ist.
- Anthropic Economic Index — kein neuer Bericht seit dem 24. März 2026 / 5. März 2026 / 22. April 2026; bestehender § 3.5-Block bleibt aktuell.
- Generationenkapital — keine neuen Tranchen- oder Renditeangaben seit dem letzten Lauf.
- Plattform-Digitalabgabe (Weimer) — keine Bewegung seit Eckpunktepapier-Ankündigung; bleibt bei dem in § 4.4 referierten Verhandlungsstand.
- Sanders robot tax — formaler Bill-Text weiterhin nicht eingebracht (Stand 13. Mai 2026); bestehender § 4.5-Block bleibt korrekt.
...
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; keine neuen Unterüberschriften; keine leeren Abschnitte; neue Blöcke in § 4.4 (Trilog-Einigung), § 6.1 (Südkorea „National Dividend") sowie Ergänzungen in § 1.1 als zusätzlicher Satzlauf am Ende des bestehenden Layoff-Absatzes. |
...
| 2.1.3 Querverweise | OK | Neue Verweise § 4.5 (Connecticut SB 5) und § 4.4 (OECD Pillar 2) aus dem Cloudflare-WARN-Block; § 8.3 (Teilhabefrage) und § 5.4 (Staatsfonds) aus dem Südkorea-Block; § 1.1 und § 8.3 aus dem AI-Act-Omnibus-Block; alle Ziele existieren. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen folgen dem etablierten Aufbau Literaturrezeption → Position → Umsetzung. Der Cluster-B-Block (AI Act Omnibus) verbleibt in Kapitel 4 (rechtliche Perspektive); der Cluster-C-Block (Südkorea) verbleibt in Kapitel 6 (internationale Praxis); die Layoff-Ergänzungen erweitern den bestehenden § 1.1-Block. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; keine neuen Tabellen; bestehende Lead-Ins (fett) konsistent fortgeführt; Versionszeile im Dokumentkopf (22.0 → 23.0) geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | AI-Act-Omnibus-Einigung 7. Mai 2026 und neue Stichtage (Anhang III 2. Dezember 2027, Anhang I 2. August 2028, Artikel 50 Abs. 2 für Bestandsmodelle 2. Dezember 2026) durch Consilium-Pressemitteilung und Kanzlei-Analysen (Modulos, Hogan Lovells, Bird & Bird, Matheson, Pinsent Masons) bestätigt. Südkorea Kim Yong-beom (12. Mai 2026) durch Bloomberg/techxplore/AI Commission bestätigt. GM-IT-Layoffs (11. Mai 2026, rund 600 / >10 %) durch TechCrunch und CNBC bestätigt. Fidelity (7./8. Mai 2026, rund 800 / 80.000, 3.300 Neueinstellungen) durch Bloomberg/Boston Globe/Boston.com/Citywire bestätigt. Cloudflare-WARN-Investigation 12. Mai 2026 (224 Beschäftigte in San Francisco) durch Strauss Borrelli PLLC bestätigt. TrueUp-Stand 12. Mai 2026 (128.270 / 286, rund 1.002/Tag) durch TrueUp-Dashboard bestätigt. |
| 2.2.2 Redundanzprüfung | OK | AI-Act-Omnibus-Block in § 4.4 ergänzt die bestehenden Trilog-Notizen ohne Doppelung — der bisherige Trilog-Stand (28. April 2026 ohne Einigung; 13. Mai 2026 nächste Runde) bleibt im Bestand­eintrag, der Folgeeintrag dokumentiert die Auflösung. Südkorea-Block in § 6.1 bildet einen abgegrenzten zweiten Strang neben dem 2017er-Investitions-Abzug. Layoff-Ergänzungen sind Tagesfortschreibung der bestehenden Reihe. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; der südkoreanische Vorschlag wird ausdrücklich als „Übergewinn-Begriff im Stil einer Windfall-Tax statt Wertschöpfung" eingeordnet — keine Vermengung mit der § 5.1-Linie. |
| 2.2.4 Ausgewogenheit | OK | Der AI-Act-Omnibus-Block dokumentiert sowohl die zeitliche Entlastung der Anbieter (verschobene Stichtage) als auch die fortbestehende Registrierungs-Logik (Anhang VIII Section B); der Südkorea-Block macht die fehlende formelle Regierungs- und Industriereaktion zum Stichtag explizit; der GM- und Fidelity-Block hebt die parallelen Neueinstellungen hervor; der WARN-Block bleibt im Konjunktiv („möglicherweise"). |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Agentic", „AI-native", „National Dividend", „Windfall-Tax", „Anhang I/III", „Watermarking", „Section B" in einheitlicher Schreibweise; APA-konforme Quellenangabe für alle neuen Belege. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sechs neue Belegcluster in § 11.3 (Consilium 7. Mai; Modulos/Hogan Lovells/Bird & Bird/Matheson/Pinsent Masons; Republik Korea / Kim Yong-beom) und § 11.5 (TechCrunch/CNBC GM; Bloomberg/Boston Globe/Boston.com/Citywire Fidelity; Strauss Borrelli WARN; TrueUp/American Bazaar Tagesstand); keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | AI-Act-Omnibus: Primärquelle Consilium-Pressemitteilung (öffentlich) sowie fünf unabhängige Kanzlei-/Beratungs-Analysen. Südkorea: Primärquelle Facebook-Beitrag Kim Yong-beom (von Bloomberg, techxplore und AI Commission referiert). GM/Fidelity: Mehrere unabhängige Wirtschaftsmedien. Strauss Borrelli: öffentliche Investigation-Page der Kanzlei. TrueUp/American Bazaar: laufende Tracker-Daten. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe: consilium.europa.eu/.../2026/05/07/... (HTTP 403 für WebFetch, aber inhaltlich durch IAPP-, Hogan-Lovells- und Modulos-Sekundärseiten verifizierbar); techxplore.com/news/2026-05-south-korea-ai-profit-social.html (öffentlich, Inhalt konsistent); techcrunch.com/2026/05/11/gm-just-laid-off-... (öffentlich); bloomberg.com/news/articles/2026-05-07/fidelity-to-cut-800-staffers... (Paywall, Headline und Lead-Sätze in Fremdwiedergabe konsistent); straussborrelli.com/2026/05/12/cloudflare-inc-warn-act-investigation/ (öffentlich); trueup.io/layoffs (öffentlich; Tagesstand variiert ggf. mit aktuellen Tracker-Updates — Stand 12. Mai festgehalten). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen AI Act Omnibus (Anhang III 2. Dezember 2027; Anhang I 2. August 2028; Artikel 50 Abs. 2 → 2. Dezember 2026 für Bestandsmodelle; Artikel 5 CSAM/NCII; Anhang VIII Section B) wörtlich aus den Kanzlei-Analysen; Kernzahlen Südkorea (Kim Yong-beom als Senior Presidential Secretary for Policy, Samsung/SK hynix, Aufkommens­zweckbindung, Moon Geum-ju) wörtlich aus dem techxplore-Bericht; Kernzahlen GM (rund 600 / >10 %), Fidelity (rund 800 / 80.000, 3.300 Neueinstellungen, davon 1.650 Tech/Produkt und 2.000 Einstieg), Cloudflare-WARN (224 Beschäftigte San Francisco, 60-Tage-Frist) und TrueUp (128.270 / 286 / rund 1.002/Tag) wörtlich aus den verifizierten Primärquellen. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die sechs neuen Belegcluster benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen, in mehreren Fällen Primärquelle ohne Paywall). |
...
Keine — die sechs Ergänzungen sind Tagesaktualisierungen einer bestehenden Linie bzw. zwei neue eigenständige Blöcke (§ 4.4 AI Act Omnibus, § 6.1 Südkorea „National Dividend") ohne Korrekturbedarf an anderen Aussagen.
...
- Neue Version: 23.0.
- PDF erstellt: (folgt in Phase 5).
- Word erstellt: (folgt in Phase 5).
