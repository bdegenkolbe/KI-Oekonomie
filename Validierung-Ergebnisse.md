...
## Validierung 8. Juni 2026 (Lauf 001 vom 8. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster Daily-Update-Lauf nach einer einmonatigen Pause seit Lauf 001 vom 8. Mai 2026 (Version 22.0). Web-Recherche im Korridor der Cluster A–J am 8. Juni 2026: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Drei belegbare Treffer im Stichprobenzeitraum 1.–8. Juni 2026 identifiziert und eingearbeitet (Sanders-NYT-Op-Ed mit *American A.I. Sovereign Wealth Fund Act* vom 1. Juni 2026; Connecticut *SB 5*/CART Act als *Public Act 26-15* mit Unterzeichnung am 2. Juni 2026; Challenger-*Mai-2026-Job-Cuts-Report* veröffentlicht am 4. Juni 2026, ergänzt durch Trackerstände TrueUp 5. Juni / SkillSyncer 7. Juni 2026); alle übrigen recherchierten Themen waren in Version 22.0 bereits enthalten oder lagen außerhalb des 7-Tage- bzw. 48-Stunden-Korridors.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Sanders, B. (1. Juni 2026). *The Public Should Own Half of the Big A.I. Companies* (Op-Ed *New York Times*; Re-Publikation sanders.senate.gov): Ankündigung des *American A.I. Sovereign Wealth Fund Act* mit einmaliger 50 %-Aktien-Abgabe auf OpenAI, Anthropic und xAI; Einlage in einen öffentlichen Sovereign Wealth Fund mit universeller Dividende und späterer Finanzierung öffentlicher Güter (Gesundheit, Bildung, Wohnen); Stimmrechte und Aufsichtsratssitze für die Bundesregierung; Begründung über die Trainingsdaten-Logik („öffentliche Ressource wertvoller als Öl"). Politische Reaktionen: Warren (D-MA) prüfbereit; Graham (R-SC) „dead on arrival". Sekundärquellen: Fox Business, Yahoo Finance, Fortune, Washington Examiner. | § 4.5 neuer eigener Absatz „Sanders-Folgevorschlag — American A.I. Sovereign Wealth Fund Act (Juni 2026)" zwischen Connecticut-Block und Bloomberg-Editorial; § 11.3 neuer Eintrag „Sanders, B. (1. Juni 2026)" mit Re-Publikations-URL; § 11.5 neuer Sammelbeleg „Sanders / New York Times" mit fünf URLs; Aktualitätshinweis am Dokumentende um den Juni-2026-Befund ergänzt; README.md mit neuem Versionseintrag 23.0. | Der Entwurf liefert die zweite konkrete Operationalisierung eines US-Sovereign-Wealth-Modells (neben dem OpenAI-Papier vom April 2026) und radikalisiert die in § 5.4 referierte Linie um *Aktienzahlung statt Cash* und *Mitbestimmungsdimension* — ein qualitativ neues Politikinstrument, das in § 4.5 als eigenständiger Block neben den im Oktober 2025 vorgelegten Sanders-Report und den Data-Center-Moratorium-Entwurf vom 25. März 2026 zu stellen ist. Bemerkenswert ist die Konvergenz der progressiven (Sanders) und tech-industriellen (OpenAI) Vorschläge auf eine ähnliche fiskalisch-eigentumsrechtliche Architektur — ein zentraler neuer Befund des Frühjahrs 2026. |
| 2 | Connecticut General Assembly / Lamont (2. Juni 2026). Unterzeichnung von *SB 5* als *Public Act 26-15* (*Connecticut Artificial Intelligence Responsibility and Transparency Act*, *CART Act*); gestaffelte Geltungsdaten: 1. Oktober 2026 für AEDT-Rahmen, Anti-Diskriminierungs-Klarstellung, Frontier-Whistleblower-Schutz, WARN-AI-Disclosure, generative-AI-Provenance-Pflichten; 1. Januar 2027 für anonyme interne Meldewege bei großen Frontier-Entwicklern; 1. Oktober 2027 für deployerseitige Vorab-Information bei substantieller KI-Nutzung in Beschäftigungsentscheidungen. Quellen: Connecticut General Assembly (Public Act 26-15), Ropes & Gray (Juni 2026), Bloomberg Law (Juni 2026). | § 4.5 Aktualisierung des Connecticut-Blocks (Unterzeichnungsdatum 2. Juni 2026, *Public Act 26-15*, CART-Act-Bezeichnung; expliziter Hinweis, dass das fiskalische *Bill 515* für die nächste Sitzungsperiode formal offen bleibt); § 11.3 Eintrag „Connecticut General Assembly (April–Juni 2026)" aktualisiert mit Unterzeichnung 2. Juni 2026 und Public-Act-Link; zwei neue Sekundärquellen-Einträge „Ropes & Gray (Juni 2026)" und „Bloomberg Law (Juni 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Schließt die in Version 22.0 noch offene Lamont-Unterzeichnung; konkretisiert die in § 9.1 diskutierte Datengrundlagen-Frage über die ab 1. Oktober 2026 wirksame WARN-AI-Disclosure und differenziert den US-bundesstaatlichen Pfad: SB 5 bereitet die fiskalische Anknüpfung datengrundlagenseitig vor, schließt sie aber nicht selbst (Bill 515 weiterhin offen) — eine für die in § 4.5 entwickelte Zwei-Spur-Lesart wichtige Trennung. |
| 3 | Challenger, Gray & Christmas (4. Juni 2026). *Mai-2026-Job-Cuts-Report*: US-weite Stellenstreichungen Mai 2026 = 97.006 (+16 % MoM, +3 % YoY, höchster Mai-Wert seit dem Pandemie-Höhepunkt 2020 mit 397.016); KI-bezogene Streichungen 38.579 (40 % aller Mai-Streichungen — höchster Monatswert seit Beginn der Challenger-Tracking-Reihe 2023; dritter Monat in Folge führender Einzelgrund); Tech allein 38.242 (höchster Monatswert seit August 2024); YTD-KI 87.714 (22 % aller 2026-Streichungs­pläne, bereits über Gesamtjahr 2025 mit 54.836); YTD-Tech 123.653 (+66 % gegenüber Vorjahresstand 74.716). Parallel: TrueUp 149.935 Personen aus 363 Layoff-Meldungen am 5. Juni 2026 (rund 974 Stellen pro Tag); SkillSyncer 134.603 Personen aus 212 Ereignissen am 7. Juni 2026 (rund 852 Stellen pro Tag). Quellen: Challenger Gray (4. Juni 2026), CNBC (5. Juni 2026), Tom's Hardware, Let's Data Science, Tech Jacks, TrueUp, SkillSyncer, TechTimes. | § 1.1 Erweiterung des Layoff-/Tracker-Blocks um den Challenger-Mai-Report, die Juni-Trackerstände und den Hochrechnungspfad zum Jahresende (350.000+ möglich); § 11.5 zwei neue Sammelbelege „Challenger / CNBC / Tom's Hardware / Let's Data Science / Tech Jacks (4./5. Juni 2026)" und „TrueUp / SkillSyncer / TechTimes (5./7. Juni 2026)" mit fünf bzw. drei URLs; Aktualitätshinweis am Dokumentende um den Juni-2026-Befund ergänzt; README.md mit neuem Versionseintrag 23.0. | Liefert die methodisch unabhängige Aggregat-Bestätigung der KI-Verdrängungslinie für Mai 2026 und schärft die in § 1.1 referierte Reihe März → April → Mai mit dem höchsten je erfassten KI-bezogenen Monatswert; gleichzeitig wird der YTD-KI-Wert 87.714 erstmals oberhalb des Gesamtjahreswertes 2025 (54.836) ausgewiesen — ein qualitativer Befund, der die in § 8.4 entwickelte Stabilitätslinie weiter unterfüttert, ohne den aggregiert moderaten Befund aus § 3.5 (Yale Budget Lab, Anthropic Economic Index) umzukehren. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Bundesrat 1065. Sitzung 8. Mai 2026 — verbindliche Beschlüsse bereits in den Mai-Läufen über den Erstdurchgang dokumentiert; nachgelagerte Entwicklungen (zweite Lesung Bundestag) bis Stichtag 8. Juni 2026 ohne öffentliche Beschlüsse innerhalb des Korridors.
- Anthropic Economic Index — kein neuer Bericht zwischen 24. März 2026 (*„Learning curves"*) und 8. Juni 2026; bestehender § 3.5-Block bleibt aktuell.
- NBER WP 33509 / 33777 (AI labor displacement) — beide außerhalb 7-Tage-Fenster; in einem späteren Vertiefungslauf für § 3 zu prüfen.
- China — 15. Fünfjahresplan, MIIT-Standardisierungssystem für humanoide Robotik (März 2026): außerhalb 7-Tage-Fenster, bereits in den Mai-Läufen verworfen.
- Hyperscaler-Q2-Capex-Daten (NVIDIA Blackwell, Microsoft, Alphabet, Amazon, Meta) — keine neuen Konzernzahlen mit Tagesimplikation im 48-Stunden-Fenster; bestehender 725-Mrd.-USD-Aggregatwert in § 1.1 bleibt aktuell.
- Tesla Optimus / Figure AI / Boston Dynamics — keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster.
- Frontier-Modell-Releases — keine Tagesmeldung mit politisch-fiskalischer Implikation im 48-Stunden-Fenster.
...
- EU AI Act Digital Omnibus — formale Adoption nach trilogärer Einigung vom 7. Mai 2026 für Juni/Juli 2026 erwartet; bis Stichtag 8. Juni 2026 keine veröffentlichte finale Rechtsfassung; bestehender § 4.3-Block bleibt korrekt.

### Prüfergebnis

| Prüfschritt | Ergebnis | Auffälligkeiten |
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; ein neuer Lead-In-Absatz „Sanders-Folgevorschlag — American A.I. Sovereign Wealth Fund Act (Juni 2026)" in § 4.5 zwischen dem Connecticut-Block und dem Bloomberg-Editorial eingefügt; keine leeren Abschnitte. |
...
| 2.1.3 Querverweise | OK | Die neue Sanders-Passage verweist auf § 5.4 (Staatsfonds-Linie), § 8.3 (Teilhabe), § 9.3 (Liquiditätsproblem windfall-orientierter Abgabe) — alle Ziele existieren; die neue Challenger-Mai-Passage in § 1.1 referiert implizit § 8.4 (Stabilität), § 3.5 (Anthropic / Yale Budget Lab) und § 5.1/§ 8.3 (Maschinenkapital-Anknüpfung). |
| 2.1.4 Roter Faden | OK | Sanders-Block fügt sich in die etablierte § 4.5-Linie (Sanders-Report Oktober 2025 → S. 4214 25. März 2026 → Op-Ed 16. April 2026 → Sovereign-Wealth-Fund-Act 1. Juni 2026) ohne Bruch ein; Connecticut-Aktualisierung verlängert die bestehende Beobachtungslinie um das Unterzeichnungsdatum; Challenger-Mai-Update setzt die Reihe März → April → Mai konsistent fort. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; ein neuer Lead-In („Sanders-Folgevorschlag — American A.I. Sovereign Wealth Fund Act (Juni 2026):") gemäß bestehendem Schema fett-kursiv eingeführt; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Zahlen (50 %-Aktien-Abgabe, OpenAI/Anthropic/xAI als genannte Adressaten, Op-Ed-Datum 1. Juni 2026, *American A.I. Sovereign Wealth Fund Act* als angekündigter Gesetzestitel) durch sanders.senate.gov-Re-Publikation und unabhängige Sekundärquellen (Fortune, Fox Business, Yahoo Finance) verifiziert; Public-Act-Nummer 26-15 und Unterzeichnungsdatum 2. Juni 2026 durch CGA-Primärdokument bestätigt; Challenger-Zahlen wörtlich aus dem Original-Mai-2026-Report (97.006, 38.579 / 40 %, 38.242, 87.714 / 22 %, 123.653 / +66 %) übernommen. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Sovereign-Wealth-Fund-Act ist ein qualitativ neues Instrument neben Sanders-Report (Oktober 2025) und S. 4214 (25. März 2026) — wird explizit als Erweiterung und nicht als Dublette eingeführt; Connecticut-Unterzeichnung ist eine Aktualisierung des bestehenden Connecticut-Blocks ohne Doppelung; Challenger-Mai ergänzt die in § 1.1 etablierte Reihe als Tagesfortschreibung. |
| 2.2.3 Argumentation | OK | Sanders-Block hebt die Eigentums- und Mitbestimmungsdimension explizit von der reinen Sanders-Robotersteuer ab und verbindet sie mit der OpenAI-Staatsfonds-Linie — Trennung zwischen Acemoglu/Thuemmel und Sanders/OpenAI unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten. |
| 2.2.4 Ausgewogenheit | OK | Sanders-Block referiert beide politischen Reaktionen (Warren prüfbereit; Graham „dead on arrival") und ordnet den Vorstoß ausdrücklich als „primär agendapolitisch zu lesen" ein; Challenger-Aggregat-Bestätigung wird explizit gegen die in § 1.1 erhaltene Washington-Post-Differenzierung gespiegelt (KI 40 %, also 60 % nicht KI-bezogen); Connecticut-Block hält die Trennung zwischen frontier-/disclosure-Pfad (SB 5) und fiskalischem Pfad (Bill 515) sauber. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund; Konjunktivpflicht gemäß Claude.md § 4.2 in der Sanders-Passage durchgängig eingehalten („sieht vor", „wäre", „erhielte"). |
| 2.3.2 Terminologie | OK | „American A.I. Sovereign Wealth Fund Act" als Gesetzestitel in der Originalschreibweise; „Public Act 26-15" und „CART Act" als Originalbezeichnungen konsistent geführt; bestehende Schreibweisen „Challenger, Gray & Christmas", „TrueUp", „SkillSyncer", „Sovereign Wealth Fund", „YTD" einheitlich; APA-konforme Quellenangabe für alle drei neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders-Op-Ed als neuer Eintrag in § 11.3 (institutionell/politisch); Connecticut-Public-Act-Eintrag um Unterzeichnung erweitert; zwei neue Kanzlei-/Presse-Einträge (Ropes & Gray, Bloomberg Law) in § 11.3; drei neue Sammelbelege (Challenger / CNBC / Tom's Hardware / Let's Data Science / Tech Jacks; TrueUp / SkillSyncer / TechTimes; Sanders / NYT / Fortune / Fox Business / Yahoo Finance / Washington Examiner) in § 11.5; keine Karteileichen. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-Stil eingehalten; URLs vollständig (kein Shortener); Datumsangaben einheitlich („1. Juni 2026", „2. Juni 2026", „4. Juni 2026"); Sammelbelege mit „/"-Trenner zwischen Quellen. |
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders: Primärquelle ist die Op-Ed in der *New York Times* vom 1. Juni 2026, re-publiziert auf sanders.senate.gov; mehrere unabhängige Sekundärquellen. Connecticut: Primärquelle ist das im CGA-Public-Act-Archiv hinterlegte PDF des Public Act 26-15. Challenger: Primärquelle ist der Original-Report von Challenger, Gray & Christmas (4. Juni 2026), auch als PDF hinterlegt. Trackerstände: Primärquellen sind die öffentlichen Dashboards von TrueUp und SkillSyncer. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: sanders.senate.gov/op-eds/the-public-should-own-half-of-the-big-a-i-companies/ (öffentlich, vollständiger Text); cga.ct.gov/2026/act/Pa/pdf/2026PA-00015-R00SB-00005-PA.PDF (öffentliches PDF, Gesetzestext); challengergray.com/blog/challenger-report-may-job-cuts-rise-16-from-april-highest-may-total-since-2020/ (öffentlich, Inhalt konsistent); challengergray.com/wp-content/uploads/2026/06/Challenger-Report-May-2026.pdf (PDF öffentlich); ropesgray.com/en/insights/alerts/2026/06/connecticut-enacts-sweeping-ai-law (öffentlich); cnbc.com/2026/06/05/ai-is-now-the-leading-reason-companies-give-for-cutting-jobs (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Sanders-Schlüsselbegriff *„öffentliche Ressource wertvoller als Öl"* wörtlich aus der sanders.senate.gov-Re-Publikation; CART-Act-Geltungsdaten (1. Oktober 2026 / 1. Januar 2027 / 1. Oktober 2027) wörtlich aus Ropes & Gray und Public Act 26-15; Challenger-Zahlen wörtlich aus dem Original-Mai-2026-Report; TrueUp- und SkillSyncer-Tagesstände wörtlich aus den öffentlichen Dashboards. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Belege benötigen keine eigene Verifizierungsmarkierung (Primärquelle sanders.senate.gov; CGA-Public-Act-Archiv; Challenger-Originalreport). |
...
Keine — die drei Ergänzungen sind belegbare Aktualisierungen ohne Korrekturbedarf an anderen Aussagen.
