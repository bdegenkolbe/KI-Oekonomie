...
## Validierung 29. Mai 2026 (Lauf 001 vom 29. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Regulärer Daily-Update-Lauf am 29. Mai 2026 (erster Lauf seit dem 8. Mai 2026). Web-Recherche im Korridor der Cluster A–J: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer / Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Sechs belegbare Treffer im 7-Tage- bzw. 48-Stunden-Fenster identifiziert und eingearbeitet (EU Digital Omnibus on AI — vorläufige Trilog-Einigung 7. Mai 2026; Connecticut SB 5 — Unterzeichnung durch Lamont; California Executive Order N-6-26 vom 21. Mai 2026; Cisco-Layoff 14. Mai 2026; Intuit-Layoff 20. Mai 2026; Wix-Layoff 25. Mai 2026; TrueUp-Tagesfortschreibung 27. Mai 2026).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU Digital Omnibus on AI — vorläufige Trilog-Einigung am 7. Mai 2026: Rat und Parlament fixieren Anwendungsstichtage 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); Übergangsfrist für die Kennzeichnungspflicht generativer KI nach Art. 50 Abs. 2 verlängert (Bestands-Compliance bis 2. Dezember 2026); neuer Art. 5-Verbot von CSAM- und nicht-konsensualer intimer Synthesedarstellung (Compliance bis 2. Dezember 2026); erweiterte Bias-Rechtsgrundlage. Förmliche Annahme bis vor dem 2. August 2026 erwartet. Quellen: Rat-Pressemitteilung 7. Mai 2026; Bird & Bird, Hogan Lovells, White & Case, Covington (Inside Privacy), Mishcon de Reya, NicFab. | § 4.3 (Trilog-Stand aktualisiert: aus „nächste Runde 13. Mai 2026" wird „vorläufige Einigung am 7. Mai 2026" mit fixierten Anwendungsstichtagen und neuen Verbots-/Übergangsregeln); § 11.3 Sektion „EU AI Act / Trilog" um Rat-Pressemitteilung und sechs Kanzleianalysen erweitert; Aktualitätshinweis am Dokumentende angepasst; README.md mit neuem Versionseintrag 23.0. | Schließt die seit der zweiten Trilog-Runde (28. April 2026) offene Frage des Verhandlungsausgangs; relevant für die Steuerdebatte, weil die fixierten Stichtage 2027/2028 den zeitlichen Vorlauf einer steuerlichen Anknüpfung an AI-Act-Klassen klären und das neue Bestands-/Watermarking-Regime erstmals für die Steuerverwaltung verwendbare Kennzeichnungssignale schafft. |
| 2 | Connecticut SB 5 — Gouverneur Lamont hat das Connecticut Artificial Intelligence Responsibility and Transparency Act im Mai 2026 unterzeichnet (67-seitiges Omnibus-Gesetz; Inkrafttreten der allgemeinen Bestimmungen am 1. Oktober 2026; AEDT-Rahmen, „AI is not a defense", Frontier-Whistleblower und WARN-AI-Disclosure ab 1. Oktober 2026; deployerseitige Vorab-Information ab 1. Oktober 2027). Quellen: DLA Piper, Davis Wright Tremaine, Littler, FPF, Akin Gump, CBIA. | § 4.5 (Status „angekündigte Unterzeichnung" wird durch Unterzeichnung ersetzt; Inkrafttretensdatum 1. Oktober 2026 ergänzt); § 11.5 neuer Sammelbeleg „DLA Piper / Davis Wright Tremaine / Littler / FPF / Akin Gump / CBIA"; Aktualitätshinweis am Dokumentende angepasst; README.md mit neuem Versionseintrag 23.0. | Schließt die Lamont-Unterzeichnung als bislang offenes Element ab und fixiert das gestaffelte Inkrafttretens-Regime, dessen WARN-AI-Erweiterung in der Steuerdebatte (§ 9.1) die standardisierte administrative Datenquelle für aggregierte KI-bezogene Stellenabbau-Statistiken schafft. |
| 3 | California Executive Order N-6-26 — Gouverneur Newsom hat am 21. Mai 2026 als „first-of-its-kind"-Initiative auf bundesstaatlicher Ebene staatlichen Behörden 180 Tage Zeit gegeben, Empfehlungen zu WARN-Act-Update, Erweiterung der Arbeitslosenversicherung, Abfindungsstandards, Umschulungsförderung und Worker-Ownership-Modellen vorzulegen; entwickelt zusätzlich ein „Worker-Centered AI Compact". Keine unmittelbaren Arbeitgeberpflichten, aber Vorbote landesweiter Regulierung. Quellen: Gouverneursbüro, NPR, CalMatters, KQED, DLA Piper, Fisher Phillips, Weintraub Tobin. | § 4.5 neuer Absatz „Sub-föderale Parallele — Kalifornien (Mai 2026)" zwischen Connecticut-Block und Trump-Framework-Block; § 11.5 neuer Sammelbeleg mit sieben URLs; Aktualitätshinweis am Dokumentende angepasst; README.md mit neuem Versionseintrag 23.0. | Erste sub-föderale Initiative der USA, die KI-induzierten Stellenabbau unmittelbar mit fiskalisch-arbeitsrechtlichen Reaktionsmustern verbindet und damit zusammen mit Connecticut (SB 5) und Maine (LD 713 / EO Nr. 5) eine Regulierungslinie definiert, die das Bundesframework (§ 4.5) durch parallele Faktenschaffung unterläuft — und konkret die in der Deutschland-These (§ 8.3) entwickelte Teilhabe-Logik in einem US-bundesstaatlichen Politikvokabular spiegelt. |
| 4 | Cisco — Layoff-Ankündigung am 14. Mai 2026: Streichung von rund 4.000 Stellen (knapp 5 % der weltweiten Belegschaft) als Teil einer Neuausrichtung auf Silizium, Optik, Sicherheit und KI; bei Q3-FY26-Quartalsbericht mit Rekordumsatz 15,8 Mrd. USD und AI-Infrastruktur-Auftragseingang 5,3 Mrd. USD; Aktie nachbörslich +20 %. Quellen: TechCrunch, IndexBox, Mirror Review, Fox Business, TheStreet. | § 1.1 (im Mai-Layoffs-Absatz nach Cloudflare aufgenommen — als erster der drei Mai-Wellen Cisco/Intuit/Wix); § 11.5 neuer Sammelbeleg „TechCrunch / IndexBox / Mirror Review / Fox Business / TheStreet"; Aktualitätshinweis am Dokumentende ergänzt. | Cisco ist der bislang größte Netzwerk-/Telco-Anbieter, der bei gleichzeitigem Umsatzrekord eine knapp 5 %-Personalreduktion mit AI-Auftragsboom verknüpft — die Asymmetrie zwischen Personalreduktion und Infrastrukturausbau (§ 1.1) verschärft sich um eine weitere Branchenkategorie und stützt die Tracker-Reihe ohne die Aggregat-Aussage zu verzerren. |
| 5 | Intuit — Layoff-Ankündigung am 20. Mai 2026: rund 3.000 Stellen (17 % von 18.200 Beschäftigten) zur Konzentration auf KI-Produktintegration; Mehrjahresverträge mit Anthropic und OpenAI; Restrukturierungsaufwand 300–340 Mio. USD; Q3-Umsatzprognose erhöht auf 21,34–21,37 Mrd. USD. Quellen: TechCrunch, Quartz, CFO Dive, CBC News. | § 1.1 (im Mai-Layoffs-Absatz nach Cisco aufgenommen — zweite Welle der Mai-Kombination); § 11.5 neuer Sammelbeleg „TechCrunch / Quartz / CFO Dive / CBC News"; Aktualitätshinweis am Dokumentende ergänzt. | Intuit ist der erste SaaS-/Fintech-Akteur, der eine konzernweite 17 %-Reduktion ausdrücklich mit Anthropic-/OpenAI-Verträgen begründet — Indiz dafür, dass auch Anbieter mit hohem Subscription-Umsatz Kostenstruktur an Modellinferenz statt an Personal binden, und damit ein zusätzlicher Anknüpfungspunkt für die in § 5.1 (Wertschöpfungsabgabe) und § 8.3 (Maschinen-Kapital-Bezug) diskutierte Bemessungsbasis. |
| 6 | Wix — Layoff-Ankündigung am 25. Mai 2026: rund 1.000 Stellen (etwa 20 % von 5.277 Beschäftigten, über 60 % davon in Israel); CEO Avishai Abrahami verweist auf „rasche Entwicklung der KI-Fähigkeiten" und Wechselkursdruck; Q1-Nettoverlust 57,5 Mio. USD trotz Umsatz +14 %; OpEx Q1 +50 % auf 423 Mio. USD; Compute-Aufwand der KI-Coding-Plattform Base44 als Treiber. Quellen: Calcalist Ctech, Haaretz, Ynet, CNBC, Fast Company. | § 1.1 (im Mai-Layoffs-Absatz nach Intuit aufgenommen — dritte und bislang relativ größte Welle); § 11.5 neuer Sammelbeleg „Calcalist Ctech / Haaretz / Ynet / CNBC / Fast Company"; Aktualitätshinweis am Dokumentende ergänzt. | Wix ist der erste israelische Tech-Anbieter mit großvolumiger Personalreduktion in dieser Welle und zugleich ein Anbieter, dessen Geschäftsmodell selbst von der Compute-Kostenstruktur eines KI-Produkts (Base44) belastet wird — exemplarisch für die in § 8.2 diskutierte Rentenverteilung zwischen Modellanbietern und KI-Anwendern. |
| 7 | TrueUp Tracker — Tagesfortschreibung zum 27. Mai 2026: 144.832 Personen aus 349 Layoff-Ereignissen (rund 979 Personen pro Tag); BusinessToday-Auswertung („May Mayhem 2026") spricht von rund 28.000 zusätzlichen Tech-Streichungen allein im Mai 2026. Quellen: Yahoo Finance, BusinessToday, TrueUp. | § 1.1 (Tagesfortschreibung als Folgemarker zur Reihe 25. April → 2. Mai → 6./7./8. Mai → 27. Mai 2026 in den Tracker-Block eingegliedert); § 11.5 neuer Eintrag „Yahoo Finance / TrueUp (Stand 27. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt. | Schließt die Tracker-Reihe an den Tag des Laufs an; bestätigt die in § 1.1 dokumentierte Beschleunigung im Mai-Verlauf, ohne den aggregiert moderaten Befund aus § 3.5 (Yale Budget Lab, Anthropic) umzukehren. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Brookings/NBER „Public finance in the age of AI" (Korinek/Lockwood, 8. Januar 2026) — bereits in Version 9.0 (§ 3.3 und § 11.1) referiert.
- NBER WP w34984 (Mai 2026) — PDF zum Recherchezeitpunkt nicht volltextlich verifizierbar; ohne unabhängige Sekundärquelle, die die Kernzahl „< 0,4 % aggregat-Beschäftigungsrückgang 2026" trägt, im nächsten Lauf zu prüfen.
- NBER WP „Workers' Incentives and the Optimal Taxation of AI" (Growiec / Prettner / Szkróbka, März 2026) — außerhalb 7-Tage-Fenster; potentiell für späteren Vertiefungslauf zu § 3 vorgesehen.
- Bundestag-Wissenschaftliche-Dienste WD 4 - 3000 - 003/26 — Verifikation des Inhalts ergab Bezug zur Übergewinnssteuer in Europa (Energiebranche), nicht zur Robotersteuer/Wertschöpfungsabgabe; nicht aufgenommen.
- Anthropic Economic Index — kein neuer Bericht zwischen 8. und 29. Mai 2026 verifizierbar; bestehender § 3.5-Block (Stand März 2026 mit *„Learning curves"*) bleibt aktuell.
- IFR World Robotics 2026 — Annual Report noch nicht freigegeben; Position Paper „Humanoid Robots: Vision and Reality" (Juli 2025) und Top-5-Trends 2026 (Januar 2026) liegen außerhalb des 7-Tage-Fensters.
- Sanders robot tax bill — keine Bewegung über die in Version 8.0 (S. 4214) und Version 16.0 referierten Initiativen hinaus zwischen 8. und 29. Mai 2026.
- LinkedIn (875), Ticketmaster, ZoomInfo, Adda247, Bill.com, Upwork, Truecaller, Arctic Wolf — Einzel-Layoffs unter der in § 1.1 etablierten Schwelle (500+ Stellen) oder ohne expliziten AI-Bezug; über die Tracker-Reihe abgedeckt.
- Meta-Tranche 8.000 Stellen ab 20. Mai 2026 — bereits in Version 9.0 (§ 1.1) angekündigt; tatsächlicher Vollzug zwischen 20. und 29. Mai 2026 nicht zusätzlich neu zu referieren.
- Bundesrat 1065. Sitzung 8. Mai 2026 (GKV-Erstdurchgang) — Folge-Beschlüsse zwischen 8. und 29. Mai 2026 nicht öffentlich neu verfügbar; im nächsten Lauf zu prüfen.
...
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; keine neuen Hauptüberschriften; in § 4.5 ein neuer Unterabsatz „Sub-föderale Parallele — Kalifornien (Mai 2026)"; keine leeren Abschnitte. |
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; der neue Newsom-Absatz in § 4.5 verweist auf § 8.3 (Teilhabefrage) und § 4.5 (Connecticut/Maine/Bundesframework) — diese Ziele existieren weiterhin. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen aktualisieren die bestehende Linie „Mai-Layoff-Welle + sub-föderale US-Initiativen + EU-Trilog-Fixpunkte" ohne Strukturbruch. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Trilog-Einigung 7. Mai 2026: Rat-Pressemitteilung und sechs unabhängige Kanzleianalysen konsistent. SB-5-Unterzeichnung: in den Kanzleianalysen DLA Piper / Davis Wright Tremaine / Littler bestätigt. EO N-6-26: Pressemitteilung des Gouverneursbüros (21. Mai 2026), NPR (22. Mai 2026), CalMatters, KQED konsistent. Cisco (4.000 / 5 %, 15,8 Mrd. USD, 5,3 Mrd. USD AI-Aufträge), Intuit (3.000 / 17 %, 18.200 Beschäftigte, 300–340 Mio. USD), Wix (1.000 / 20 %, 5.277 Beschäftigte) jeweils in mehreren Sekundärquellen konsistent. |
| 2.2.2 Redundanzprüfung | OK | Die Cisco-/Intuit-/Wix-Wellen sind in keinem Vorlauf erwähnt. Die SB-5-Aktualisierung ersetzt nur „angekündigte Unterzeichnung" durch „erfolgte Unterzeichnung" — keine Doppelung. Die Trilog-Einigung schreibt das in Version 16.0/17.0 dokumentierte Verhandlungsfenster fort und löst die offene Frage. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Newsom-EO im Konjunktiv referiert (kein verabschiedeter Akt im Sinne unmittelbarer Arbeitgeberpflichten). |
| 2.2.4 Ausgewogenheit | OK | Die in § 1.1 etablierte *Washington-Post*-Differenzierung vom 1. Mai 2026 bleibt erhalten; die drei Mai-Layoff-Wellen werden ohne monokausale KI-Zuschreibung referiert (Cisco bei Umsatzrekord, Wix mit Wechselkursdruck als Co-Treiber). |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Worker-Centered AI Compact" und „Executive Order N-6-26" als zitierte Begriffe; APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sechs neue Sammelbelege in § 11.5 und § 11.3; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Trilog: Primärquelle Rat-Pressemitteilung 7. Mai 2026; SB 5: Sekundärquellen Kanzleianalysen Mai 2026; EO N-6-26: Primärquelle Gouverneursbüro 21. Mai 2026; Cisco/Intuit/Wix: Konzern-Q-Berichte plus mehrere unabhängige Sekundärquellen; TrueUp Stand 27. Mai 2026 via Yahoo Finance / BusinessToday. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: consilium.europa.eu/.../2026/05/07/... (öffentlich, 403 bei Direct-Fetch, Inhalt aber via Bird & Bird, Hogan Lovells und White & Case-Analysen konsistent); calcalistech.com/.../b1oebi11xge (öffentlich, Inhalt konsistent); gov.ca.gov/.../signs-first-of-its-kind-executive-order/ (öffentlich); techcrunch.com/2026/05/14/cisco-cuts-nearly-4000-jobs/ und techcrunch.com/2026/05/20/intuit-to-lay-off-over-3000-employees/ (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Trilog (7. Mai 2026; 2. Dezember 2027 / 2. August 2028 / 2. Dezember 2026 / 2. August 2026) wörtlich aus Rat-Pressemitteilung und Kanzleianalysen; Kernzahlen Cisco (4.000 / 5 %, 15,8 Mrd. USD, 5,3 Mrd. USD), Intuit (3.000 / 17 %, 18.200, 300–340 Mio. USD) und Wix (1.000 / 20 %, 5.277, 57,5 Mio. USD, OpEx +50 %) wörtlich aus den verifizierten Sekundärquellen. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die sechs neuen Sammelbelege benötigen keine eigene Verifizierungsmarkierung. |
...
Keine — die sechs (mit Tracker sieben) Ergänzungen sind Aktualisierungen einer bestehenden Linie ohne Korrekturbedarf an anderen Aussagen.
