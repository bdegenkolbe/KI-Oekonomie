...
## Validierung 17. Juni 2026 (Lauf 001 vom 17. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf nach einer Unterbrechung von rund fünf Wochen (letzter Lauf 8. Mai 2026, Lauf 001). Web-Recherche im Korridor der Cluster A–J am 17. Juni 2026, mit gemäß *Suchthemen.md*-Anwendungslogik und in Anlehnung an Lauf 003 vom 7. Mai 2026 erweitertem Zeitfenster: nicht die letzten 7 Tage bzw. 48 Stunden, sondern die Entwicklungen seit dem letzten Lauf (8. Mai – 17. Juni 2026), damit die Fünf-Wochen-Lücke nicht zu Berichtsausfällen führt. Sechs belegbare Treffer aufgenommen und eingearbeitet: (1) Sanders, *American AI Sovereign Wealth Fund Act* — Ankündigung im *New York Times*-Gastbeitrag *„The Public Should Own Half of the Big A.I. Companies"* am 1. Juni 2026 (parallel sanders.senate.gov); (2) Trilog zum *Digital Omnibus on AI* — vorläufige politische Einigung 6. Mai 2026, Ratsbestätigung 13. Mai 2026; (3) *Challenger, Gray & Christmas* *Mai-2026-Job-Cuts-Report* (5./6. Juni 2026); (4) GKV-Beitragssatzstabilisierungsgesetz — Bundestag-Erstlesung und Bundesrat-Erstdurchgang 12. Juni 2026, Anhörung 22. Juni 2026; (5) IAB-Kurzbericht 8/2026 Friedrich & Kagerl *„KI in deutschen Betrieben"* (Mai 2026); (6) Tech-Personalanpassungen Juni 2026 — Microsoft-Xbox-„Reset" Asha Sharma (10. Juni 2026), Uber People-and-Places (3. Juni 2026) sowie humanoide Robotik (Tesla Optimus Gen 3, Figure 02 BMW, Apptronik/1X, Anfang Juni 2026). Übrige recherchierte Themen waren in Version 22.0 bereits enthalten, außerhalb des Recherche-Korridors oder ohne neuen Befund seit dem letzten Lauf.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Bernie Sanders, *American AI Sovereign Wealth Fund Act* — Ankündigung im *New York Times*-Gastbeitrag *„The Public Should Own Half of the Big A.I. Companies"* (1. Juni 2026, parallel sanders.senate.gov): einmalige Eigenkapital-Abgabe von 50 % gegenüber OpenAI, Anthropic und xAI; Übertragung des Aktienpakets in einen öffentlich-rechtlichen Staatsfonds mit Bundes­stimmrechten und Verwaltungsratssitzen; Erträge über Direktzahlungen sowie zweckgebundene Mittel für Gesundheit, Bildung und Wohnen; Bill-Einbringung „in den kommenden Wochen" angekündigt. Quellen: sanders.senate.gov-Op-Ed, *The Hill*, *Common Dreams*, *Newsweek*, *Washington Times*, *Fox Business*; Kritik: *Reason* (2. Juni), *AEI* (Juni 2026). | Neuer Block in § 4.5 zwischen Sanders-Robotersteuer/Moratorium-Block und Sub-föderale-Parallele-Maine-Block; Aktualisierungen in § 5.4 (Eigentumsbeteiligungs-Pfad konkretisiert) und § 8.3 (Pfadvergleich Sanders-Eigentumsvariante vs. OpenAI-Public-Wealth-Fund-Variante); neuer Eintrag in § 11.3 (Sanders 1. Juni 2026 mit sieben Sekundärquellen); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Der bislang konkreteste US-bundesgesetzliche Vorstoß, KI-Renten unmittelbar in einen demokratisch kontrollierten Staatsfonds zu überführen — und das erste Mal, dass OpenAI- und Anthropic-eigene Vorschläge in eine konkurrierende Gesetzesvorlage überführt werden. Für die Deutschland-These (§ 8.3) und die Wertschöpfungsabgabe-Diskussion (§ 5.1, § 5.4) ist der Vorstoß als verfassungsrechtlich anders gelagertes Alternativmodell (Eigentum vs. Cash-Flow-Anknüpfung) zentral. |
| 2 | EU-Trilog zum *Digital Omnibus on AI* — vorläufige politische Einigung am 6. Mai 2026, Bestätigung durch Mitgliedstaaten-Vertretungen im Rat am 13. Mai 2026: Verschiebung der Hochrisiko-Pflichten auf 2. Dezember 2027 (Anhang III) und 2. August 2028 (Anhang I); förmlich noch ausstehend: Plenarvotum EP, formale Ratsannahme, Veröffentlichung im Amtsblatt; bis zur Veröffentlichung bleibt der ursprüngliche Stichtag 2. August 2026 in Kraft. Quellen: Bird & Bird, Gibson Dunn, DLA Piper, innobu, GLACIS, IAPP (Juni 2026). | § 4.3 (Trilog-Passage entsprechend aktualisiert: bisheriger Ausblick „nächste Runde 13. Mai 2026" durch dokumentierte Einigung 6. Mai / Bestätigung 13. Mai 2026 ersetzt; Hinweis auf ausstehende formale Schritte ergänzt); neuer Eintrag in § 11.3 (Trilog-Einigung Mai 2026 mit vier URLs); Aktualitätshinweis am Dokumentende ergänzt. | Schließt die in Version 22.0 noch offene Trilog-Linie und stellt den Hochrisiko-Pflichten-Stichtag rechtssicher dar: politisch fixiert, formell noch nicht abgeschlossen. |
| 3 | Challenger, Gray & Christmas — *Mai-2026-Job-Cuts-Report* (5./6. Juni 2026, in Lauf 001 vom 8. Mai 2026 für den Mai-Folgereport markiert): May-Streichungen 97.006 (+16 % gegenüber April; höchster Mai-Wert seit 2020); KI-bezogen 38.579 (rund 40 % aller Mai-Streichungen, erstmals führender Einzelgrund in der Tracking-Reihe); Tech 38.242 im Mai (höchster Monatswert seit August 2024); YTD Tech 123.653 (+66 % gegenüber Vorjahresvergleich); YTD KI-bezogen 87.714 (übertrifft Vorjahresgesamtwert 54.836 nach fünf Monaten); gesamtwirtschaftlich YTD 397.755 (−43 % gegenüber 2025, da 2025 die US-Bundesverwaltungs-Streichungen den Vergleichsmaßstab erhöht hatten). Quellen: Challenger Original-Report, Bloomberg (4. Juni 2026), Yahoo Finance, Tech Times (16. Juni 2026). | § 1.1 (neuer Absatz nach dem Cloudflare-/Capex-Block mit der Mai-Aggregat-Bestätigung und der erstmaligen KI-#1-Position im Challenger-Tracking); neuer Eintrag in § 11.5 (Challenger/Bloomberg/Yahoo Finance/Tech Times mit fünf URLs); Aktualitätshinweis am Dokumentende ergänzt. | Methodisch unabhängige Sekundärquelle zu TrueUp/SkillSyncer; dokumentiert empirisch die in § 1.1 referierte Beschleunigung der KI-Verdrängungs-Sichtbarkeit; KI-Anteil 40 % markiert den ersten Monat mit KI als Führungsgrund — relevant für § 9.1 (Messbarkeit) und § 8.4 (Stabilitätslinie). |
| 4 | Deutscher Bundestag / Bundesrat — erste Lesung und Erstdurchgang zum *GKV-Beitragssatzstabilisierungsgesetz* am 12. Juni 2026; Anhörung des Bundestags-Gesundheitsausschusses für 22. Juni 2026 terminiert. Drucksache 256/26. Quellen: Bundestag-Textarchiv, AOK Presse und Politik, DIP. | § 5.2 (Aktualisierung des bestehenden GKV-Reform-Blocks: die früher als „im weiteren Verlauf des Mai/Juni 2026 vorgesehen" angegebene erste Bundestagslesung ist mit Datum 12. Juni 2026 fixiert, Bundesrat-Erstdurchgang am selben Tag, Anhörung 22. Juni 2026); neuer Eintrag in § 11.3 (Bundestag/Bundesrat 12. Juni 2026 mit vier URLs); Aktualitätshinweis am Dokumentende ergänzt. | Schließt die in Lauf 001 vom 8. Mai 2026 als „im nächsten Lauf nachzutragen" markierte Lücke zur parlamentarischen Behandlung — datiert genau die Stelle, an der die in § 5.1 / § 5.2 begründete Spannung der lohnbasierten Sicherungszweige gesetzgeberisch sichtbar wird. |
| 5 | IAB-Kurzbericht 8/2026 — Friedrich, M., & Kagerl, C., *Künstliche Intelligenz in deutschen Betrieben: Jeder vierte Betrieb nutzt mittlerweile generative KI* (Mai 2026, DOI 10.48720/IAB.KB.2608): Verbreitung generativer KI in Betrieben von 5 % (2023) auf 25 % (2025); weitere 9 % der Betriebe mit Einsatzplanung; 48 % der Großbetriebe (≥ 200 Beschäftigte), 21 % der Kleinstbetriebe (< 10); sektoraler Spitzenwert Information und Kommunikation 59 %, Finanz- und Versicherungsdienste 50 %. Quelle: doku.iab.de/kurzber/2026/kb2026-08.pdf. | § 1.1 (Innenperspektive zur deutschen Adoptionsdynamik in den neuen Absatz integriert); neuer Eintrag in § 11.1 (Friedrich & Kagerl Mai 2026 mit zwei URLs); Aktualitätshinweis am Dokumentende ergänzt. | Erste belastbare Größenordnung für die deutsche KI-Adoption auf Betriebsebene auf Basis des IAB-Betriebspanels (rund 15.000 Betriebe); strukturelle Voraussetzung für die in § 8.1 (KI als dritter Produktionsfaktor) und § 5.1 (Wertschöpfungsabgabe) entwickelten Aussagen über inländische KI-Nutzung und ihre fiskalische Anknüpfbarkeit. |
| 6 | Microsoft (10. Juni 2026, Bloomberg) — interne Mitteilung der neuen Xbox-Vorstandsvorsitzenden Asha Sharma zu einem 100-Tage-„Reset" der Xbox-Sparte mit für Juli 2026 angekündigten Stellenstreichungen „in den Tausenden" (Hintergrund: 20 Mrd. USD Inhalt-/Plattform-/Hardware-Subventionen über fünf Jahre bei rund 500 Mio. USD Umsatzrückgang). Uber (3. Juni 2026, CNBC) — Streichung von rund 23 % der People-and-Places-Sparte, ausdrücklich nicht KI-attribuiert, < 340 Stellen bzw. < 1 % der globalen Belegschaft. Humanoide Robotik (Anfang Juni 2026, Tech Times, iFactory): Tesla beendet Model-S-/X-Produktion zum Umbau der Fremont-Linie für Optimus Gen 3 (Stückzahlziele im niedrigen Tausenderbereich, Produktionsstart Sommer 2026); Figure liefert Figure-02 an ein BMW-Werk in South Carolina aus; Apptronik / 1X (NEO-Preorder, Auslieferung 2026) in der Frühserie. | § 1.1 (Microsoft-Xbox- und Uber-Punkt im neuen Absatz aufgenommen; humanoide Robotik als gemeinsame Frühserie ebenfalls ergänzt); neuer Eintrag in § 11.5 (CNBC/Bloomberg sowie Tech Times/iFactory). | Microsoft Xbox markiert den ersten Spartenfall innerhalb eines Hyperscalers, in dem ein konzerninterner Eigentümerwechsel und nicht primär KI als Begründung der Streichungen genannt wird — relevant für die Differenzierung in § 1.1. Uber liefert ein bewusst nicht-KI-attribuierter Gegenpol, der die Messbarkeitsfrage in § 9.1 stützt. Die Konvergenz dreier humanoider Programme in der Frühserienphase ist die belegbare Erstaktualisierung von Cluster J seit der Aufnahme der Hardware-Linie. |

**Nicht aufgenommen (bewusste Auslassungen):**
- *Stanford HAI AI Index 2026* (13. April 2026) — außerhalb des Recherche-Korridors; Kernbefund (Software-Developer 22–25 J. −20 % seit 2024) bereits in früheren Versionen (vgl. Lauf 003 vom 7. Mai 2026) als „außerhalb 7-Tage-Fenster" markiert; potenziell für einen vertieften Wochenend-/Quartalslauf.
- *NBER WP 34705 — Manning & Aguirre*, *MIT FutureTech „Crashing Waves vs. Rising Tides"*, *NBER w33509 / Brookings AI Labor Market* — außerhalb des Recherche-Korridors; potenziell für einen vertieften ökonomischen Folgelauf in § 3.
- *Meta-Layoffs* (Beginn 18. Mai 2026, rund 8.000 Stellen) — Welle bereits in Version 13.0 / 14.0 im Tracker-Block referenziert; kein neuer Befund über die in § 1.1 dokumentierte „AI labor crisis"-Lesart hinaus.
- *Sachverständigenrat-Frühjahrsgutachten 2026* — Wiesbaden-Vorstellungstermin 27. Juni 2026 liegt nach dem Stichtag dieses Laufs; im nächsten Lauf zu prüfen.
- *Generationenkapital* (KENFO-Mandatsverlängerung Ende 2026) — keine neuen Tranchen-/Renditeangaben zwischen 8. Mai und 17. Juni 2026; bestehender § 8.6-Verweis bleibt aktuell.
- G-BA / gematik / BfArM (DiGA-KI) — Cluster G ohne KI-spezifische neue Beschlüsse oder Listings im Recherche-Korridor; fünfter Lauf in Folge ohne Treffer.
- *AccountingToday — States introduce AI tax changes* (11. Juni 2026, Michigan/Indiana/Illinois generative-AI-Tax-Vorstöße) — Sammelbericht ohne Primärquellen­konkretisierung; in einem späteren Lauf bei verfügbarer Primärquelle (Bundesstaaten-Gesetzesblätter, Tax Foundation) gezielt zu prüfen.
- *Cloudflare / Coinbase / PayPal / Freshworks / Cognizant* — bereits in Version 22.0 in § 1.1 aufgenommen.
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; die neue Sanders-Sovereign-Wealth-Fund-Passage in § 4.5 referenziert § 5.4 und § 8.3 — beide Ziele existieren; § 5.4 und § 8.3 referenzieren wechselseitig § 4.5; § 5.2-Aktualisierung berührt keine bestehenden Querverweise. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen führen die bestehende Argumentationslinie OpenAI-Vorschlag (§ 4.5) → Staatsfonds (§ 5.4) → Teilhabe (§ 8.3) weiter; Sanders' Sovereign-Wealth-Fund-Vorschlag wird ausdrücklich als alternative Pfadlogik (Eigentumsbeteiligung vs. fiskalische Anknüpfung) eingeordnet, nicht als neue These. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; keine neuen Tabellen; bestehende Lead-Ins-Schreibweise („**Sanders — American AI Sovereign Wealth Fund Act (Juni 2026):**") konsistent mit den Geschwister-Lead-Ins in § 4.5; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Vorschlag: 50 % Eigenkapital-Abgabe, namentlich genannte Adressaten (OpenAI/Anthropic/xAI), Stimmrechte und Verwaltungsratssitze in NYT-Op-Ed und sanders.senate.gov-Fassung konsistent; Trilog-Daten 6./13. Mai 2026 in Bird & Bird, Gibson Dunn, DLA Piper, innobu konsistent; Challenger-Zahlen (97.006 / +16 %; 38.579 / 40 %; 38.242 Tech / 123.653 YTD / +66 %; 87.714 KI YTD / 54.836 Vorjahr; 397.755 / −43 %) wörtlich aus Challenger-Originalreport; IAB-Zahlen wörtlich aus dem PDF des Kurzberichts; GKV-Datum 12. Juni 2026 aus Bundestag-Textarchiv und Drucksache 256/26; Microsoft-Xbox-Hintergrund (20 Mrd. USD / 500 Mio. USD) aus Bloomberg vom 10. Juni 2026; Uber-Streichungsanteil 23 % aus CNBC vom 3. Juni 2026; Tesla-/Figure-Daten aus Tech Times Anfang Juni 2026. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Sovereign-Wealth-Fund wird in § 4.5 (Initiativen-Übersicht), § 5.4 (Staatsfonds-Mechanik), § 8.3 (Teilhabe-Pfadvergleich) jeweils in unterschiedlicher Vertiefung referiert: § 4.5 enthält die Sachstandsbeschreibung, § 5.4 nimmt sie als konkretes Anwendungsbeispiel der Eigentumsbeteiligungs-Variante auf und § 8.3 ordnet sie als Pfad­alternative zur OpenAI-Public-Wealth-Fund-Variante ein. Querverweise expliziert; keine Doppelungen. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Sanders-Sovereign-Wealth-Fund wird formal als „Eigentumsabgabe" gegenüber der Sanders-Robotersteuer (laufende Verbrauchsteuer auf automatisierende Technologie) abgegrenzt — keine Vermengung; der OpenAI-Vorschlag wird als konzeptionell verwandt, aber operativ offen markiert. |
| 2.2.4 Ausgewogenheit | OK | Der Sanders-Sovereign-Wealth-Fund-Block enthält sowohl die Befürworter-Belege (Common Dreams, Newsweek, Washington Times, sanders.senate.gov) als auch die Kritik (Reason, AEI); Microsoft-Xbox und Uber sind sachlich als nicht primär bzw. nicht KI-getriebene Restrukturierungen wiedergegeben; das Bloomberg-Editorial und die Washington-Post-Differenzierung bleiben im Dokument als publizistische Gegenpositionen erhalten. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund; Lead-In-Schreibung („**Sanders — American AI Sovereign Wealth Fund Act (Juni 2026):**") mit Großschreibung nach Punkt korrekt; Konjunktiv bei Sanders-Vorschlag und Trilog-Einigung konsequent verwendet (Bill noch nicht eingebracht, Trilog-Beschluss noch nicht förmlich verabschiedet). |
| 2.3.2 Terminologie | OK | „American AI Sovereign Wealth Fund Act" durchgehend so geschrieben; „Trilog" / „Plenarvotum" / „Ratsannahme" einheitlich; „IAB-Kurzbericht 8/2026" mit der im IAB-Schreibstil üblichen Notation; „humanoide Robotik" einheitlich. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders 1. Juni 2026 als neuer Eintrag in § 11.3 mit sieben URLs (Op-Ed + sechs Sekundärquellen + zwei Kritiken); Trilog-Einigung Mai 2026 als neuer Eintrag in § 11.3 mit vier URLs; GKV 12. Juni 2026 als neuer Eintrag in § 11.3 mit vier URLs; Friedrich & Kagerl als neuer Eintrag in § 11.1 mit zwei URLs; Challenger / Bloomberg / Yahoo Finance / Tech Times als neuer Eintrag in § 11.5; CNBC / Bloomberg Xbox / Uber als neuer Eintrag in § 11.5; Tech Times / iFactory (Tesla/Figure) als neuer Eintrag in § 11.5. Keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders: Primärquelle ist die Op-Ed auf sanders.senate.gov, NYT als Erstveröffentlichung referiert; Trilog: Primärquelle ist die Bestätigung im Rat sowie die Bird & Bird-/Gibson-Dunn-/DLA-Piper-/innobu-Berichterstattung mit konsistenten Stichtagen; Challenger: Primärquelle ist der Original-Report (challengergray.com); IAB: Primärquelle ist der PDF-Kurzbericht 8/2026 mit DOI; GKV: Primärquellen sind das Bundestag-Textarchiv und die Drucksache 256/26; Microsoft Xbox: Primärquelle ist Bloomberg mit interner Mitteilung Sharma; Uber: Primärquelle ist CNBC mit Uber-Sprecher-Zitat; Tesla/Figure: Tech Times / Wikipedia / iFactory als Sekundärquellen, konsistent mit den Q1-2026-Earnings-Aussagen. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobenartig geprüft: sanders.senate.gov/op-eds (öffentlich, Inhalt konsistent); challengergray.com/blog/challenger-report-may-job-cuts (öffentlich); bloomberg.com/news/articles/2026-06-04 (Paywall, Lead konsistent); doku.iab.de/kurzber/2026/kb2026-08.pdf (öffentlich, PDF prüfbar); bundestag.de/dokumente/textarchiv/2026/kw24-de-gkv (öffentlich); cnbc.com/2026/06/03/uber-layoffs (öffentlich); techtimes.com/articles/318071 (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernaussagen Sanders (50 % Eigenkapital-Abgabe, OpenAI/Anthropic/xAI, Stimmrechte und Verwaltungsratssitze, Direktzahlungen plus Gesundheit/Bildung/Wohnen) wörtlich aus der Op-Ed bzw. Sekundärberichterstattung; Challenger-Zahlen wörtlich aus dem Originalreport; IAB-Zahlen wörtlich aus dem Kurzbericht; Trilog-Daten (6./13. Mai 2026, Stichtage 2. Dezember 2027 und 2. August 2028) wörtlich aus Bird & Bird / Gibson Dunn / DLA Piper / innobu. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Einträge benötigen keine eigene Verifizierungsmarkierung. |
...
Keine — die sechs Ergänzungen sind regelkonforme Erweiterungen ohne Korrekturbedarf an anderen Aussagen.
