...
## Validierung 10. Juni 2026 (Lauf 001 vom 10. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf am 10. Juni 2026 nach dem Lauf 001 vom 8. Mai 2026. Web-Recherche im Korridor der Cluster A–J am 10. Juni 2026: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Drei belegbare Treffer im 7-Tage- bzw. 48-Stunden-Fenster identifiziert und eingearbeitet (Sanders *American AI Sovereign Wealth Fund Act*-Ankündigung vom 2. Juni 2026; Connecticut SB 5 — Unterzeichnung am 2. Juni 2026 als *Public Act 26-15* / CART Act; Challenger *Mai-2026-Job-Cuts-Report* vom 4. Juni 2026 in Verbindung mit der TrueUp-Tagesfortschreibung zum 10. Juni 2026). Alle übrigen recherchierten Themen lagen außerhalb des 7-Tage- bzw. 48-Stunden-Korridors oder waren in Version 22.0 bereits enthalten.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Sanders — *American AI Sovereign Wealth Fund Act*-Ankündigung am 2. Juni 2026 (Op-ed „The Public Should Own Half of the Big A.I. Companies" + Sammelbeleg Fox Business / Common Dreams / Fortune / Newsweek / Washington Times / Free Beacon / Reason / R Street): Einmalige, in Aktien zu entrichtende 50-prozentige Vermögensabgabe auf die größten KI-Unternehmen (u. a. OpenAI, Anthropic, xAI); Einbringung der Anteile in einen öffentlichen Fonds mit Stimmrechten, Aufsichtsratssitzen und direkter Bürgerdividende; Verwendung auch für Gesundheit, Bildung und Wohnen; Bill-Text „in den kommenden Wochen". Kritische Begleitstimmen aus R Street Institute, Reason und Free Beacon („Soviet approach", „Seizure"); Fortune hebt parallele Sovereign-Wealth-Fund-Überlegungen im Weißen Haus hervor. | § 4.5 (Erweiterung des Sanders-Folgeblocks um den Sovereign-Wealth-Fund-Vorschlag im Konjunktiv gemäß Claude.md § 4.2; Querverweis auf § 5.4 zur Architektur-Frage); § 5.4 (Kurzfassung mit Querverweis auf § 4.5; Einordnung als US-Übersetzung des norwegischen Staatsfonds-Modells, abgrenzend zur OpenAI-Variante mit laufender Abgabe); § 11.3 neue Primärquelle (Sanders-Op-ed sanders.senate.gov) plus drei neue Sammelbelege (befürwortend/Sekundärberichterstattung und kritische Gegenstimmen); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erster US-bundesweiter Gesetzgebungsvorschlag, der den Staatsfonds-Gedanken (§ 5.4) nicht über eine laufende zweckgebundene Steuer, sondern über eine einmalige Pflicht-Kapitalbeteiligung am Bestand der größten KI-Anbieter operationalisiert — und damit eine in § 8.3 (Teilhabefrage) ohnehin angelegte Architektur erstmals in einen konkreten US-Gesetzestext überführt. Die Aufnahme der kritischen Gegenstimmen (R Street, Reason, Free Beacon) erfüllt das in Claude.md § 4.3 geforderte Ausgewogenheitsgebot. |
| 2 | Connecticut — Unterzeichnung von SB 5 durch Gouverneur Ned Lamont am 2. Juni 2026 als *Public Act 26-15* (Connecticut Artificial Intelligence Responsibility and Transparency Act, „CART Act"). Connecticut wird nach Colorado und Texas zum dritten US-Bundesstaat mit einem umfassenden Querschnitts­gesetz zu KI in Beschäftigung, Gesundheit, sozialen Medien und Frontier-Modellen. Gestaffelte Geltungsdaten unverändert (Automated Employment Decision Technology / „AI is not a defense" / WARN-AI-Disclosure / Frontier-Whistleblower ab 1. Oktober 2026; anonyme interne Meldewege Frontier-Entwickler ab 1. Januar 2027; Deployer-Vorab-Information ab 1. Oktober 2027). Quellen: Ropes & Gray, Law and the Workplace (Proskauer), DLA Piper, Future of Privacy Forum, Akin Gump (Juni 2026). | § 4.5 (Update der Connecticut-Passage: „angekündigte Unterzeichnung" → „am 2. Juni 2026 unterzeichnet als Public Act 26-15 / CART Act" mit Einordnung als dritter US-Bundesstaat nach Colorado und Texas); § 11.3 neuer Eintrag „State of Connecticut, Governor Ned Lamont (2. Juni 2026): Public Act 26-15 — CART Act" mit fünf Anwaltsanalyse-URLs; Aktualitätshinweis am Dokumentende aktualisiert; README.md mit neuem Versionseintrag 23.0. | Die formale Inkraftsetzung von SB 5 schließt den in Lauf 001 vom 8. Mai 2026 offen markierten Vorgang ab; die Einordnung als „dritter US-Bundesstaat nach Colorado und Texas" macht die in § 9.5 referierte Patchwork-Logik US-bundesstaatlicher KI-Regulierung empirisch greifbarer, ohne die Detail-Beschreibung des Geltungsregimes zu verändern. |
| 3 | Challenger, Gray & Christmas — *Mai-2026-Job-Cuts-Report* (veröffentlicht 4. Juni 2026): US-Streichungen 97.006 (+16 % gegenüber April; höchster Mai-Wert seit 2020); KI-bezogene Streichungen 38.804 (40 %, erstmals führender Einzelgrund; Anstieg von 7 % im Januar, 25 % im März, 26 % im April); Tech 38.242 im Mai (höchster Monatswert seit August 2024); YTD KI-bezogen 87.714 mit rund 22 % aller 2026-Pläne, Überschreitung des Vorjahres-Gesamtwerts (54.836 im Kalenderjahr 2025) nach fünf Monaten. Ergänzend: Deutsche-Bank-Auswertung zum *AI redundancy washing* (rhetorische KI-Begründung in Layoff-Kommunikation auch ohne belegten Automatisierungspfad). TrueUp-Tagesfortschreibung zum 10. Juni 2026: 247 Layoff-Meldungen mit 183.966 betroffenen Beschäftigten (rund 1.143 Personen pro Tag); Oracle bleibt mit rund 30.000 Stellen die einzelne größte 2026-Streichung. Quellen: Challenger Gray (4. Juni 2026), Tech Jacks Solutions, OpenTools, Let's Data Science, AOL, TrueUp, Newsweek, Yahoo Finance, Deutsche Bank / 24/7 Wall St. / LeadDev. | § 1.1 (Erweiterung des Layoff-/Tracker-Blocks um den Mai-Report und die Tagesfortschreibung zum 10. Juni 2026; Aufnahme der Deutsche-Bank-Linie zum „AI redundancy washing" mit explizitem Querverweis auf § 9.1); § 11.5 neue Einträge für Challenger-Mai-Sammelbeleg, TrueUp-Stand 10. Juni 2026 sowie Deutsche-Bank-/AI-redundancy-washing-Sammelbeleg; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Der KI-Anteil von 40 % an den Mai-Streichungen markiert das erste Mal, dass KI als am häufigsten genannter Einzelgrund nicht nur den Monat führt, sondern dabei zugleich die 38 %-Schwelle überschreitet — ein quantitativer Sprung gegenüber April (26 %). Die YTD-Überschreitung des Vorjahres-Gesamtwerts (54.836) bereits nach fünf Monaten ist die deutlichste verfügbare Aggregat-Bestätigung der in § 1.1 referierten Beschleunigung. Die Deutsche-Bank-Linie zum „AI redundancy washing" liefert empirisch zugleich das in § 9.1 dokumentierte Argument gegen eine vorschnelle Typ-5-Anknüpfung an Self-Reported AI-Begründungen. |

**Nicht aufgenommen (bewusste Auslassungen):**
- EU Digital Omnibus on AI — politische Trilog-Einigung 7. Mai 2026 (Hochrisiko-Pflichten 2. Dezember 2027 / 2. August 2028): liegt außerhalb des 7-Tage-Fensters (zwischen Lauf 001 vom 8. Mai 2026 und Lauf 001 vom 10. Juni 2026); in den bestehenden Aktualitätshinweis-Block ist die Konvergenz auf die beiden Stichtage bereits aufgenommen. Im nächsten Lauf zu prüfen, sobald die formale Parlaments- und Rats-Annahme (vor 2. August 2026 erwartet) und die OJ-Publikation erfolgt sind.
- Bundesrat 1066. Sitzung (12. Juni 2026) und Bundestag-AI-Verordnungs-Befassung (KW 24, 11. Juni 2026): liegen nach dem Stichtag 10. Juni 2026; in den Aktualitätshinweis als „angesetzt" aufgenommen; im nächsten Lauf nach erfolgter Befassung nachzutragen.
- China — Hangzhou Intermediate People's Court (30. April 2026) und MOHRSS-Politikdokument zum Umgang mit KI-Beschäftigungseffekten: Hangzhou-Entscheidung im Berichtszeitraum (Fortune 3. Mai 2026) außerhalb 7-Tage-Fenster; MOHRSS-Dokument zum Recherchezeitpunkt noch nicht öffentlich indexiert. Im nächsten Lauf zu prüfen.
- Frontier-Modelle (Cluster I) — Gemini 3.5 Pro, GPT-5.6, Claude Opus 4.8: Claude Opus 4.8 (28. Mai 2026) außerhalb 48-Stunden-Fenster; Gemini 3.5 Pro nach Google-I/O-Ankündigung 19. Mai 2026 noch in limited Vertex Preview, ohne politisch-fiskalisch relevante Tagesmeldung im 48-Stunden-Fenster; GPT-5.6 ausschließlich Codex-Leak ohne offiziellen Release. Im nächsten Lauf zu prüfen.
- Humanoide Robotik (Cluster J) — Figure 03 / Tesla Optimus / Boston Dynamics Atlas: 2026er Produktionsstart-Meldungen vorhanden, im 48-Stunden-Fenster aber ohne politisch-fiskalisch relevante Tagesmeldung; im nächsten Lauf zu prüfen.
...
- Generationenkapital / KENFO — keine neuen Tranchen- oder Renditeangaben im Berichtsfenster; bestehender § 8.6-Verweis bleibt aktuell.
- Plattform-Digitalabgabe (Weimer) — keine Bewegung über Version 10.0/11.0 hinaus; im nächsten Lauf zu prüfen.
...
| 2.1.3 Querverweise | OK | Neuer Querverweis § 4.5 → § 5.4 (Sanders-SWF-Architektur) und Rückverweis § 5.4 → § 4.5 funktionsfähig; Querverweis § 1.1 → § 9.1 (AI redundancy washing) funktionsfähig; alle bestehenden §-Querverweise unverändert. |
| 2.1.4 Roter Faden | OK | Sanders-SWF-Ergänzung ist die thematische Weiterführung der bisherigen Sanders-Linie aus § 4.5 (Robotersteuer + Moratorium); die Architektur-Differenzierung zwischen einmaliger Vermögensabgabe (Sanders SWF) und laufender Abgabe (OpenAI-Papier) wird sauber gegen § 5.4 abgegrenzt. Connecticut-Update und Mai-Challenger-Report aktualisieren bestehende Blöcke ohne Strukturänderung. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Ankündigungsdatum 2. Juni 2026, 50 %-Quote, in Aktien zu entrichtende Vermögensabgabe und genannte Adressaten (OpenAI, Anthropic, xAI) in der Sanders-Op-ed (sanders.senate.gov) sowie in mehreren unabhängigen Quellen (Fortune 3. Juni 2026, Fox Business, Newsweek, Common Dreams) konsistent. Connecticut Public Act 26-15 / CART Act und Unterzeichnungsdatum 2. Juni 2026 in mehreren unabhängigen Kanzleibegleitanalysen (Ropes & Gray, Proskauer / Law and the Workplace, DLA Piper, FPF) belegt. Challenger-Mai-Zahlen (97.006 Streichungen, 38.804 KI-bezogen / 40 %, Tech 38.242, YTD KI 87.714) wörtlich aus dem Challenger-Originalreport (4. Juni 2026) und der Tech-Jacks-/OpenTools-/Let's-Data-Science-Sekundärwiedergabe. TrueUp-Stand 10. Juni 2026 (247 / 183.966 / ~1.143 pro Tag) wörtlich aus TrueUp-Dashboard und Newsweek-/Yahoo-Finance-Wiedergabe. |
| 2.2.2 Redundanzprüfung | OK | Sanders-SWF wird in § 4.5 ausführlich eingeführt und in § 5.4 nur als Kurzfassung mit Querverweis geführt — entspricht der in Claude.md § 4.3 verankerten „kein-Redundanzen"-Regel. Der bestehende OpenAI-Staatsfonds-Block in § 5.4 bleibt davon unberührt. Connecticut-Update ersetzt vorhandene „angekündigte Unterzeichnung"-Formulierung punktgenau ohne Strukturdopplung. Mai-Challenger-Report ist explizit als Folge zum April-Report formuliert (Anstieg von 26 % auf 40 %). |
| 2.2.3 Argumentation | OK | Sanders-SWF wird im Konjunktiv referiert (Claude.md § 4.2). Die Acemoglu-/Thuemmel-Trennung bleibt unangetastet. Die Deutschland-These (drei Säulen) bleibt unverändert. Die fünf Robotersteuer-Typen aus § 2.1 werden weiterhin auseinandergehalten — Sanders-SWF wird ausdrücklich als Kapitalbeteiligungs-Variante außerhalb der Typologie eingeführt, nicht als zusätzlicher Typ. |
| 2.2.4 Ausgewogenheit | OK | Sanders-SWF mit Kritik R Street / Reason / Free Beacon im selben Block aufgenommen; Fortune-Hinweis auf parallele Sovereign-Wealth-Fund-Überlegungen im Weißen Haus relativiert die parteipolitische Frontlinie. Mai-Challenger-Report mit Deutsche-Bank-Befund zum *AI redundancy washing* explizit kontrastiert, um eine vorschnelle Typ-5-Lesart zu vermeiden. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund; korrektes Genus / Numerus in den Querverweisen; Anführungszeichen einheitlich („…"). |
| 2.3.2 Terminologie | OK | „Sovereign Wealth Fund" als Eigenname erläutert (vgl. norwegisches Vorbild); „CART Act" beim ersten Auftreten ausgeschrieben; „AI redundancy washing" in Anführungszeichen als Fachbegriff der Deutschen Bank eingeführt; bestehende Schreibweisen „TrueUp", „Hyperscaler", „VRSAR" einheitlich; APA-Stil bei neuen Quellenangaben eingehalten. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders-Op-ed als Primärquelle in § 11.3; befürwortende Sekundärberichterstattung (Common Dreams / Fox Business / Fortune / Newsweek / Washington Times) als Sammelbeleg in § 11.3; kritische Gegenstimmen (R Street / Reason / Free Beacon) als separater Sammelbeleg in § 11.3; Connecticut Public Act 26-15 mit fünf Anwaltsanalyse-URLs in § 11.3; Challenger-Mai-Report-Sammelbeleg in § 11.5; TrueUp-Stand-10.-Juni-2026 in § 11.5; Deutsche-Bank-/AI-redundancy-washing-Sammelbeleg in § 11.5. Keine Karteileichen. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-Stil eingehalten; URLs vollständig (kein Shortener); Datumsangaben einheitlich; Sammelbelege mit „/"-Trenner zwischen Quellen, vollständige Listenführung in der Quellenangabe. |
| 2.4.3 Aktualität und Belastbarkeit | OK | Primärquelle für Sanders-SWF ist die Op-ed des US-Senators auf sanders.senate.gov; flankierend mehrere unabhängige Sekundärquellen aus Mainstream-Medien (Fortune, Fox Business, Common Dreams, Newsweek). Connecticut Public Act 26-15 durch fünf unabhängige Kanzleibegleitanalysen gestützt. Challenger-Mai-Report direkt aus dem Originalreport (Challenger-PDF) sowie aus Sekundärwiedergaben (Tech Jacks, OpenTools, Let's Data Science). |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Sanders-Senate-URL, Challenger-Originaldokument-URL und TrueUp-Dashboard-URL stichprobenartig auf Erreichbarkeit geprüft (alle Antwort 200). Kanzlei-Analysen Ropes & Gray, Proskauer und DLA Piper konsistent abrufbar. |
| 2.4.5 Zitatgenauigkeit | OK | Sanders-Zitat „direct ownership stake" und Aussage zur 50-%-Quote in der Op-ed und in der Sekundärberichterstattung konsistent. Challenger-Zahlen (40 %, 38.804, 97.006, 38.242 Tech, 87.714 YTD KI) wörtlich übernommen. TrueUp 247 / 183.966 / ~1.143 pro Tag aus dem aktuellen Dashboard-Stand. Konjunktivpflicht für Sanders-SWF (noch nicht eingebrachter Entwurf) durchgängig eingehalten („vorgeschlagen", „solle", „flössen", „würde"). |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | de la Feria et al. 2022 bleibt als verifizierungsbedürftig markiert; Sanders-2025-Titelangabe bleibt seit Version 5.0 als vollständig verifiziert geführt; in dieser Aktualisierung keine neuen verifizierungsbedürftigen Einträge entstanden. |
| 2.5 Versionskonsistenz und Lizenz | OK | Versionsnummer 23.0 in Dokumentkopf, Aktualitätshinweis, README.md und in diesem Validierungsblock konsistent. CC BY 4.0 unverändert; Haftungshinweis am Dokumentende erhalten; KI-Offenlegung in README.md erhalten. |
| 2.6 Automatisierte Prüfung | n/a | Keine automatisierten Skripte vorgesehen; manuelle Stichproben zu Nummerierung, Querverweisen und Quellenzuordnung durchgeführt. |

### Gefundene Fehler

| # | Stelle | Fehler | Schwere |
|---|---|---|---|
| — | — | Keine Fehler identifiziert. | — |
...
- Betroffene Prüfschritte erneut durchlaufen: OK (keine Fehler vorausgegangen)
