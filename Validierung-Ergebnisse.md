...
## Validierung 19. Juni 2026 (Lauf 002 vom 19. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Zweiter regulärer Daily-Update-Lauf, sechs Wochen nach Lauf 001 vom 8. Mai 2026. Web-Recherche im Korridor der Cluster A–J am 19. Juni 2026: Optimalsteuer-/Aufgabenforschung (Cluster A, ohne neue Treffer im 7-Tage-Fenster); DE/EU-Regulierung (Cluster B, Bundestag-KIVDG vom 11. Juni 2026 und EU-Verhaltenskodex vom 10. Juni 2026); internationale Praxis (Cluster C, ohne neue Treffer im 7-Tage-Fenster); Politik-Initiativen (Cluster D — vertieft: Sanders American AI Sovereign Wealth Fund Act vom 18. Juni 2026, Anthropic Economic Policy Framework vom 11. Juni 2026, Trump-Administration-Sondierung vom 5. Juni 2026); Arbeitsmarktdaten (Cluster E, IAB-Prognose nicht aktualisiert seit 24. März 2026); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F — vertieft: Challenger Mai-2026-Report Anfang Juni 2026 und TrueUp-/SkillSyncer-Tagesstand Mitte Juni 2026 inkl. Gartner-Studie); Gesundheitswesen (Cluster G, ohne neue Treffer); Deutschland-These-Bezugspunkte (Cluster H, indirekt über Cluster B); Frontier-Modelle (Cluster I, 48h-Fenster ohne valide neue Releases — Claude 4.8 lag am 28. Mai außerhalb); Robotik (Cluster J, ohne neue Treffer). Sechs belegbare Treffer in zwei vertieften Clustern (D und F) und Cluster B eingearbeitet.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Senator Bernie Sanders — *American AI Sovereign Wealth Fund Act* eingebracht am 18. Juni 2026: einmalige 50-%-Aktienabgabe für KI-Unternehmen ab 200 Mio. USD Jahresbruttoumsatz; Sondervermögen rund 7 Bio. USD; 5 % jährliche Ausschüttung als ca. 1.000-USD-Pro-Kopf-Dividende; siebenköpfige unabhängige Aufsichtskommission. Quellen: sanders.senate.gov, Roll Call, Quartz, Interesting Engineering, Broadband Breakfast, New Republic. | § 4.5 (neuer Absatz im Sanders-Block); § 5.4 (Anbindung als US-Bundeskonkretisierung des Staatsfonds-Konzepts); § 11.3 (neuer Sanders-Pressemitteilungs-Eintrag); § 11.5 (neuer Sammelbeleg Roll Call / Quartz / Interesting Engineering / Broadband Breakfast / New Republic); Aktualitätshinweis und README.md mit Versionseintrag 23.0. | Erster fiskalisch konkret ausformulierter US-Bundesgesetzentwurf für ein Staatsfonds-Beteiligungsmodell an KI-Unternehmen — quantitative Schließung der bisher nur konzeptionellen OpenAI/Sanders-Linie aus dem April-2026-Papier. Verschiebt den Sanders-Schwerpunkt vom Verbrauchsteuer-Robotersteuer-Konzept (Oktober 2025) auf eine Aktien-Beteiligungsmechanik. |
| 2 | Anthropic — *Economic Policy Framework* am 11. Juni 2026: dreistufiger Politikansatz indexiert an die Arbeitslosenquote (~5 % / ~10 % / beispiellos) mit Universal Capital Accounts, automatischen Verlängerungen der Arbeitslosenversicherung, gemeinsamem Einkommensboden, Levy on AI use, BGE- und KI-Staatsfonds-Optionen; 350-Mio.-USD-Pledge (200 Mio. Forschung, 150 Mio. Retraining); „Fair-Share"-Selbstbesteuerungsbekenntnis. Quellen: Anthropic-Whitepaper (cdn.anthropic.com), darioamodei.com, Fortune (11. Juni 2026), Gizmodo, VentureBeat. | § 4.5 (neuer eigenständiger Absatz nach Sanders/Trump-Block); § 5.4 (Anbindung als unternehmensseitige Selbstadressierung); § 11.3 (Anthropic-Eintrag im Verzeichnis); § 11.5 (Sammelbeleg Fortune/Gizmodo/VentureBeat/Anthropic); Aktualitätshinweis und README.md mit Versionseintrag 23.0. | Zweites Policy-Papier eines führenden KI-Anbieters nach OpenAI April 2026 — schreibt die Selbstadressierung der Branche systematisch fort und führt mit der kennzahlenbasierten Auslösung (Arbeitslosenquote statt politischer Aushandlung) eine prozessuale Differenzierung ein. Stufe 3 adressiert ausdrücklich Levy on AI use und KI-Staatsfonds und korrespondiert damit direkt zu den Sanders- und Trump-Vorstößen. |
| 3 | Trump-Administration — öffentliche Sondierung vom 5. Juni 2026 (Pressekonferenz Trump) für eine freiwillige Aktien-„Spende" von OpenAI, xAI und Anthropic in einen *Public Wealth Fund* nach dem im OpenAI-Papier vom April 2026 entwickelten Mechanismus; Anthropic verneint öffentlich Verhandlungsbeteiligung; im Februar 2026 hatte die Trump-Administration Bundes-Beschaffung von Anthropic-Technologie blockiert. Quellen: Washington Post, CNBC, TechTimes, OpenTools, MLQ News. | § 4.5 (neuer Trump-Equity-Block nach Sanders-SWF-Block); § 5.4 (Anbindung als Gegenmechanik); § 11.5 (Sammelbeleg Washington Post / CNBC / TechTimes / OpenTools / MLQ News). | Erstmals stehen sich auf US-Bundesebene zwei Vorstöße zur staatlichen Beteiligung an KI-Unternehmen gegenüber — Sanders (verpflichtende 50 %) und Trump (freiwillige Aktien-„Spende") — mit gegensätzlicher Begründungslogik, aber strukturell verwandter Wirkung. Bestätigt das in § 8.3 entwickelte Teilhabe-Argument im primären politischen US-Diskurs. |
| 4 | Deutscher Bundestag — Beschluss vom 11. Juni 2026 zum *KI-Verordnungs-Durchführungsgesetz* (KIVDG) in der vom Digitalausschuss geänderten Fassung mit den Stimmen CDU/CSU + SPD; Bundesnetzagentur als zentrale Marktüberwachungsbehörde und Beschwerdestelle; Bußgelder bis 7 Mio. EUR oder 1 % des weltweiten Jahresumsatzes; Bundesrat steht noch aus. Parallel EU-Kommission am 10. Juni 2026: endgültiger Verhaltenskodex zur Kennzeichnung von KI-Inhalten. Ab 2. August 2026 Kennzeichnungspflicht für Deepfakes und KI-Texte von öffentlichem Interesse. Quellen: bundestag.de (kw24-1183820), bundesregierung.de, Boerse Express, Ad-hoc-news. | § 4.3 (neuer Absatz nach dem AI-Act-Trilog-Block, vor § 4.4); § 11.3 (Bundestag-/Bundesregierungs-/EU-Kommissions-Einträge); § 11.5 (Sammelbeleg Boerse Express / Ad-hoc-news); Aktualitätshinweis und README.md. | Klärt die deutsche institutionelle Anbindung der EU-KI-VO (Marktüberwachung, Vollzug, Bußgeld), auf die eine spätere steuerliche Anknüpfung an AI-Act-Kategorien verwaltungsorganisatorisch aufsetzen könnte. KIVDG selbst entfaltet keine fiskalische Wirkung — relevant für die Steuerdebatte ausdrücklich als institutionelle Vorbereitung. |
| 5 | Challenger, Gray & Christmas — *Mai-2026-Job-Cuts-Report* (veröffentlicht Anfang Juni 2026): 97.006 angekündigte Streichungen im Mai (+16 % gegenüber April; höchster Mai-Wert seit 2020); Tech 38.242 (höchster Monatswert seit August 2024); Tech-YTD 123.653 (+66 % YoY); KI bleibt führender Einzelgrund; YTD-Gesamt 397.755 (−43 % gegenüber 2025; bereinigt parallel zu 2024 mit 385.859 bis Ende Mai). Quellen: challengergray.com (PDF und Blog), Yahoo Finance. | § 1.1 (Fortschreibung der KI-Verdrängungs-Aggregat-Linie nach dem April-2026-Block); § 11.5 (neuer Eintrag Challenger Gray May-2026). | Liefert die Aggregat-Fortschreibung der KI-Verdrängungslinie über sechs Wochen seit Lauf 001 und bestätigt das Niveau (höchster Mai-Wert seit Pandemie-Spitze 2020; Tech +66 % YoY). |
| 6 | SkillSyncer / TrueUp / TechTimes — Tracker-Tagesstand Mitte Juni 2026: SkillSyncer 267 Layoff-Ereignisse / 185.894 Beschäftigte / rund 1.115 Stellen pro Arbeitstag (versus 564/Tag in 2025); 56 % der Ereignisse explizit KI-, Automatisierungs- oder Machine-Learning-begründet (≥ 150.000 Beschäftigte bei 150 Unternehmen). TrueUp parallel ca. 399 Ereignisse / 153.608 Beschäftigte / 909 pro Tag mit Gesamtjahres-Projektion 370.000. Gartner-Studie Mai 2026 (350 Unternehmen): keine systematische Verbesserung der Finanzkennzahlen bei den am stärksten abbauenden Firmen. Quellen: techtimes.com (16. Juni 2026), skillsyncer.com, trueup.io. | § 1.1 (Tagesfortschreibung der Tracker-Reihe nach dem 8.-Mai-2026-Stand); § 11.5 (neuer Sammelbeleg TechTimes / SkillSyncer / TrueUp). | Sechswöchige Fortschreibung der Tracker-Linie auf erstmals rund 1.115 Stellen/Arbeitstag (gegenüber 564/Tag im Vorjahresdurchschnitt) und Erstdokumentation des methodischen Vorbehalts gegen die Produktivitäts-Begründung durch die Gartner-Studie — flankiert die in § 9.1 dokumentierten Mess- und Kausalitätsprobleme der Typ-5-Logik. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Korea Trade Commission — Tarife auf Industrieroboter (17,45–18,64 % japanisch; 15,96–19,85 % chinesisch) vom 26. März 2026: außerhalb 7-Tage-Fenster; in einem späteren Lauf gegebenenfalls als Cluster-C-/Cluster-J-Bezug aufzunehmen.
- Frontier-Modell-Releases (Claude 4.8 am 28. Mai, GPT-5.6-Leaks, Gemini 3.5 Pro): außerhalb des Cluster-I-48-Stunden-Fensters; ohne fiskalische oder arbeitsmarktbezogene Implikation für die Steuerdebatte zum Recherchezeitpunkt.
- US Senate / Roll Call Sanders Press-Release-Detail-Texte einzelner Folgekommentare: Sammelbelege decken die Kernzahlen ab; spätere Kommentare und Hearings sind im nächsten Lauf zu prüfen.
- AI Index 2026 (Stanford HAI) Sekundärbefunde zu Inferenzkosten: bereits über die in § 1.1 dokumentierte Hyperscaler-Capex-Linie indirekt abgedeckt; ohne neue politisch-fiskalische Implikation im 7-Tage-Fenster.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide Treffer im 7-Tage-Fenster; Empfehlung für die nächsten Läufe weiterhin bestehend (gezielter Abruf g-ba.de, gematik, BfArM).
- Cluster A (Optimalsteuer) im 7-Tage-Fenster ohne neue Working Paper; bestehende Linie (Hamilton/Acemoglu/Massenkoff & McCrory) bleibt aktuell.
...
| 2.1.3 Querverweise | OK | Neue Absätze in § 4.5 verweisen auf § 5.4 (zweifach), § 8.3 (zweifach) und § 9.1 (einmal) — alle Ziele existieren weiterhin. § 4.3-Erweiterung verweist auf § 4.4 (existiert). § 5.4-Erweiterung verweist auf § 4.5 (existiert), § 8.3 (existiert), § 5.3 (existiert). |
| 2.1.4 Roter Faden | OK | Die Juni-Ergänzungen schreiben die in § 4.5 etablierte Initiativen-Linie sowie die in § 1.1 dokumentierte Tech-Layoff-Aggregat-Linie fort; Anthropic-Framework bildet das systematische Pendant zum OpenAI-Papier vom April 2026; KIVDG schließt institutionell an § 4.4 an. Der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; bestehende Lead-Ins unverändert; neue Fett-Lead-Ins „Trump-Administration und Government-Equity-Diskussion (Juni 2026):" und „Anthropic Economic Policy Framework (11. Juni 2026):" in der bestehenden Notation; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Eckdaten (200 Mio. USD Schwelle, 50 % Aktienabgabe, 7 Bio. USD Sondervermögen, 5 % jährliche Ausschüttung, ca. 1.000 USD Pro-Kopf-Dividende, siebenköpfige Kommission) konsistent über fünf unabhängige Sekundärquellen plus Primärquelle sanders.senate.gov. Anthropic-Stufeneckdaten (~5 % / ~10 % / beispiellos, 350-Mio.-USD-Pledge, 200/150 Mio. Aufteilung) konsistent über vier unabhängige Sekundärquellen plus Primärquelle anthropic.com. Trump-5.-Juni-2026-Sondierung in mehreren Mainstream-US-Quellen (Washington Post, CNBC). KIVDG-Beschluss vom 11. Juni 2026 amtlich auf bundestag.de dokumentiert. Challenger-Mai-Zahlen aus dem Original-PDF; Tracker-Stände mit Datum und Methodik gekennzeichnet. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Block in § 4.5 wird um den fiskalisch neuen SWF-Act ergänzt — keine Doppelung zum bestehenden Sanders-Report-Eintrag von Oktober 2025 oder zum Data-Center-Moratorium von März 2026. Anthropic-Framework hat keinen Vorgänger im Dokument; klar abgegrenzt vom in § 3.5 referierten Anthropic-Economic-Index. Trump-Block ergänzt den bestehenden „Trump-AI-Action-Plan-/National-AI-Policy-Framework"-Block um die Government-Equity-Dimension. KIVDG-Block ergänzt den bestehenden Trilog-Block um die nationale Durchführungsebene. § 5.4-Erweiterung kennzeichnet ausdrücklich „ausführlich in § 4.5" als Querverweisform. |
| 2.2.3 Argumentation | OK | Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; Sanders/OpenAI-Linie und Anthropic-Stufenpfad sind als Akteurspositionen klar zugewiesen, nicht als Autorenposition. Konjunktiv durchgängig bei Politikvorschlägen verwendet (Sanders-Entwurf, Anthropic-Framework, Trump-Sondierung). |
| 2.2.4 Ausgewogenheit | OK | Die Bandbreite der Akteure (Sanders progressiv, Trump-Administration republikanisch, Anthropic unternehmensseitig) wird in § 4.5 ausdrücklich gegenübergestellt; methodischer Vorbehalt zur Produktivitäts-Begründung (Gartner-Studie Mai 2026) flankiert die Tracker-Linie. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „American AI Sovereign Wealth Fund Act", „Economic Policy Framework", „Public Wealth Fund", „KI-Verordnungs-Durchführungsgesetz (KIVDG)" als Eigennamen kursiv bzw. vollständig ausgeschrieben mit Klammerabkürzung bei Erstnennung; APA-konforme Quellenangabe für alle sechs neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders-Pressemitteilung und Anthropic-Whitepaper in § 11.3 (institutionell-politische Dokumente); Bundestag-/Bundesregierungs-/EU-Kommissions-Einträge ebenfalls in § 11.3; alle Sekundärbelege als Sammelbelege in § 11.5. Keine Karteileichen; keine im Fließtext genannten Belege fehlen im Verzeichnis. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders: Primärquelle ist Pressemitteilung sanders.senate.gov; mehrere Mainstream-Sekundärquellen (Roll Call, Quartz, Interesting Engineering, Broadband Breakfast, New Republic). Anthropic: Primärquelle ist anthropic.com und cdn.anthropic.com (Whitepaper-PDF). Trump-Sondierung: Mainstream-Quellen Washington Post und CNBC. KIVDG: Primärquelle bundestag.de. Challenger: Original-PDF des Reports. Tracker-Daten: öffentlich zugängliche Dashboards der jeweiligen Anbieter. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs: sanders.senate.gov/press-releases/news-sanders-introduces-legislation-to-create-7-trillion-ai-sovereign-wealth-fund/ (öffentlich); www-cdn.anthropic.com/files/4zrzovbb/website/9ea607a5dd67c168093829b701f3a0a6d21156d5.pdf (öffentlich); bundestag.de/dokumente/textarchiv/2026/kw24-de-ki-1183820 (öffentlich); challengergray.com/wp-content/uploads/2026/06/Challenger-Report-May-2026.pdf (öffentlich); techtimes.com/articles/318466/20260616/tech-layoffs-hit-1115-day-2026-companies-cite-ai-cuts-fail-boost-returns.htm (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Sanders-Kernzahlen (200 Mio. USD Schwelle, 50 % Aktien, 7 Bio. USD, 5 % Ausschüttung, 1.000 USD Pro-Kopf) wörtlich aus sanders.senate.gov und Roll Call. Anthropic-Stufengrenzen (~5 % / ~10 % / beispiellos), 350-Mio.-USD-Pledge mit 200/150-Aufteilung wörtlich aus anthropic.com. Trump-„considering equity stakes" wörtlich aus Washington Post / CNBC vom 5. Juni 2026. Challenger-Kernzahlen (97.006, +16 %, 38.242, 123.653 / +66 %, 397.755 / −43 %) wörtlich aus dem Originalreport. Tracker-Kernzahlen (1.115/Tag, 267 / 185.894, 56 %) wörtlich aus TechTimes vom 16. Juni 2026 und skillsyncer.com. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die sechs neuen Belegcluster benötigen keine eigene Verifizierungsmarkierung (Primärquellen plus mehrere unabhängige Sekundärquellen). |
...
Keine — die sechs Ergänzungen schreiben bestehende Linien fort bzw. öffnen neue thematische Linien in passenden Abschnitten ohne Korrekturbedarf an anderen Aussagen.
