...
## Validierung 22. Juni 2026 (Lauf 001 vom 22. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf nach dem Vorlauf vom 8. Mai 2026 (Sechs-Wochen-Lücke). Web-Recherche im Korridor der Cluster A–J am 22. Juni 2026: Optimalsteuer-/Aufgabenforschung (Cluster A); Robotersteuer/Wertschöpfungsabgabe DE/EU (Cluster B); internationale Praxis (Cluster C); Politik-Initiativen (Cluster D); Arbeitsmarkt- und Sozialversicherungsdaten (Cluster E); Tech-Layoffs / KI-Capex 48-Stunden-Fenster (Cluster F); Gesundheitswesen (Cluster G); Deutschland-These-Bezugspunkte (Cluster H); Frontier-Modelle (Cluster I); Robotik (Cluster J). Wegen der Sechs-Wochen-Lücke wurde der Recherche-Horizont in Cluster A–E sowie G–J pragmatisch auf „seit letztem Lauf am 8. Mai 2026" erweitert; in Cluster F (48-Stunden-Fenster) zusätzlich der Mai-Challenger-Report (5. Juni 2026) und der OECD Economic Outlook (3. Juni 2026) als Folgewerte der bereits etablierten Reihen aufgenommen. Zwei zentrale Politik-Treffer (Sanders American AI Sovereign Wealth Fund Act vom 18. Juni 2026 und Anthropic Economic Policy Framework Juni 2026) sowie eine Aktualisierung der KI-Arbeitsmarkt-Indikatoren (TrueUp-Tagesstand ~153.608, Challenger Mai-Report, ServiceNow, Salesforce, OECD-Gegenstimme) eingearbeitet; alle übrigen recherchierten Themen entweder bereits in Version 22.0 enthalten oder ohne aktuell belegbare Bewegung.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Senator Bernie Sanders — *American AI Sovereign Wealth Fund Act* vom 18. Juni 2026: Einmalige Steuer in Höhe von 50 % des Aktienkapitals von KI-Unternehmen mit ≥ 200 Mio. USD jährlichem KI-Umsatz; geschätztes Fondsvolumen rund 7 Bio. USD; jährliche Dividende von etwa 5 % an US-Bürgerinnen und Bürger (Direkttransfer > 1.000 USD pro Person und Jahr); Anwendungsbereich: AI data centers, computing infrastructure, AI services, advanced robotics; Verwaltung durch eine *Independent Commission for Democratic AI*. Quellen: sanders.senate.gov Pressemitteilung (18. Juni 2026), NPR (18. Juni 2026), Roll Call (18. Juni 2026), The Hill, Fox Business, Reason, RedState. | Neuer Absatz in § 4.5 („Sanders — American AI Sovereign Wealth Fund Act"); Erweiterung in § 5.4 (Staatsfonds und Dividendenmodelle: Sanders-Bill als Maximalvariante); neuer Eintrag in § 11.3 (sanders.senate.gov Pressemitteilung und Summary-PDF); neuer Sammelbeleg in § 11.5 (NPR / Roll Call / The Hill / Fox Business / Reason / RedState); Aktualitätshinweis am Dokumentende erweitert; README.md mit neuem Versionseintrag 23.0. | Verschiebt die Sanders-Linie erstmals von der reinen Robotersteuer-Logik (Sanders-Report 2025) und vom infrastrukturpolitischen Moratorium (S. 4214) auf eine Beteiligungs- und Dividendenkonstruktion, die strukturell näher an § 5.4 und an die in § 8.3 entwickelte Teilhabe-Komponente heranrückt. Für die in § 8.3 und § 8.6 entwickelte Teilhabe-Logik ist die Konstellation deshalb relevant, weil sie eine Maximalvariante markiert: Selbst in den USA, wo Staatsfondskonstruktionen historisch unbeliebt sind, wandert das politische Vokabular von Abgaben auf einzelne Maschinen zu Eigentums- und Dividendenmodellen. |
| 2 | Anthropic — *Economic Policy Framework* (Juni 2026): Dreistufige Eskalationsleiter indexiert an der Arbeitslosenquote — Stufe 1 (5 %): universelle „pre-distributive" Kapitalkonten, Ausbau der bereits angelegten Bundes-Konten für Neugeborene auf Kinder, Berufsanfänger in exponierten Berufen, alle Erwerbsfähigen; Stufe 2 (10 %): deutlich aufgestockte Arbeitslosenversicherung mit sektoralen Übergangshilfen; Stufe 3 (unprecedented): explizit „basic income, sovereign wealth models, and equity-sharing mechanisms". Flankierende Investitionszusage 200 Mio. USD für Forschung zu KI-Arbeitsmarktwirkungen. Quellen: anthropic.com/policy-on-the-ai-exponential/epf und Sekundärbeleg actionnewsjax.com. | Neuer Absatz in § 4.5 („Anthropic — Economic Policy Framework"); Erweiterung in § 5.4 (Anthropic-Framework als zweite externe Referenz für Fondsmodelle); neuer Eintrag in § 11.3 (Anthropic Economic Policy Framework PDF und Anthropic-Policy-Seite); Aktualitätshinweis am Dokumentende erweitert; README.md mit neuem Versionseintrag 23.0. | Erstes konkurrierendes Frontier-Modell-Anbieter-Papier neben OpenAI April 2026, das eine sozialpolitische Eskalationsleiter mit messbaren Triggerschwellen formuliert und explizit Staatsfondsmodelle in Aussicht stellt. Die Konvergenz zweier konkurrierender Frontier-Anbieter auf Fonds- und Kapitalkontenmodelle stützt das Argument, dass auch eine deutsche/europäische Teilhabe-Architektur nicht als Sonderweg, sondern als Antwort auf eine breit erkannte Strukturfrage zu konzipieren ist (§ 8.3, § 8.6). |
| 3 | Aktualisierung der KI-Arbeitsmarkt-Indikatoren-Reihe: (a) TrueUp-Tagesstand zum Juni 2026: rund 153.608 Personen aus 399 Layoff-Meldungen, rund 909 Stellen pro Tag; methodische Anteilsangabe: über 50 % der erfassten Ereignisse mit explizitem KI-/Automatisierungs-/ML-Bezug; (b) Challenger *Mai-2026-Job-Cuts-Report* (5. Juni 2026): 97.006 US-Streichungen Mai (höchster Mai seit 2020, +16 % gegenüber April, dritter Monatsanstieg in Folge); KI 38.579 / 40 % (historischer Monats-Höchstwert seit Erfassung 2023); YTD KI 87.714 / 22 % (gegenüber 54.836 ganzes Jahr 2025); Tech 38.242 (höchster Sektor-Monatswert seit August 2024); (c) ServiceNow — mehrere hundert Stellen Mitte Juni 2026 mit Verweis auf „real AI efficiencies"; (d) Salesforce — 86 Stellen Mulesoft/Marketing Cloud am 13. Juni 2026; (e) OECD *Economic Outlook* (3. Juni 2026) als analytische Gegenstimme: „keine Anzeichen einer breiten KI-induzierten Verdrängung auf Branchen­ebene"; Engpass primär Mangel an digital qualifizierten Arbeitskräften. Quellen: trueup.io, finance.yahoo.com (TrueUp-Aggregat), challengergray.com (Mai-Report-PDF und Blog), salesforceben.com, kore1.com (ServiceNow), Fortune (OECD-Reuters-Sekundärbeleg). | § 1.1: ein neuer Absatz mit der Sechs-Wochen-Aktualisierung im Anschluss an den bisherigen 8.-Mai-Stand; § 11.5: neue Sammelbelege „Challenger May-Report", „TrueUp / Yahoo Finance / Programs.com", „Salesforce Ben / KORE1", „OECD / Fortune"; Aktualitätshinweis am Dokumentende erweitert; README.md mit neuem Versionseintrag 23.0. | Die Reihe TrueUp / Challenger / Einzel-Konzern-Layoffs / OECD-Lesart wird in Lauf 001 vom 8. Mai 2026 erstmals seit sechs Wochen aktualisiert. Die Anhebung des Challenger-KI-Anteils von 26 % (April) auf 40 % (Mai) und des YTD-KI-Anteils von 16 % auf 22 % schärft die in § 1.1 dokumentierte Asymmetrie-Linie quantitativ; die OECD-Gegenstimme ergänzt die in § 9.1 dokumentierte Messproblematik und liefert ein zusätzliches Mainstream-Argument neben der *Washington-Post*-Differenzierung vom 1. Mai 2026. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Chinesische Gerichtsentscheide (Hangzhou / Beijing, April–Mai 2026) zur Unzulässigkeit KI-bedingter Kündigungen — folgeberichtet in Friends of Socialist China (4. Juni 2026) und China.org.cn (30. April 2026); thematisch hochrelevant für Cluster C / § 6.4 und § 9.5, aber Erstberichterstattung außerhalb des erweiterten 7-Tage- / Sechs-Wochen-Fensters und der einschlägige Primärbeleg (gerichtlicher Modell-Fall) im Kern bereits in Caixin und Bloomberg vom 30. April / 2. Mai 2026 dokumentiert; im nächsten Lauf bei Verfügbarkeit eines deutschsprachigen Sekundärbelegs oder einer MOHRSS-Richtlinie nachzutragen.
- Humanoid-Robotik Q2 2026 (Tesla Optimus Gen 2/3, Figure 02/03, Apptronik Apollo) — drei Programme übergehen nach übereinstimmenden Branchenberichten Q2 2026 von Prototyp zu limitierter Produktion; BMW Spartanburg-Pilot mit Figure 02 für rund ein Jahr und Beteiligung an mehr als 30.000 BMW-X3-Fahrzeugen abgeschlossen; Tesla Fremont-Conversion Q2 2026 in Aussicht. Cluster J ohne klar fiskalisch-politische Implikation im 48-Stunden-Fenster; thematisch fortschreitend, im nächsten Lauf bei IFR-Update oder konkreter Stückzahlen-Meldung mit Steuerbezug zu prüfen.
- OpenAI Workshop / Washington — Stand 22. Juni 2026 keine substanziell neue Verlautbarung über die im Mai 2026 dokumentierte Eröffnung hinaus; bestehender § 4.5-Block bleibt korrekt.
- Connecticut SB 5 Lamont-Unterzeichnung — Stand 22. Juni 2026 keine zwischen 8. Mai und 22. Juni 2026 datierbare Pressemeldung ermittelt; bestehender § 4.5-Block bleibt korrekt; im nächsten Lauf zu prüfen.
- Bundesrat-Folgesitzungen / GKV-Beitragssatzstabilisierungsgesetz — parlamentarische Befassung war für Mai/Juni 2026 angekündigt; Stand 22. Juni 2026 keine in der Recherche identifizierbare Bundestagsverabschiedung; § 5.2-Block bleibt korrekt; im nächsten Lauf zu prüfen.
- Weimer Plattform-Digitalabgabe — Eckpunktepapier weiterhin angekündigt, ohne neue Bewegung im Mai/Juni 2026 über Lauf 001 vom 8. Mai 2026 hinaus; § 11.3-Eintrag und § 4.5-Block bleiben korrekt; im nächsten Lauf zu prüfen.
- EU AI Act Digital Omnibus — politische Einigung im Mai 2026 zur Stichtagsverschiebung (Anhang III auf 2. Dezember 2027, Anhang I auf 2. August 2028); bereits in Version 22.0 in § 4.5 / § 11.3 dokumentiert (Trilog-Konvergenz Konvergenz-Sätze); kein neuer fiskalisch-relevanter Sachverhalt zwischen 8. Mai und 22. Juni 2026; im nächsten Lauf bei formaler Adoption in der Amtsblatt-Fassung nachzutragen.
- Generationenkapital / KENFO — keine neuen Tranchen-/Renditeangaben zwischen 8. Mai und 22. Juni 2026; bestehender § 8.6-Verweis bleibt aktuell.
- IAB-Folgeprognose — Stand 22. Juni 2026 kein im Recherchefenster identifizierter Folgeband zur Frühjahrsprognose vom 24. März 2026; bestehender § 1.1- und § 11.3-Eintrag bleibt aktuell.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide KI-spezifische Treffer im 7-Tage-/Sechs-Wochen-Fenster (G-BA, gematik, BfArM ohne KI-spezifische neue Beschlüsse zwischen 8. Mai und 22. Juni 2026); Empfehlung für die nächsten Läufe weiterhin bestehend.
- Cluster I (Frontier-Modelle) und Detail-Capex-Folgewerte — keine über die in § 1.1 referierten Q1-Earnings-Calls vom 28.–30. April 2026 hinausgehende quantitative Aktualisierung; Q2-Earnings-Calls werden voraussichtlich erst im Juli/August 2026 publiziert.

### Prüfergebnis

| Prüfschritt | Ergebnis | Auffälligkeiten |
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; keine neuen Unterüberschriften; keine leeren Abschnitte. Die zwei neuen Absätze in § 4.5 („Sanders — American AI Sovereign Wealth Fund Act" und „Anthropic — Economic Policy Framework") und der ein neuer Absatz in § 1.1 und § 5.4 sind im bestehenden Absatzschema (fett geleitete Lead-Ins in § 4.5) korrekt eingegliedert. |
...
| 2.1.3 Querverweise | OK | Bestehende §-Querverweise unverändert; die neuen Sanders- und Anthropic-Passagen in § 4.5 verweisen ausdrücklich auf § 5.4 und § 8.3 — diese Ziele existieren. Der neue Absatz in § 5.4 verweist zurück auf § 4.5 und § 8.3; die neuen Verweise auf § 4.3 und § 4.4 (Verfassungs-/Europarechts-Vorbehalt für direkte Aktienenteignung) existieren. |
| 2.1.4 Roter Faden | OK | Die Ergänzungen sind eine Fortschreibung der etablierten Linie OpenAI April 2026 → Sanders-Report Oktober 2025 → S. 4214 März 2026 → Sanders Sovereign Wealth Fund Act Juni 2026, ergänzt um Anthropic-Framework Juni 2026; der rote Faden Literaturrezeption → Position → Umsetzung bleibt unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; keine neuen Tabellen oder Lead-Ins; bestehende Lead-Ins unverändert; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert; Stand-Zeile (Mai 2026 → Juni 2026) konsistent geändert. |
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Kernzahlen (einmalige 50-%-Steuer auf Aktienkapital, ≥ 200 Mio. USD Schwelle, rund 7 Bio. USD Fondsvolumen, rund 5 % Jahresdividende, mehr als 1.000 USD pro Person/Jahr, Independent Commission for Democratic AI) in mehreren unabhängigen Quellen (sanders.senate.gov, NPR, Roll Call, The Hill, Fox Business) konsistent. Anthropic-Kernzahlen (drei Stufen, 200 Mio. USD Investitionszusage, sovereign wealth / equity-sharing / basic income in Stufe 3) im Anthropic-Originalpapier und einem Sekundärbeleg konsistent. Challenger Mai-Daten (97.006 / +16 %; KI 38.579 / 40 %; YTD KI 87.714 / 22 %; Tech 38.242) wörtlich aus dem Challenger-Report (5. Juni 2026). TrueUp-Tagesstand (153.608 / 399 / 909 pro Tag) und Yahoo-Finance-Auswertung konsistent. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Sovereign-Wealth-Fund-Bill ist eine NEUE Initiative gegenüber Sanders-Report 2025 und S. 4214 März 2026; bestehende Sanders-Blöcke in § 4.5 bleiben als zeitlich frühere Referenzen erhalten und werden durch den neuen Absatz nicht redundant doppelt geführt. Anthropic-Framework ist eine NEUE Veröffentlichung gegenüber den Anthropic-Economic-Index-Berichten (März/April 2026) und dem Massenkoff/McCrory-Papier (5. März 2026); die Index-Reihe (deskriptiv) und das Policy Framework (präskriptiv) werden klar getrennt geführt. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten. Sanders-Bill und Anthropic-Framework werden in Konjunktivform referiert (Claude.md § 4.2: „sähe vor", „würde", „solle"), wie für Gesetzentwürfe / Policy-Papiere ohne Verabschiedung vorgeschrieben. |
| 2.2.4 Ausgewogenheit | OK | Sanders-Bill: Aussicht auf Verabschiedung wird als „erneut gering" markiert (analog zur S. 4214-Einordnung); kritische Stimmen (Reason, RedState) werden im § 11.5-Sammelbeleg explizit referenziert. Anthropic-Framework wird sachlich-deskriptiv referiert; OECD-Gegenstimme wird explizit als „analytische Gegenstimme" eingeführt und gegen die KI-zentrische Lesart gestellt. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Sovereign Wealth Fund" als gegnerseitiger Eigenname; „pre-distributive capital accounts" und „equity-sharing mechanisms" als Anthropic-Originalterminologie in Anführungszeichen; bestehende Schreibweisen „TrueUp", „Challenger, Gray & Christmas", „OECD" einheitlich; APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders-Bill: Eintrag in § 11.3 (Pressemitteilung + Summary-PDF) plus Sammelbeleg in § 11.5 (NPR / Roll Call / The Hill / Fox Business / Reason / RedState). Anthropic-Framework: Eintrag in § 11.3 (Anthropic-Policy-Seite + Direkt-PDF). Challenger May / TrueUp / ServiceNow / OECD: vier Sammelbelege in § 11.5. Keine Karteileichen. |
| 2.4.2 Formale Einheitlichkeit | OK | APA-Stil eingehalten; URLs vollständig (kein Shortener); Datumsangaben einheitlich (18. Juni 2026; 5. Juni 2026; 13. Juni 2026; 3. Juni 2026); Sammelbelege mit „/"-Trenner zwischen Quellen. |
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders-Bill: Primärquelle ist die sanders.senate.gov-Pressemitteilung und das Summary-PDF, mehrere unabhängige Sekundärquellen (NPR, Roll Call, The Hill, Fox Business, Interesting Engineering, NewsNation). Anthropic-Framework: Primärquelle ist das Anthropic-PDF auf www-cdn.anthropic.com. Challenger May: Primärquelle ist der Challenger-Report-Blog mit verlinktem PDF. TrueUp: Primärquelle ist das öffentlich zugängliche Tracker-Dashboard; Yahoo Finance / Programs.com als Sekundärbelege. OECD: Primärquelle ist der OECD Economic Outlook; Fortune als Sekundärbeleg. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs nach Recherche-Aufrufen: sanders.senate.gov/press-releases/news-sanders-introduces-legislation-to-create-7-trillion-ai-sovereign-wealth-fund/ (öffentlich, Inhalt konsistent); rollcall.com/2026/06/18/sovereign-wealth-fund-tax-on-ai-companies-unveiled-by-sanders/ (öffentlich); www-cdn.anthropic.com/files/.../9ea607a5dd67c168093829b701f3a0a6d21156d5.pdf (öffentlich); www.anthropic.com/policy-on-the-ai-exponential/epf (öffentlich); challengergray.com/blog/challenger-report-may-job-cuts-rise-16-from-april-highest-may-total-since-2020/ (öffentlich); trueup.io/layoffs (öffentlich, dynamisch); fortune.com/2026/06/03/oecd-economic-outlook-scarring-effects-recession-ai-labour-displacement/ (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Sanders (50 % Aktienkapital, ≥ 200 Mio. USD, ~7 Bio. USD, ~5 % Dividende, >1.000 USD/Jahr) wörtlich aus sanders.senate.gov; Kernzahlen Anthropic (5 % / 10 % / unprecedented, 200 Mio. USD) wörtlich aus dem Anthropic-PDF; Challenger Mai-Daten (97.006, +16 %, 38.579 / 40 %, 87.714 / 22 %, 38.242) wörtlich aus Challenger-Report; TrueUp Stand (153.608 / 399 / 909) wörtlich aus dem Tracker-Aggregat-Snapshot und Yahoo-Finance-Folgeartikel. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die neuen Belege benötigen keine eigene Verifizierungsmarkierung (Sanders: Primärquelle Senat; Anthropic: Primärquelle Anthropic-CDN; Challenger: Primärquelle Challenger-Blog; TrueUp: Live-Dashboard; OECD: Primärquelle OECD Outlook). |
| 2.5 Versionskonsistenz und Lizenz | OK | Versionsnummer 23.0 in Dokumentkopf, Aktualitätshinweis, README.md (Versionszeile, Zitiervorschlag, KI-Offenlegung mit neuem Versionseintrag) und diesem Validierungsblock identisch; Stand-Angabe (Juni 2026) in Dokumentkopf und README.md identisch; CC-BY-4.0-Hinweis und Haftungshinweis unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Keine Skripte vorhanden; manuelle Stichproben gemäß § 2.6 ersetzen den automatisierten Teil. |

### Gefundene Fehler

Keine — die Ergänzungen sind Fortschreibungen einer bestehenden Linie und neue Politik-Treffer ohne Korrekturbedarf an anderen Aussagen.
