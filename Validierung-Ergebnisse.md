...
## Validierung 20. Mai 2026 (Lauf 001 vom 20. Mai 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster regulärer Daily-Update-Lauf nach dem Lauf 001 vom 8. Mai 2026 (Versionsstand 22.0). Web-Recherche im Korridor der Cluster A–J am 20. Mai 2026 mit Schwerpunkt 7-Tage-Fenster (13.–20. Mai 2026; Cluster F und I im 48-Stunden-Fenster, bei Cluster F mit zwei Verlängerungen ins erweiterte Fenster für Innovaccer 15. Mai und AI21 18. Mai). Fünf belegbare Treffer im 7-Tage-Fenster bzw. als Korrekturen zu in Version 22.0 noch offen markierten Vorgängen identifiziert und eingearbeitet (EU-Trilog-Einigung 7. Mai 2026 als Korrektur zur in Version 22.0 als „nächste Runde 13. Mai 2026" geführten Trilog-Erwartung; Hangzhou-Urteil 30. April / 1. Mai 2026 als bisher in keinem Lauf erfasste internationale Praxis; Innovaccer 15. Mai, AI21 Labs 18. Mai und Meta 20. Mai 2026 als drei neue KI-Layoff-Wellen im 7-Tage-Fenster; TrueUp-Tagesfortschreibung Stand 18./19. Mai 2026); alle übrigen recherchierten Themen waren in Version 22.0 bereits enthalten oder lagen außerhalb des 7-Tage- bzw. 48-Stunden-Korridors.

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | EU AI Act *Digital Omnibus on AI* — Provisorische politische Trilog-Einigung von Rat und Parlament in den frühen Stunden des 7. Mai 2026 (zwei Wochen vor der ursprünglich für 13. Mai 2026 angesetzten Folgerunde): Bestätigung der Stichtage 2. Dezember 2027 für Anhang III (Hochrisiko-Stand-alone-Systeme) und 2. August 2028 für Anhang I (Hochrisiko-KI in regulierten Produkten); neue verbotene Praxis nach Art. 5 zu KI-generiertem Material sexueller Gewalt an Kindern und nicht einvernehmlicher intimer Bildern; Verschiebung der nationalen AI-Regulatory-Sandbox-Frist auf 2. August 2027; verkürzte Übergangsfrist für die Transparenzpflichten nach Art. 50 Abs. 2 von sechs auf drei Monate (für bereits am Markt befindliche Systeme bis 2. Dezember 2026); formelle Annahme durch beide Co-Gesetzgeber vor 2. August 2026 vorgesehen. Quellen: Rat der EU Pressemitteilung 7. Mai 2026 (URL 2026/05/07/...); Kanzleianalysen Bird & Bird, White & Case, VerifyWise. | § 4.4 (neuer Absatz mit Implikationen für die Steuerdebatte: Verschiebung des fiskalisch wirksamen Erfüllungsaufwands; Anknüpfungspunkt für kennzeichnungsbasierte Erfassung von KI-Output über Art. 50 Abs. 2); § 11.3 alter Trilog-Eintrag als zeitlich frühere Referenz erhalten (Claude.md § 4.2), neuer Eintrag „Rat der EU / Europäisches Parlament (7. Mai 2026)" mit drei URLs ergänzt; Aktualitätshinweis am Dokumentende auf den 20. Mai 2026 aktualisiert; README.md mit neuem Versionseintrag 23.0. | Korrigiert die in Version 22.0 noch geführte Erwartung „nächste Runde 13. Mai 2026" und verändert das in § 4.3/§ 4.4 dokumentierte regulatorische Zeitfenster für KI-Anbieter substanziell — die für 2. August 2026 vorgesehene volle Anwendbarkeit der Hochrisiko-Pflichten ist damit faktisch um zwölf bis 17 Monate verschoben. Für die Steuerdebatte ist die kennzeichnungsbasierte Transparenzpflicht (Art. 50 Abs. 2) der wichtigste neue Anknüpfungspunkt, weil sie mittelbar einen output-/transaktionsbasierten Steuertatbestand (Typ 3/4 nach § 2.1, vgl. § 9.1) erfassbar macht. |
| 2 | VR China — *Hangzhou Intermediate People's Court* veröffentlicht am 30. April / 1. Mai 2026 aus Anlass des Internationalen Tages der Arbeit ein Bündel sogenannter „typischer Fälle zum Schutz der Rechte von KI-Unternehmen und Arbeitnehmenden". Im Leitfall „Zhou" (Qualitätssicherungsbeauftragter Sprachmodelle, 25.000 Yuan / Monat seit November 2022) wertet das Gericht die einseitige Versetzung auf eine niedriger dotierte Stelle (15.000 Yuan) und die anschließende Kündigung mit Verweis auf KI-Übernahme der Tätigkeit als unzulässig unter Chinas Arbeitsvertragsgesetz (KI-Einsatz als strategische unternehmerische Entscheidung, nicht als „wesentliche Veränderung der objektiven Umstände"). Ein parallel publizierter Beijing-Fall folgt derselben Linie. Quellen: Caixin Global (30. April 2026), NPR (1. Mai 2026), Bloomberg (2. Mai 2026), CGTN (2. Mai 2026), Fortune (3. Mai 2026), China.org.cn / SCIO (30. April 2026), Tom's Hardware. | § 6.5 neuer Unterabschnitt „VR China: Arbeitsrechtliche Begrenzung KI-bedingter Entlassungen (April/Mai 2026)" mit Fallbeschreibung, internationaler Rezeption und doppelter Anbindung an § 4.5 (US-/EU-Disclosure-Linie als Kontrast) und § 9.1 (Kausalitätsmessung); § 9.1 Querverweis bei „Displacement-basiert" auf § 6.5 ergänzt; § 11.3 neuer Eintrag „Hangzhou Intermediate People's Court / Beijing People's Court (30. April / 1. Mai 2026)" mit fünf URLs (Caixin, NPR, Bloomberg, Fortune, CGTN); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Erstmalige internationale Etablierung einer arbeitsrechtlichen Mindestschwelle gegen rein KI-getriebene Personalreduktion — und damit ein vom Tax-Design unabhängiges, aber dasselbe Steuerungsproblem („wer trägt die Kosten der KI-Verdrängung") adressierendes Instrument. Direkter Kontrast zur in § 4.5 referierten US-/EU-Linie (Disclosure, Hochrisiko-Klassifizierung, Sanders/AOC-Moratorium) und gleichzeitig empirischer Verstärker der in § 9.1 dokumentierten Kausalitätsprobleme einer Typ-5-Ersatzabgabe (§ 2.1) — wenn Arbeitsgerichte den Nachweis einer rein KI-bedingten Kündigung systematisch zurückweisen, wird auch die fiskalische Anknüpfung schwerer kodifizierbar. Der Vorgang wurde in den Läufen vom 7./8. Mai 2026 nicht erfasst und ist deshalb als Nachtrag aufgenommen. |
| 3 | Innovaccer / AI21 Labs / Meta — Drei neue KI-Layoff-Wellen im 7-Tage-Fenster: (a) am 15. Mai 2026 hat das kalifornisch ansässige Healthtech-Einhorn *Innovaccer* (Großkunden u. a. CommonSpirit Health, Kaiser Permanente, Banner Health) im dritten Restrukturierungslauf binnen vier Jahren rund 340 Stellen mit Schwerpunkt Indien und USA gestrichen; CEO Abhinav Shashank begründet im internen Memo die Transition zu einem „AI-native"-Betriebsmodell. (b) am 18. Mai 2026 hat das israelische Foundation-Model-Startup *AI21 Labs* mehr als 60 % seiner Belegschaft (rund 110 von 180 Beschäftigten) entlassen, nachdem Verkaufsgespräche mit dem Cloud-Anbieter *Nebius* gescheitert waren; anstelle einer Übernahme schlossen die Unternehmen eine kommerzielle Partnerschaft im Volumen mehrerer zehn Millionen US-Dollar; AI21 stellt den eigenständigen Verkauf seiner Sprachmodelle ein und konzentriert sich vollständig auf die Agent-Optimierungs-Plattform *Maestro*. (c) am 20. Mai 2026 beginnt *Meta* die größte konzerneigene Restrukturierung seit 2023 mit der Streichung von rund 8.000 Stellen (10 % einer 78.865-köpfigen Belegschaft) und der Streichung von rund 6.000 offenen Stellenausschreibungen — effektive Kopfzahlreduktion 14.000 Positionen — bei rekordverdächtigem Q1-2026-Umsatz von 56,31 Mrd. US-Dollar und einer auf 115–145 Mrd. US-Dollar angehobenen KI-Capex-Planung 2026; gleichzeitig Verlagerung von rund 7.000 Beschäftigten in KI-Initiativen; Reorganisation in KI-fokussierte „Pods" unter dem von Chief AI Officer Alexandr Wang geführten *Meta Superintelligence Labs* (Memo Chief People Officer Janelle Gale, 18. Mai 2026). Quellen: Inc42 / NewsBytes / Entrackr / People Matters / American Bazaar (Innovaccer); Calcalist (Ctech) / Ynet / Latestly / Crypto Briefing (AI21); The Next Web / CNBC / Tech Startups / Rappler / TechResearchOnline (Meta). | § 1.1 (Ergänzung des bestehenden Layoff-Blocks: drei neue Wellen explizit als „Folgewochen verlängern diese Linie um drei weitere Wellen" nach dem Cloudflare-Block aufgenommen; konkrete Programmkonditionen mit Begründungslinien); § 11.5 drei neue Sammelbelege „Inc42/NewsBytes/Entrackr/People Matters/American Bazaar" (Innovaccer), „Calcalist (Ctech)/Ynet/Latestly/Crypto Briefing" (AI21), „The Next Web/CNBC/Tech Startups/Rappler/TechResearchOnline" (Meta); Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Drei verschiedene Anbietertypen mit unterschiedlicher Logik: Healthtech (Cluster G-Anknüpfung mit Indien-Schwerpunkt — relevant für die in § 7 referierte deutsche Gesundheits-IT-Diskussion, weil Innovaccer in Konkurrenz zu deutschen Anbietern für KI-gestützte Versorgungsplanung steht); Foundation-Model-Startup (Cluster I-Anknüpfung — AI21 markiert mit dem Pivot vom Standalone-Model zur Agent-Plattform eine Strukturverschiebung im Frontier-Markt zugunsten weniger, größerer Anbieter); Hyperscaler (Cluster F-Anknüpfung — Meta liefert mit der gleichzeitigen Umsatzhöchstmarke 56,31 Mrd. USD und der KI-Capex-Erhöhung auf bis zu 145 Mrd. USD die bislang krasseste Asymmetrie zwischen Personalreduktion und Infrastrukturausbau und verschärft die in § 1.1 entwickelte Linie sowie die in § 5.1 / § 8.3 referierte Anknüpfung an Maschinenkapital). |
| 4 | TrueUp Tracker — Tagesfortschreibung zum 18./19. Mai 2026: 138.947 Personen aus 325 Layoff-Meldungen (rund 1.000 Personen pro Tag); SkillSyncer mit 113.863 Personen aus 179 Ereignissen unverändert. Quellen: TrueUp Dashboard, SkillSyncer Dashboard, kron4.com (Mai 2026), techtimes.com (18. Mai 2026). | § 1.1 (Tagesfortschreibung der Tracker-Reihe an den 27. April → 2. Mai → 6. Mai → 7. Mai → 8. Mai 2026-Reihe angeschlossen; explizit als Verlängerung um die Innovaccer-/AI21-/Meta-Wellen lesbar gemacht); § 11.5 neuer Eintrag „TrueUp / SkillSyncer / kron4 / techtimes (Stand 18./19. Mai 2026)"; Aktualitätshinweis am Dokumentende ergänzt; README.md mit neuem Versionseintrag 23.0. | Schließt die Tracker-Reihe an den Tag des Laufs an. Bemerkenswert: das Tagestempo bleibt bei rund 1.000 Personen pro Tag (vergleichbar mit dem 8.-Mai-Stand), während die Aggregatmenge in elf Tagen um rund 11.500 Personen und 42 Meldungen weiter angestiegen ist — das Niveau des KI-bezogenen Personalabbaus stabilisiert sich auf hohem Niveau, ohne (Stand 20. Mai 2026) erneut zu beschleunigen. |

**Nicht aufgenommen (bewusste Auslassungen):**
- Connecticut SB 5 — Lamont-Unterzeichnung zum Stichtag 20. Mai 2026 noch nicht formell mit Datum dokumentiert; mehrere Sekundärquellen (DLA Piper Mai 2026, Davis Wright Tremaine, Littler, CBIA, Freshfields, ctmirror.org 19. Mai 2026 „CT's AI bills are not the finish line", govtech) referieren weiterhin nur die Unterzeichnungsabsicht des Gouverneurs; bestehender § 4.5-Block bleibt korrekt; im nächsten Lauf nachzutragen, sobald die formelle Unterzeichnung mit Datum belegt ist.
- NBER WP 34705 (Manning & Aguirre, *How Adaptable Are American Workers to AI-Induced Job Displacement?*) — bereits in Lauf 002 vom 7. Mai 2026 als „außerhalb 7-Tage-Fenster" verworfen; Brookings-Analyse-Wiedergabe Januar 2026; aktuelle Sekundärquellen liegen weiterhin außerhalb des 7-Tage-Fensters.
- Federal Reserve Bank of Atlanta WP 2026-04 (Acemoglu/Manera/Restrepo-Folgepapier) — bereits in Lauf 003 vom 7. Mai 2026 als „außerhalb 7-Tage-Fenster" markiert; keine Bewegung im 7-Tage-Fenster.
- Bundesrat 1065. Sitzung 8. Mai 2026 — der erste Durchgang des GKV-Beitragssatzstabilisierungsgesetzes hat ausweislich der „Bundesrat-Kompakt"-Übersicht und der Stellungnahme der Deutschen Krankenhausgesellschaft (8. Mai 2026) zwar stattgefunden, eine eigenständige im Logbuch dokumentationswürdige Beschluss-Linie über die in Version 17.0 etablierte Darstellung hinaus liegt jedoch nicht vor; bestehender § 5.2- und Aktualitätshinweis-Verweis bleibt korrekt.
- IFR World Robotics Report — aktuellster Bericht weiterhin Edition 2025 (September 2025, 542.000 Installationen 2024); keine Mai-2026-Aktualisierung.
- AI21-Käufer / Nebius-Folgeentwicklung — Nebius übernimmt einen Teil der ausgeschiedenen Engineers im Zuge der kommerziellen Partnerschaft, eine vollständige Acquihire-Konstruktion ist im 7-Tage-Fenster jedoch nicht öffentlich dokumentiert; nicht trennscharf genug für die Steuerdebatte.
- Snap-Layoffs 15. April 2026 (rund 1.000 Stellen, 16 %, CEO Evan Spiegel) — außerhalb 7-Tage-Fenster; bleibt für späteren Vertiefungslauf marker.
- Cluster G im engeren Sinne (G-BA, gematik, BfArM) — fünftes Mal in Folge ohne valide Treffer im 7-Tage-Fenster; Empfehlung für die nächsten Läufe weiterhin bestehend.

### Prüfergebnis

| Prüfschritt | Ergebnis | Auffälligkeiten |
|---|---|---|
| 2.1.1 Gliederung | OK | 11 Kapitel + Executive Summary unverändert; neuer Unterabschnitt § 6.5 „VR China: Arbeitsrechtliche Begrenzung KI-bedingter Entlassungen (April/Mai 2026)" als sechster Unterabschnitt von Kapitel 6 ergänzt (zusammen mit den bestehenden § 6.1 Südkorea, § 6.2 Italien, § 6.3 Polen, § 6.4 Weitere Ansätze) — Kapitelanzahl 11 unverändert, Inhaltsverzeichnis-Eintrag „6. Internationale Praxis und Fallbeispiele" unverändert (keine Unterabschnitt-Ebene im Inhaltsverzeichnis). |
| 2.1.2 Nummerierung | OK | Kapitel 1–11 lückenlos; Unterabschnitt 8.1–8.7 lückenlos; fünf Robotersteuer-Typen, drei Hebel der Deutschland-These und sieben Empfehlungen unverändert; § 6 nun mit fünf Unterabschnitten (6.1–6.5) lückenlos. |
| 2.1.3 Querverweise | OK | Neuer Querverweis aus § 9.1 (Displacement-basiert) auf § 6.5 ergänzt; § 6.5 verweist über bestehende Linien auf § 4.5 und § 9.1; § 4.4 verweist auf § 9.1 und § 4.3; alle Ziele existieren. |
| 2.1.4 Roter Faden | OK | Die fünf Ergänzungen sind Aktualisierungen/Nachträge zu bereits etablierten Linien (Trilog → § 4.4; China → § 6 internationale Praxis; drei Layoff-Wellen → § 1.1-Block; Tracker → § 1.1); der rote Faden Literaturrezeption → Sektoranwendung → eigene Position → Umsetzung bleibt unverändert. |
| 2.1.5 Formatierung | OK | Keine doppelten Trennlinien; keine neuen Tabellen außerhalb der Validierung selbst; bestehende Lead-Ins unverändert; Versionszeile im Dokumentkopf (22.0 → 23.0) konsistent geändert; neuer Lead-In „EU AI Act — provisorische Trilog-Einigung zum Digital Omnibus on AI (7. Mai 2026):" in § 4.4 in der bestehenden Lead-In-Konvention formatiert. |
| 2.2.1 Sachliche Richtigkeit | OK | Trilog-Einigungsdatum 7. Mai 2026 in Rat-der-EU-Pressemitteilung, Bird & Bird und VerifyWise konsistent (URL 2026/05/07/); Hangzhou-Fall-Kennzahlen (25.000 → 15.000 Yuan, Qualitätssicherung Sprachmodelle, November 2022) in Caixin/NPR/CGTN konsistent; Innovaccer 340 Stellen / Indien-Schwerpunkt in Inc42/People Matters/Entrackr konsistent; AI21 110 von 180 / Maestro / Nebius-Partnerschaft in Calcalist/Ynet/Crypto Briefing konsistent; Meta 8.000 + 6.000 / 14.000 / 56,31 Mrd. USD / 115–145 Mrd. USD / Wang Superintelligence Labs / Memo Gale in The Next Web/CNBC/Tech Startups konsistent; TrueUp 138.947 / 325 in kron4/techtimes konsistent. |
| 2.2.2 Redundanzprüfung | OK | Die TrueUp-Reihe wird gemäß Claude.md § 4.2 als Tagesfortschreibung der bisherigen Stände geführt — keine Doppelung. Die alte Trilog-Erwartung im Literaturverzeichnis bleibt als zeitlich frühere Referenz erhalten; die neue Einigung steht als eigener nachgelagerter Eintrag (Claude.md § 4.2 explizit). § 6.5 ist neu und überschneidet sich nicht mit § 6.1–§ 6.4 (Südkorea/Italien/Polen/weitere): § 6.5 behandelt nicht Steuerinstrumente, sondern arbeitsrechtliche Schutzmechanismen, und schließt das Spektrum „Subvention → Reduktion → Wertschöpfungsabgabe → arbeitsrechtliche Begrenzung" ab. Drei Layoff-Wellen sind neue, in keinem Vorlauf erwähnte Maßnahmen. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen unverändert auseinandergehalten; § 6.5 referiert das Hangzhou-Urteil im Indikativ (Urteilsfeststellung) und die Politikimplikationen für die Steuerdebatte im Konjunktiv (Claude.md § 4.2); § 4.4 referiert die EU-Einigung im Indikativ (provisorische politische Einigung steht) und die Steuerimplikationen im Konjunktiv. |
| 2.2.4 Ausgewogenheit | OK | Hangzhou-Urteil wird neutral wiedergegeben — sowohl als arbeitsrechtlicher Schutz als auch als zusätzliche Erschwerung einer Typ-5-Ersatzabgabe; Meta-Memo (Janelle Gale) wird als Konzern-Eigenaussage zitiert ohne Wertung; die bestehende *Washington-Post*-Differenzierungsanalyse vom 1. Mai 2026 bleibt erhalten und wird durch die Meta-Asymmetrie (Rekordumsatz parallel zur Restrukturierung) weiter gestützt. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „AI-native" / „AI-Pods" / „Superintelligence Labs" / „Maestro" / „agentic AI-first operating model" als zitierte Eigenbezeichnungen in Anführungszeichen / Kursiv; bestehende Schreibweisen einheitlich; APA-konforme Quellenangabe für alle neuen Belegcluster. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | EU-Trilog-Eintrag in § 11.3 (institutionelle Quellen); Hangzhou-Urteil in § 11.3 (institutionelle Quellen mit fünf Sekundärquellen-URLs); drei Layoff-Wellen + Tracker in § 11.5 (journalistische Quellen); keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | EU-Einigung: Primärquelle Rat der EU Pressemitteilung 7. Mai 2026; Kanzleianalysen Bird & Bird und VerifyWise als Sekundärquellen. Hangzhou-Urteil: Primärquelle Hangzhou Intermediate People's Court Veröffentlichung 30. April 2026; Sekundärrezeption Caixin/NPR/Bloomberg/Fortune/CGTN. Innovaccer/AI21/Meta: jeweils mehrere unabhängige Sekundärquellen, in Meta-Fall plus Memo der Chief People Officer als interne Primärquelle. |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: consilium.europa.eu (HTTP 403, aber URL-Struktur mit Datum 2026/05/07 belastbar); verifywise.ai/blog/eu-ai-act-omnibus-what-changed (öffentlich, Inhalt konsistent); inc42.com (öffentlich, Inhalt konsistent); thenextweb.com/news/meta-layoffs-may-2026-ai-restructuring-thousands (öffentlich); calcalistech.com (öffentlich); caixinglobal.com (öffentlich, mit Datum 2026-04-30); kron4.com (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | EU-Stichtage (2. Dezember 2027 / 2. August 2028; 2. August 2027 Sandbox; 2. Dezember 2026 Transparenz; 2. August 2026 formelle Annahme) wörtlich aus Bird & Bird und VerifyWise übernommen; Hangzhou-Fall-Kennzahlen (25.000 → 15.000 Yuan, November 2022) wörtlich aus Caixin/CGTN; Innovaccer 340 / drittes Restrukturierungspaket / AI-native wörtlich aus Inc42; AI21 110 von 180 / >60 % / Maestro / Nebius-Wix wörtlich aus Calcalist; Meta 8.000 + 6.000 / 56,31 Mrd. USD / 115–145 Mrd. USD / Wang / Memo Gale wörtlich aus The Next Web/CNBC; TrueUp 138.947 / 325 / ca. 1.000/Tag wörtlich aus kron4. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die fünf neuen Belege benötigen keine eigene Verifizierungsmarkierung (mehrere unabhängige Sekundärquellen, in zwei Fällen Verfügbarkeit der Primärquelle ohne Paywall). |
...
|---|---|---|---|
| 1 | Aktualitätshinweis am Dokumentende und § 11.3 Literatureintrag „Europäisches Parlament / Rat der EU (April–Mai 2026)" | Behauptete in Version 22.0: „nächste Runde 13. Mai 2026" für den Digital Omnibus on AI Trilog. Tatsächlich hat sich der Trilog in den frühen Stunden des 7. Mai 2026 — zwei Wochen vor dem in Version 22.0 erwarteten Termin — auf eine provisorische politische Einigung verständigt; der Lauf 001 vom 8. Mai 2026 hat diese Bewegung übersehen. | Mittel (Sachstand veraltet; keine Auswirkung auf die Deutschland-These oder Kernaussagen, aber irreführend für Leserinnen und Leser, die das regulatorische Zeitfenster falsch einschätzen würden). |
| 2 | Keine zweite eigenständige Fehlerstelle | Hangzhou-Urteil und drei Layoff-Wellen sind keine Fehler in Version 22.0, sondern Aktualisierungen einer bestehenden Linie. | – |

### Durchgeführte Bereinigungen

| # | Fehler | Maßnahme | Erledigt |
|---|---|---|---|
| 1 | Veraltete Trilog-Erwartung „nächste Runde 13. Mai 2026" | Im Aktualitätshinweis durch den tatsächlichen Sachstand „in den frühen Stunden des 7. Mai 2026 nach dem Scheitern der zweiten Trilogrunde am 28. April 2026 erreichten provisorischen politischen Trilog-Einigung" ersetzt; in § 11.3 alten Eintrag als zeitlich frühere Referenz behalten und neuen Eintrag mit der Einigung ergänzt (Claude.md § 4.2 — alte Quelle nicht löschen, sondern nachgelagert als zeitlich frühere Referenz erhalten); § 4.4 um eigenen Absatz mit Sachstand und Steuer-Implikationen ergänzt. | Ja |
