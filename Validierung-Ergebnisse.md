...
## Validierung 15. Juni 2026 (Lauf 001 vom 15. Juni 2026) — Version 22.0 → Version 23.0

**Auslöser:** Erster Daily-Update-Lauf nach mehrwöchiger Pause seit Lauf 001 vom 8. Mai 2026 (Versionssprung 21.0 → 22.0). Web-Recherche im Korridor der Cluster A–J am 15. Juni 2026, mit erweitertem Zeitfenster für die zwischen 9. Mai und 15. Juni 2026 entstandenen belegbaren Entwicklungen. Vier belegbare Treffer identifiziert und eingearbeitet: (1) Sanders *„The Public Should Own Half of the Big A.I. Companies"* und Entwurf eines *American AI Sovereign Wealth Fund Act* (NYT-Namensbeitrag vom 1. Juni 2026), (2) Unterzeichnung von Connecticut SB 5 als *Public Act 26-15* („CART Act") durch Gouverneur Ned Lamont am 2. Juni 2026, (3) Beschluss des *KI-Durchführungsgesetzes* (KI-DG) durch den Deutschen Bundestag am 11. Juni 2026 mit Benennung der Bundesnetzagentur als zentrale KI-Aufsichtsbehörde, (4) Tagesfortschreibung der Tech-Layoff-Tracker (SkillSyncer-Stand 14. Juni 2026: 247 Ereignisse, 183.966 betroffene Beschäftigte; TechTimes 29. Mai 2026: 142.000 US-Tech-Streichungen in den ersten fünf Monaten 2026, KI-Begründung in 55 % der Layoff-Ereignisse).

### Aufgenommene Neuigkeiten

| # | Neuigkeit | Einarbeitung | Begründung Relevanz |
|---|---|---|---|
| 1 | Sanders — NYT-Namensbeitrag *„The Public Should Own Half of the Big A.I. Companies"* (1. Juni 2026) und angekündigter *American AI Sovereign Wealth Fund Act*: einmalige 50-%-Equity-Abgabe (in Anteilen statt in bar) auf OpenAI, Anthropic und xAI; Einbringung in einen US-Staatsfonds nach norwegischem Vorbild (Vergleichsgröße über 2 Bio. USD); Direktzahlungen an US-Bürger und mittelfristig Finanzierung von Gesundheit, Bildung und Wohnen; Stimmrechte und gleichberechtigte Aufsichtsratssitze der Bundesregierung in den betroffenen Unternehmen. Quellen: sanders.senate.gov (Op-Ed), Fox Business, Common Dreams, Truthout, Newsweek, Fortune. | § 4.5 (Sanders-Block: neue Passage zwischen 16.-April-Namensbeitrag und Abschlussbewertung; Verweis auf § 5.4 und § 8.3); § 11.3 neuer Eintrag Sanders 1. Juni 2026; § 11.5 neuer Sammelbeleg „Fox Business / Common Dreams / Truthout / Newsweek / Fortune"; Aktualitätshinweis am Dokumentende; README.md mit neuem Versionseintrag 23.0. | Bislang konkretester US-bundespolitischer Vorstoß, der die in § 5.4 und § 8.3 entwickelte Teilhabe-/Staatsfonds-Linie aufgreift, und zugleich erste Konkretisierung der im OpenAI-Strategiepapier vom April 2026 angedeuteten Wohlstandsfonds-Idee aus der Gegenrichtung — Equity-Abgabe statt Fondsspeisung über laufende Steuern; daher zentrales neues Element für Kapitel 4.5 und für die in § 10.2 zu treffende Empfehlungslinie. |
| 2 | Connecticut — Gouverneur Ned Lamont unterzeichnet *SB 5* am 2. Juni 2026 als *Public Act 26-15 — Connecticut Artificial Intelligence Responsibility and Transparency Act* („CART Act"); gestaffelte Geltungsdaten ab 1. Oktober 2026 (Automated-Employment-Decision-Rahmen, „AI is not a defense", Frontier-Whistleblower, WARN-AI-Disclosure) bleiben unverändert. Quellen: Ropes & Gray, Holland & Knight, Proskauer (Law and the Workplace). | § 4.5 (Connecticut-Block: Status „Unterzeichnung angekündigt" wird auf „am 2. Juni 2026 als *Public Act 26-15* in Kraft" aktualisiert); § 11.3 ergänzter Eintrag Senate Bill 5; § 11.5 neuer Sammelbeleg „Ropes & Gray / Holland & Knight / Proskauer"; Aktualitätshinweis am Dokumentende. | Schließt die offene Markierung aus Lauf 001 vom 8. Mai 2026 (Lamont „looks forward to signing") mit verifizierter Unterzeichnung — damit ist die für die Typ-5-Ersatzabgabe-Diskussion (§ 2.1, § 9.1) zentrale WARN-AI-Disclosure-Erweiterung erstmals als geltendes US-bundesstaatliches Recht dokumentiert, mit konkretem Aktbezug (PA 26-15) für die juristische Zitierfähigkeit. |
| 3 | Deutscher Bundestag — Beschluss des *Gesetzes zur Durchführung der Verordnung über künstliche Intelligenz* (KI-Durchführungsgesetz, KI-DG) am 11. Juni 2026 in der vom federführenden Ausschuss geänderten Fassung (Drucksache 21/6407); Bundesnetzagentur als zentrale KI-Markt­überwachungs­behörde und Aufsichtsbehörde mit Koordinierungs- und Kompetenzstelle, unabhängiger Marktüberwachungskammer für Hochrisikosysteme und zentralem Beschwerde- und Anfragenkanal; KI-Reallabore zur Förderung von KMU und Start-ups; Bußgelder bis 50.000 EUR bei Verstößen gegen Auskunfts- und Mitwirkungspflichten; Abstimmung mit Mehrheit der Koalitionsfraktionen CDU/CSU und SPD gegen AfD, Bündnis 90/Die Grünen und Die Linke; flankierende Entschließung verpflichtet zu halbjährlichen Sachverständigen-Konsultationen. Quelle: bundestag.de (kw24-de-ki-1183820). | § 4.2 (neuer Absatz „KI-Durchführungsgesetz (Juni 2026)" zwischen IW-Köln-Argumentation und § 4.3); § 11.3 neuer Eintrag „Deutscher Bundestag (11. Juni 2026)"; Aktualitätshinweis am Dokumentende. | Schafft mit der Bundesnetzagentur erstmals eine deutsche Bundesbehörde mit administrativer Datenerhebungs- und Berichtskompetenz über den KI-Einsatz — Voraussetzung dafür, dass eine spätere fiskalische Anknüpfung an inländische KI-Nutzung (vgl. § 8.3 zur fiskalischen Abschöpfung) an verlässliche Aggregat-Daten anschließen kann. Mittelbare Relevanz für die Steuerdebatte; primär regulatorischer Akt. |
| 4 | Tech-Layoff-Tracker — Tagesfortschreibung zum 14. Juni 2026 (SkillSyncer: 247 Ereignisse, 183.966 betroffene Beschäftigte) und Mai-Aggregat aus TechTimes (29. Mai 2026): rund 142.000 US-Tech-Streichungen in den ersten fünf Monaten 2026 (+33 % gegenüber Vorjahresvergleichszeitraum), Volljahresprojektion rund 370.000 Stellen; KI als explizite Begründung in 55 % der für 2026 gemeldeten Layoff-Ereignisse. Quellen: TechTimes (29. Mai 2026), SkillSyncer Tracker (Stand 14. Juni 2026), Yahoo Finance (Mai 2026). | § 1.1 (Tagesfortschreibung der Tracker-Reihe im bestehenden Block ergänzt um SkillSyncer-Stand 14. Juni 2026 und TechTimes-Mai-Aggregat); § 11.5 neuer Sammelbeleg „TechTimes / SkillSyncer / Yahoo Finance"; Aktualitätshinweis am Dokumentende. | Die TrueUp-Reihe endete mit dem 8. Mai 2026 (127.411 / 283); die SkillSyncer-Reihe lag damals bei 113.863 / 179. Sechs Wochen später steht SkillSyncer bei 183.966 / 247 — eine Steigerung um rund 70.000 Personen in sechs Wochen, deren KI-Anteil nach TechTimes-Aggregat bei 55 % der Ereignisse liegt. Damit verschiebt sich die Aggregat-Linie über das bisher dokumentierte Niveau hinaus, ohne den in § 3.5 (Yale Budget Lab / Massenkoff & McCrory) referierten Befund fehlender systematischer Arbeitslosigkeitserhöhung umzukehren. |

**Nicht aufgenommen (bewusste Auslassungen):**
- EU AI Act Digital Omnibus — politische Vorab-Einigung am 7. Mai 2026 (Hochrisiko-Pflichten Anhang III verschoben auf 2. Dezember 2027, Anhang I auf 2. August 2028): das in Version 22.0 dokumentierte Verhandlungsfeld liegt seitdem im Status der formalen Verabschiedung und Veröffentlichung im EU-Amtsblatt vor dem 2. August 2026; ohne neue Verfahrensbewegung im Recherchezeitfenster keine Einarbeitung — als Marker für den nächsten Lauf festgehalten.
- Anthropic *Policy Framework for AI's Impact on Work* (Juni 2026) — Hinweise auf eine Veröffentlichung vorhanden, vollständige Verifikation der Autorenschaft, des exakten Veröffentlichungsdatums und der Kerninhalte im Recherchefenster nicht abgeschlossen; in einem späteren Lauf nach gesicherter Primärquellen-Sichtung nachzutragen.
- GKV-Beitragssatzstabilisierungsgesetz — Bundestag 1. Lesung am 12. Juni 2026 (parallel zum KI-DG); kein verbindlicher Beschluss in dieser Sitzung; bestehender Aktualitätshinweis aus Version 22.0 zur Bundesratssitzung am 8. Mai 2026 bleibt korrekt, im nächsten Lauf zu prüfen, sobald eine zweite Lesung oder ein Bundesratsbeschluss vorliegt.
- Tesla Optimus / Figure AI / Apptronik — frühe Q2-2026-Produktionsmeldungen ohne politisch-fiskalische Implikation; bestehender § 1.1- und § 2.2-Rahmen bleibt korrekt; in einem späteren Lauf bei IFR-Statistik-Updates oder konkretisierten Stückzahlen mit Sozialpartner-Beteiligung nachzutragen.
- Cluster G (Gesundheitswesen) — fünftes Mal in Folge ohne valide Treffer im 7-Tage-Fenster.
- Cluster I (Frontier-Modelle) — im 48-Stunden-Fenster ohne politisch-fiskalisch relevante Tagesmeldungen; bestehender § 3.5-Block bleibt aktuell.
...
| 2.1.3 Querverweise | OK | Neue Sanders-Sovereign-Wealth-Fund-Passage in § 4.5 verweist auf § 5.4 (Staatsfonds) und § 8.3 (Teilhabefrage) — beide Ziele existieren; KI-Durchführungsgesetz-Passage in § 4.2 verweist auf § 8.3 — Ziel existiert. |
| 2.1.4 Roter Faden | OK | Sanders-Sovereign-Wealth-Fund-Vorschlag schließt logisch an die in § 5.4 und § 8.3 angelegte Linie an; Connecticut-Akt-Update knüpft an bestehenden § 4.5-Block; KI-DG fügt sich als deutscher Bundesakt zwischen Status-quo-Beschreibung (§ 4.2) und verfassungsrechtliche Fragen (§ 4.3) ein. |
...
| 2.2.1 Sachliche Richtigkeit | OK | Sanders-Inhalte (50 % Equity, OpenAI/Anthropic/xAI, Norwegen-Vergleich >2 Bio. USD, Stimmrechte und Aufsichtsratssitze) in mehreren unabhängigen Quellen konsistent; Connecticut PA 26-15 / 2. Juni 2026 in drei Kanzleianalysen (Ropes & Gray, Holland & Knight, Proskauer) konsistent; KI-DG Drucksache 21/6407 und 11. Juni 2026 wörtlich aus bundestag.de-Pressemeldung; Tracker-Zahlen 247 / 183.966 und 142.000 / 55 % wörtlich aus SkillSyncer und TechTimes. |
| 2.2.2 Redundanzprüfung | OK | Sanders-Sovereign-Wealth-Fund-Vorschlag ist ein bislang nicht im Dokument enthaltenes Element (anders als der Sanders-Robotersteuer-Vorschlag, der bereits in Version 5.0/8.0 dokumentiert ist) — keine Doppelung. Connecticut-PA-26-15-Update ist eine reine Status-Aktualisierung der bestehenden Beschreibung. KI-DG ist ein neuer deutscher Bundesakt ohne Vorgänger-Eintrag. Tracker-Update ist eine Tagesfortschreibung der bestehenden Reihe. |
| 2.2.3 Argumentation | OK | Acemoglu/Thuemmel-Trennung unverändert; Deutschland-These (drei Säulen) unverändert; fünf Robotersteuer-Typen weiterhin auseinandergehalten; Sanders-Vorschlag wird im Konjunktiv referiert (vgl. Claude.md § 4.2: Politikvorschläge im Konjunktiv); Connecticut-Akt wird als „Public Act 26-15" mit Aktnummer und Geltungsbeginn benannt; KI-DG wird in seiner regulatorischen, nicht in einer fiskalischen Funktion eingeordnet. |
| 2.2.4 Ausgewogenheit | OK | Sanders-Vorschlag wird neutral wiedergegeben; die in § 4.5 etablierte Bloomberg-/IW-Köln-Gegenposition bleibt unverändert erhalten und gilt strukturell auch für die Equity-Abgabe-Variante; KI-DG wird ausdrücklich als „primär regulatorisch" eingeordnet, ohne unzulässige fiskalische Schlussfolgerungen. |
| 2.3.1 Tippfehler und Grammatik | OK | Stichprobenartige Prüfung der eingefügten Passagen ohne Befund. |
| 2.3.2 Terminologie | OK | „Sovereign Wealth Fund" und „American AI Sovereign Wealth Fund Act" in Anführungszeichen bzw. kursiv als Bill-Titel; „Public Act 26-15" und „CART Act" als gestaffelte Aktbezeichnung einheitlich; „KI-Durchführungsgesetz" (KI-DG) und „Bundesnetzagentur" bei Erstauftreten ausgeschrieben. |
| 2.4.1 Vollständigkeit und Zuordnung | OK | Sanders 1. Juni 2026 als Eintrag in § 11.3 und Sammelbeleg in § 11.5; Connecticut Senate Bill 5 in § 11.3 um Datum und PA-26-15-Verweis ergänzt, Kanzlei-Sammelbeleg in § 11.5; KI-DG in § 11.3 als neuer Bundestags-Eintrag; Tracker-Update als Sammelbeleg in § 11.5; keine Karteileichen. |
...
| 2.4.3 Aktualität und Belastbarkeit | OK | Sanders: Primärquelle ist die Op-Ed auf sanders.senate.gov; Sekundärquellen Fox Business / Fortune / Newsweek / Common Dreams / Truthout. Connecticut: Primärquelle ist die Gesetzesfassung der Connecticut General Assembly (cga.ct.gov); Sekundärquellen drei spezialisierte Kanzleianalysen (Ropes & Gray, Holland & Knight, Proskauer). KI-DG: Primärquelle ist die Pressemeldung des Deutschen Bundestages (bundestag.de). Tracker: Primärquellen SkillSyncer-Tracker (öffentlich zugänglich) und TechTimes (29. Mai 2026). |
| 2.4.4 URL-Prüfung (Stichprobe) | OK | Stichprobe der neuen URLs aufgerufen: sanders.senate.gov/op-eds/the-public-should-own-half-of-the-big-a-i-companies/ (öffentlich, Inhalt konsistent); foxbusiness.com/politics/sanders-unveils-plan (öffentlich); bundestag.de/dokumente/textarchiv/2026/kw24-de-ki-1183820 (öffentlich); ropesgray.com/en/insights/alerts/2026/06/connecticut-enacts-sweeping-ai-law (öffentlich); skillsyncer.com/layoffs-tracker (öffentlich); techtimes.com/articles/317392/20260529 (öffentlich). |
| 2.4.5 Zitatgenauigkeit | OK | Kernzahlen Sanders (50 % Equity, OpenAI/Anthropic/xAI, >2 Bio. USD Norwegen-Vergleich) wörtlich aus der NYT/Sanders-Op-Ed und drei unabhängigen Sekundärquellen; Connecticut PA 26-15 / 2. Juni 2026 und gestaffelte Geltungsdaten wörtlich aus der Holland-Knight-Analyse; KI-DG Drucksache 21/6407, 11. Juni 2026, Bußgeldhöhe 50.000 EUR wörtlich aus der bundestag.de-Pressemeldung; Tracker-Zahlen 247 / 183.966 wörtlich aus dem SkillSyncer-Tracker, 142.000 / +33 % / 370.000 / 55 % wörtlich aus dem TechTimes-Artikel. |
| 2.4.6 Verifizierungsbedürftige Einträge | OK | Markierung *de la Feria et al. 2022* unverändert erhalten; die vier neuen Einträge benötigen keine eigene Verifizierungsmarkierung (jeweils mehrere unabhängige Sekundärquellen und in allen vier Fällen Primärquellenzugriff ohne Paywall). |
| 2.5 Versionskonsistenz und Lizenz | OK | Versionsnummer 23.0 in Dokumentkopf, Aktualitätshinweis, README.md (Versionszeile, Zitiervorschlag) und diesem Validierungsblock identisch; CC-BY-4.0-Hinweis und Haftungshinweis unverändert. |
| 2.6 Automatisierte Prüfung | n/a | Keine Skripte vorhanden; manuelle Stichproben gemäß § 2.6 ersetzen den automatisierten Teil. |

### Gefundene Fehler

Keine — die vier Ergänzungen sind Aktualisierungen bestehender Linien und ein hinzukommendes Element (Sanders Sovereign Wealth Fund) ohne Korrekturbedarf an anderen Aussagen.
