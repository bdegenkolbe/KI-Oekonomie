...
**Aktueller Stand:** Version 5.0, April 2026, 11 Kapitel, rund 25 Seiten.
...
- Ein Literatureintrag ist weiterhin als verifizierungsbedürftig markiert (de la Feria et al. 2022) — diese Markierung darf nicht entfernt werden, bevor die Verifikation erfolgt ist. Die Sanders-Titelangabe wurde in Validierung 4.0 → 5.0 gegen die offizielle Senate-HELP-Pressemitteilung („The Big Tech Oligarchs' War Against Workers", 6. Oktober 2025) verifiziert und der Markierungshinweis entfernt.
