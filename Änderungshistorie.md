...
## 2026-09-04 — Lauf 001 — Version 83.0 → Version 84.0

### Recherchekorridor

- Genutzte Cluster aus `Suchthemen.md`: A, B, C, D, F, G, H, I (Cluster E und J gestreift ohne Neubefund im 7-Tage-Fenster). Ein struktureller Neuzugang im 7-Tage-Fenster (28. August – 4. September 2026): der am *29. August 2026* von EU-Kommissions-Vizepräsidentin *Henna Virkkunen* bestätigte, förmliche Enforcement-Schritt des *AI Office* — erstmaliger Versand von *Requests for Information* nach Art. 101 AI Act an über dreißig weltweit ansässige GPAI-Anbieter, mit sekundärer Rezeption zwischen *29. August* und *2. September 2026* (u. a. *Help Net Security* [04.08./29.08. mit Update], *SuperPowerDaily* [01.09./02.09.2026], *OOMeta AI* [September 2026], *Tokenstead* [September 2026], *Al Jazeera* [02.09.2026]). Substanz: (i) zwei getrennte Auskunftsstränge (Sicherheit, unabhängige externe Evaluierungen, Nach-Marktüberwachung, Angriffsresistenz sowie Zusammenfassungen der Trainingsdateninhalte); (ii) offiziell nicht publizierte Empfängerliste, per *Euractiv*-Rezeption OpenAI, Anthropic, Google unter den Empfängern; (iii) Bußgeldgerüst nach Art. 101 AI Act bis 15 Millionen Euro oder 3 % des weltweiten Jahresumsatzes bei Standardverstößen (nach *OOMeta AI* 7,5 Millionen Euro oder 1,5 % bei geringeren, 35 Millionen Euro oder 7 % bei schwerwiegenden Verstößen); (iv) Kommission kann Korrekturmaßnahmen anordnen oder Modellverfügbarkeit in der EU einschränken; (v) formale RFI folgt vier Wochen nach Aktivierung der GPAI-Durchsetzung am 2. August 2026 und drei Wochen nach der bilateralen Krisenkommunikation mit *OpenAI* und *Anthropic* am 3. August 2026. Konjunktivpflicht (§ 4.2 Claude.md) explizit angebracht, da einzelne Empfängernamen und Antwortfristen nicht offiziell publiziert sind.
- Einarbeitung als neuer Absatz *„Erste formale Auskunftsanfragen des AI Office an über dreißig GPAI-Anbieter (29. August 2026)"* in § 4.3 unmittelbar nach dem Absatz *„Aktivierung der AI-Act-Durchsetzung zum 2. August 2026"*, vor § 4.4 (Europäisches Sekundärrecht); ergänzender Literatureintrag in § 11.3. Kein neuer Unterabschnitt; keine Umstrukturierung.
- Zeitfenster: Standard 7 Tage (28. August – 4. September 2026); Cluster F und I zusätzlich im 48-Stunden-Fenster (2. September – 4. September 2026). Die Virkkunen-Bestätigung vom 29. August 2026 liegt vollständig innerhalb des 7-Tage-Fensters; die vier Sekundärquellen zwischen Ende August und Anfang September 2026 tragen die Aufnahme.
- Anzahl Suchanfragen: 11 Web-Suchen (Cluster A/B/C/D/F/G/H/I durchsucht) plus fünf Primärquellen-Abrufe (WebFetch Help Net Security, WebFetch Fortune, WebFetch NBER W35437, WebFetch OOMeta AI, WebFetch Tokenstead; WebFetch Axios anbieterseitig gesperrt). Weiter gefunden: *NBER Working Paper 35437* (Dynan/Elmendorf/Sheiner) *„How Might Fiscal Policy Respond to the Rise of Artificial Intelligence?"* (Juli 2026 — außerhalb 7-Tage-Fenster, wiederholter Aufnahmekandidat für konzentrierten Cluster-A-Lauf mit § 3.5-/§ 8.4-Bezug; Kernbefund AI-Effekt kürzt US-Bundesschuld um 39–49 pp des BIP über 30 Jahre, Politikoptionen: Umschulung, progressive Besteuerung, öffentliche Kapitalbeteiligung); *Anthropic/OpenAI Trainingspause* (Axios 1. September 2026, Fortune 2. September 2026 — im 7-Tage-Fenster, aber sicherheits- und regulierungs­bezogener Cluster-I-Vorgang mit primärer Kausalattribution auf METR-Externevaluierung, sekundär zur Steuerdebatte; als Aufnahmekandidat für konzentrierten Cluster-I-Lauf vorgemerkt); *Bill Gates Robot/Token-Tax*-Wiederaufnahme (Fortune 26. August 2026 — außerhalb 7-Tage-Fenster, wiederholter Aufnahmekandidat); *AI Tax Integrity Act HR 9501* (Buchanan et al., Juni 2026 — außerhalb 7-Tage-Fenster, Aufnahmekandidat mit § 4.5-Bezug für konzentrierten Cluster-B/D-Lauf); *TCS-Layoffs-12.000-Stellen* (August 2026 — außerhalb 48-Stunden-Fenster, Aufnahmekandidat für Cluster-F-Lauf); *Nvidia Q2 FY27 Earnings* (26. August 2026, $96,2 Milliarden Umsatz, $89,0 Milliarden Data Center — außerhalb 7-Tage-Fenster, wiederholter Aufnahmekandidat für konzentrierten Cluster-I-Lauf); *China humanoid robot factory 10.000 Einheiten/Jahr* (März 2026 — außerhalb aller Fenster, bekannt); *IAB-Kurzbericht 08/2026* (5. Mai 2026 — bereits in § 8.1 abgedeckt, Dublette).
- Prinzip *Breite vor Tiefe*: Der aufgenommene Datenpunkt schließt die in § 4.3 rekonstruierte Enforcement-Sequenz (Trilog-Einigung 7. Mai 2026 → OJ-Publikation 24. Juli 2026 → Aktivierung 2. August 2026 → bilaterale Krisenkommunikation 3. August 2026) um den ersten förmlichen Verwaltungsschritt und dokumentiert die operative Belastbarkeit der GPAI-Kategorien vier Wochen nach Aktivierung. Nicht als eigener Neueintrag aufgenommen: die genannten Aufnahmekandidaten außerhalb der Fenster beziehungsweise mit primär sicherheits-/marktbezogener Kausalattribution.
- Lauf 001 vom 4. September 2026 ist der Folgelauf zu Lauf 001 vom 3. September 2026 (Version 82.0 → 83.0).

### Gefundene Quellen

| # | Cluster | Quelle (Autor/Institution, Titel, Datum) | URL | Bewertung |
|---|---------|-----------------------------------------|-----|-----------|
| 1 | B/D | *Help Net Security*, *„EU begins enforcing AI Act, putting AI models under the microscope"*, 4. August 2026 (mit RFI-Update-Passus 29. August 2026) | https://www.helpnetsecurity.com/2026/08/04/eu-ai-act-enforcement-ai-models/ | übernommen (direkt verifiziert per WebFetch, Enforcement-Timeline und Bußgeldgerüst extrahiert) |
| 2 | B/D | *SuperPowerDaily*, *„EU Seeks AI Act Answers From 30-Plus Companies, With Fines for Misleading Replies"*, 1./2. September 2026 | https://superpowerdaily.com/posts/eu-seeks-ai-act-answers-from-30-plus-companies-with-fines-for-misleading-replies | übernommen (direkt verifiziert per WebFetch, Virkkunen-Bestätigung 29. August 2026, zwei Auskunftsstränge, Euractiv-Empfängerrezeption OpenAI/Anthropic/Google) |
| 3 | B/D | *OOMeta AI*, *„EU AI Act's first RFIs land on 30+ AI companies"*, September 2026 | https://oometa.ai/en/insights/eu-ai-act-first-rfi-enforcement-2026 | übernommen (direkt verifiziert per WebFetch, differenzierte Bußgeldstaffelung 7,5 / 15 / 35 Millionen Euro, Auslöserbezug auf Sicherheitsvorfälle Sommer 2026) |
| 4 | B/D | *Tokenstead*, *„EU AI Act Enforcement Begins: The AI Office Starts Asking"*, September 2026 | https://tokenstead.ai/guides/eu-ai-act-first-enforcement-security-rfis | übernommen (direkt verifiziert per WebFetch, RFI-Sendedatum 29. August 2026, Escalationspfad bei Nichtbeantwortung: Korrekturmaßnahmen und Marktzugangs­einschränkung) |
| 5 | B/D/C | *Al Jazeera*, *„What came into force with the EU's AI Act this week – and what didn't"*, 6. August 2026 (mit Update-Referenz auf RFI 29. August 2026 in Cross-Reference-Berichterstattung vom 2. September 2026) | https://www.aljazeera.com/news/2026/8/6/what-came-into-force-with-the-eus-ai-act-this-week-and-what-didnt | übernommen (Sekundärrezeption, Bestätigung der transatlantischen Asymmetrie zur *Carolina-Principles*-Selbstverpflichtung) |
| 6 | A | *NBER Working Paper 35437* (Dynan, K. E.; Elmendorf, D. W.; Sheiner, L.), *„How Might Fiscal Policy Respond to the Rise of Artificial Intelligence?"*, Juli 2026 | https://www.nber.org/papers/w35437 | verworfen (außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat für konzentrierten Cluster-A-Lauf mit § 3.5-/§ 8.4-Bezug) |
| 7 | I | *Axios* (Ryan Heath), *„Anthropic paused some AI training after Claude took unauthorized actions"*, 1. September 2026 | https://www.axios.com/2026/09/01/anthropic-paused-some-ai-training-after-claude-took-unauthorized-actions | verworfen (im 7-Tage-Fenster, aber primär sicherheits- und externe-Evaluierungs­bezogen, sekundär zur Steuerdebatte; Aufnahmekandidat für konzentrierten Cluster-I-Lauf) |
| 8 | I | *Fortune*, *„Anthropic follows OpenAI in pausing some AI training following rogue agent hacks"*, 2. September 2026 | https://fortune.com/2026/09/02/anthropic-ai-pause-rogue-agent-hacks-openai/ | verworfen (Dublette zur Axios-Berichterstattung; primär Cluster-I-Vorgang mit sekundärem Steuerbezug) |
| 9 | D | *Fortune*, *„Bill Gates wants to tax robots and AI tokens to deter businesses from replacing humans"*, 26. August 2026 | https://fortune.com/2026/08/26/bill-gates-robot-ai-tax-replacehuman-workers/ | verworfen (außerhalb 7-Tage-Fenster um zwei Tage; wiederholter Aufnahmekandidat) |
| 10 | B/D | US-Repräsentantenhaus, *AI Tax Integrity Act of 2026* (H.R. 9501, Buchanan/Bean/Schweikert/Horsford), 29. Juni 2026 | https://www.congress.gov/bill/119th-congress/house-bill/9501/text | verworfen (außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat mit § 4.5-Bezug) |
| 11 | F | *Reuters/Yahoo/Gulfnews*, *TCS-Layoffs 12.000 Stellen* (K. Krithivasan), August 2026 | https://gulfnews.com/technology/accenture-cuts-thousands-of-jobs-in-global-ai-restructuring-1.500290493 | verworfen (außerhalb 48-Stunden-Fenster; wiederholter Aufnahmekandidat für Cluster-F-Lauf mit § 1.1-Bezug) |
| 12 | I | *NVIDIA Corp*, Q2 FY27 Earnings Release, 26. August 2026 (Data Center $89,0 Milliarden, Gesamtumsatz $96,2 Milliarden) | https://nvidianews.nvidia.com/news/nvidia-announces-financial-results-for-second-quarter-fiscal-2027 | verworfen (außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat) |
| 13 | J | *Interesting Engineering / TechTimes / Yahoo Finance*, chinesische humanoide Robotik — Leju/Dongfeng-Fabrik 10.000 Einheiten/Jahr, UBTECH-BYD-Deployment 100–200 Einheiten, CATL-Scale-Deployment | https://interestingengineering.com/ai-robotics/china-opens-humanoid-robot-factory | verworfen (Nachricht aus März–August 2026, außerhalb aller Fenster; wiederholter Aufnahmekandidat für konzentrierten Cluster-J-Lauf) |

### Eingearbeitete Änderungen

| # | Stelle (§) | Art | Inhalt in einem Satz | Quelle # |
|---|-----------|-----|----------------------|----------|
| 1 | § 4.3 (neuer Absatz *„Erste formale Auskunftsanfragen des AI Office an über dreißig GPAI-Anbieter (29. August 2026)"* nach dem Absatz *„Aktivierung der AI-Act-Durchsetzung zum 2. August 2026"*) | Ergänzung | Neuer Absatz mit Rekonstruktion der Virkkunen-Bestätigung vom 29. August 2026 (formaler RFI-Versand nach Art. 101 AI Act an über dreißig GPAI-Anbieter weltweit), zwei Auskunftsstränge (Sicherheit/externe Evaluierungen/Nach-Marktüberwachung/Angriffsresistenz und Trainingsdatenzusammenfassungen), Bußgeldgerüst bis 15 Millionen Euro/3 % (bzw. 7,5 Millionen/1,5 % bei geringeren und 35 Millionen/7 % bei schwerwiegenden Verstößen) sowie Kommissionsbefugnis zu Korrekturmaßnahmen und Marktverfügbarkeits­einschränkung; drei abgeleitete Konsequenzen für die Steuerdebatte (operative Belastbarkeit der GPAI-Kategorie für spätere fiskalische Anknüpfung, Verstetigung der transatlantischen Asymmetrie zur US-*Carolina-Principles*-Selbstverpflichtung, methodische Anschlussfähigkeit an eine wertschöpfungs­orientierte inländische KI-Nutzungsabgabe über die Trainingsdatenzusammenfassung); Rückwirkung auf § 4.2 Claude.md (Konjunktivpflicht), § 4.5 (Vergleichspunkt), § 5.1 und § 8.3 (Bemessungsbasis), § 9.1 (Kausalattribution auf Anbieter- statt Deployer-Ebene). | 1–5 |
| 2 | § 11.3 (neuer Literatureintrag) | Ergänzung | Neuer Eintrag „Europäische Kommission / AI Office / Virkkunen, H. / Help Net Security / SuperPowerDaily / OOMeta AI / Tokenstead. (29. August 2026, sekundär rezipiert 1./2. September 2026), *AI Office issues first formal requests for information to more than thirty providers of general-purpose AI models under Article 101 of the AI Act*" mit fünf Sekundärquellen-URLs | 1–5 |
| 3 | Dokumentkopf, Aktualitätshinweis, `README.md` (Header + Zitiervorschlag), `Validierung-Ergebnisse.md` | Aktualisierung | Versionssprung 83.0 → 84.0 an vier Stellen konsistent nachgezogen; Stichtag von *3. September 2026* auf *4. September 2026*, Lauf-Kennung von *Lauf 001 vom 3. September 2026* auf *Lauf 001 vom 4. September 2026*, Stand-Angabe *Anfang September 2026* unverändert | — |

### Verworfene Treffer (mit Begründung)

| # | Quelle | Cluster | Begründung |
|---|--------|---------|------------|
| 1 | *NBER Working Paper 35437* (Dynan/Elmendorf/Sheiner), Juli 2026 | A | Außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat mit § 3.5-/§ 8.4-/§ 10.2-Bezug |
| 2 | *Axios* (Anthropic Trainingspause, 1. September 2026) | I | Im 7-Tage-Fenster, aber primär sicherheits- und externe-Evaluierungs­bezogen (METR); nur sekundär zur Steuerdebatte |
| 3 | *Fortune* (Anthropic/OpenAI Trainingspause, 2. September 2026) | I | Dublette zur Axios-Berichterstattung; primär Cluster-I-Vorgang |
| 4 | *Fortune* (Bill Gates Robot/Token-Tax-Wiederaufnahme, 26. August 2026) | D | Außerhalb 7-Tage-Fenster um zwei Tage; wiederholter Aufnahmekandidat |
| 5 | US-Repräsentantenhaus, *AI Tax Integrity Act H.R. 9501* (Buchanan et al., Juni 2026) | B/D | Außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat |
| 6 | *TCS-Layoffs 12.000 Stellen* (August 2026) | F | Außerhalb 48-Stunden-Fenster; wiederholter Aufnahmekandidat |
| 7 | *NVIDIA Corp*, Q2 FY27 Earnings (26. August 2026) | I | Außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat |
| 8 | Chinesische humanoide Robotik (Leju/Dongfeng, UBTECH-BYD, CATL) | J | Nachrichten März–August 2026, außerhalb aller Fenster; wiederholter Aufnahmekandidat |

### Verarbeitungsschritte

- Recherche abgeschlossen: Ja
- Deduplikation gegen Hauptdokument: Ja
- Validierung gemäß `Validierung.md` ausgeführt: Ja (siehe Block *Validierung 4. September 2026 (Lauf 001 vom 4. September 2026) — Version 83.0 → Version 84.0* in `Validierung-Ergebnisse.md`)
...
- Branch auf main gemerged und gelöscht: Ja (Merge-Commit `0ade68b`, Session-Branch `claude/determined-einstein-5urq1q`; Remote-Branch-Löschung mit HTTP 403 abgelehnt — serverseitige Branch-Protection wie in den Vorläufen, lokaler Branch gelöscht)
...
- **Phase 6 (Commit/Merge/Cleanup):** PR #6 als Draft gegen `main` eröffnet und über lokalen `git merge --no-ff` in Merge-Commit `0ade68b` überführt. Push auf `main` erfolgreich (Branch-Protection über bypass zugelassen). Lokaler Session-Branch `claude/determined-einstein-5urq1q` gelöscht; Remote-Branch-Löschung mit HTTP 403 abgelehnt (serverseitige Branch-Protection, unverändert gegenüber Vorläufen).
- **NBER Working Paper 35437 (Dynan/Elmendorf/Sheiner):** Juli 2026 publiziert; außerhalb 7-Tage-Fenster; für einen konzentrierten Cluster-A-Lauf vorgemerkt, da der Kernbefund (AI-Effekt kürzt US-Bundesschuld um 39–49 pp des BIP über 30 Jahre bei gleichzeitig 2 pp höherer strukturell erhöhter Arbeitslosenquote und 4 pp niedrigerer Erwerbsquote bei Job-Displacement-Szenarien) sowohl § 3.5 (Ökonomische Perspektive) als auch § 8.4 (Systemstabilität) und § 10.2 (Empfehlungen) unmittelbaren fiskalischen Bezug hat.
- **Anthropic/OpenAI Trainingspausen (28. Aug./1. Sep. 2026):** Im 7-Tage-Fenster, aber primär sicherheits- und externe-Evaluierungs­bezogen (METR, UK AISI); für die Steuerdebatte nur mittelbar über die in § 4.3 dokumentierte Enforcement-Verschiebung von der Kennzeichnungs- auf die Systemrisiko-Ebene relevant; als Aufnahmekandidat für konzentrierten Cluster-I-Lauf vorgemerkt.
- **AI Tax Integrity Act (H.R. 9501, Juni 2026):** Nicht mit dem *AI Tax and Work Protection Act* (H.R. 10044) oder dem *AI Workforce PREPARE Act* (S. 3339) zu verwechseln; das Buchanan-Pilot-Programm zielt auf KI-gestützte Betrugserkennung durch das Treasury, nicht auf eine Verdrängungs­abgabe; als möglicher Aufnahmekandidat für einen konzentrierten Cluster-B/D-Lauf zur institutionellen Anwendung von KI in der Steuerverwaltung vorgemerkt.
- **Reuters-Primärquelle für Meta Project OT (Lauf vom 3. September 2026):** Bleibt anbieterseitig gesperrt; keine Nachverifikation im Lauf erforderlich.

---

## 2026-09-03 — Lauf 001 — Version 82.0 → Version 83.0

### Recherchekorridor

- Genutzte Cluster aus `Suchthemen.md`: A, B, C, D, F, G, H, I (Cluster E und J gestreift ohne Neubefund im 7-Tage-Fenster). Ein struktureller Neuzugang im 7-Tage-Fenster (27. August – 3. September 2026): der *Reuters*-Special-Report vom *26. August 2026* zum Meta-Reorganisationsprojekt *„Project OT"* (Organization Transformation) durch *Katie Paul* mit breiter Sekundärrezeption zwischen *26.* und *31. August 2026* (u. a. *BNN Bloomberg* 26. August 2026, *Engadget*, *Daily Kos* 30. August 2026, *AI Weekly* 30. August 2026, *TheNextWeb* 31. August 2026, *IBTimes*, *CellCog*, *Free Press Journal*, *Financial Times/Yahoo Finance*, *MLQ News*, *The News (Pakistan)*). Substanz: (i) im Januar 2026 auf einer Klausur in Zuckerbergs Hawaii-Anwesen initiierter zweiteiliger Restrukturierungs­plan zur AI-nativen Umgestaltung der Meta-Organisation mit geplanter Reduktion einzelner Teams um bis zu sechzig Prozent und einer schlanken *„talent-dense"*-Führungsschicht zur Überwachung virtueller KI-Arbeiter; (ii) tatsächliche Vollziehung der ersten Welle am 20. Mai 2026 mit rund acht­tausend Stellen (etwa zehn Prozent der Belegschaft); (iii) Absage der für November 2026 vorgesehenen zweiten Welle in der Nacht zum 19. Mai 2026, Stunden vor Beginn der ersten Welle; (iv) interne Produktivitätsdaten (KI-assistierte Code-Änderungen im Jahresvergleich +220 %; tatsächlich beim Nutzer angekommene neue oder aufgewertete Produktfunktionen nur +36 %; schwere Sicherheitsvorfälle +40 %; Feuerlöscharbeiten +70 %) als Grund für den Rückzug; (v) Zuckerbergs Ankündigung Anfang Juli 2026, „nicht mit weiteren unternehmens­weiten Entlassungen im laufenden Jahr" zu rechnen. Konjunktivpflicht (§ 4.2 Claude.md) explizit angebracht, da die internen Meta-Zahlen nicht öffentlich publiziert sind und über die Reuters-Rekonstruktion referiert werden.
- Einarbeitung als neuer Absatz *„Empirische Ergänzung USA — AI-native Restrukturierung als Realfall (Reuters-Special-Report vom 26. August 2026 zum Meta Project OT)"* am Ende von § 3.5, unmittelbar nach dem FOMC-Minutes-Absatz und vor dem Kapiteltrenner zu Kapitel 4; ergänzender Literatureintrag in § 11.5. Kein neuer Unterabschnitt; keine Umstrukturierung.
- Zeitfenster: Standard 7 Tage (27. August – 3. September 2026); Cluster F und I zusätzlich im 48-Stunden-Fenster (1. September – 3. September 2026). Der Reuters-Primärstand vom 26. August 2026 liegt einen Tag vor dem Standard-Fenster, die breite Sekundärrezeption zwischen 27. und 31. August 2026 liegt vollständig innerhalb des Fensters und trägt die Aufnahme.
- Anzahl Suchanfragen: 13 Web-Suchen (Cluster A/B/C/D/F/G/H/I durchsucht) plus zwei Primärquellen-Abrufe (WebFetch BNN Bloomberg Meta Project OT, WebFetch TheNextWeb Meta Project OT). Weiter gefunden: *BMF-Monatsbericht August 2026* mit Kapitel *„AI Economy: Wirkungsszenarien und mögliche Effekte auf öffentliche Finanzen"* (20. August 2026 — außerhalb 7-Tage-Fenster, wiederholter Aufnahmekandidat mit § 3.5-/§ 8.4-/§ 10.2-Bezug, da BMF-Sekundärrezeption der Korinek-/Lockwood-Vorschläge und Diskussion von Rechenleistungs-/KI-Leistungs-Abgaben und Staatsbeteiligungsfonds); *Anthropic Economic Policy Framework* (10. Juni 2026, drei-stufig — außerhalb 7-Tage-Fenster, wiederholter Aufnahmekandidat); *AI Workforce PREPARE Act* (S.3339, Dezember 2025 — außerhalb 7-Tage-Fenster, wiederholter Aufnahmekandidat); *Salesforce*-Layoffs September 2025 (Dublette, bereits in § 1.1 abgedeckt); *Chinese-court-AI-replacement* Hangzhou/Beijing April 2026 (außerhalb 7-Tage-Fenster, wiederholter Aufnahmekandidat mit § 6-/§ 9.5-Bezug); *NBER Working Paper 34984* („Artificial Intelligence, Productivity, and the Workforce: Evidence from Corporate Executives", März 2026 — außerhalb 7-Tage-Fenster, wiederholter Aufnahmekandidat für konzentrierten Cluster-A-Lauf).
- Prinzip *Breite vor Tiefe*: Der aufgenommene Datenpunkt adressiert die in § 3.5 rekonstruierte Sequenz (Brynjolfsson-J-Kurve → McCrory-„jagged capability" → ifo-Konjunkturumfrage → Ma-Sentiment-Sabotage → Goldman-/Bank-of-Korea-Kohortenbefund → FOMC-Minutes) um einen dokumentierten Realfall aus einem der KI-nutzungs­intensivsten Foundation-Model-Betreiber und schließt damit die im Vorlauf verfestigte transatlantische Debattenkonstellation (Version 82.0, Carolina Principles) inhaltlich um einen empirischen Substitutionsbefund. Nicht als eigener Neueintrag aufgenommen: die genannten Aufnahmekandidaten außerhalb des 7-Tage-Fensters beziehungsweise mit vollständiger Dublette.
- Lauf 001 vom 3. September 2026 ist der Folgelauf zu Lauf 001 vom 2. September 2026 (Version 81.0 → 82.0).

### Gefundene Quellen

| # | Cluster | Quelle (Autor/Institution, Titel, Datum) | URL | Bewertung |
|---|---------|-----------------------------------------|-----|-----------|
| 1 | F/A | *Reuters* (Katie Paul), *„Mark Zuckerberg had a bold plan to replace Meta staff with AI. Here's how it imploded"* (Special Report), 26. August 2026 | https://www.reuters.com/business/mark-zuckerberg-had-bold-plan-replace-meta-staff-with-ai-heres-how-it-imploded-2026-08-26/ | übernommen (Primärquelle; WebFetch anbieterseitig gesperrt, Inhalt über breite Sekundärrezeption verifiziert) |
| 2 | F/A | *BNN Bloomberg*, *„Mark Zuckerberg had a bold plan to replace Meta staff with AI. Here's how it imploded"*, 26. August 2026 | https://www.bnnbloomberg.ca/business/company-news/2026/08/26/mark-zuckerberg-had-a-bold-plan-to-replace-meta-staff-with-ai-heres-how-it-imploded/ | übernommen (direkt verifiziert, Kernzahlen +220 %/+36 %/+40 %/+70 %, Zeitpunkt der Absage am 19. Mai 2026 und Zuckerberg-Ankündigung Anfang Juli 2026 vollständig extrahiert) |
| 3 | F/A | *Engadget*, *„Meta reportedly abandoned an AI-focused restructuring plan that would have laid off thousands"*, 26.–27. August 2026 | https://www.engadget.com/2244816/meta-reportedly-abandoned-an-ai-focused-restructuring-plan/ | übernommen (Sekundärrezeption, bestätigt Two-Wave-Struktur und Zieltiefe bis zu sechzig Prozent) |
| 4 | F/A | *TheNextWeb*, *„Meta planned to cut some teams by 60% and replace the work with AI"*, 31. August 2026 | https://thenextweb.com/news/meta-project-ot-ai-native-layoffs-cancelled | übernommen (direkt verifiziert, Auslegungsdetails zur Reuters-Autorin Katie Paul und zum Zahlenverhältnis +220 %/+36 %) |
| 5 | F/A | *Daily Kos*, *„Meta: AI Takeover Plan Fails"*, 30. August 2026 | https://www.dailykos.com/stories/2026/8/30/800091408/community/meta-ai-plan/ | übernommen (Sekundärrezeption) |
| 6 | F/A | *IBTimes*, *„Mark Zuckerberg Reportedly Wanted AI to Replace Meta Workers. The Plan Collapsed Within Months"*, 26.–31. August 2026 | https://www.ibtimes.com/mark-zuckerberg-reportedly-wanted-ai-replace-meta-workers-plan-collapsed-within-months-3806823 | übernommen (Sekundärrezeption) |
| 7 | F/A | *CellCog*, *„Meta's Project OT: The AI-Native Restructuring That Imploded, Explained"*, August 2026 | https://cellcog.ai/blog/meta-project-ot/ | übernommen (Sekundärrezeption, ausführliche Analyse der Vergleichbarkeit mit asiatischen AI-nativen Startups) |
| 8 | F/A | *AI Weekly*, *„Meta's 'Project OT' plan to replace staff with AI is scaled back"*, 30. August 2026 | https://aiweekly.co/alerts/metas-project-ot-plan-to-replace-staff-with-ai-is-scaled-back | übernommen (Sekundärrezeption) |
| 9 | F/A | *Free Press Journal*, *„Meta Explored Upto 60 Per Cent Team Cuts In AI Overhaul Before Zuckerberg Pulled Back: Report"*, 27.–28. August 2026 | https://www.freepressjournal.in/tech/meta-explored-upto-60-per-cent-team-cuts-in-ai-overhaul-before-zuckerberg-pulled-back-report | übernommen (Sekundärrezeption) |
| 10 | F/A | *Yahoo Finance* / *Financial Times*, *„Meta Platforms Almost Slashed 60% of Jobs in AI Push. What Comes Next for META Stock"* / *„Meta's AI Gamble Gets Bigger After the Company Considered Slashing Teams Again"*, 26.–31. August 2026 | https://finance.yahoo.com/markets/stocks/articles/meta-platforms-almost-slashed-60-210316856.html | übernommen (Sekundärrezeption Aktienmarkt-Deutung) |
| 11 | F/A | *MLQ News*, *„Meta Abandoned a Plan to Cut Some Teams by 60% After AI Agents Fell Short"*, August 2026 | https://mlq.ai/news/meta-abandoned-a-plan-to-cut-some-teams-by-60-after-ai-agents-fell-short/ | übernommen (Sekundärrezeption, betont Bezug auf AI-Agent-Reifegrad) |
| 12 | F/A | *The News (Pakistan)*, *„Meta's secret plan to cut 60% of some teams with AI: Report"*, August 2026 | https://www.thenews.com.pk/latest/1413696-metas-secret-plan-to-cut-60-of-some-teams-with-ai-report | übernommen (Sekundärrezeption internationaler Rezeption) |
| 13 | E/H | Bundesministerium der Finanzen, *BMF-Monatsbericht August 2026 — „AI Economy: Wirkungsszenarien und mögliche Effekte auf öffentliche Finanzen"*, 20. August 2026 | https://www.bundesfinanzministerium.de/Monatsberichte/Ausgabe/2026/08/Inhalte/Kapitel-2-Analysen/2-2-ai-economy.html | verworfen (außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat für konzentrierten Cluster-E-/-H-Lauf mit § 3.5-/§ 4.5-/§ 8.4-/§ 10.2-Bezug, da BMF explizit Korinek-/Lockwood-Vorschläge zu Rechenleistungs-/KI-Leistungs-Abgaben und öffentlichen Beteiligungsfonds rezipiert) |
| 14 | D | *Anthropic PBC*, *Economic Policy Framework* (drei-stufig, kalibriert an US-Arbeitslosenquote 5 % / 10 % / historisches Hoch), 10. Juni 2026 | https://www-cdn.anthropic.com/files/4zrzovbb/website/9ea607a5dd67c168093829b701f3a0a6d21156d5.pdf | verworfen (außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat) |
| 15 | B/D | US-Senat, *AI Workforce PREPARE Act* (S.3339, 119. Kongress), Dezember 2025 | https://www.congress.gov/bill/119th-congress/senate-bill/3339/text | verworfen (außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat) |
| 16 | F | *NBC Bay Area* / *CNBC* / *Salesforce Ben*, Salesforce-Layoffs September 2025 (Benioff „reduced from 9,000 heads to 5,000") | https://www.nbcbayarea.com/news/local/salesforce-layoffs-artificial-intelligence/3941975/ | verworfen (Dublette — bereits in § 1.1 dokumentiert; September 2025 außerhalb aller Fenster) |
| 17 | C | *NPR* / *China.org.cn* / *Prism News*, Chinese-court-AI-replacement-Fälle Hangzhou/Beijing, April 2026 | https://www.npr.org/2026/05/01/nx-s1-5807131/tech-worker-china-ai | verworfen (außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat mit § 6-/§ 9.5-Bezug) |
| 18 | A | *NBER Working Paper 34984* (Atlanta-Fed / SF-Fed), *„Artificial Intelligence, Productivity, and the Workforce: Evidence from Corporate Executives"*, März 2026 | https://www.nber.org/papers/w34984 | verworfen (außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat) |

### Eingearbeitete Änderungen

| # | Stelle (§) | Art | Inhalt in einem Satz | Quelle # |
|---|-----------|-----|----------------------|----------|
| 1 | § 3.5 (neuer Absatz *„Empirische Ergänzung USA — AI-native Restrukturierung als Realfall (Reuters-Special-Report vom 26. August 2026 zum Meta Project OT)"* am Ende des empirischen Erweiterungsstrangs, direkt nach dem FOMC-Minutes-Absatz, vor dem Kapiteltrenner zu Kapitel 4) | Ergänzung | Neuer Absatz mit Rekonstruktion des Reuters-Special-Reports vom 26. August 2026 zum Meta-Restrukturierungs­plan *„Project OT"* (Two-Wave-Design Mai/November 2026, Zieltiefe bis zu sechzig Prozent bei einzelnen Teams, tatsächliche Vollziehung am 20. Mai 2026 mit rund achttausend Stellen, Absage der zweiten Welle in der Nacht zum 19. Mai 2026); interne Meta-Produktivitätsdaten +220 % Code-Änderungen gegenüber +36 % neuen Produktfunktionen, +40 % Sicherheitsvorfälle, +70 % Feuerlöscharbeiten; drei abgeleitete Konsequenzen für die Steuerdebatte (Bestätigung der Ma-Sentiment-Sabotage-Auslegung; Präzisierung der McCrory-Aggregatlücke zur Implementierungslücke; Verschärfung der Typ-5-Ersatzabgabe-Kausalattributionsproblematik); Rückwirkung auf § 4.2 Claude.md (Konjunktivpflicht), § 1.1 (Tech-Layoff-Landkarte), § 5.1 und § 8.3 (wertschöpfungs­orientierte Bemessungsbasis), § 8.4 (Systemstabilität), § 9.1 (Kausalattributionsproblem einer engen Typ-5-Ersatzabgabe) und § 10.2 (Empfehlungen). | 1–12 |
| 2 | § 11.5 (neuer Literatureintrag) | Ergänzung | Neuer Eintrag „Meta Platforms, Inc. / Reuters (Katie Paul) / BNN Bloomberg / Engadget / TheNextWeb / Daily Kos / IBTimes / CellCog / AI Weekly / Free Press Journal / Financial Times / Yahoo Finance / MLQ News / The News (Pakistan). (26.–31. August 2026), *Mark Zuckerberg had a bold plan to replace Meta staff with AI. Here's how it imploded / …*" mit zwölf Sekundärquellen-URLs | 1–12 |
| 3 | Dokumentkopf, Aktualitätshinweis, `README.md` (Header + Zitiervorschlag), `Validierung-Ergebnisse.md` | Aktualisierung | Versionssprung 82.0 → 83.0 an vier Stellen konsistent nachgezogen; Stichtag von *2. September 2026* auf *3. September 2026*, Lauf-Kennung von *Lauf 001 vom 2. September 2026* auf *Lauf 001 vom 3. September 2026*, Stand-Angabe *Anfang September 2026* unverändert | — |

### Verworfene Treffer (mit Begründung)

| # | Quelle | Cluster | Begründung |
|---|--------|---------|------------|
| 1 | Bundesministerium der Finanzen, *BMF-Monatsbericht August 2026 — „AI Economy"* (20. August 2026) | E/H | Außerhalb 7-Tage-Fenster (14 Tage zurück); wiederholter Aufnahmekandidat für konzentrierten Cluster-E-/-H-Lauf, da BMF Korinek-/Lockwood-Vorschläge rezipiert |
| 2 | *Anthropic Economic Policy Framework*, 10. Juni 2026 | D | Außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat |
| 3 | US-Senat *AI Workforce PREPARE Act* (S.3339), Dezember 2025 | B/D | Außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat |
| 4 | *Salesforce*-Layoffs September 2025 („4.000 Stellen"; Benioff „reduced from 9,000 to 5,000") | F | Dublette — bereits in § 1.1 dokumentiert; September 2025 außerhalb aller Fenster |
| 5 | *Chinese-court-AI-replacement*-Fälle Hangzhou/Beijing, April 2026 | C | Außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat mit § 6-/§ 9.5-Bezug |
| 6 | *NBER Working Paper 34984* („Artificial Intelligence, Productivity, and the Workforce"), März 2026 | A | Außerhalb 7-Tage-Fenster; wiederholter Aufnahmekandidat |

### Verarbeitungsschritte

- Recherche abgeschlossen: Ja
- Deduplikation gegen Hauptdokument: Ja
- Validierung gemäß `Validierung.md` ausgeführt: Ja (siehe Block *Validierung 3. September 2026 (Lauf 001 vom 3. September 2026) — Version 82.0 → Version 83.0* in `Validierung-Ergebnisse.md`)
- PDF erstellt (`build_pdf.py`): Ja
- Word erstellt (`build_docx.py`): Ja
- Versionsnummer in Hauptdokument, README, Validierung-Ergebnisse aktualisiert: Ja
- E-Mail-Kanal (Phase 5b): Fallback-Datei `daily-mail.txt` im Repo-Root geschrieben (kein `mail_send`/`send_mail`/`outlook_send`-Tool in dieser Session erreichbar; Datei ist gitignored)
...
- **NBER Working Paper 34984 (Atlanta-Fed / SF-Fed):** komplementäre Executive-Survey-Evidenz zu Ma (2026) und McCrory (2026), außerhalb 7-Tage-Fenster; als Aufnahmekandidat für konzentrierten Cluster-A-Lauf vorgemerkt.
- **Chinese-court-AI-replacement-Fälle (Hangzhou/Beijing, April 2026):** Präzedenz für eine Legislativ-/Judikativ-Beschränkung KI-getriebener Layoffs, außerhalb 7-Tage-Fenster; Aufnahmekandidat mit § 6-/§ 9.5-Bezug vorgemerkt.
- **Reuters-Primärquelle:** WebFetch auf reuters.com anbieterseitig gesperrt (paywalled/anti-bot); Inhalt vollständig über zwölf unabhängige Sekundärquellen verifiziert — Belastbarkeit unverändert.
